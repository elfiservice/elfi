 ...
 */
		...
		$sql_n_orc = mysql_query("SELECT * FROM clientes WHERE id = '$ID_cliente' ") or die (mysql_error()); 
		//$n_linhas_orc_feitos = mysql_num_rows($sql_n_orc); 
					
			$linha = mysql_fetch_object($sql_n_orc);			
			$nome_cliente = $linha->razao_social;
...
<h3> Cliente: <?php echo $nome_cliente; ?> </h3>

	
	
<fieldset>
    <legend><h3>Orçamentos executados</h3></legend>	
...
<TABLE class="display" id="example"  >
	...
	<tbody>
<?php
       $sql = "SELECT * FROM acompanhamento WHERE cliente = '$nome_cliente'";
        $res = mysql_query( $sql );
...
echo "<TR><TD align=\"center\">".$n_orc."</TD> <TD align=\"center\">".$ano_orc."</TD> <td>".$inf_servicos."</td> <TD align=\"center\">".$valor_orc."</TD></TR>";		

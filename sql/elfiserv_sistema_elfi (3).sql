...
-- Tempo de Geração: 15/04/2016 às 20:13
-- Versão do servidor: 5.5.34-cll-lve
...
--
-- Banco de dados: `elfiserv_sistema_elfi`
--
...
CREATE TABLE IF NOT EXISTS `acompanhamento` (
  ...
  `colab` varchar(100) NOT NULL,
  `cliente` varchar(200) NOT NULL,
  `atividade` varchar(100) NOT NULL,
  `classificacao` varchar(100) NOT NULL,
  `inf_servicos` varchar(500) NOT NULL,
  `novo_cliente` enum('n','s') NOT NULL,
  `n_orc` varchar(10) NOT NULL,
  `prazo_exec` int(5) NOT NULL,
  `data_aprovada` date NOT NULL,
  `ano` varchar(5) NOT NULL,
  `email` varchar(200) NOT NULL,
  `data_inicio` date NOT NULL,
  `data_conclusao` date NOT NULL,
  `dias_d_aprovado` int(11) NOT NULL,
  `dias_d_exec` int(11) NOT NULL,
  `dias_ultrapassad` int(11) NOT NULL,
  `serv_concluido` enum('n','s') NOT NULL,
  `feito_pos_entreg` enum('n','s') NOT NULL,
  `nao_conformidade` enum('n','s') NOT NULL,
  `obs_n_conformidad` varchar(500) NOT NULL,
  `client_insatisfeito` enum('n','s') NOT NULL,
  `vr_orc` decimal(20,2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=220 ;

--
-- Fazendo dump de dados para tabela `acompanhamento`
--

INSERT INTO `acompanhamento` (`id`, `colab`, `cliente`, `atividade`, `classificacao`, `inf_servicos`, `novo_cliente`, `n_orc`, `prazo_exec`, `data_aprovada`, `ano`, `email`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `vr_orc`) VALUES
(6, 'junior', 'CONDOMINIO DO SHOPPING CENTER IGUATEMI', 'ManutenÃ§Ã£o', 'Disjuntor', '- PROPOSTA PARA SERVICO DE INSTALACAO E MANUTENCAO CORRETIVA DE UM DISJUNTOR SIEMENS, TIPO AC3 -BRA 800A/15KV, CONFORME ABAIXO:<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO PARA IGUATEMI<br /><br /><br /><br />\r\n- RETIRADA DO VAZAMENTO DE OLEO DOS POLOS COM TROCA<br /><br /><br /><br />\r\nDE GUARNICOES DE VEDACAO LAVAGEM E TROCA DE CARGA DE<br /><br /><br /><br />\r\nOLEO DOS POLOS<br /><br /><br /><br />\r\n- REGULAGEM E LUBRIFICACAO DO C', 'n', '66.2013', 15, '2014-01-02', '2014', 'rafael.silva@iguatemifortaleza.com.br', '2014-04-14', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '3480.00'),
(7, 'junior', 'BRADESCO - AGENCIA WALDEMAR DE ALCANTARA', 'ServiÃ§o TÃ©cnico', 'Transformador', 'CONSULTORIA E VISTORIA TECNICA DE VERIFICACAO DO TAP DO TRANSFORMADOR E FORNECIMENTO DA TENSAO NA<br /><br />\r\nAGENCIA WALDEMAR DE ALCANTARA J. 0683 - SERVICO EXECUTADO DIA 04 E 06 DE JANEIRO DE 2014', 'n', '64.2013', 1, '2014-01-03', '2014', 'lucas.branco@cw-opr.com.br', '2014-01-04', '2014-01-07', 0, 0, 2, 's', 's', 'n', '', 'n', '900.00'),
(10, 'junior', 'ESMALTEC S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DE UMA SUBESTACAO DE 69KV, COM (02) TRANSFORMADORES DE 5.000 KVA E QUATRO SUBESTACOES DE MEDIA TENSAO EM CLASSE 15KV, ONDE ENCONTRAM-SE DISTRIBUIDOS (05) TRANSFORMADORES DE<br />\r\n1,5KVA, (03) TRANSFORMADORES 1,0KVA E (01)TRANSFORMADOR 0,5KVA.', 'n', '18.2013', 1, '2014-01-08', '2014', 'gilson.chaves@esmaltec.com.br', '2014-01-12', '2014-01-13', 0, 0, 0, 's', 's', 'n', '', 'n', '19077.00'),
(11, 'junior', 'SEICOM-SERVICOS ENGENHARIA E INSTALACAO', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ABRIGADA,BLINDADA, COM UM TRANSFORMADOR DE 500KVA A SECO,DISJUNTOR DE ALTA TENSAO, CHAVES SECCIONADORAS E TRES QUADROS GERAIS DE BAIXA TENSAO, CONFORME RELACAO DE SERVICOS ABAIXO:<br /><br /><br /><br />\r\n- SERVICO DE TERMOGRAFIA ESTA INCLUSO NA PROPOSTA<br /><br /><br /><br />\r\nLOCAL DO SERVICO: CENTRAL VIVO E TELEFONIA - RUA<br /><br /><br /><br />\r\nGONCALVES LEDO NÂ° 911 - PRAIA DE IRACEMA - 085-81670305', 'n', '1', 5, '2014-01-13', '2014', 'julio.lima@seicom.com', '2014-02-22', '2014-02-24', 1, 0, 0, 's', 's', 'n', '', 'n', '2700.00'),
(12, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'SPDA', 'MANUTENCAO CORRETIVA NO SISTEMA DE PARA-RAIOS (SPDA) DOS SEGUINTES BRINQUEDOS:<br /><br /><br />\r\n- RAMU-BRINCAR<br /><br /><br />\r\n- ARREPIOS<br /><br /><br />\r\n- INSANO<br /><br /><br />\r\nNO RAMU-BRINCAR E NO ARREPIOS SERA FEITA UMA MALHA DE TERRA PARA CADA.<br /><br /><br />\r\nMATERIAL FONECIDO PELA ELFI.<br /><br /><br />\r\nSERVICO REALIZADO EM ALTURA COM PESSOAL DE RAPEL.', 'n', '068.2014', 10, '2014-01-15', '2014', 'ricardo@beachpark.com.br', '2014-01-22', '2014-05-16', 0, 0, 105, 's', 'n', 'n', '', 'n', '13470.00'),
(13, 'junior', 'BANCO BRADESCO AG Montese J. 1379', 'ServiÃ§o TÃ©cnico', 'Transformador', 'SERVICO DE TROCA DE TAP DO TRANSFORMADOR DA SUBESTACAO PARA AJUSTE DE TENSAO CONFORME SOLICITADO POR EMAIL<br /><br />\r\nCHAMADO: 07838975<br /><br />\r\nAGENCIA: MONTESE URB. FORTALEZA<br /><br />\r\nJUNCAO: 1379', 'n', '18', 1, '2014-01-21', '2014', 'guilherme.lopes@cw-opr.com.br', '2014-01-25', '2014-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '1180.00'),
(14, 'junior', 'YPIOCA AGROINDUSTRIAL LTDA', 'ManutenÃ§Ã£o', 'Transformador', '- MANUTENCAO CORRETIVA EM UM TRASFORMADOR DE 225KVA NÂ° 120.527, CONFORME DESCRICAO ABAIXO.<br /><br />\r\n- RELACAO DE SERVICOS:<br />\r\n- TRANSPORTE CAMINHAO MUCK PARA PEGAR E LEVAR DE VOLTA PARA INDUSTRIA EM PARAIPABA<br />\r\n- DESENCAIXOTAMENTO<br />\r\n- SUBISTITUICAO DE 1 COLUNA DE ALTA TENSAO "H2"<br />\r\n- SECAGEM DA PARTE ATIVA EM ESTUFA<br />\r\n- TROCA DE TODAS GUARNICOES E VEDACOES<br />\r\n- TRATAMENTO DAS PECAS OXIDADAS', 'n', '17', 20, '2014-01-22', '2014', 'hipolito.alves@ypioca.com.br', '2014-01-25', '2014-01-30', 0, 0, 0, 's', 's', 'n', '', 'n', '4000.00'),
(15, 'junior', 'ADEL COCO BRASIL', 'InstalaÃ§Ã£o', 'Aterramento', '- INSTALACAO DE ATERRAMENTO COM MALHA EM UM TANQUE CONFORME ESBOCO FORNECIDO POR EMAIL.<br /><br /><br /><br /><br />\r\n- MATERIAL FORNECIDO PELA ELFI<br /><br /><br /><br /><br />\r\n- MEDICAO DO ATERRAENTO COM FORNECIMENTO DE LAUDO E ART DO CREA.<br /><br /><br /><br /><br />\r\n- LOCAL: TRAIRI-CE', 's', '2', 2, '2014-01-24', '2014', 'compras@adelcoco.com.br', '2014-01-28', '2014-01-28', 0, 0, 0, 's', 's', 'n', '', 'n', '2980.00'),
(16, 'junior', 'OSASUNA PARTICIPACOES LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'SERVICO EMERGENCIAL EXECUTADO DIA 27/01/2014 AS 09:00:<br /><br /><br />\r\nLOCAL: JANGADEIRO TEXTIL,<br /><br /><br />\r\nEQUIPAMENTO: SUBESTACAO DE ENERGIA DE 150 KVA AEREA<br /><br /><br />\r\nMOTIVO: CURTO-CIRCUITO, QUEIMA DAS "CANELAS" DAS<br /><br /><br />\r\nCHAVES SECCIONADORAS UNIPOLARES.<br /><br /><br />\r\nREPARO: REALIZADA A TROCA DOS ELOS FUSIVEIS, FEITO UMA<br /><br /><br />\r\nLIMPEZA NAS BUCHAS COM REAPERTO DAS CONEXOES DO<br /><br /><br />\r\nTRANSFORMADOR.', 'n', '22', 1, '2014-01-27', '2014', 'ivon@jangadeirotextil.com.br', '2014-01-27', '2014-01-27', 3, 0, 0, 's', 's', 'n', '', 'n', '646.00'),
(17, 'junior', 'DOM PASTEL SELF-SERVICE LTDA-ME', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA REALIZAR A ETAPA DE INSTERLIGACAO DA SE-300KVA (NOVA) COM O NOVO QGBT, INTERLIGAR O NOVO<br /><br /><br /><br />\r\nQGBT COM O QDF (EXISTENTE DA SE-112,5KVA - GERADOR), PARA PODER DESATIVAR A SUBESTACAO ANTIGA.', 'n', '9', 5, '2014-01-30', '2014', 'marconisantana1@gmail.com', '2014-02-03', '2014-02-18', 0, 0, 11, 's', 's', 'n', '', 'n', '3000.00'),
(18, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'MATERIAL FORNECIDO DIA 28/JAN/14 PARA SERVICO BEACH GRILL - OS 23.2013 DA ELFI, ONDE ESTE SO COBRI MAO DE<br /><br /><br />\r\nOBRA.<br /><br /><br />\r\n- ABRACADEIRAS CHAVETA<br /><br /><br />\r\n- COND. ALUM. 02<br /><br /><br />\r\n- CABO FLEX 1KV 2X1,5MM<br /><br /><br />\r\n- TERM. PRESSAO 240MM<br /><br /><br />\r\n- PARAFUSOS CAB. PAN AA<br /><br /><br />\r\n- TOMADA 2P+T P/ CONDULETE<br /><br /><br />\r\n- TERM. PRESSAO 400MM<br /><br /><br />\r\n- ACESSORIOS', 'n', '25', 1, '2014-01-28', '2014', 'emerson@beachpark.com.br', '2014-01-28', '2014-01-31', 8, 0, 2, 's', 's', 'n', '', 'n', '450.00'),
(19, 'junior', 'CONDOMINIO LIVING', 'ServiÃ§o TÃ©cnico', 'Transformador', 'SERVICO DE TROCA DE TAP DO TRANSFORMADOR DA SUBESTACAO PARA AJUSTE DE TENSAO, SE Cond. Living', 'n', '30', 1, '2014-02-07', '2014', 'jcamelo@beachpark.com.br', '2014-02-07', '2014-02-07', 0, 0, 0, 's', 's', 'n', '', 'n', '900.00'),
(20, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'MediÃ§Ã£o', 'Aterramento', 'REALIZAR TESTE DE RESISTENCIA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA<br /><br /><br /><br />\r\nSPDA. COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM ART DO CREA-CE.<br /><br /><br /><br />\r\nLOCAL: SESC CRATO-CE; DISTANCIA: 1050 KM ( IDA E VOLTA), APROXIMADO 08 HORAS DE VIAGEM.<br /><br /><br /><br />\r\n', 'n', '29', 2, '2014-02-07', '2014', 'abatista@sesc-ce.com.br', '2014-02-14', '2014-02-14', 0, 0, 0, 's', 's', 'n', '', 'n', '1810.00'),
(21, 'junior', 'INVESTAR HOTELARIA S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENÃ‡ÃƒO PREVENTIVA DA SUBESTAÃ‡ÃƒO ABRIGADA COM DOIS TRANSFORMADORES A SECO DE 500KVA, DISJUNTOR DE MEDIA TENSÃƒO, CHAVES SECCIONADORAS E QUADRO GERAL DE BAIXA TENSÃƒO.', 'n', '24', 3, '2014-02-12', '2014', 'infra.fortaleza@bluetree.com.br', '2014-02-26', '2014-02-27', 1, 0, 0, 's', 's', 'n', '', 'n', '1500.00'),
(22, '', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'ServiÃ§o TÃ©cnico', 'Equipamento SubestaÃ§Ã£o', 'TROCA DA CHAVE SECCIONADORA TRIPOLAR DE 15 VK, 400 A, DO ITEM "A" DO RELATORIO. (Abertura com Carga)', 'n', '44.2013', 1, '2014-02-19', '2014', 'ednardo@beachpark.com.br', '2014-02-25', '2014-02-25', 0, 0, 0, 's', 's', 'n', '', 'n', '2100.00'),
(23, '', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'InstalaÃ§Ã£o', 'SPDA', 'FORNECIMENTO DE MATERIAIS PARA MANUTENCAO CORRETIVA NO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS (SPDA) DO HOTEL MARIUBA', 'n', '27', 1, '2014-02-19', '2014', 'ednardo@beachpark.com.br', '2014-02-25', '2014-02-25', 0, 0, 0, 's', 's', 'n', '', 'n', '1841.00'),
(24, 'junior', 'OSASUNA PARTICIPACOES LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA BLINDADA COM TRES TRANSFORMADORES DE 1000KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS E UMA SUBESTACAO AEREA DE 225 KVA, CONFORME DESCRICAO DOS SERVICOS EM ANEXO<br /><br /><br /><br />\r\nCOM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA-CE.', 'n', '51', 5, '2014-02-20', '2014', 'ivon@jangadeirotextil.com.br', '2014-03-04', '2014-03-10', 0, 0, 1, 's', 's', 'n', '', 'n', '4239.00'),
(25, 'junior', 'CONSTRUTORA GRANITO LTDA', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '00ESTAMOS PASSANDO PROPOSTA DE MAO DE OBRA PARA FAZER AMPLIACAO DA PARTE ELETRICA DE MEDIA TENSAO, 15KV, COM INSTALACAO DO CUBICULO DE ENTRADA DE ENERGIA 15KV,(DISJUNTOR, CHAVE, ISOLADORES, BARRAMENTO, ETC), TROCA DOS CABOS DA REDE AEREA TRIFASICA EM ALUMINIO 1/0AWG, COM EXTENSAO APROXIMADO DE 270M, DESCONEXAO DOS CABOS DE MEDIA TENSAO QUE ALIMENTA OS TRANSFORMADORES E INSTALAR UM BAYPASS PROVISORIO ENQUANTO OS NOVOS CUBICULOS METALICOS SAO INSTALADOS. E INTERLIGACAO DOS CABOS DE BAIXA TENSAO DO', 'n', '35', 45, '2014-02-18', '2014', 'compras@granito.com.br', '2014-04-15', '2014-06-15', 9, 0, 0, 's', 'n', 'n', '', 'n', '55000.00'),
(26, 'junior', 'CONSTRUTORA GRANITO LTDA', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', 'Projeto e INSTALACAO DE UMA SUBESTACAO AEREA DE 112,5KVA EM CASCAVEL-CE<br /><br /><br /><br />\r\n', 'n', '46', 45, '2014-02-24', '2014', 'compras@granito.com.br', '2014-03-18', '2014-05-18', 3, 0, 0, 's', 'n', 'n', '', 'n', '6000.00'),
(27, 'junior', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'NSTALACAO DE DOIS FUSIVEL PARA O TP, FORNECIDOS PELA MRH.<br /><br /><br /><br /><br />\r\n- INSTALACAO DE DOIS FUSIVEL DE 15KV NO TRANSFORMADOR DE POTENCIA DENTRO DA SUBESTACAO<br /><br /><br /><br /><br />\r\n- TROCA DE UM NOBREAK E DE UMA FONTE CAPACITIVA DA SUBESTACAO, DENTRO DO CONTRATO<br /><br /><br /><br /><br />\r\n- PROGRAMACAO DO SERVICO PARA O DIA 09.03.2014, DEPOIS DA APROVACAO DA PROPOSTA', 'n', '56', 1, '2014-02-28', '2014', 'marliete@mrhgestao.com.br', '2014-03-16', '2014-03-18', 0, 0, 1, 's', 's', 'n', '', 'n', '660.00'),
(28, 'junior', 'BANCO CENTRAL DO BRASIL - BACEN', 'ManutenÃ§Ã£o', 'Gerador', 'SERVICO - REVISAO/INSPECAO GERAL DO GRUPO GERADOR COM FORNECIMENTO DE PECAS:<br /><br /><br /><br />\r\n2891 BICO INJETORES 6,00<br /><br /><br /><br />\r\n2892 UNIAO FLEXIVEL DE ACO 6 X 350MM 1,00<br /><br /><br /><br />\r\n2893 SUPORTE DE FERRO P/ FIXACAO DA DESCARGA 1,00<br /><br /><br /><br />\r\n2894 FLANGE DE ACOPLAMENTO DA DESCARGA 2,00<br /><br /><br /><br />\r\n2895 PARABOLT DE 9/16'' X 3'' 4,00', 'n', '53', 20, '2014-03-05', '2014', 'nero.torres@bcb.gov.br', '2014-03-06', '2014-03-10', 1, 0, 0, 's', 's', 'n', '', 'n', '12530.00'),
(29, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'INSTALACAO DE 02 DISJUNTORES TIPO CAIXA MOLDADA DE 175 1,00 4.860,00 4.860,00<br /><br /><br />\r\nA 250A AJUSTAVEL, TRIFASICO, PARA ALIMENTAR OS<br /><br /><br />\r\nCOMPRESSORES NA UNIDADE DO IJF.<br /><br /><br />\r\nMATERIAL FORNECIDO PELA ELFI:<br /><br /><br />\r\n- 02 UND DISJUNTOR TRIPOLAR AJUSTAVEL 175-250A, CAIXA<br /><br /><br />\r\nMOLDADA<br /><br /><br />\r\n- 12 UND TERMINAL DE COMPRESSAO PARA CABO 120MMÂ²<br /><br /><br />\r\n- 12 M CABO ISOLADO 120MM 1KV', 'n', '61.2013', 1, '2014-03-07', '2014', 'allysson_mesquita@praxair.com', '2014-03-12', '2014-03-13', 0, 0, 0, 's', 's', 'n', '', 'n', '4860.00'),
(30, 'junior', 'BRADESCO AG. SENADOR POMPEU', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO DA SUBESTACAO ABRIGADA DE 225KVA, DA AGENCIA SENADOR POMPEU ONDE SE REALIZADO O SERVICOS', 'n', '62', 2, '2014-03-07', '2014', '0678.gerencia@bradesco.com.br', '2014-03-08', '2014-03-10', 0, 0, 0, 's', 's', 'n', '', 'n', '2600.00'),
(31, 'junior', 'DOM PASTEL SELF-SERVICE LTDA-ME', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '- PROPOSTA PARA INSTALACAO DE SUBESTACAO DE 300KVA, 1,00 8.680,00 8.680,00<br /><br /><br />\r\nCONFORME DESCRICAO DOS SERVICOS ABAIXO:<br /><br /><br />\r\n- DESMONTAGEM DA SUBESTACAO DE 300KVA (NOVA) E<br /><br /><br />\r\nINSTALAR EM OUTRO LOCAL AO LADO DE SE-112,5KVA<br /><br /><br />\r\n(EXISTENTE)<br /><br /><br />\r\n- REMOCAO DA SE- 112,5KVA PARA INSTALACAO DA SE-300KVA<br /><br /><br />\r\n(NOVA)<br /><br /><br />\r\n- INSTERLIGACAO DA SE-300KVA COM O NOVO QGBT<br /><br /><br />\r\n- ALUGUEL DE CAMINHA', 'n', '65', 5, '2014-03-12', '2014', 'marconisantana1@gmail.com', '2014-03-28', '2014-03-29', 0, 0, 0, 's', 's', 'n', '', 'n', '7500.00'),
(32, 'junior', 'INVESTAR HOTELARIA S/A', 'MediÃ§Ã£o', 'Aterramento', 'MEDICAO E INSPECAO DO SPDA COM LAUDO TECNICO E ART EM UM TOTAL DE TRES DESCIDAS.', 'n', '73', 2, '2014-03-18', '2014', 'infra.fortaleza@bluetree.com.br', '2014-03-18', '2014-03-20', 0, 0, 0, 's', 's', 'n', '', 'n', '1100.00'),
(33, '', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', 'InstalaÃ§Ã£o', 'Banco de Capacitores', 'INSTALACAO DE BANCO CAPCITOR DE 25KVR EM 440V SEMI-AUTOMATICO NA SUBESTACAO.', 'n', '77', 5, '2014-03-24', '2014', 'josegilmar@beachpark.com.br', '2014-03-26', '2014-03-02', 0, 0, 0, 's', 's', 'n', '', 'n', '3150.00'),
(34, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACAO EM CARATER DE EMERGENCIAL DE 3 TERMINAIS DE COMPRESSAO DE 400MM, E ISOLAMENTO COM FITA DE AUTA FUSAO, PARTE DOS CABOS DANIFICADOS. ESTE TRABALHO FOI REALIZADO NO DIA 29 E 30/03/2014, AS 18 HORAS AS 3:00 DA MADRUGADA POR UMA EQUIPE DE QUATRO TECNICOS DA ELFI. O LOCAL DO SERVICO FOI REALIZADO NA CASA DE MAQUINA DA ARCA DE NOE.', 'n', '87', 1, '2014-03-29', '2014', 'emerson@beachpark.com.br', '2014-03-29', '2014-03-29', 4, 0, 0, 's', 's', 'n', '', 'n', '2380.00'),
(35, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA INSTALACAO DE 3 CHAVES FUSIVEIS UNIPOLAR 400A,25KV COM 3 ELO FUSIVEL 50K, NO POSTE DO RAMAL DE ENTRADA DA SUBESTACAO DE 90KVA.', 'n', '86', 1, '2014-04-08', '2014', 'francisco.aves@estacio.br', '2014-04-13', '2014-04-13', 2, 0, 0, 's', 's', 'n', '', 'n', '1620.00'),
(36, 'junior', 'CONSORCIO CETENCO ENGENHARIA', 'MediÃ§Ã£o', 'Aterramento', 'SERVICO DE MEDICAO RESISTENCIA OHMICA DE ATERRAMENTO EM 20 CONTAINERS E 2 GRUPOS GERADORES SENDO UM DE 180KVA E OUTRO DE 100KVA. COM EMISSAO DE LAUDO COM ART DO CREA-CE', 's', '93', 4, '2014-04-11', '2014', 'rialto.ibanez.mira@acciona.com', '2014-04-16', '2014-04-16', 0, 0, 0, 's', 's', 'n', '', 'n', '1700.00'),
(37, 'junior', 'STL INFORMATICA LTDA ', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO.', 'n', '88', 1, '2014-04-11', '2014', 'nunes@stl.com.br', '2014-05-24', '2014-05-25', 3, 0, 0, 's', 'n', 'n', '', 'n', '1467.00'),
(38, 'junior', 'EMERSON NETWORK POWER DO BRASIL LTDA', 'MediÃ§Ã£o', 'Aterramento', 'MEDICAO DA RESISTENCIA OHMICA DO ATERRAMENTO EM 09 (NOVE) PONTOS COM EMISSAO DE ART DO CREA E LAUDO TECNICO.', 'n', '94', 1, '2014-04-16', '2014', 'antonio.glayton@emerson.com', '2014-04-16', '2014-04-16', 0, 0, 0, 's', 's', 'n', '', 'n', '800.00'),
(39, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'InstalaÃ§Ã£o', 'Gerador', 'INSTALACAO DE UM GRUPO GERADOR PROVISORIO COM INTERLIGACAO DOS CABOS NO BARRAMENTO DE EMERGENCIA DA USCA (APOS O SERVICO SERA REALIZADO TESTE).', 'n', '101', 2, '2014-04-17', '2014', 'francisco@holidayfortaleza.com.br', '2014-04-17', '2014-04-18', 5, 0, 0, 's', 's', 'n', '', 'n', '1605.00'),
(40, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'ServiÃ§o TÃ©cnico', 'Plantonista', '- LOCACAO HOMEM X HORA DE UM ELETRECISTA PLANTONISTA NO PERIODO DE 15 DIAS PARA ACIONAMENTO DO GERADOR (VALOR DO HOMEM X HORA)', 'n', '102', 30, '2014-04-17', '2014', 'francisco@holidayfortaleza.com.br', '2014-04-17', '2014-05-13', 5, 0, 0, 's', 's', 'n', '', 'n', '25.00'),
(41, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACAO COM MODERNIZACAO DE UM QUADRO DE COMANDO PARA ACIONAMENTO DAS BOMBAS COM INTERTRAVAMENTO DAS MESMAS ATRAVES DE SOFT-STARTER. COM FORNECIMENTO DE TODO MATERIAL PELA ELFI. NOTA: SERA FORNECIDO DIAGRAMA UNIFILAR DO QUADRO', 'n', '40', 6, '2014-04-24', '2014', 'gustavo_oliveira@praxair.com', '2014-05-05', '2014-05-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '23507.00'),
(42, 'junior', 'AGROPAULO AGROINDUSTRIAL S.A', 'ManutenÃ§Ã£o', 'Transformador', 'MANUTENCAO DE UM TRANSFORMADOR DE 750KVA NÂ° BI47/78 FABRICACAO INOUSELET, ANO DE FABRICACAO 1978, SEGUE ABAIXO RELACAO DE SERVICO:<br /><br /><br /><br />\r\n- RECUPERACAO DE FIO PARTIDO NA DERIVACAO DA COLUNA H2<br /><br /><br /><br />\r\n- DESENCAIXOTAMENTO DA PARTE ATIVA;<br /><br /><br /><br />\r\n- PINTURA GERAL DA CAIXA, TAMPA E RADIADORES;<br /><br /><br /><br />\r\n- RETIRADA DE VAZAMENTO COM A TROCA DE TODAS AS GUARNICOES DE VEDACOES;<br /><br /><br /><br />\r\n- TRATAR E COMPLETAR O OLEO ISOLAN', 'n', '98', 15, '2014-04-24', '2014', 'bruno.rafael@agropaulo.com', '2014-04-16', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '3676.00'),
(43, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- PROPOSTA PARA INSTALACAO DE REDE ELETRICA PARA FAZER CORRECAO NUM CIRCUITO ELETRICO COM SUBISTITUICAO DOS<br /><br /><br />\r\nCABOS QUE SE ENCONTRA EXPOSTO E PASSA NOVA FIACAO NA TUBULACAO PARA ALIMENTACAO DE DOIS PAINEIS DA ADMINISTRACAO.<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELO BEACH PARK<br /><br /><br />\r\nABAIXO:<br /><br /><br />\r\n- 60 MT CABO FLEX 1KV 50MM<br /><br /><br />\r\n- 15 UND LUNA DE COMPRESSAO PARA CABO DE 50MM<br /><br /><br />\r\n- 02 UND FITA ISOLANTE DE BAIXA TEN', 'n', '82', 1, '2014-04-15', '2014', 'ricardo@beachpark.com.br', '2014-04-25', '2014-04-25', 10, 0, 0, 's', 's', 'n', '', 'n', '2640.00'),
(44, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DA SUBESTACAO DE 500KVA DA UNIDADE SESC CENTRO: LIMPEZA DOS CUBICULOS INCLUINDO TRANSFORMADORES DE CORRENTES, DISJUNTORES, CHAVE SECCIONADORA, QUADRO GERAL, MEDICAO DE RESISTENCIA DE ISOLAMENTO DO TRANSFORMADOR, CONFORME RELACAO DE SERVICOS EM ANEXO.', 'n', '106', 13, '2014-04-25', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-05-10', '2014-05-15', 0, 0, 0, 's', 'n', 'n', '', 'n', '1600.00'),
(45, 'junior', 'SUPERINTENDENCIA REG. DO TRAB. E EMPREGO - SRTE-CE', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACAO DE UM DISJUNTOR TRIFASICO DE 250A, COM CABIACAO, TERMINAIS FITAS ISOLANTES ETC', 'n', '116', 1, '2014-04-28', '2014', 'arnaldo.amaral@mte.gov.br', '2014-04-28', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '1400.00'),
(46, 'junior', 'EMPRESA BRASILEIRA DE BEBIDAS E ALIMENTOS S/A', 'InstalaÃ§Ã£o', 'SPDA', 'SERVICOS DE ADEQUACAO E INSTALACAO DO SISTEMA PROTECAO CONTRA DESCARGA ATMOSFERICAS (S.P.D.A) NOS PREDIOS DA EBBA, CONFORME ESCOPO DE SERVICOS FORNECIDOS COM PROJETO E RELACAO DE MATERIAS. <br /><br /><br />\r\nNOTA: MATERIAL FORNECIDO PELA EBBA, CONFORME RELACAO QUE SEGUE EM ANEXO. NO MODELO DA EBBA.', 's', '60', 20, '2014-04-30', '2014', 'rebeca.correia@ebba.com.br', '2014-06-09', '2014-10-16', 2, 0, 109, 's', 'n', 'n', '', 'n', '39000.00'),
(48, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'INSTALACAO DE MEDIDOR DE GRANDEZAS ELETRICAS EM TRES TRANSFORMADORES DE 300KVA, POR UM PERIODO DE 24 HORAS EM CADA TRAFO ( DIAS UTEIS ), PARA ANALISAR A QUALIDADE DE ENERGIA NO SISTEMA FIC; ONDE SERA FORNECIDO RELATORIO COM OS VALORES DE : POTENCIA ATIVA E REATIVA ENTRE FASES - CORRENTE POR FASE PARA ANALISAR POSSIVEIS ESBALANCIAMENTOS MEDICAO DE FATOR DE POTENCIA.', 'n', '96', 6, '2014-05-08', '2014', 'francisco.alves@estacio.br', '2014-05-12', '2014-05-22', 0, 0, 4, 's', 's', 'n', '', 'n', '3360.00'),
(49, 'junior', 'CONSTRUTORA GRANITO LTDA', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA INSTALACAO DE UMA SUBESTACAO AEREA DE 45 KVA, COM PROJETO APROVADO NA COELCE NO MUNICIPIO DE ALTO SANTO - CE.<br /><br /><br />\r\n- PROJETO COM MAO DE OBRA PARA INSTALACAO', 'n', '97', 30, '2014-04-15', '2014', 'orcamento@granito.com.br', '2014-05-05', '2014-08-05', 23, 0, 0, 's', 'n', 'n', '', 'n', '7690.00'),
(50, 'junior', 'STOCK TECH LOGISTICA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACAO DE 03 PROJETORES NA AREA AMINISTRATIVA, PARTE EXTERNA E NO ESTACIONAMENTO. TODO MATERIAL FORNECIDO PELA STOCKTECH.', 'n', '74', 3, '2014-05-09', '2014', 'evandro.alves@stocktech.com.br', '2014-05-19', '2014-05-22', 0, 0, 0, 's', 's', 'n', '', 'n', '1480.00'),
(51, 'junior', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '- MANUTENCAO PREVENTIVA NA SUBESTACAO ABRIGADA E CORRETIVA:<br /><br /><br /><br /><br />\r\n- REALIZAR A TROCA DA CARGA DE OLEO ISOLANTE DO TRAFO DE 225KVA, NÂ° 122026<br /><br /><br /><br /><br />\r\n- MANUTENCAO PREVENTIVA DA SUBESTACAO CONFORME RELACAO DE SERVICO ABAIXO (BANCO CAPACITOR JA INCLUSO)', 'n', '122', 2, '2014-05-12', '2014', 'wellington@cdlfor.com.br', '2014-05-25', '2014-05-26', 0, 0, 0, 's', 's', 'n', '', 'n', '4084.00'),
(52, 'junior', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', 'MediÃ§Ã£o', 'SPDA', 'PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO DA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA-CE.', 'n', '123', 2, '2014-05-12', '2014', 'wellington@cdlfor.com.br', '2014-05-14', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '1100.00'),
(53, 'junior', 'MANSERV MONTAGEM E MANUTENCAO S/A', 'MediÃ§Ã£o', 'Aterramento', 'MEDEICAO DE ATERRAMENTO EM UM PONTO DE TOMADA, NO SEGUNDO ANDAR DO EDIFICIO POTENZA, SALA 212 A 215. SERA EMITIDO LAUDO COM ART DO CREA-CE.', 's', '134', 1, '2014-05-16', '2014', 'admfort@br.ibm.com', '2014-05-16', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '600.00'),
(54, 'junior', 'STOCK TECH LOGISTICA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA EM UMA SUBESTACAO ABRIGADA COM UM TRAFO DE 1.000 KVA, DISJUNTOR DE MEDIA TENSAO, QGBT E BANCO CAPACITORES, CONFORME RELACAO DE SERVICOS ABAIXO:', 'n', '44', 18, '2014-05-16', '2014', 'valdair.souza@stocktech.com.br', '2014-05-25', '2014-06-12', 0, 0, 0, 's', 's', 'n', '', 'n', '2413.00'),
(55, 'junior', 'STOCK TECH LOGISTICA', 'MediÃ§Ã£o', 'SPDA', 'INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO, COM A CONCLUSAO SERA REMETIDO RELATORIO TECNICO E ART DO CREA-CE.', 'n', '45', 3, '2014-05-16', '2014', 'valdair.souza@stocktech.com.br', '2014-05-21', '2014-05-22', 0, 0, 0, 's', 's', 'n', '', 'n', '1000.00'),
(56, 'junior', 'CONDOMINIO LIVING', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MANUTENCAO PREVENTIVA EM UM QUADRO DE DISTRIBUICAO DO CONDOMINIO PARA RETIRADA DE INFILTRACAO DE AGUA NA TUBULACAO E LIMPEZA COM RETIRADA DE AGUA E AREIA DENTRO DO QUADRO.', 'n', '141', 1, '2014-05-16', '2014', 'gustavopereira@beachpark.com.br', '2014-05-16', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '1200.00'),
(57, 'junior', 'INVESTAR HOTELARIA S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENÃ‡ÃƒO CORRETIVA NA SUBESTAÃ‡ÃƒO PARA MUDANÃ‡A D TAP EM 2 TRAFOS A SECO, TROCA DE 03 CHAVES FUSIVEIS  FORNECIDOS PELO CLIENTE.', 'n', '153', 1, '2014-05-28', '2014', 'infra.fortaleza@bluetree.com.br', '2014-05-29', '2014-05-29', 0, 0, 0, 's', 's', 'n', '', 'n', '1480.00'),
(58, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'InstalaÃ§Ã£o', 'Gerador', 'INSTALACAO DE UM GRUPO GERADOR ALUGADO COM INTERLIGACAO DOS CABOS DO QUADRO GERAL DE EMERGENCIA (QTA).', 'n', '160', 1, '2014-06-02', '2014', 'atylabrasil@hotmail.com', '2014-06-03', '2014-06-03', 1, 0, 0, 's', 's', 'n', '', 'n', '2124.00'),
(59, 'junior', 'SANTANA TEXTIL S/A', 'MediÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA INSPECAO E MEDICAO DE RESISTENCIA OHMICA DOS PONTOS DE ATERRAMENTOS RELACIONADOS ABAIXO. COM A CONCLUSAO SERA FORNECIDO LAUDO COM ART.<br /><br /><br />\r\n- PIT STOP - CAIXA D''AGUA - GALPAO DA CALDEIRA P1 - GALPAO DA CALDEIRA P2 - GALPAO DA CALDEIRA P3 - GALPAO DE QUIMICA - GALPAO DA TECELAGEM - GALPAO DO COMPRESSOR - GALPAO DA FIACAO - GALPAO DA TECELAGEM/ACABAMENTO - ADMINISTRACAO - REFEITORIO', 'n', '159', 3, '2014-06-10', '2014', 'andre@santanatextiles.com', '2014-06-06', '2014-06-09', 1, 0, 0, 's', 's', 'n', '', 'n', '1890.00'),
(60, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO CORRETIVA NA SUBESTACAO ELETRICA COM TROCA DE 01 ISOLADOR PEDESTAL 15KV E UM CAPACITOR TRIFASICO DE 20 KVAR EM 440V. ', 'n', '161', 1, '2014-06-10', '2014', 'carlosdias@beachpark.com.br', '2014-06-30', '2014-06-30', 1, 0, 0, 's', 's', 'n', '', 'n', '1378.00'),
(61, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'MediÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA MEDICAO DE MALHA DE ATERRAMENTO NOS QUADROS DE MAQUINA DOS MOTORES. NUM TOTAL DE 19 PAINES.', 'n', '173', 5, '2014-06-11', '2014', 'ricardo@beachpark.com.br', '2014-06-16', '2014-06-20', 5, 0, 0, 's', 's', 'n', '', 'n', '2592.00'),
(62, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'SPDA', 'MANUTENCAO PREVENTIVA E CORRETIVACOM REPOSICAO DE PECAS, COM TESTE DE RESISTIVIDADE DO SISTEMA DE UN 4 PROTECAO CONTRA DESCARGAS ATMOSFERICAS - SPDA<br /><br /><br /><br />\r\nLOCAL: HOTEL - SESC IPARANA * COM EMISAO DE LAUDO TECNICO E EMISSAO DE ART DO SERVICO REALIZADO<br /><br /><br /><br />\r\n1,00 512,00 512,00- MANUTENCAO PREVENTIVA E CORRETIVA COM REPOSICAO DE PECAS, COM TESTE DE RESISTIVIDADE DO SISTEMA DE UN 1 PROTECAO CONTRA DESCARGAS ATMOSFERICAS - SPDA<br /><br /><br /><br />\r\nLOCAL: TOR', 'n', '140', 2, '2014-06-24', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-06-10', '2014-06-29', 0, 0, 17, 's', 's', 'n', '', 'n', '3030.00'),
(63, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'SPDA', 'ManutenÃ§Ã£o corretiva no SPDA<br /><br /><br /><br />\r\nLocal:  MAriuba', 'n', '164', 5, '2014-06-24', '2014', 'ednardo@beachpark.com.br', '2014-07-01', '2014-07-03', 0, 0, 0, 's', 's', 'n', '', 'n', '3224.00'),
(64, 'junior', 'ALAMO ENGENHARIA S/A ', 'MediÃ§Ã£o', 'Aterramento', 'CONFORME SOLICITADO ESTAMOS APRESENTADO PROPOSTA PARA INSPECAO DO SPDA E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTA DESCARGAS ATMOSFERICAS DO PREDIO DA ALAMO ENGENHARIA.COM A CONCLUSAO SERA REMETIDO LAUDO TECNICO E ART DO CREA-CE', 'n', '170', 1, '2014-06-18', '2014', 'adm2.vivoba@alamoengenharia.com.br', '2014-06-18', '2014-06-19', 7, 0, 0, 's', 's', 'n', '', 'n', '1498.00'),
(65, 'junior', 'EMERSON NETWORK POWER DO BRASIL LTDA', 'InspeÃ§Ã£o', 'TermovisÃ£o', ' ORCAMENTO PARA ANALISE TERMOGRAFICA DOS SEGUINTES EQUIPAMENTOS: SUBESTACAO, QUADRO DO BANCO CAPACITOR, QUADRO CHILLER, QCA, QDGE, CHAVES AT, TRANSFORMADOR E DISJUNTOR DE MEDIA TENSAO. COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM ART', 'n', '172', 2, '2014-06-18', '2014', 'Antonio.Glayton@Emerson.com', '2014-06-18', '2014-06-20', 7, 0, 0, 's', 's', 'n', '', 'n', '1360.00'),
(66, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'MediÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA INSPECAO E MEDICAO DE RESISTENCIA OHMICA MALHA DE ATERRAMENTO NA UNIDADE EDUCAR - SESC FORTALEZA. COM A CONCLUSAO SERA FORNECIDO RELATORIO COM ART.', 'n', '165', 5, '2014-06-09', '2014', 'abatista@sesc-ce.com.br', '2014-06-10', '2014-06-15', 16, 0, 0, 's', 's', 'n', '', 'n', '980.00'),
(67, 'junior', 'BERACA SABARA QUIMICOS E INGREDIENTES S/A', 'MediÃ§Ã£o', 'SPDA', 'SERVICO DE MEDICAO E INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICAS (SPDA) COM EMISSAO DE LAUDO ART-CREA', 'n', '186', 2, '2014-06-26', '2014', 'joao.batista@beraca.com', '2014-06-27', '2014-06-27', 0, 0, 0, 's', 's', 'n', '', 'n', '1050.00'),
(68, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '00SERVICOS PARA MANUTENCAO DE UMA SUBESTACAO ABRIGADA: - COM QUATRO TRANSFORMADORES, SENDO UM TR-112,5KVA DOIS TR - 300KVA E UM 500KVA A SECO, - COM DISJUNTOR DE ALTA TENSAO ALTONS E - DOIS QUADROS GERAIS DE BAIXA TENSAO E - DE UMA SUBESTACAO AEREA DE 150 KVA DA LAVANDERIA', 'n', '138', 12, '2014-05-20', '2014', 'atylabrasil@hotmail.com', '2014-08-02', '2014-08-06', 37, 0, 0, 's', 'n', 'n', '', 'n', '6000.00'),
(69, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ServiÃ§o TÃ©cnico', 'Transformador', 'TRATAMENTO TERMO-VACUO EM 03 TRANFORMADORES DA SE-01, UM DE 112,5KVA E DOIS DE 300KVA, PARA CORRIGIR TEOR DE AGUA E RIGIDEZ E DIELETRICA DOS MESMOS. APOS TRATAMENTO SERA FEITA NOVA ANALISE DE OLEO ISOLANTE<br /><br />\r\n<br /><br />\r\n00NO TRAFO DE 150KVA, "SE" LAVANDERIA , NAO E POSSIVEL FAZER TRATAMENTO TERMO-VACUO POR SEREM POSTE, RECOMENDAMOS TROCAR CARGA DE OLEO', 'n', '139', 2, '2014-05-27', '2014', 'atylabrasil@hotmail.com', '2014-05-27', '2014-05-27', 30, 0, 0, 's', 'n', 'n', '', 'n', '5365.00'),
(70, 'junior', 'ADEL COCO BRASIL', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '00MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA COM 02 TRAFOS DE 300KVA, CHAVES SECCIONADORAS, TRES QUADROS GERAIS DE BAIXA TENSAO E DISJUNTOR DE MEDIA TENSAO.<br /><br />\r\nNOTA: SERVICO SERA REALIZADO EM APENAS 01 TRANSFORMADOR.<br /><br />\r\n<br /><br />\r\n00ANALISE DO OLEO ISOLATE FISICO-QUIMICO EM 01 TRANSFORMADO', 'n', '31', 12, '2014-06-01', '2014', 'compras@adelcoco.com.br', '2014-06-01', '2014-06-01', 25, 0, 0, 's', 'n', 'n', '', 'n', '2800.00'),
(71, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA INSTALACAO DOS CABOS SUBITERANEO DA SUBESTACAO AEREA DE 112,5KVA (EXISTENTE ) DA ESTACAO DE TRATAMENTO DE ESGOTO, PARTINDO DO QUADRO DE PROTECAO ATE O QGBT. TUBULACAO EXISTENTE.<br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELO BEACH PARK ABAIXO:<br /><br />\r\n- 320 MT CABO FLEX DE 70MM 1KV - 100 MT CABO FLEX 35MM 1 KV (VERDE) - 100 MT CABO FLEX 35MM 1 KV (AZUL) - 06 UND TERMINAL DE COMPRESSAO PARA CABO 70MM - 06 UND TERMINAL DE COMPRESSAO PARA CABO 35MM - 02 UND FITA DE BAIXA TENSA', 'n', '83', 4, '2014-05-21', '2014', 'ricardo@beachpark.com.br', '2014-05-21', '2014-05-21', 36, 0, 0, 's', 'n', 'n', '', 'n', '3240.00'),
(72, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'CONFORME A NECESSIDADE DE ACRESCIMO DE MAIS DOIS MOTORES, NA PROPOSTA JA APROVADA DE NÂ° 40/14 E PEDIDO NÂ° 408838110J2014 DA WHITE. ESTAMOS PASSANDO PROPOSTA PARA ADITIVAR ACRESCIMO CONFORME ABAIXO.<br /><br /><br />\r\n- RELACAO DE MATERIAL;<br /><br /><br />\r\n01 UND - CX. MET TIPO QG 1700X600X600MM 03 UND - DISJUNTOR MOTOR MPW25-3-D063(4-6.3A) C/10409817 03 UND - MINICONTATOR CW07.10 30V25 220V - C/10185951 30 MT - CABO FLEXSIVEL 10MM - PRETO 10 UND - SPIRAL 3/4 PE BRNACO - METRO 03 UND - CANAL', 'n', '166', 4, '2014-06-04', '2014', 'poliana_costa@praxair.com', '2014-06-04', '2014-08-04', 22, 0, 0, 's', 'n', 'n', '', 'n', '5146.00'),
(73, 'junior', 'COCO BAMBU PIZZARIA LTDA', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA PROJETO APROVADO NA COELCE E INSTALACAO DE UMA SUBESTACAO DE 300KVA AEREA E DESMONTAGEM DE DUAS SUBESTACOES DE 75KVA EXISTENTE, INSTALACAO DO QUADRO GERAL (QGBT) NOVO DA SE 300 KVA E PASSAR RAMAL DE INTERLIGACAO ENTRE SE 300KVAE QGBT NOVO. INSTALAR DOIS RAMAIS DERIVANDO DO NOVO QGBT DA SE-300KVA, PARA OS DOIS QGBT (EXISTENTE )DAS DUAS SUBESTACOES DE 75KVA QUE SERAO DESATIVADAS.<br /><br /><br />\r\n1,00 10.000,00 10.000,00- PROJETO + MAO DE OBRA (ELFI RECEBENDO 2TR-75KVA)<br /><br />', 'n', '84', 30, '2014-06-01', '2014', 'pedrorodrigues20@yahoo.com.br', '2014-07-03', '2014-08-03', 30, 0, 0, 's', 'n', 'n', '', 'n', '10000.00'),
(74, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'INSTALACAO DE UM NOVO RAMAL DE ENTRADA DA SUBESTACAO ABRIGADA DE 500KVA, COM MODIFICACAO NO PROJETO E APROVACAO NA COELCE, CONFORME DT002/2011', 'n', '169', 30, '2014-07-01', '2014', 'fabianosilva@beachpark.com.br', '2014-10-15', '2014-11-15', 0, 0, 0, 's', 'n', 'n', '', 'n', '17918.00'),
(76, 'junior', 'LB SERVICE TERCEIRIZACAO E COBRANCA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA INSTALACAO DE LUMINARIAS, FIACOES, SENSOR DE PRESENCA, PERFILADOS, TOMADAS, QUADRO DE COMANDO, NAS AREAS DO LEVANTAMENTO: GARAGEM 01 (SUBSOLO) - GARAGEM 02 (AREA RECPCAO) - ESCADAS E CORREDORES. (Materiais faturado direto para Cond. Edificio Iracema Praia Park II  ORC 115/14<br /><br /><br />\r\n)', 's', '114', 20, '2014-07-02', '2014', 'supervisoroperacional@ibservice.com.br', '2014-08-06', '2014-10-20', 1, 0, 55, 's', 'n', 'n', '', 'n', '22977.00'),
(77, 'junior', 'LB SERVICE TERCEIRIZACAO E COBRANCA', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA Fornecimento DE MATERIAIS NAS AREAS: GARAGEM 01 (SUBSOLO), GARAGEM 02, ESCADAS E CORREDORES. <br /><br /><br />\r\n(Material faturato direto para Cond. Ed. Iracema Praia Park II CNPJ 23.727.316/0001-85 )', 'n', '115', 20, '2014-07-02', '2014', 'supervisoroperacional@ibservice.com.br', '2014-07-03', '2014-08-04', 1, 0, 12, 's', 'n', 'n', '', 'n', '0.00'),
(78, 'junior', 'STOCK TECH LOGISTICA', 'ServiÃ§o TÃ©cnico', 'TermovisÃ£o', 'MEDIÃ‡ÃƒO TERMOGRAFIA EM PAINEIS ELETRICOS NA SUBESTAÃ‡ÃƒO E GALPÃƒO DE DESCARREGAMENTO E CAEMRAS FRIAS, COM ART', 'n', '184', 5, '2014-07-03', '2014', 'evandro.alves@stocktech.com.br', '2014-07-11', '2014-07-16', 0, 0, 0, 's', 's', 'n', '', 'n', '1500.00'),
(79, 'junior', 'CONDOMINIO EDIFICIO ALVORADA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'Emergencia: - PROPOSTA PARA MANUTENCAO CORRETIVA NO RAMAL DE ENTRADA DE ALTA TENSAO DA SUBESTACAO, ONDE SERA REALIZADO A TROCA DOS CABOS DE ALTA TENSAO E MUFLAS TERMO CONTRATIL, RELACAO DE MATERIAL ABAIXO:<br /><br /><br /><br />\r\n250 METROS - CABO SINYENAX 8,7 / 15KV SE 25MM 08 UND - MUFLAS TERMO CONTRATIL PARA CABO DE 25MM USO EXTERNO, 15KV <br /><br /><br /><br />\r\n(APenas MÃ£o de OBra)_', 's', '192', 2, '2014-07-07', '2014', 'NÃ£o tem', '2014-07-07', '2014-07-08', 0, 0, 0, 's', 's', 'n', '', 'n', '3370.00'),
(80, 'junior', 'STL INFORMATICA LTDA ', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA TROCA DE TRES CHAVES FUSIVEIS DE 25KV, 300A, E 3 ELOS FUSIVEL DE 5H.', 'n', '194', 1, '2014-07-15', '2014', 'nunes@stl.com.br', '2014-08-09', '2014-08-10', 0, 0, 0, 's', 's', 'n', '', 'n', '2300.00'),
(81, 'junior', 'CLINICA DE DOENCAS RENAIS E HIPERT. ARTERIAL LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 75 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO ABAIXO.', 'n', '182', 1, '2014-07-15', '2014', 'rimcentro@gmail.com', '2014-07-27', '2014-07-28', 0, 0, 0, 's', 's', 'n', '', 'n', '1200.00'),
(82, 'junior', 'CLINICA DE DOENCAS RENAIS E HIPERT. ARTERIAL LTDA', 'InstalaÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA NOVA MALHA DE ATERRAMENTO PARA A SE -75KVA, RELACAO DE MATERIAL ABAIXO:<br /><br /><br /><br />\r\n06 UND - HASTE DE TERRA 5/8''X2400M 06 UND - CONECTOR TIPO GRAMPO PARA HASTE 15 KL - CABO BOBRE NU 50MM 01 UND - CAIXA DE INSPECAO COM TAMPA 04 UND - CONECTOR SPLIT-BOLT 50MM', 'n', '183', 2, '2014-07-15', '2014', 'rimcentro@gmail.com', '2014-07-17', '2014-07-18', 0, 0, 0, 's', 's', 'n', '', 'n', '1700.00'),
(83, 'junior', 'STRATURA ASFALTOS S.A', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'DIARIA DE UM TECNICO ELETROTECNICO E UM ELETRECISTA PARA EXECUTAR SERVICOS DE INSTALACOES ELETRICAS EM DIA COMERCIAL (08:00 AS 17:30 / SEGUNDA A SEXTA)', 'n', '199', 1, '2014-07-17', '2014', 'denis.viana@stratura.com.br', '2014-07-17', '2014-07-21', 0, 0, 3, 's', 's', 'n', '', 'n', '1630.00'),
(84, 'junior', 'GERDAU ACOS LONGOS S/A', 'MediÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA REALIZAR AFERICAO DE CONFORMIDADE COM FOTOS DAS MALHAS DE ATERRAMENTO E SPDA NUM TOTAL DE 42 PONTOS, COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM MEDICOES DE RESISTENCIA OHMICA DOS ATERRAMENTOS E ART, CREA-CE', 'n', '167', 5, '2014-07-18', '2014', 'jose.rocha@gerdau.com.br', '2014-08-20', '2014-08-26', 0, 0, 1, 's', 'n', 'n', '', 'n', '6000.00'),
(85, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Aterramento', 'INSTALACAO DE UMA NOVA MALHA DE TERRA NA SUBESTACAO DO BEACH GRILL.<br /><br /><br />\r\n- OBS: SERVICO JA EXECUTADO NO DIA 19.07.2014', 'n', '202', 1, '2014-07-21', '2014', 'emerson@beachpark.com.br', '2014-07-19', '2014-07-19', 0, 0, 0, 's', 's', 'n', '', 'n', '1689.00'),
(86, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA INSTALACAO DE UM AUTO TRAFO DE 35KVA NA SUBESTACAO AVRIGADA DO ATLANTIS', 'n', '203', 1, '2014-07-21', '2014', 'emerson@beachpark.com.br', '2014-07-21', '2014-07-22', 0, 0, 0, 's', 's', 'n', '', 'n', '1196.00'),
(87, 'junior', 'EMAC ENGENHARIA DE MANUTENCAO LTDA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- PROPOSTA PARA MANUTENCAO CORRETIVA DE UM BANCO DE CAPACITORES DA SUBESTACAO, ONDE SERA REALIZADO A TROCA DE DOIS CONTROLADORES DE FATOR DE POTENCIA DE 12 ESTAGIOS, E 10 CAPACITORES DANIFICADOS, CONFORME RELACAO ABAIXO:<br /><br /><br />\r\n02 UND - CONTROLADOR FATOR DE POTENCIA 12 ESTAGIOS, FABRICACAO SULTECH ST-8200C - 12 SAIDAS / TC<br /><br /><br />\r\n04 UND - CONTACTOR PARA CAPACITOR TRIFASICO DE 7,2KVAR, 220V<br /><br /><br />\r\n04 UND - CONTACTOR PARA CAPCITOR 7,2 KVAR 3,80V<br /><br /><br /', 'n', '187', 15, '2014-07-11', '2014', 'na29opt@emac.com.br', '2014-07-28', '2014-07-31', 13, 0, 0, 's', 's', 'n', '', 'n', '6794.00'),
(88, 'junior', 'M. DIAS BRANCO S.A. IND. E COM. DE ALIMENTOS - GME', 'MediÃ§Ã£o', 'SPDA', 'PROPOSTA DE SERVICO DE MEDICOES DE SPDA NO TOTAL DE 50 PONTOS EM NOSSAS MAQUINAS E EQUIPAMENTOS NA AREA DE PRODUCAO E SUBESTACOES 13,8KV E 69KV, DE ACORDO COM AS NORMAS TECNICAS OFICIAIS VIGENTES (12.15/2120208), COM EMISSAO DE LAUDOS TECNICOS POR EQUIPAMENTOS E MAQUINAS NO INTERIOR DE NOSSA UNIDADE MOINHO DIAS BRANCO, LOCALIZADO NO MUCURIPE.', 's', '206', 5, '2014-07-24', '2014', 'afonso.costa@mdiasbranco.com.br', '2014-07-28', '2014-08-04', 0, 0, 2, 's', 's', 'n', '', 'n', '2700.00'),
(89, 'junior', 'DOM PASTEL SELF-SERVICE LTDA-ME', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', ' PROPOSTA PARA INSTALACAO DE UM BANCO CAPACITOR COM PROGRAMADOR HORARIO, (TIMER) COM POTENCIA DE 25KVAR EM 440V.<br /><br /><br />\r\n- VALOR DO MATERIAL <br /><br /><br />\r\nOBS: MATERIAL COMPRADO PELO CLIENTE<br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br />\r\n01 UND - QUADRO DE COMANDO EM CHAPA DE ACO 600X500X250MM 01 UND - CAPACITOR 25KVAR 440V WEG 01 UND - DISJUNTOR TRIPOLAR 50A FIXACAO DIM 01 UND - DISJUNTOR MONOPOLAR DE 2A 20 MTS - CABO FLEX 10MM 1KV 15 MTS - CABO FLEX DE 2,5', 'n', '190', 3, '2014-07-09', '2014', 'marconisantana1@gmail.com', '2014-07-23', '2014-07-24', 16, 0, 0, 's', 's', 'n', '', 'n', '1050.00'),
(90, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', ' PROPOSTA PARA MANUTENCAO PREVENTIVA EM 21 PAINEIS ELETRICOS E BUSWAY ONDE SERAO REALIZADO OS SEGUINTES SERVICOS; - ANALISE TERMOGRAFICA - MANUTENCAO PREVENTIVA NO BUSWAY (REAPERTO E LIMPEZA) - MEDICAO DA MALHA TERRA SPDA DO PREDIO (SERA EMITIDO LAUDO COM ART)<br /><br /><br />\r\n- ANALISE TERMOGRAFICA = 1200,00<br /><br /><br />\r\n- MANUTENCAO BUSWAY = 1900,00<br /><br /><br />\r\n- MEDICAO DA MALHA DE TERRA = 900,00', 'n', '209', 5, '2014-07-29', '2014', 'francisco@holidayfortaleza.com.br', '2014-08-04', '2014-08-08', 0, 0, 0, 's', 'n', 'n', '', 'n', '4000.00'),
(91, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A (OCEANI)', 'ManutenÃ§Ã£o', 'SPDA', '- MANUTENCAO CORRETIVA NO PARA RAIO NO MASTRO E MEDICAO DO SISTEMA DO (SPDA), COM LAUDO TECNICO.<br /><br /><br />\r\nRELACAO DE MATERIAL ABAIXO:<br /><br /><br />\r\n01 UND - CAPITOR TIPO FRNAKLIN 300MM 2 DESCIDAS 01 UND - ISOLADOR PEDESTAL CLASSE 15KV 02 UND - BUCHA DE REDUCAO 2/4'' PARA 1/2 02 UND - NYPLE FERRO GALVANIZADO DE 3/4', 'n', '197', 1, '2014-07-30', '2014', 'antoniakatia@beachpark.com.br', '2014-08-07', '2014-08-07', 0, 0, 0, 's', 's', 'n', '', 'n', '1466.00'),
(92, 'junior', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', 'MediÃ§Ã£o', 'SPDA', 'MEDICAO DE RESISTENCIA OHMICA DA MALHA DE TERRA DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA E INSPECAO EM TODO SISTEMA DE PROTECAO, APOS A MEDICAO SERA ENVIADO RELATORIO TECNICO E ART CREA-CE.', 'n', '124', 4, '2014-08-01', '2014', 'manutencao.cfo@atlanticahotels.com.br', '2014-08-11', '2014-08-12', 0, 0, 0, 's', 's', 'n', '', 'n', '900.00'),
(93, 'junior', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MANUTENCAO PREVENTIVA EM 27 PAINEIS ELETRICOS, ONDE SERA REALIZADO OS SEGUINTES SERVICOS; ORGANIZACAO DA FIACAO MEDICAO DE ISOLAMENTO, LIMPEZA E REAPERTOS NAS CONEXOES ELETRICAS; BALACEMANETO DE CARGA; TERMOGRAFIA PARA VERIFICAR A EXISTENCIA DE PONTOS, QUENTES E ELIMINAR.', 'n', '125', 5, '2014-08-01', '2014', 'manutencao.cfo@atlanticahotels.com.br', '2014-09-11', '2014-09-19', 0, 0, 3, 's', 's', 'n', '', 'n', '3700.00'),
(94, 'junior', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', 'ManutenÃ§Ã£o', 'Disjuntor', 'MANUTENCAO CORRETIVA NO LOCAL EM UM DISJUNTOR DE ALTA TENSAO DA SUBESTACAO ONDE SERA REALIZADAS TESTES ELETRICOS E REATIVACAO DO SISTEMA OPERACIONAL E CONSERTO DO MECANISMO', 'n', '126', 1, '2014-08-01', '2014', 'manutencao.cfo@atlanticahotels.com.br', '2014-09-06', '2014-09-06', 0, 0, 0, 's', 's', 'n', '', 'n', '1700.00'),
(95, 'junior', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '00INSTALACAO COM TROCA PARA CORRECAO NO POSTE DE ILUMINACAO DO ESTACIONAMENTO, ONDE SERAO SUBSTITUIDAS LAMPADAS E REATORES COM FOTO CELULA CONFORME ABAIXO:<br /><br /><br />\r\n- CAMINHAO ..................R$: 300,00<br /><br /><br />\r\n- 04 UND REATOR USO EXTERNO P/ LAMPADA DE 400W VAPOR METALICO; ..................................R$: 559.68<br /><br /><br />\r\n- 04 UND LAMPADA TUBULAR VALOR METALICO.............R$: 373,76<br /><br /><br />\r\n- 02 UND RELE FOTO CELULA COM BASE......................R', 'n', '213', 1, '2014-08-01', '2014', 'wellington@cdlfor.com.br', '2014-08-05', '2014-08-06', 3, 0, 0, 's', 's', 'n', '', 'n', '1860.00'),
(96, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO CORRETIVA NO RAMAL DE ENTRADA DA SUBESTACAO ELETRICA, JA REALIZADO NO DIA 04.08.2014 COM REAPERTO E LIMPEZA NA CHAVE FUSIVEL.', 'n', '214', 1, '2014-08-04', '2014', 'francisco@holidayfortaleza.com.br', '2014-08-04', '2014-08-05', 3, 0, 0, 's', 's', 'n', '', 'n', '600.00'),
(97, 'junior', 'STRATURA ASFALTOS S.A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'DIARIA DE UM TECNICO ELETROTECNICO E UM ELETRECISTA PARA EXECUTAR SERVICOS DE INSTALACOES ELETRICAS EM DIA COMERCIAL (08:00 AS 17:30 / SEGUNDA A SEXTA) - Foram 2 diarias', 'n', '218', 2, '2014-08-04', '2014', 'denis.viana@stratura.com.br', '2014-08-04', '2014-08-05', 3, 0, 0, 's', 's', 'n', '', 'n', '1160.00'),
(98, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'MediÃ§Ã£o', 'SPDA', '00SERVICO DE INSPECAO E MEDICOES DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS ( SPDA), COM EMISSAO DE LAUDO TECNICO COM ART DO CREA-CE.<br /><br /><br />\r\nLOCAL: FIC ALDEOTA', 'n', '52', 5, '2014-08-11', '2014', 'luis.lima@estacio.br', '2014-08-11', '2014-08-12', 0, 0, 0, 's', 's', 'n', '', 'n', '900.00'),
(100, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A (OCEANI)', 'ManutenÃ§Ã£o', 'Gerador', 'REMANEJO DOS CABOS DO GRUPO GERADOR PARA MANUTENÃ‡ÃƒO CORRETIVA DO MESMO', 'n', '224', 2, '2014-08-18', '2014', 'carlosdias@beachpark.com.br', '2014-09-02', '2014-09-02', 0, 0, 0, 's', 's', 'n', '', 'n', '1692.00'),
(101, 'junior', 'DISTRIBUIDORA FARMACEUTICA PANARELLO', 'ManutenÃ§Ã£o', 'Transformador', '- PROPOSTA PARA MANUTENCAO PREVENTIVA E CORRETIVA DA SUBESTACAO:<br /><br /><br />\r\n1.1- TRANFORMADOR DE 225KVA: - RETIRADA DO TRANSFORMADOR DO POSTE COM CAMINHAO MUCK E COLOCACAO DE OUTRO ALUGADO. - PINTURA GERAL DA CAIXA DO TRANSFORMADOR - TROCA TODAS AS GUARNICOES DE VEDACAO - SECAGEM PARTE ATIVA NA ESTUFA - TRATAMENTO DO OLEO ISOLANTE PELO PROCESSO TERMO-VACUO - ANALISE DO OLEO ISOLANTE - ENSAIOS ELETRICOS - REISTALACAO NO POSTE E RETIRADA DO OUTRO TRAFO<br /><br /><br />\r\n1.2- PINTURA DO QU', 's', '168', 20, '2014-08-19', '2014', 'francisco.santos@panpharma.com.br', '2014-08-24', '2014-09-15', 0, 0, 2, 's', 'n', 'n', '', 'n', '5200.00'),
(102, 'junior', 'NACIONAL ARCO-IRIS IND. E COM. DE TINTAS LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '- MANUTENCAO PREVENTIVA NA SUBESTACAO ELETRICA DE 2.225KVA, ( DOIS TRAFO DE 1000KVA E 1 X 225KVA); COM ANALISE DE OLEO , DENTRO DA MANUTENCAO SERA REALIZADO OS SEGUINTES SERVICOS ABAIXO;<br /><br /><br />\r\n1 - FORNECER E INSTALAR UMA MULFA TERMO CONTRATIL AO RAMAL DE ENTRADA 2 - FAZER TESTE EM UM TR - 1000KVA, PARA ENERGIZACAO', 'n', '230', 5, '2014-08-21', '2014', 'angelo.queiroz@hipercor.com.br', '2014-08-23', '2014-09-08', 0, 0, 11, 's', 'n', 'n', '', 'n', '3900.00'),
(103, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'InstalaÃ§Ã£o', 'Gerador', ' SERVICO JA EXECUTADO NO DIA 26.08.2014 PARA INSTALACAO DE UM GRUPO GERADOR PROVISSORIO NA SUBESTACAO ELETRICA PARA O CONSERTO DO OUTRO GERADOR QUE ESTA COM DEFEITO.', 'n', '239', 1, '2014-08-26', '2014', 'jonatan@beachpark.com.br', '2014-08-26', '2014-08-27', 1, 0, 0, 's', 's', 'n', '', 'n', '1300.00'),
(104, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', ' INSTALACAO DOS SEGUINTES ITENS JA FORNECIDO EM 26.08.2014 NA SUBESTACAO DO BEACH GRILL.<br /><br /><br />\r\n20 UND - TERMINAL DE COMPRESSAO 400MM 50 MT - DUTO PEAD 90MM', 'n', '240', 1, '2014-08-26', '2014', 'oliveira@beachpark.com.br', '2014-08-26', '2014-08-27', 2, 0, 0, 's', 's', 'n', '', 'n', '1290.00'),
(106, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '  INSTALACAO COM FORNECIMENTO DOS SEGUINTES MATERIAIS PARA ADEQUACAO DA SUBESTACAO DO BEACH GRILL<br /><br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL IND. UNIPOLAR 25KV 300A, RVP. 6,3KA 03 UND - ELO FUSIVEL', 'n', '238', 1, '2014-08-28', '2014', 'emerson@beachpark.com.br', '2014-09-17', '2014-09-18', 1, 0, 0, 's', 's', 'n', '', 'n', '1214.00'),
(107, 'junior', 'BERMAS MARACANAU INDUSTRIA E COMERCIO', 'MediÃ§Ã£o', 'SPDA', 'SERVICO DE MEDICAO DA RESISTENCIA OHMICA DO ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS<br /><br /><br />\r\nATMOSFERICAS<br /><br /><br />\r\nEM 13 PONTOS NAS DEPENDENCIAS DA BERMAS. SERA<br /><br /><br />\r\nFORNECIDO LAUDO TECNICO COM OS VALORES DAS MEDICOES<br /><br /><br />\r\nCOM ART DO<br /><br /><br />\r\nCREA-CE.', 's', '246', 5, '2014-09-09', '2014', 'lsilva@bermas.com.br', '2014-09-10', '2014-09-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '1000.00'),
(108, 'junior', 'ALAMO ENGENHARIA S/A ', 'ManutenÃ§Ã£o', 'Transformador', 'MANUTENCAO PREVENTIVA DE UM TRANSFORMADOR EM POSTE, RETIRADA DE AMOSTRA DE OLEO PARA REALZIAR<br /><br /><br /><br />\r\nANALISE FISICO<br /><br /><br /><br />\r\nQUIMICO DO MESMO CONFORME RELACAO DE SERVICOS<br /><br /><br /><br />\r\nABAIXO;', 'n', '251', 1, '2014-09-16', '2014', 'adm2.vivoba@alamoengenharia.com.br', '2014-09-28', '2014-10-16', 0, 0, 17, 's', 'n', 'n', '', 'n', '1320.00'),
(109, 'junior', 'M. DIAS BRANCO S.A. IND. E COM. DE ALIMENTOS - GME', 'MediÃ§Ã£o', 'SPDA', 'SERVICO DE MEDICOES DE SPDA E ATERRAMENTO NO TOTAL DE APROXIMADAMENTE 25 PONTOS NAS SUBESTACOES 13,8KV E<br /><br /><br />\r\n69KV E MOINHOS, DE ACORDO COM AS NORMAS TECNICAS<br /><br /><br />\r\nOFICIAIS VIGENTES (12.15/2120208), COM EMISSAO DE LAUDOS<br /><br /><br />\r\nTECNICOS.', 'n', '219', 5, '2014-09-22', '2014', 'afonso.costa@mdiasbranco.com.br', '2014-09-24', '2014-09-25', 0, 0, 0, 's', 's', 'n', '', 'n', '1425.00'),
(110, 'junior', 'CALCADOS ANIGER NORDESTE LTDA', 'Laudo TÃ©cnico', 'Transformador', 'ANALISE FISICO QUIMICO EM 03 AMOSTRA DE OLEO ISOLANTE DOS TRANSFORMADORES.', 'n', '252', 15, '2014-09-22', '2014', 'fatima.pinheiro@ne.aniger.com.br', '2014-09-29', '2014-10-17', 0, 0, 3, 's', 'n', 'n', '', 'n', '600.00');
INSERT INTO `acompanhamento` (`id`, `colab`, `cliente`, `atividade`, `classificacao`, `inf_servicos`, `novo_cliente`, `n_orc`, `prazo_exec`, `data_aprovada`, `ano`, `email`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `vr_orc`) VALUES
(111, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO DO QUADRO GERAL DE BAIXA TENSAO (QGBT) COM LIMPEZA, REAPERTO DAS CONEXOES,<br /><br /><br />\r\nINDETIFICACAO DOS DISJUNTORES PARA CONFECCAO DE UM<br /><br /><br />\r\nDIAGRAMA UNIFILAR DO QUADRO E INSTALACAO DE UM<br /><br /><br />\r\nREGISTRADOR DE GRANDEZAS ELETRICAS PARA INDETIFICAR,<br /><br /><br />\r\nVALORES DE: TENSAO-CORRENTE, POTENCIA, FATOR DE<br /><br /><br />\r\nPOTENCIA. COM A CONCLUSAO SERA ELABORADO LAUDO<br /><br /><br />\r\nTECNICO COM DIAGRAMA UNIFILAR E ART.', 'n', '144', 5, '2014-09-22', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-09-23', '2014-10-13', 0, 0, 15, 's', 'n', 'n', '', 'n', '1260.00'),
(112, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Gerador', 'REMOCAO DOS CABOS GERADORES 1 E 2 E INSTALAR OS CABOS NO GERADOR PROVISORIO.', 'n', '257', 1, '2014-09-26', '2014', 'oliveira@beachpark.com.br', '2014-09-26', '2014-09-26', 3, 0, 0, 's', 's', 'n', '', 'n', '1200.00'),
(113, 'junior', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', 'MediÃ§Ã£o', 'SPDA', 'MEDICAO E INSPECAO DO SPDA E PONTOS DE ATERRAMENTO DO PREDIO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA.', 'n', '130', 1, '2014-09-30', '2014', 'marliete@mrhgestao.com.br', '2014-10-01', '2014-10-02', 0, 0, 0, 's', 's', 'n', '', 'n', '960.00'),
(114, 'junior', 'CONDOMINIO ED. IRACEMA PRAIA PARK II', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MANUTENCAO CORRETIVA NOS QUADROS DE MEDICAO DA COELCE QUE ALIMENTA OS APARTAMENTOS ONDE SERAO REALIZADOS A TROCA DAS FIACOES PARTIDO DO QUADRO DE MEDICAO ATE OS APARTAMENTOS COM REAPERTOS DAS CONEXOES E LIMPEZA.', 'n', '244', 14, '2014-10-01', '2014', 'praiapark1020@hotmail.com', '2014-10-20', '2014-11-05', 0, 0, 2, 's', 'n', 'n', '', 'n', '9240.00'),
(115, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- TROCA DE RAMAL DE ENTRADA DE 15KV DA SUBESTACAO ATLANTIS, CONFORME MATERIAL ABAIXO FORNECIDO PELA<br /><br /><br />\r\nELFI.<br /><br /><br />\r\n03 UND - ALCA PREF. P/ COND. COBRE 25MM<br /><br /><br />\r\n30 UND - ARRUELA QUAD. 50X3MMC/FURO DE 18MM<br /><br /><br />\r\n08 UND - ARRUELA QUAD. 32X3MM C/FURO DE 18MM<br /><br /><br />\r\n6,2 KG - CABO DE COBRE NU 25MM<br /><br /><br />\r\n03 UND - CHAVE FUSIVEL IND. 25KV, 300A RUP 6,3KA<br /><br /><br />\r\n01 UND - CINTA DE ACO INOX (1ROLO)<br /><br /><br />', 'n', '254', 1, '2014-10-01', '2014', 'emerson@beachpark.com.br', '2014-10-08', '2014-11-19', 0, 0, 41, 's', 'n', 'n', '', 'n', '5765.00'),
(116, 'junior', 'IFT IND COMERCIO DE MATERIAIS const - Polimix', 'InstalaÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA CORRIGIR MALHA DE ATERRAMENTO DA eMPRESA POLIMIX, CONFORME LAUDO TECNICO DA CONTROL<br /><br /><br /><br />\r\nENGENHARIA E RELACAO DE MATERIAL ABAIXO FORNECIDO<br /><br /><br /><br />\r\nPELA ELFI.<br /><br /><br /><br />\r\n42 UND - HASTE DE TERRA ROSCADA 5/8'' X 240MM<br /><br /><br /><br />\r\n12 PCT - TERROGEL 14KL CADA<br /><br /><br /><br />\r\n60 MT - CABO DE COBRE NU DE 50MM<br /><br /><br /><br />\r\n30 UND - CONECTOR REFORCADO TIPO GRAMPO<br /><br /><br /><br />\r\n18 UND - LUVA ROSCAD', 's', '259', 8, '2014-10-02', '2014', 'faturamento1.ift@britta.com.br', '2014-10-06', '2014-10-15', 0, 0, 1, 's', 'n', 's', 'VAlor Paiol 01 ficou fora do recomendado de 10 Ã´hms, apÃ³s a PoliMix ter chamado outra empresa para fazer a mediÃ§Ã£o; Tomamos medidas imediatas para corrigir o Valor citado.', 'n', '8000.00'),
(117, 'junior', 'HOSPITAL DE OLHOS LEIRIA DE ANDRADE', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'REALIZAR MEDICAO PARA VERIFICAR O CARREGAMENTO EM DOIS TRANSFORMADORES A OLEO DA SUBESTACAO, SENDO UM DE 225KVA E OUTRO DE 150KVA, COM INSTALACAO DE UM REGISTRADOR DE GRANDEZAS NO SECUNDARIO DE CADA TRAFO POR UM PERIODO DE 05 DIAS EM CADA, PARA IDENTIFICAR POSSIVEIS SOBRE CARGAS. SERA FORNECIDO TABELA COM MEMORIA DE MASSA COM TENSOES, CORRENTES E POTENCIAS.', 'n', '261', 15, '2014-10-07', '2014', 'thalestelles@gmail.com', '2014-10-07', '2014-10-28', 0, 0, 6, 's', 's', 'n', '', 'n', '2900.00'),
(118, 'junior', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', 'ServiÃ§o TÃ©cnico', 'Transformador', 'MUDANCA DO "TAP" DO TRANSFORMADOR DE 300KVA DA SUBESTACAO AEREA, PARA AJUSTE DA TENSAO FORNECIDA.', 'n', '267', 1, '2014-10-14', '2014', 'josegilmar@beachpark.com.br', '2014-10-14', '2014-10-14', 0, 0, 0, 's', 's', 'n', '', 'n', '900.00'),
(119, 'junior', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'SERVICO DE ACOMPANHAMENTO DE UM TECNICO ELETROTECNICO PARA ACOMPANHAMENTO DE INSTALACOES ELETRICAS DE BAIXA TENSAO DENTRO DA SUBESTACAO ABRIGADA DA MRH, EM UM DIA DE DOMINGO.', 'n', '268', 1, '2014-10-15', '2014', 'marliete@mrhgestao.com.br', '2014-10-19', '2014-10-20', 0, 0, 0, 's', 's', 'n', '', 'n', '520.00'),
(120, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Gerador', 'INSTALAR CABOS DO GERADOR DEFINITIVAMENTE APOS JA EXECUTADO O SERVICO DO ORCAMENTO 257/14, DE INSTALACAO NO GERADOR PROVISORIO.<br /><br /><br />\r\nLOCAL: MAREMOTO<br /><br /><br />\r\nNOTA: SERVICO JA EXECUTADO DIA 15/10/2014', 'n', '269', 2, '2014-10-15', '2014', 'emerson@beachpark.com.br', '2014-10-15', '2014-10-16', 1, 0, 0, 's', 's', 'n', '', 'n', '1800.00'),
(121, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'MediÃ§Ã£o', 'Transformador', 'INSTALACAO DE REGISTRADOR DE GRANDEZAS ELETRICAS, POR UM PERIODO DE 72 HORAS, EM CADA TRANSFORMADOR, SENDO<br /><br /><br />\r\n03 DE 300 KVA. SERA EMITIDO MEMORIA DE MASSA IDENTIFICANDO O TOTAL DE CARGA QUE CADA TRAFO ESTA ATENDENDO E QUANTO ESTA SOBRANDO PARA FUTURA DISTRIBUICAO DE NOVAS CARGAS DE APROXIMADAMENTE 275 KW, CONFOME INFORMADO PELA FIC.', 'n', '274', 10, '2014-10-24', '2014', 'francisco.alves@estacio.br', '2014-10-27', '2014-11-10', 0, 0, 4, 's', 'n', 'n', '', 'n', '3000.00'),
(122, 'junior', 'CALCADOS ANIGER NORDESTE LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '1-SERVICOS PARA MANUTENCAO DE 03 SUBESTACOES ABRIGADAS, CADA UMA COM:<br /><br /><br /><br /><br />\r\n- 01 TRANSFORMADOR;<br /><br /><br /><br /><br />\r\n- 01 DISJUNTOR DE MEDIA TENSAO;<br /><br /><br /><br /><br />\r\n- QUADROS GERAIS DE BAIXA TENSAO E<br /><br /><br /><br /><br />\r\n- CHAVE SECCIONADORAS.<br /><br /><br /><br /><br />\r\nCONFORME RELACAO DE SERVICOS ABAIXO:<br /><br /><br /><br /><br />\r\n<br /><br /><br /><br /><br />\r\n2- CONFORME RELATORIO DO OLEO ISOLANTE DO TRANSFORMADOR DE 450KVA', 'n', '272', 5, '2014-10-24', '2014', 'fatima.pinheiro@ne.aniger.com.br', '2014-11-16', '2014-11-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '6250.00'),
(123, 'junior', 'STRATURA ASFALTOS S.A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- INSTALACAO DA NOVA TUBULACAO E PASSAGEM DE CABOS ELETRICOS DO NOVO PAINEL DOS AQUECEDORES PARA OS DOIS MOTORES, UM DE 25CV E OUTRO DE 1,5CV. OBS: MATERIAL FORNECIDO PELO CLIENTE, RELACAO DE<br /><br /><br /><br />\r\nMATERIAL ABAIXO:', 'n', '233', 3, '2014-10-28', '2014', 'denis.viana@stratura.com.br', '2014-10-30', '2014-10-31', 0, 0, 0, 's', 's', 'n', '', 'n', '1311.00'),
(124, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'MediÃ§Ã£o', 'Aterramento', 'MEDICAO DA RESISTENCIA OHIMCA DA MALHA DE ATERRAMENTO DOS TANQUES, E DO SPDA DAS INSTALACOES DA WHITE NA AV. FRANCISCO SA, COM EMISSAO DE LAUDO E ART DO CREA, CE', 'n', '285', 1, '2014-10-31', '2014', 'gustavo_oliveira@praxair.com', '2014-10-31', '2014-10-31', 3, 0, 0, 's', 's', 'n', '', 'n', '1000.00'),
(125, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'InstalaÃ§Ã£o', 'Gerador', 'ATENDIMENTO DE EMERGENCIA REALIZADO DIA 01/11/2014 (SABABDO) PARA INSTALACAO DE UM GRUPO GERADOR PROVISORIO PARA ALIMENTACAO DAS CARGAS PRIORITARIAS. LOCAL: HOTEL HOLIDAY INN', 'n', '286', 1, '2014-11-03', '2014', 'francisco@holidayfortaleza.com.br', '2014-11-03', '2014-11-03', 0, 0, 0, 's', 'n', 'n', '', 'n', '1850.00'),
(126, 'junior', 'STOCK TECH LOGISTICA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACOES ELETRICAS PARA MANUTENCAO CORRETIVA NA SALA DA KIBON ONDE SERA REMANEJADO O CIRCUITO DE TOMADAS DO QFAC PARA O QUADRO DISTRIBUICAO. PARA EVITAR OCILACOES E QUEDA DE TENSAO, INSTALAR TAMPAS CEGAS NAS TOMADAS DE PISOS: (VALOR APENAS DA MAO DE OBRA)<br /><br /><br />\r\n03 UND - TOMADA CEGA EM LATAO PARA TOMADA DE PISO 4 X 4<br /><br /><br />\r\n10 MT - CO TUBO 1"<br /><br /><br />\r\n06 UND - ABRACADEIRA DE 1" TIPO "D"<br /><br /><br />\r\n30 MT - CABO FLEX 6MM PRETO<br /><br /><br />\r\n30 MT -', 'n', '215', 2, '2014-11-03', '2014', 'aristophanes.sousa@stocktech.com.br', '2015-02-14', '2015-02-14', 1, 0, 0, 's', 'n', 'n', '', 'n', '1100.00'),
(127, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'MONTAGEM DE UM PAINEL DE CONTROLE PARA AUTOMACAO DO ENCHIMENTO CO2 NA OFICINA DA ELFI, MATERIAL TODO<br /><br /><br />\r\nFORNECIDO PELA WHITE MARTINS.', 'n', '289', 5, '2014-11-04', '2014', 'gustavo_oliveira@praxair.com', '2014-11-10', '2014-11-14', 0, 0, 0, 's', 'n', 'n', '', 'n', '1200.00'),
(128, 'junior', 'AGROPAULO AGROINDUSTRIAL S.A', 'ManutenÃ§Ã£o', 'Transformador', '- MANUTENCAO CORRETIVA EM UM TRASFORMADOR DE 150 KVA NÂ° 21109227, WEG, CONFORME DESCRICAO ABAIXO.<br /><br />\r\n- RELACAO DE SERVICOS:<br /><br />\r\n- DESENCAIXOTAMENTO<br /><br />\r\n- SUBISTITUICAO DE 02 COLUNAS DE ALTA TENSAO "H1" E "H3"<br /><br />\r\n- SUBISTITUICAO DE 01 COLUNA DE BAIXA TENSAO "H1"<br /><br />\r\n- SECAGEM DA PARTE ATIVA EM ESTUFA<br /><br />\r\n- TROCA DE TODAS GUARNICOES DE VEDACOES<br /><br />\r\n- TRATAMENTO DAS PECAS OXIDADAS<br /><br />\r\n- TRATAMENTO DA CARGA DE OLEO ISOLANTE<b', 'n', '288', 25, '2014-11-10', '2014', 'bruno.rafael@agropaulo.com', '2014-11-10', '2014-11-27', 0, 0, 0, 's', 'n', 'n', '', 'n', '3650.00'),
(129, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA RETIRADA DE UM PAINEL ELETRICO ENERGIZADO DO GRUPO GERADOR ANTIGO.', 'n', '298', 2, '2014-11-12', '2014', 'atylabrasil@hotmail.com', '2015-03-28', '2015-03-28', 0, 0, 0, 's', 'n', 'n', '', 'n', '1300.00'),
(130, 'junior', 'CENTRO DE ESPECIALIDADES MEDICAS JOSE DE ALENCAR', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'SERVICO DE EMERGENCIA PARA INSTALACAO DE TRES CHAVES FUSIVEIS COM PARA RAIO POLIMERICO E UMA CRUZETA PArA ATIVACAO DA SUBESTACAO ELETRICA NO PREDIO DO CEMJA-JACARECANGA.<br /><br /><br />\r\nRELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 UND - CHAVE FUSIVEL 25KV UNIPOLAR<br /><br /><br />\r\n03 UND - PARA RAIO POLIMERICO 12KV 10KA<br /><br /><br />\r\n01 UND - CRUZETA DE CONCRETO PARA ESTRUTURA H<br /><br /><br />\r\n03 VR - VERGALHAO DE COBRE 1/4'' X 3M<br /><br /><br />\r\n04 UND -', 'n', '306', 1, '2014-11-13', '2014', 'rosana.frf@hotmail.com', '2014-11-13', '2014-11-14', 0, 0, 0, 's', 'n', 'n', '', 'n', '3980.00'),
(131, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'MediÃ§Ã£o', 'SPDA', 'TESTE DE RESISTENCIA OHMICA DO ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA SPDA, COM EMISSAO DE ART. <br /><br /><br />\r\nLOCAL:<br /><br /><br />\r\nEDUCAR SESC FORTALEZA<br /><br /><br />\r\nav jose bastos 813', 'n', '300', 4, '2014-11-13', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-11-14', '2014-11-17', 0, 0, 0, 's', 'n', 'n', '', 'n', '900.00'),
(132, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'SPDA', 'PROPOSTA PARA FAZER CORRECAO DOS PONTOS DE ATERRAMENTO DO SPDA DO AUDITORIO E CAIXA DAGUA, PARA DEIXAR OS MESMOS DENTRO DOS PADROES NBR 5419, QUE RECOMENDA NO MAXIMO 10 OHMIS. COM A CONCLUSAO SERA EMITIDO UM LAUDO COM ART.<br /><br />\r\n- LOCAL:<br /><br />\r\nEDUCAR SESC FORTALEZA', 'n', '311', 5, '2014-11-27', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-11-27', '2014-11-27', 0, 0, 0, 's', 'n', 'n', '', 'n', '1740.00'),
(133, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'MediÃ§Ã£o', 'SPDA', 'PROPOSTA PARA MEDICAO DA MALHA DE ATERRAMENTO DO SPDA DO CONDOMINIO ACQUA RESORT APOS A MEDICAO SERA EMITIDO LAUDO E ART.', 'n', '317', 2, '2014-12-03', '2014', 'eneiasfacanha@beachpark.com.br', '2014-12-10', '2014-12-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '1260.00'),
(134, 'junior', 'ESMALTEC S/A', 'MediÃ§Ã£o', 'Aterramento', 'INSPECAO E MEDICOES EM 205 PONTOS SPDA (165 PAINEIS E 40 PONTOS SPDA) REFERENTE A MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS (SPDA), NAS SUBESTACOES E NOS QUADROS DE DISTRIBUICOES DE FORCA E ILUMINACAO, COM O FIM DE OBTER O VALOR DA RESISTENCIA DE ISOLAMENTO, COM EMISSAO DE LAUDO ASSINADO POR PROFISSIONAL HABILITADO E ART', 'n', '309', 15, '2014-12-01', '2014', 'francisco.gentil@esmaltec.com.br', '2014-12-16', '2014-12-30', 2, 0, 0, 's', 'n', 'n', '', 'n', '6400.00'),
(135, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'MediÃ§Ã£o', 'SPDA', 'MEDICAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA COM LAUDO E ART, NA LOCALIDADE DE QUIXERAMOBIM', 'n', '313', 5, '2014-11-26', '2014', 'wagnerbastos@sesc-ce.com.br', '2014-12-02', '2014-12-04', 7, 0, 0, 's', 'n', 'n', '', 'n', '1200.00'),
(136, 'junior', 'RESTAURANTE LIMONE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO.<br /><br /><br /><br />\r\nITEM 02 - MANUTENCAO CORRETIVA, TROCA;<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL UNIPOLAR DE 25KV, 300A, 6,3KA<br /><br /><br /><br />\r\n03 UND - PARA - RAIOS POLIMERICOOXIDO DE ZINCO, 12KV,<br /><br /><br /><br />\r\n10KA<br /><br /><br /><br />\r\n03 UND - ELO FUSIVEL 6K<br /><br /><br /><br /', 's', '282', 16, '2014-12-03', '2014', 'lelabardot@hotmail.com', '2014-12-22', '2015-01-06', 1, 0, 0, 's', 'n', 'n', '', 'n', '2610.00'),
(137, 'junior', 'HOSPITAL DE OLHOS LEIRIA DE ANDRADE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ELETRICA COM 02 TRAFOS, SENDO UM DE 225 KVA E OUTRO DE 150 KVA CONFORME DESCRICAO DOS SERVICOS EM ANEXO, COM EMISSAO DE LAUDO E ART-CREA. COM ANALISE FISICO-QUIMICO DO OLEO ISOLANTE DOS TRANSFORMADORES.', 'n', '307', 16, '2014-11-28', '2014', 'thalestelles@gmail.com', '2014-12-20', '2015-01-06', 6, 0, 0, 's', 'n', 'n', '', 'n', '2000.00'),
(138, 'junior', 'BANCO CENTRAL DO BRASIL - BACEN', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA CONSERTO DE 02 <br />\r\nBOMBAs KSB 100-150-2 COM 1,00 3.760,00 3.760,00<br /><br />\r\nTROCA DE ROLAMENTOS, RETENTORES, JOGO DE JUNTA,<br /><br />\r\nGAXETAS, ANEIS, ORING, BUCHAS PROTETORA DO EIXO, JUNTA<br /><br />\r\nDO MANCAL, CARGA DE OELO MAIS SERVICOS DE RETIRADA<br /><br />\r\nREINSTALACAO, CONFORME RELACAO DE COMPONENTES A<br /><br />\r\nSEREM TROCADOS:<br /><br />\r\n02 - ROLAMENTO<br /><br />\r\n02 - RETETORES<br /><br />\r\n01 - JOGO DE JUNTA<br /><br />\r\n01 - JOGO DE GAXETA 3/8<br /><b', 'n', '327', 10, '2014-12-09', '2014', 'nero.torres@bcb.gov.br', '2014-12-10', '2015-01-20', 1, 0, 0, 's', 'n', 'n', '', 'n', '7520.00'),
(139, 'junior', 'ALAMO ENGENHARIA S/A ', 'MediÃ§Ã£o', 'SPDA', 'CONFORME SOLICITADO ESTAMOS APRESENTADO PROPOSTA PARA INSPECAO DO SPDA E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTA DESCARGAS ATMOSFERICAS DO PREDIO DA ALAMO ENGENHARIA.COM A CONCLUSAO SERA REMETIDO LAUDO TECNICO E ART DO CREA-CE.', 'n', '320', 4, '2014-12-11', '2014', 'enc.vivoce@alamoengenharia.com.br', '2014-12-12', '2014-12-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '1500.00'),
(140, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'MediÃ§Ã£o', 'Aterramento', 'MEDICAO DE ATERRAMENTO EM PAINEIS ELETRICOS E POSTES 1,00 2.950,00 2.950,00<br /><br />\r\nMETALICOS, FREZER, FORNOS E MOTORES CONFORME NR-10<br /><br />\r\nNBR-5410 APOS AS MEDICOES SERA EMITIDO LAUDO E ART.<br /><br />\r\n- RELACAO DE PAINEIS E EQUIPAMENTO ABAIXO;- PAINEL CALDEIRA;- PAINEL CALDEIRA ELETRICA;- CALDEIRA 1 E ;- QUADRO E BOMBADO ESGOTO;- QUADRO COZINHA;- QUADRO DA COZINHA BALCAO;- QUADRO EXALTOUR;- QUADRO DA OMBA RECALQUE;- BOMBA HIDRANTE;- QUADRO Q.F.A.C.S;- QUADRO DO HALL 1 E 2;- QUAD', 'n', '329', 5, '2014-12-12', '2014', 'jonatan@beachpark.com.br', '2015-01-05', '2015-01-10', 0, 0, 0, 's', 'n', 'n', '', 'n', '2950.00'),
(141, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA COM 03 TRANSFORMADORES DE FORCA DE 300KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS, QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO E BANCOS CAPACITORES, CONFORME DESCRICAO DOS SERVICOS EM ANEXO.', 'n', '321', 20, '2014-12-05', '2014', 'francisco@holidayfortaleza.com.br', '2014-12-17', '2015-01-06', 11, 0, 0, 's', 'n', 'n', '', 'n', '1800.00'),
(142, 'junior', 'OSASUNA PARTICIPACOES LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA BLINDADA COM TRES TRANSFORMADORES DE 1000KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS DE UMA SUBESTACAO AEREA DE 225KVA E 150KAV CONFORME DESCRICAO DOS SERVICOS EM ANEXO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CRE-CE.', 'n', '312', 15, '2014-12-15', '2014', 'ivon@jangadeirotextil.com.br', '2014-12-31', '2015-01-06', 1, 0, 0, 's', 'n', 'n', '', 'n', '4460.00'),
(143, 'junior', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'INSTALACAO DE QUADRO DE COMANDO COM UM SOFT-START PARA MOTOR DA CASCATA. TODO MATERIAL FORNECIDO PELA ELFI, CONFORME ABAIXO.<br /><br /><br />\r\nRELACAO DE MATERIAIS<br /><br /><br />\r\n01 UND SOFT START SSW.05 - WEG P/ 20CV<br /><br /><br />\r\n01 UND MINI CONTATOR 220V 6A 2NA+2NF<br /><br /><br />\r\n01 UND QUADRO DE COMANDO 300X300X200MM PVC<br /><br /><br />\r\n01 UND BOTOEIRA LIGA DESLIGA DUPLO<br /><br /><br />\r\n01 UND DISJUNTOR MONOPOLAR DE 2A<br /><br /><br />\r\n01 UND CONJUNTO DE SINALIZACAO LED', 'n', '276', 5, '2014-12-16', '2014', 'josegilmar@beachpark.com.br', '2014-12-19', '2015-01-15', 0, 0, 0, 's', 'n', 'n', 'Passou do prazo de execuÃ§Ã£o devido a prioridade do serviÃ§o dos Geradores', 'n', '4100.00'),
(144, 'junior', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', 'ManutenÃ§Ã£o', 'Gerador', 'PROPOSTA DE MAO DE OBRA PARA MANUTENCAO DE DOIS GRUPOS GERADORES, ONDE SERAO REALIZADOS OS SERVICOS DE PINTURA, TROCA DE OLEO LUBRIFICANTE, FILTROS, ADITIVOS DOS RADIADORES, ( MATERIAIS FORNECIDOS PELO CLIENTE CONFORME ABAIXO).<br /><br />\r\nRELACAO MATERIAIS:<br /><br />\r\n60 LTRS OLEO LUBRIFICANTE PARA MOTOR A DIESEL<br /><br />\r\n02 UND FILTRO DE COMBUSTIVEL FF5052<br /><br />\r\n02 UND FILTRO DE OLEO LUBRIFICANTE 1280<br /><br />\r\n02 UND ADITIVO P/ AGUA RADIADOR<br /><br />\r\n01 GL. TINTA PARA FER', 'n', '280', 15, '2014-12-16', '2014', 'josegilmar@beachpark.com.br', '2014-12-29', '2015-01-13', 0, 0, 0, 's', 'n', 'n', '', 'n', '17000.00'),
(145, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA DE 225KVA, CONFORME RELACAO DE SERVICOS EM ANEXO.', 'n', '325', 15, '2014-12-18', '2014', 'wagnerbastos@sesc-ce.com.br', '2015-01-10', '2015-01-25', 0, 0, 0, 's', 'n', 'n', '', 'n', '1200.00'),
(146, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', 'DIAGRAMA UNIFILAR DOS PAINEIS ELETRICOS E SUBESTACAO COM ESPECIFICACAO DE DISJUNTORES E CABOS COM SUAS PROTECOES. CONFORME RELACAO ABAIXO;<br /><br /><br />\r\nOBS: SERA FORNECIDO DESENHOS EM CD<br /><br /><br />\r\n- PAINEL CALDEIRA;<br /><br /><br />\r\n- PAINEL CALDEIRA ELETRICA;<br /><br /><br />\r\n- CALDEIRA 1 E 2;<br /><br /><br />\r\n- QUADRO E BOMBADO ESGOTO;<br /><br /><br />\r\n- QUADRO COZINHA;<br /><br /><br />\r\n- QUADRO DA COZINHA BALCAO;<br /><br /><br />\r\n- QUADRO EXALTOUR;<br /><br /><br />', 'n', '330', 25, '2014-12-18', '2014', 'jonatan@beachpark.com.br', '2015-01-06', '2015-02-26', 1, 0, 0, 's', 'n', 'n', '', 'n', '6100.00'),
(147, 'junior', 'MARQUISE EMPREENDIMENTOS S/A', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA SUBISTITUICAO DA FIACAO QUE ALIMENTA OS MOTORES DA BOMBA DE EMERGENCIA DE 40CV COM INSTALACAO DE QUADRO DE COMANDO COM SOFTSTARTER E DISJUNTOR DE PROTECAO NO SUBESTACAO.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA 1,00 2.256,00 2.256,00<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELA ELFI; <br /><br /><br />\r\n210 MT - CABO FLEX 16MM 1KV<br /><br /><br />\r\n09 UND - TERMINAL DE COMPRESSAO CABO 16MM<br /><br /><br />\r\n01 UND - QUADRO DE COMANDO EM CHAPA DE ACO<br /><br /><br />\r', 'n', '318', 6, '2014-12-29', '2014', 'acelio@granmarquise.com.br', '2015-01-21', '2015-01-26', 0, 0, 0, 's', 'n', 'n', '', 'n', '7600.00'),
(148, 'junior', 'DEPARTAMENTO NACIONAL DE PRODUCAO MINERAL - DNPM', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'SERVICO DE MANUTENCAO DE UM TRANSFORMADOR DE 75 KVA EM POSTE, INCLUINDO OS SEGUINTES SERVICOS:<br /><br /><br />\r\n- RETIRADA DO OLEO PARA ANALISE EM LABORATORIO OFICIAL,<br /><br /><br />\r\nDE ACIDEZ E RIGIDEZ DIELETRICA;<br /><br /><br />\r\n- LIMPEZA EXTERNA DO TRANSFORMADOR NO POSTE;<br /><br /><br />\r\n- MANUTENCAO E CALIBRACAO DAS CHAVES FUSIVEIS<br /><br /><br />\r\nINDICADORAS;<br /><br /><br />\r\n- LIMPEZA, REAPERTOS E POLIMENTOS DOS EQUIPAMENTOS DA<br /><br /><br />\r\nSUBESTACAO;<br /><br /><br', 'n', '294', 4, '2014-12-29', '2014', 'aline.bezerra@dnpm.gov.br', '2015-01-10', '2015-02-05', 0, 0, 0, 's', 'n', 'n', '', 'n', '1989.00'),
(149, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROJETO E INSTALACAO DE UM RAMAL DE BAIXA TENSAO TRIFASICO SUBITERRANEO COM EXTENSAO APROXIMADA DE 170M, PARTINDO DO QGBT DA SUBESTACAO EXISTENTE DE 900KVA, PARA ALIMENTAR UM QUADRO DE FORCA QDF, E QUATRO QUADROS DE DISTRIBUICAO DE LUZ E FORCA QDLF, PARA ENERGIZAR AS 42 SALAS DE AULA. ( POSTEIROMENTE PASSAREMOS UMA PROPOSTA PARA ATENDER AS 42 SALAS DE<br /><br /><br />\r\nAULA).', 'n', '310', 15, '2014-12-10', '2014', 'chicosombra@gmail.com', '2015-01-13', '2015-02-13', 27, 0, 0, 's', 'n', 'n', '', 'n', '15768.00'),
(150, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'SERVICO DE SUBSTITUICAO DO DISJUNTOR TRIPOLAR DE 250A, DEVE SER FORNECIDO PELA A PRESTADORA DE SERVICO<br /><br /><br /><br />\r\nCONTRATADA.<br /><br /><br /><br />\r\nSERVICO DE SUBSTITUICAO TC 15 KVA - 100/5 FORNECIDO PELO SESC PARA CUBICULO DE ENTRADA;<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DO CUBICULO<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DA SUBESTACAO 01<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DA SUBESTACAO 02<br /><br /><br /><br />\r\nSE', 'n', '11', 15, '2015-01-16', '2015', 'wagnerbastos@sesc-ce.com.br', '2015-01-19', '2015-02-09', 3, 0, 6, 's', 's', 'n', '', 'n', '3969.00'),
(151, 'junior', 'NACIONAL ARCO-IRIS IND. E COM. DE TINTAS LTDA', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'CONFORME SUA SOLICITACAO DE UMA VISITA TECNICA, ONDE FOI REALIZADO EM 06.01.2015. ESTAMOS PASSANDO PROPOSTA<br /><br /><br /><br />\r\nPARA COLOCAR EM PARALELO OS 2 TRANSFORMADORES DE 1000KVA, PARA DISTRIBUIR MELHOR AS CARGAS, COM O ACRESCIMO DE UM SEGUNDO MOINHO NO SISTEMA.<br /><br /><br /><br />\r\nOBS: 1 - FAVOR PASSAR DIAGRAMA UNIFILAR DA SUBESTACAO COM QUADRO DE CARGA E MOMORIAL DE CALCULO.<br /><br /><br /><br />\r\n2- DURANTE O SERVICO TEREMOS QUE PASSAR APARELHOS: MEGA -MICROMIMETRO - TTR PAR', 'n', '8', 1, '2015-01-19', '2015', 'ronauth.rodrigues@hipercor.com.br', '2015-01-25', '2015-01-26', 0, 0, 0, 's', 's', 'n', '', 'n', '2200.00'),
(152, 'junior', 'CONSTRUTORA GRANITO LTDA', 'ServiÃ§o TÃ©cnico', 'Disjuntor', 'PROPOSTA PARA PARAMETRIZACAO DAS PROTECOES COM AJUSTE DOS RELES, BASEADO NOS VALORES DE CALCULO DO PROJETO FORNECIDO PELA CAGECE, NO DISJUNTOR GERAL DE ENTRADA DA COELCE E DAS PROTECOES DAS SUBESTACOES DAS EBB-01 E EBB-02.', 'n', '326', 10, '2015-01-19', '2015', 'wmelo_engcivil@hotmail.com', '2015-01-28', '2015-01-29', 1, 0, 0, 's', 'n', 'n', '', 'n', '3000.00'),
(154, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'MediÃ§Ã£o', 'SPDA', 'MEDICAO DA MALHA DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA DOS SEGUINTES BRIQUEDOS; INSANO; RAMUBRINCAR; ARREPIOS; TORRE. LAUDO E ART.', 'n', '22', 1, '2015-01-23', '2015', 'emerson@beachpark.com.br', '2015-01-23', '2015-01-24', 6, 0, 0, 's', 's', 'n', '', 'n', '1200.00'),
(155, 'junior', 'RESTAURANTE LIMONE', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'INSTALACAO DE UM DISJUNTOR TRIPOLAR DE BAIXA TENSAO DA SUBESTACAO, EM SUBSTITUICAO AO ATUAL QUE NAO ESTA OPERANDO.<br /><br /><br /><br />\r\n- 01 UND DISJUNTOR TRIPOLAR 175A 10KA TIPO CA ELETROMAR - FORNECIMENTO E TROCA DA CARGA DE OLEO DO TRANSFORMADOR DE 112,5 KVA COM VOLUME TOTAL DE 120 LITROS, POR OLEO NOVO TIPO AV-GOIN, PETROBRAS.', 'n', '33', 1, '2015-02-06', '2015', 'danielle_costa20@hotmail.com', '2015-02-09', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '2403.00'),
(156, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA INSTALACAO DE REDE ELETRICA NO ESTACIONAMENTO PARA ALUNOS III, QUE FOI ROUBADO, CONFORME RELACAO DE MATERIAIS ABAIXO;<br /><br /><br />\r\n40 MT - CABO ISOLADO 750V, 2,5MM<br /><br /><br />\r\n10 MT - CABO ISOLADO 750V 6,00MM', 'n', '38', 2, '2015-02-06', '2015', 'telma.maciel@estacio.br', '2015-02-10', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '900.00'),
(157, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA FAZER REDE ELETRICA NO ESTACIONAMENTO DOS ALUNOS III, QUE FOI ROUBADO.<br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br />\r\n60MT - CABO DE ALUMINIO MULTIFLEXADO 16MM<br /><br /><br />\r\nVB - FITA ISOLANTE , TERMINAIS ETC', 'n', '39', 2, '2015-02-06', '2015', 'telma.maciel@estacio.br', '2015-02-10', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '1000.00'),
(158, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'ServiÃ§o TÃ©cnico', 'Aterramento', 'PROPOSTA PARA MELHORIA DO ATERRAMENTO NOS PAINEIS ELETRICOS E POSTE METALICO CONFORME A RELACAO ABAIXO;<br /><br /><br /><br />\r\n- QUADRO DA BOMBA DE RECALQUE;<br /><br /><br /><br />\r\n- QUADRO RAMAL 1 E 2;<br /><br /><br /><br />\r\n- QUADRO DO EXASTOR DA PADARIA;<br /><br /><br /><br />\r\n- POSTE METALICO;<br /><br /><br /><br />\r\n- QUADRO DO CAMARIM;<br /><br /><br /><br />\r\nOBS: COM A CONCLUSAO SERA EMITO LAUDO <br /><br /><br /><br />\r\nNOTA: MATERIAL FORNECIDO PELO BEACH PARK MARIUBA<br /><br ', 'n', '44', 10, '2015-02-10', '2015', 'jonatan@beachpark.com.br', '2015-02-25', '2015-02-27', 1, 0, 0, 's', 's', 'n', '', 'n', '6800.00'),
(159, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'MediÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA MEDICAO E INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA; APOS AS MEDICOES SERAO EMITIDOS LAUDOS E ART.', 'n', '42', 4, '2015-02-09', '2015', 'jonatan@beachpark.com.br', '2015-02-10', '2015-02-11', 2, 0, 0, 's', 's', 'n', '', 'n', '1440.00'),
(160, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', 'Laudo TÃ©cnico', 'Aterramento', 'PROPOSTA PARA FORNECIMENTO DE LAUDO TECNICO DE ATERRAMENTO ELETRICO NO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICAS, NO PREDIO DE IGUATU- CE. <br /><br /><br />\r\n<br /><br /><br />\r\nLOCAL: SESC IGUATU', 'n', '31', 2, '2015-02-10', '2015', 'wagnerbastos@sesc-ce.com.br', '2015-03-03', '2015-03-04', 1, 0, 0, 's', 's', 'n', '', 'n', '1800.00'),
(161, 'junior', 'STOCK TECH LOGISTICA', 'ServiÃ§o TÃ©cnico', 'Plantonista', 'SERVICO DE UMA DIARIA DE UM ELETRECISTA EXECUTADO NO DIA 11.02.2015 NA STOCK TECH.<br /><br /><br /><br />\r\n- ORDEM DE COMPRA NÂ° 739', 'n', '48', 1, '2015-02-11', '2015', 'aristophanes.sousa@stocktech.com.br', '2015-02-11', '2015-02-11', 8, 0, 0, 's', 's', 'n', '', 'n', '288.00'),
(162, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'Transformador', 'ESTACÃƒO DE TRATAMENTO<br /><br /><br />\r\n<br /><br /><br />\r\n1 - PROPOSTA PARA MANUTENCAO CORRETIVA NO TRAFO DE<br /><br /><br />\r\n112,5KVA DE NÂ° A91406, ANO FABRICACAO 2012.<br /><br /><br />\r\n- SERVICOS A SER REALIZADO;<br /><br /><br />\r\n- TRATAMENTOS DOS TERMINAIS DE ALTA E BAIXA TENSAO QUE<br /><br /><br />\r\nESTAO OXIDADOS;<br /><br /><br />\r\n- PINTURA EXTERNA;<br /><br /><br />\r\n- TROCA DOS TRES PARA-RAIO CLASSE 12KV, 10KA;<br /><br /><br />\r\n- SECAGEM DA PARTE ATIVA NA ESTUFA 48 HORAS;<', 'n', '47', 8, '2015-02-19', '2015', 'ricardo@beachpark.com.br', '2015-03-02', '2015-03-25', 0, 0, 0, 's', 'n', 'n', '', 'n', '3200.00'),
(163, 'junior', 'MINISTERIO DA SAUDE', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'SERVICO DE EMERGENCIA PARA SUBISTIRUICAO DE UMA CHAVE DE BAIXA TENSAO IRTA DE 1000A, TIPO DTI QUE NAO<br /><br /><br /><br />\r\nEXISTE MAIS NO COMERCIO; ELIMANDO A CHAVE E SUBISTITUINDO PELA CABIACAO DE COBRE FICANDO PROTEGIDO PELOS TRES FUSIVEIS DE 1000A EXISTENTES.', 's', '46', 2, '2015-02-19', '2015', 'selma.mota@saude.gov.br', '2015-02-21', '2015-02-23', 0, 0, 1, 's', 's', 'n', '', 'n', '7120.00'),
(164, 'junior', 'OSASUNA PARTICIPACOES LTDA', 'ServiÃ§o TÃ©cnico', 'Transformador', 'CONFORME LAUDO DE OLEO ISOLANTE DOS TRANSFORMADORES DE 1000KVA, NÂ° 123526.NÂ° 123527 E NÂ° 90102, ESTAMOS PASSANDO PROPOSTA PARA FAZER TRATAMENTO DO OLEO MINERAL ISOLANTE PELO PROCESSO TERMO-VACUO CORRIGIR TEOR DE AGUA E RIGIDEZ DIELETRICA.<br /><br /><br /><br /><br />\r\nNOTA<br /><br /><br /><br /><br />\r\n1 - A ELFI GARANTE O VALOR DE TEOR DE AGUA SATISFATORIO DA AMOSTRA APOIS O TRATAMENTO.<br /><br /><br /><br /><br />\r\n2 - TRATAMENTO COM OS TRES TRANSFORMADORES ENERGIZADOS', 'n', '41', 20, '2015-02-12', '2015', 'ivon@jangadeirotextil.com.br', '2015-02-19', '2015-03-09', 8, 0, 0, 's', 's', 'n', '', 'n', '8000.00'),
(165, 'junior', 'COBAP-COM. E BENEFICIAMENTO DE ARTEFATOS DE PAPEL', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '- VISITA TECNICA REALIZADA 20/02/2015 DE EMERGENCIA, ONDE FOI RECLAMADO UM PROBLEMA NO TRANSFORMADOR DA SUBESTACAO, A ELFI APLICOU OS APARELHOS DE MEDICOES ELETRICAS NO MESMO CONSTATANDO QUE O MESMO ESTA SEM PROBLEMAS. O REAL PROBLEMA FOI INDENTIFICADO EM UM DISJUNTOR DE BAIXA TENSAO NO QGBT DA SUBESTACAO ONDE O RESPONSAVEL DA POC, SR. ALEX, FICOU DE SUBSTITUIR O MESMO.<br /><br /><br />\r\nNOTA: RECOMENDAMOS UMA MANUTENCAO PREVENTIVA GERAL NA SUBESTACAO (SEGUE EM NOVO ORCAMENTO)', 's', '49', 1, '2015-02-20', '2015', 'suprimentos2@cobap.com.br', '2015-02-20', '2015-02-20', 5, 0, 0, 's', 's', 'n', '', 'n', '450.00'),
(166, 'junior', 'INVESTAR HOTELARIA S/A', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ABRIGADA COM dOIS TRANSFORMADORES A SECO DE 500KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS E QUADRO GERAL DE BAIXA TENSAO, CONFORME RELACAO DE SERVICOS ABAIXO:', 'n', '18', 3, '2015-02-25', '2015', 'infra.fortaleza@bluetree.com.br', '2015-04-02', '2015-04-02', 0, 0, 0, 's', 'n', 'n', '', 'n', '1600.00'),
(167, 'junior', 'INVESTAR HOTELARIA S/A', 'ManutenÃ§Ã£o', 'SPDA', 'MANUTENCAO PREVENTIVA E CORRETIVA DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS SPDA, COM MEDICOES DA RESISTENCIA DA MALHA DE TERRA E SUBISTITUICAO DO MASTRO E DEMAIS COMPONENTES ABAIXO;<br /><br /><br />\r\n01 UND - MASTRO F.G A FOGO 4M X 1 1/2<br /><br /><br />\r\n01 UND - BASE PARA MASTRO 1 1/2'' G. A FOFO<br /><br /><br />\r\n04 UND - ISOLADOR PARA MASTRO 1 1/2 X 2<br /><br /><br />\r\n01 UND - CAPITOR CROMADO LATAO 300MM PARA 2 DESCIDAS<br /><br /><br />\r\n20 MT - CABO DE ACO ISOLADO COM PLAST', 'n', '40', 5, '2015-02-25', '2015', 'infra.fortaleza@bluetree.com.br', '2015-03-02', '2015-03-10', 1, 0, 3, 's', 'n', 'n', '', 'n', '1675.00'),
(168, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'ManutenÃ§Ã£o', 'Disjuntor', 'PROPOSTA PARA MANUTENCAO CORRETIVA DE UM DISJUNTOR DE MEDIA TENSAO 17KV, FABRICACAO BEGHIM NÂ° 1780 17,5KV; 630A A VACUO, CONFORME DESCRICAO DOS SERVICOS ABAIXO;<br /><br /><br />\r\n- TRANSPORTE<br /><br /><br />\r\n- PINTURA NO GABINETE<br /><br /><br />\r\n- TRATAMENTO DAS PARTES ISOLANTES<br /><br /><br />\r\n- TRATAMENTO DOS 3 TC''S<br /><br /><br />\r\n- TRATAMENTO DAS BARRAS DE COBRE E PARAFUSOS ETC<br /><br /><br />\r\n- ENSAIOS ELETRICOS;<br /><br /><br />\r\n- MEDICAO DE RESISTENCIA DE ISOLAMENTO<br ', 'n', '62', 5, '2015-02-26', '2015', 'fabianosilva@beachpark.com.br', '2015-02-26', '2015-03-13', 0, 0, 10, 's', 'n', 'n', '', 'n', '2650.00'),
(169, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'Aterramento', 'PROPOSTA PARA MANUTENCAO CORRETIVA NA MALHA DE TERRA DOS PAINEIS ELETRICOS DOS BRIQUEDOS: ACQUA CIRCO, QGBT-1211, QUANDO INSANO, QUADRO MOREIA NEGRA, QUADRO ZUMPTCHIBUM, QUADRO NS-0215, BOMBA 4 CORRENTEZA, QUADRO DE BOMBA NS-50213, CORRENTEZA BOMBA 3, CCM ATLANTIS NS-0344 NUM TOTAL DE 10 PAINEIS.<br /><br /><br /><br />\r\n- RELACAO DE MATERIAIS ABAIXO:<br /><br /><br /><br />\r\n40 UND - HASTE TERRA 5/8 X 2,40 MTS COBREADA ROSCADA<br /><br /><br /><br />\r\n40 UND - LUVA PARA HASTE TERRA 5/8<br /><br', 'n', '189 /14', 10, '2015-02-26', '2015', 'emerson@beachpark.com.br', '2015-03-04', '2015-03-05', 5, 0, 0, 's', 's', 'n', '', 'n', '9950.00'),
(170, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', 'ManutenÃ§Ã£o', 'SPDA', 'PROPOSTA PARA MELHORIA DO ATERRAMENTO NOS PONTOS DAS TORRE 1 E 2, EM UM TOTAL DE 4 PONTOS.<br /><br />\r\nOBS: COM A CONCLUSAO SERA EMITO LAUDO<br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELO BEACH PARK MARIUBA;<br /><br />\r\n30 MT - CABO DE COBRE NU DE 35MM<br /><br />\r\n12 UND - HASTE DE TERRA ROSCADA 5/8 X 2,400<br /><br />\r\n12 UND - LUVA PARA HASTE DE TERRA 5/8<br /><br />\r\n30 UND - CONECTOR TIPO GRAMPO REFORCADO<br /><br />\r\n04 DOSE - TERROGEL', 'n', '65', 10, '2015-03-04', '2015', 'jonatan@beachpark.com.br', '2015-03-04', '2015-03-04', 0, 0, 0, 's', 'n', 'n', '', 'n', '3260.00'),
(171, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '1- PROPOSTA PARA SERVICO DE MODIFICACAO NAS INSTALACOES DA SUBESTACAO;<br /><br /><br /><br /><br /><br /><br />\r\n1.1 - FAZER BY PASS D TRANSFORMADOR - TR-02 E TR-03 TRAFOS DE 300KVA; PARA RETIRADA DOS CABOS GERADOR E QUADRO DE TRANSFERENCIA.<br /><br /><br /><br /><br /><br /><br />\r\n1.2 - FAZER BY PASS DO TRAFO DE 500KVA PARA A RETIRADA DOS CABOS DO GERADOR E RETIRADA DO QUADRO DE TRANSFERENCIA.<br /><br /><br /><br /><br /><br /><br />\r\n1.3 - FAZER INSTALACAO DO GRUPO GERADOR COM PASSAGEM DOS', 'n', '64', 1, '2015-03-04', '2015', 'atylabrasil@hsmce.com.br', '2015-03-28', '2015-03-28', 0, 0, 0, 's', 's', 'n', '', 'n', '18500.00'),
(172, 'junior', 'INSTITUTO DOENCAS RENAIS', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 225KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', 'n', '66', 16, '2015-03-06', '2015', 'helenajuca@grupoinstitutodorim.med.br', '2015-03-15', '2015-03-30', 0, 0, 0, 's', 'n', 'n', '', 'n', '1215.00'),
(173, 'junior', 'INSTITUTO DO RIM', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 150KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', 'n', '67', 16, '2015-03-06', '2015', 'helenajuca@grupoinstitutodorim.med.br', '2015-03-15', '2015-03-30', 0, 0, 0, 's', 'n', 'n', '', 'n', '1215.00'),
(174, 'junior', 'POLICLINICA DO RIM S/S LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 112,5KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', 'n', '68', 16, '2015-03-06', '2015', 'helenajuca@grupoinstitutodorim.med.br', '2015-03-22', '2015-04-22', 0, 0, 0, 's', 'n', 'n', '', 'n', '1215.00'),
(175, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'SERVICO DE EMERGENCIA EXECUTADO DIA 07/03/2015 (SAB) COM RETIRADA DE UM TC (TRANSFORMADOR DE CORRENTE), DEIXANDO UM BYPASS NO MESMO; E DIA 09/03/2015 (SEG) COM RETIRADA DE UM FUSIVEL HH 20A, CLASSE 15KV DO TRANSFORMADOR NÂº02. <br /><br /><br />\r\nLOCAL: FIC VIA CORPUS - SUBESTACAO DO BLOCO NOVO', 'n', '71', 5, '2015-03-07', '2015', 'francisco.sousa@estacio.br', '2015-03-07', '2015-03-09', 3, 0, 0, 's', 's', 'n', '', 'n', '2050.00'),
(176, 'junior', 'RENAGUA IND. E COM. DE AGUA LTDA', 'ManutenÃ§Ã£o', 'Banco de Capacitores', 'MANUTENCAO PREVENTIVA EM UM BANCO DE CAPACITOR CONFORME FOTO ENVIADA.<br /><br /><br />\r\n- LIMPEZA GERAL COM PRODUTOS APROPRIADOS.<br /><br /><br />\r\n- LEVANTAMENTO DAS POTENCIAS DOS CAPACITORES, PARA<br /><br /><br />\r\nAVALIAR O RENDIMENTO DOS MESMOS.<br /><br /><br />\r\n- MEDICAO DA CORRENTE ELETRICA EM CADA FASE.<br /><br /><br />\r\n- REAPERTO DAS CONEXOES.<br /><br /><br />\r\n- EMISSAO DE LAUDO.', 'n', '72', 4, '2015-03-10', '2015', 'contato@renagua.com.br', '2015-03-10', '2015-03-12', 0, 0, 0, 's', 's', 'n', '', 'n', '550.00'),
(177, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA PARA INSTALACAO DE 03 CHAVES FUSIVEIS CLASSE 25KV E TROCA DE UM QUADRO DE PROTECAO SECUNDARIA, PARA ADEQUACAO DA SUBESTACAO AEREA 112,5KVA DA ESTACAO DE TRATAMENTO ETA.<br /><br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL CLASSE 25KV 300A COM ELO FUSIVEL<br /><br /><br /><br />\r\n01 UND - QUADRO DE PROTECAO SECUNDARIA SUBESTACAO<br /><br /><br /><br />\r\nAEREA DE 1125,5KA PADRAO COELCE.', 'n', '57', 4, '2015-03-12', '2015', 'ricardo@beachpark.com.br', '2015-03-13', '2015-03-13', 0, 0, 0, 's', 's', 'n', '', 'n', '2918.00'),
(178, 'junior', 'STOCK TECH LOGISTICA', 'ServiÃ§o TÃ©cnico', 'Transformador', 'PROPOSTA PARA MUDANCA DE TAP DE UM TRANSFORMADOR DE 750KVA. COM A COM A CONCLUSAO DO SERVICO SERA FEITO MEDICOES DE RESISTENCIA DE CONTATO E DE RELACAO DE TRANSFORMACAO (TTR).', 'n', '69', 1, '2015-03-12', '2015', 'aristophanes.sousa@stocktech.com.br', '2015-03-15', '2015-03-16', 0, 0, 0, 's', 'n', 'n', '', 'n', '880.00'),
(179, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'MediÃ§Ã£o', 'Aterramento', '- MEDICAO DE ATERRAMENTO EM 01 (UM) QUADRO COM EMISSAO DE LAUDO.<br /><br />\r\nLOCAL: PARQUE - QUADRO GERAL DAS CABANAS', 'n', '75', 2, '2015-03-12', '2015', 'emerson@beachpark.com.br', '2015-03-12', '2015-03-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '600.00'),
(180, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'Material', 'Equipamento SubestaÃ§Ã£o', 'FORNECIMENTO VERGALHAO COBRE 3/8 X 3000MM, NUM TOTAL DE 03 PECAS, CONFORME SOLICITADO.', 'n', '78', 1, '2015-03-13', '2015', 'fabianosilva@beachpark.com.br', '2015-03-13', '2015-03-13', 3, 0, 0, 's', 's', 'n', '', 'n', '550.00'),
(181, 'junior', 'STL INFORMATICA LTDA ', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'pROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO', 'n', '79', 16, '2015-03-17', '2015', 'nunes@stl.com.br', '2015-03-19', '2015-03-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '1477.00'),
(182, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'Material', 'Fornecimento', 'MATERIAL FORNECIDO PARA SER INSTALADO NA SUBESTACAO DA ESTACAO DE ESGOTO DO PARQUE EM 23/03/2015<br /><br /><br />\r\n- 03 UND ISOLADOR ANCOR POLIM SUSP 25KV<br /><br /><br />\r\n- 02 UND CURVA<br /><br /><br />\r\n- 03 UND LUVAS', 'n', '84', 1, '2015-03-23', '2015', 'emerson@beachpark.com.br', '2015-03-23', '2015-03-24', 1, 0, 0, 's', 's', 'n', '', 'n', '570.00'),
(183, 'junior', 'INSTITUTO DOENCAS RENAIS', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA INSTALACAO DO CABO DE ATERRAMENTO De COBRE NU DE 35MM NO QUADRO GERAL DE BAIXA TENSAO PARA QUE A SUBESTACAO FIQUE DENTRO DOS PADROES DE SEGURANCA.', 'n', '91', 1, '2015-03-31', '2015', 'helenajuca@grupoinstitutodorim.med.br', '2015-04-07', '2015-04-08', 0, 0, 0, 's', 'n', 'n', '', 'n', '400.00'),
(184, 'junior', 'STOCK TECH LOGISTICA', 'MediÃ§Ã£o', 'SPDA', 'INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO, COM A CONCLUSAO SERA REMETIDO RELATORIO TECNICO E ART DO CREA-CE.', 'n', '85', 3, '2015-03-31', '2015', 'angelo.zavadski@stocktech.com.br', '2015-03-31', '2015-03-31', 0, 0, 0, 's', 'n', 'n', '', 'n', '1000.00'),
(185, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '1 - PROPOSTA PARA RETIRADA DE UM MOTOR DA CAIXA DAGUA E INSTALACAO DE UM NOVO (1CV, MONOFASICO, 127/220V) FORNECIDO PELA ELFI.<br /><br /><br />\r\n2 - CONSERTO DE UM MOTOR BUSCK TYPE: M563B-4', 'n', '86', 5, '2015-03-25', '2015', 'gustavo_oliveira@praxair.com', '2015-03-25', '2015-04-06', 13, 0, 7, 's', 'n', 'n', '', 'n', '1680.00'),
(186, 'junior', 'STOCK TECH LOGISTICA', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', 'SERVICO DE EMERGENCIA REALIZADO NO DIA 07/04/2015 A NOITE, NA SUBESTACAO ELETRICA ONDE FORAM REALIZADO INSPECAO VISUAL NO DISJUNTOR DE ALTA TENSAO, DISJUNTOR DE BAIXA TENSAO , TRANSFORMADOR, CHAVES ETC. FOI CONSTATADO QUE DOIS PORTA FUSIVEIS TINHA DESARMADO, FOI REALIZADO A TROCA DOS FUSIVEIS RESTABELECIDO E FORNECIMENTO DE ENERGIA.(RECOMENDAMOS A TROCA DAS 3 CHAVES FUSIVEIS DO POSTE PARA CLASSE 25KV)', 'n', '99', 1, '2015-04-07', '2015', 'aristophanes.sousa@stocktech.com.br', '2015-04-07', '2015-04-08', 1, 0, 0, 's', 'n', 'n', '', 'n', '960.00'),
(187, 'junior', 'AMENDOAS DO BRASIL LTDA', 'ServiÃ§o TÃ©cnico', 'Transformador', 'PROPOSTA PARA FILTRAGEM DE OLEO ISOLANTE PELO O PROCESSO TERMO VACUO EM 02 (DOIS) TRANSFORMADOR SENDO UM 500KVA E OUTRO DE 300KVA APOS A FILTRAGEM SERA EMITIDO UM NOVO RELATORIO DE ANALISE DE OLEO.', 'n', '56', 3, '2015-04-13', '2015', 'brito@amendoasdobrasil.com.br', '2015-04-21', '2015-04-22', 0, 0, 0, 's', 'n', 'n', '', 'n', '3200.00'),
(188, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- PROPOSTA PARA MONTAGEM DE ELETROCALHA COM PASSAGEM DOS CABOS E INTERLIGACAO COM O GERARDOR NOVO.<br /><br /><br />\r\nOBS: RELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 UND - CALHA PERFURADA 200 X 50 X 300<br /><br /><br />\r\n03 UND - EMENDA PARA CALHA 200 X 50 JUNCAO INTERNA<br /><br /><br />\r\n06 UND - SUPORTE ANGULAR 200 X 50<br /><br /><br />\r\n09 MT - BARRA ROSCADA DE 3/8''<br /><br /><br />\r\n15 UND - GANCHO CURTO PARA PREFILADO<br /><br /><br />\r\n50 UND - PORCA SERTAVAD', 'n', '93', 5, '2015-04-08', '2015', 'francisco@holidayfortaleza.com.br', '2015-04-13', '2015-05-13', 5, 0, 0, 's', 'n', 'n', '', 'n', '2116.00'),
(189, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA FAZER UM NOVO PROJETO APROVADO NA COELCE, DO RAMAL DE ENTRADA DA SUBESTACAO DO ACQUARESORT CONFORME CARTA PROJETO NÂ° 013/2015, ONDE SERA FEITO ESTUDO E CALCULOS COORDERNACAO E SELETIVIDADE, COM AJUSTE DA PROTECAO E ADEQUACAO DO PROJETO DENTRO DAS EXISTENCIAS DA COELCE.', 'n', '111', 30, '2015-04-16', '2015', 'fabianosilva@beachpark.com.br', '2015-04-16', '2015-04-16', 1, 0, 0, 's', 'n', 'n', '', 'n', '5000.00'),
(190, 'junior', 'INSTITUTO DOENCAS RENAIS', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- PROPOSTA PARA INSTALACAO DE CABO DE ATERRAMENTO DA 1,00 980,00 980,00<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nSUBESTACAO AEREA DE 225KVA, EM SUBISTITUICAO AO OUTRO<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nQUE FOI ROUBADO. O CABO DEPOIS DE INSTALADO SERA<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nREVERTIDO E COM PROTECAO DE CIMENTO NA DECIDA DO<br /><br /><br /><br /><br /><br /><br ', 'n', '5', 1, '2016-01-07', '2016', 'helenajuca@grupoinstitutodorim.med.br', '2016-01-07', '2016-01-07', 0, 0, 0, 's', 's', 'n', '', 'n', '980.00'),
(191, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- PROPOSTA COM SISTEMA ENERGIZADO PARA INSTALACAO 1,00 17.840,00 17.840,00<br /><br /><br /><br /><br /><br />\r\nCOM PASSAGENS DE CABOS DO QTA PARA O QUADRO DE<br /><br /><br /><br /><br /><br />\r\nEMERGENCIA. COM OS DEMAIS SERVICOS;<br /><br /><br /><br /><br /><br />\r\n- RETIRADA DO BY PASS GERADOR PROVISORIO PARA O QGBT<br /><br /><br /><br /><br /><br />\r\n- RETIRADA DOS 5 CIRCUUITOS TRIFASICOS DE 300KVA PARA<br /><br /><br /><br /><br /><br />\r\nQGBT 500KVA<br /><br /><br /><br /><br /><br />\r\n-', 'n', '2', 5, '2016-01-12', '2016', 'atylabrasil@hsmce.com.br', '2016-01-23', '2016-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '17840.00'),
(192, 'junior', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1 - CONFORME CARTA COELCE: PROJETO DE NÂ° 195/2015, 1,00 12.162,00 12.162,00<br /><br />\r\nESTAMOS PASSANDO PROPOSTA PARA PROJETO ELETRICO<br /><br />\r\nREFERENTE A UM ACRESCIMO DE POTENCIA DE 150KVA PARA<br /><br />\r\n600KVA, AFIM DE ATENDER AS NOVAS CARGAS. DESCRICAO<br /><br />\r\nCONFORME ABAIXO;<br /><br />\r\n1.1 - PROVIDENCIAR DOCUMENTACAO EXIGIDO PELA COELCE.<br /><br />\r\n1.2 - FAZER NOVA ART.<br /><br />\r\n1.3 - REFAZER NOVO MEMORIAL DESCRITIVO PARA SE<br /><br />\r\nENQUADRA DENTRO DAS ESPECIFIC', 'n', '03', 30, '2016-01-11', '2016', 'wildenbergy.lucas@nacionalgas.com.br', '2016-01-12', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '12162.00'),
(193, 'junior', 'INAPI INDUSTRIA NAC. DE ACESS. PARA IRRIGACAO S/A', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA INSPECAO EM DOIS TRANSFORMADORES DE 1,00 1.960,00 1.960,00<br /><br /><br /><br />\r\n750KVA E OUTRO DE 500KVA, ONDE FOI REALIZADO OS<br /><br /><br /><br />\r\nSEGUINTES ENSAIOS; RESISTENCIA OHMICA DE ISOLAMENTO,<br /><br /><br /><br />\r\nRESISTENCIA OHMICAS ENROLAMENTOS, RELACAO DE<br /><br /><br /><br />\r\nTRANSFROMACAO (TTR), COLETA DE OLEO NOS DOIS<br /><br /><br /><br />\r\nTRANSFOS, PARA ENSAIO FISICO-QUIMICO E<br /><br /><br /><br />\r\nCROMATOGRAFICO NO TRANSFORMADOR DE 750KVA.', 'n', '10', 5, '2016-01-13', '2016', 'jrbsousa@yahoo.com.br', '2016-01-09', '2016-01-27', 0, 0, 13, 's', 's', 'n', '', 'n', '1900.00'),
(194, 'junior', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- PROPOSTA PARA MANUTENCAO CORRETIVA DE UM DISJUNTOR 1,00 3.580,00 3.580,00<br /><br /><br /><br />\r\nDE MEDIA TENSAO AEC, TIPO DSF, 630A, 17,5KV, CONFORME<br /><br /><br /><br />\r\nDESCRICAO DE SERVICO ABAIXO;<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO PARA JORNAL O POVO<br /><br /><br /><br />\r\n- TROCA DE 3 BARRA DE TRACAO<br /><br /><br /><br />\r\n- REGULAGEM LUBRIFICADO COMANDO<br /><br /><br /><br />\r\n- REGULAGEM E TROCA DE OLEO D', 'n', '09', 15, '2016-01-13', '2016', 'thiago.alencar@nacionalgas.com.br', '2016-01-11', '2016-01-27', 1, 0, 1, 's', 's', 'n', '', 'n', '3580.00'),
(195, 'junior', 'FIORI INDUSTRIA E COMERCIO DE CONFECCOES LTDA', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA 1,00 1.350,00 1.350,00<br /><br /><br /><br /><br /><br />\r\nSUBESTACAO AEREA COM UM TRANSFORMADOR DE 150 KVA E<br /><br /><br /><br /><br /><br />\r\nQUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME<br /><br /><br /><br /><br /><br />\r\nRELACAO DE SERVICO EM ANEXO.', 'n', '13', 1, '2016-01-15', '2016', 'Lany Gomes <lany@turmadamalha.com.br>', '2016-02-13', '2016-02-29', 0, 0, 16, 's', 's', 'n', '', 'n', '1350.00'),
(196, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA MANUTENCAO CORRETIVA NO DISJUNTOR DE 1,00 3.400,00 3.400,00<br /><br /><br /><br />\r\nMEDIA TENSAO FABRICACAO BEGHIM NÂ° FABRICACAO 1780,<br /><br /><br /><br />\r\nCLASSE 15KV 630A, TIPO PL COM TRES TRANSFORMADORES DE<br /><br /><br /><br />\r\nCORRENTE, E 01 (TP A OLEO )<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO<br /><br /><br /><br />\r\n- REGULAGEM LUBRIFICADO COMANDO<br /><br /><br /><br />\r\n- RECUPERACAO DAS PARTES ISO', 'n', '15', 10, '2016-01-19', '2016', 'Emerson Oliveira da Silva <emerson@beachpark.com.br>', '2016-01-18', '2016-02-02', 0, 0, 5, 's', 's', 'n', '', 'n', '3400.00'),
(197, 'junior', 'CRAVEIRO IMOBILIARIA LTDEA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1 - CONFORME LAUDO COELCE NÂ° UC. 9010524, DE 30/12/2015 1,00 554,00 554,00<br /><br />\r\nESTAMOS PASSANDO RELACAO DE MATERIAL FORNECIDO PELO<br /><br />\r\nCLIENTE E MAO DE OBRA DA ELFI PARA CORRIGIR VALOR<br /><br />\r\nATERRAMENTO PARA VALORES ABAIXO DE 10 HOMIS.<br /><br />\r\n- VALOR DA MAO DE OBRA<br /><br />\r\n1,00 0,00 0,00<br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELO CLIENTE;<br /><br />\r\n06 UND - HASTE TERRA ROSCADA 5/8'' X 2,40MTS<br /><br />\r\n06 UND - LUVA PARA HASTE DE TERRA<br /', 'n', '21', 1, '2016-01-21', '2016', 'ana@craveiroimobiliaria.com.br', '2016-03-24', '2016-03-24', 0, 0, 0, 's', 'n', 'n', '', 'n', '554.00');
INSERT INTO `acompanhamento` (`id`, `colab`, `cliente`, `atividade`, `classificacao`, `inf_servicos`, `novo_cliente`, `n_orc`, `prazo_exec`, `data_aprovada`, `ano`, `email`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `vr_orc`) VALUES
(198, 'junior', 'GERDAU ACOS LONGOS S/A', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- PROPOSTA PARA MEDICAO E INSPECAO DO SISTEMA DE 1,00 7.750,00 7.750,00<br /><br /><br /><br /><br />\r\nPROTECAO CONTRA DESCARGAS ATMOSFERICAS SPDA, SENDO<br /><br /><br /><br /><br />\r\nUM TOTAL DE 89 PONTOS A SEREM MEDIDOS, E 189 CAIXA DE<br /><br /><br /><br /><br />\r\nINSPECAO A SEREM INSPECIONADOS . SERA TIRADO FOTO DOS<br /><br /><br /><br /><br />\r\nPONTOS COM FALHAS PARA CORRECAO APOS A CONCLUSAO<br /><br /><br /><br /><br />\r\nSERA FORNECIDO LAUDO COM ART.<br /><br /><br /><br /><br />\r\n- SE', 'n', '342-15', 15, '2016-01-21', '2016', 'jefferson.pereira@gerdau.com.br', '2016-01-27', '2016-02-15', 0, 0, 4, 's', 's', 'n', '', 'n', '7750.00'),
(199, 'junior', 'BRADESCO AG. JOAO DE CASTRO EST UNIF', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- SERVICO DE EMERGENCIA JA EXECUTADO DIA 25/01/2016 DE 1,00 1.400,00 1.400,00<br /><br /><br />\r\nMANUTENCAO CORRETIVA NO QGBT DA SUBESTACAO DESTA<br /><br /><br />\r\nAGENCIA BRADESCO, COM FORNECIMENTO E TROCA DO<br /><br /><br />\r\nDISJUNTOR GERAL DE BAIXA TENSAO DA MESMA.', 'n', '27', 1, '2016-01-25', '2016', '0643.adm@bradesco.com.br', '2016-01-25', '2016-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '1400.00'),
(200, 'junior', 'CONSTRUTORA GRANITO LTDA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', ' CONCLUIR A MONTAGEM DE UMA SUBESTACAO ABRIGADA DA CAGECE NO PECEM DE 500KVA COM DISJUNTOR EVOKIT BLINDADO. FALTA FAZER OS SEGUINTES SERVICOS;<br /><br /><br />\r\n1 - FAZER MUFLAS DO RAMAL DE ENTRADA NO POSTE <br /><br /><br />\r\n2 - FAZER MUFLAS DO CUBICULO DE ALTA TENSAO<br /><br /><br />\r\n3 - FAZER MUFLAS DO TRANSFORMADOR DE 500KVA<br /><br /><br />\r\n4 - CONECTAR MUFLAS NA CHAVE FUSIVEL DO RAMAL DE ENTRADA <br /><br /><br />\r\n5 - LIMPEZA DO TRANSFORMADOR E DISJUNTOR DE ALTA TENSAO <br /><br /><', 'n', '26', 5, '2016-01-28', '2016', 'vandemberg@msn.com', '2016-01-28', '2016-02-05', 0, 0, 3, 's', 's', 'n', '', 'n', '6690.00'),
(201, 'junior', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- PROPOSTA PARA MANUTENCAO CORRETIVA COM TROCA DE 1,00 3.456,00 3.456,00<br /><br />\r\nTRES CHAVES SECCIONADORA TRIPOLAR 25KV, 400A, E<br /><br />\r\nISOLADORES DE PEDESTAL 25KV NA SUBESTACAO ELETRICA<br /><br />\r\nPARA ADEQUACAO FUTURA AO PROJETO DE MODERNIZACAO DA<br /><br />\r\nMESMA, A SER APROVADO NA COELCE.', 'n', '8', 2, '2016-02-05', '2016', 'raimundo.gomes@nacionalgas.com.br] ', '2016-04-03', '2016-04-04', 0, 0, 0, 's', 'n', 'n', '', 'n', '3456.00'),
(202, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'PROPOSTA PARA TRATAMENTO TERMO VACUO NO OLEO 1,00 2.200,00 2.200,00<br /><br /><br /><br />\r\nISOLANTE DO TRANSFORMADOR DE 500KVA, NÂ° 128787, PARA<br /><br /><br /><br />\r\nCORRIGIR RIGIDEZ DIELETRICA E TEOR DE AGUA QUE ESTAO<br /><br /><br /><br />\r\nFORA DOS VALORES PADROES PARA OLEO EM USO. COM A<br /><br /><br /><br />\r\nCONCLUSAO SERA FORNECIDO NOVO LAUDO.', 's', '44', 1, '2016-02-17', '2016', 'ricardo@beachpark.com.br', '2016-02-17', '2016-02-29', 0, 0, 12, 's', 's', 'n', '', 'n', '2200.00'),
(203, 'junior', 'YPIOCA AGRICOLA LTDA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'MANUTENCAO CORRETIVA EM DOIS TRANSFORMADORES DE 1,00 8.868,00 8.868,00<br /><br /><br /><br />\r\n75KVA, NÂ° 127483 E NÂ° 220.817.', 'n', '37', 20, '2016-02-16', '2016', 'FRANCISCO.CALIXTO@YPIOCA.COM.BR', '2016-02-15', '2016-02-26', 9, 0, 0, 's', 's', 'n', '', 'n', '8868.00'),
(204, 'junior', 'STOCK TECH LOGISTICA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- SERVICO DE EMERGENCIA NA SUBESTACAO ELETRICAS NO DIA 1,00 0,00 0,00<br /><br /><br />\r\n12.02.2016 AS 20:00 HORAS: PROBLEMA NA CHAVE FUSIVEL DO<br /><br /><br />\r\nRAMAL DE ENTRADA COM ELO ROMPIDO OCASIONANDO FALTA<br /><br /><br />\r\nDE FASE NO QGBT. FOI REALIZADO A TROCA DO ELO E AJUSTE<br /><br /><br />\r\nDA LAMINA DE CONTATO DA MESMA, COMO MEDIDA PALEATIVA<br /><br /><br />\r\nRECOMENDAMOS A TROCA COM URGENCIA.<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 U', 'n', '42', 1, '2016-02-23', '2016', 'angelo.zavadski@stockteach.com.br', '2016-02-28', '2016-02-29', 2, 0, 0, 's', 's', 'n', '', 'n', '3220.00'),
(205, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- TRATAMENTO DO OLEO ISOLANTE PELO PROCESSO 1,00 3.980,00 3.980,00<br /><br />\r\nTERMO-VACUO EM 02 TRANFORMADORES DE 300KVA, PARA<br /><br />\r\nCORRIGIR TEOR DE AGUA E RIGIDEZ E DIELETRICA DOS<br /><br />\r\nMESMOS. APOS TRATAMENTO SERA FEITA NOVA ANALISE DE<br /><br />\r\nOLEO ISOLANTE', 'n', '28', 2, '2016-03-02', '2016', 'Atyla Brasil <atylabrasil@hsmce.com.br>', '2016-04-03', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '3980.00'),
(206, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '- PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA 1,00 4.820,00 4.820,00<br /><br />\r\nSUBESTACAO ABRIGADA: COM TRES TRANSFORMADORES, DOIS<br /><br />\r\nTR - 300KVA A OLEO ISOLANTE E UM 500KVA A SECO, COM<br /><br />\r\nDISJUNTOR DE ALTA TENSAO DOIS QUADROS GERAIS DE BAIXA<br /><br />\r\nTENSAO E UMA SUBESTACAO AEREA DE 150 KVA DA<br /><br />\r\nLAVANDERIA.<br /><br />\r\nCONFORME RELACAO DE SERVICOS ABAIXO:', 'n', '29', 11, '2016-03-02', '2016', 'Atyla Brasil <atylabrasil@hsmce.com.br>', '2016-04-02', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '4820.00'),
(207, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'PROPOSTA PARA INSTALACAO DE 6 MEDIDORES DE ENERGIA 1,00 4.147,00 4.147,00<br /><br /><br />\r\nMONOFASICO COM PASSAGEM DOS CABOS PARA ALIMENTACAO<br /><br /><br />\r\nDOS 6 QUIOSQUE DOS NOVOS BLOCOS.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA', 'n', '48', 6, '2016-03-02', '2016', 'sami@bayde.com.br', '2016-03-10', '2016-03-18', 0, 0, 2, 's', 's', 'n', '', 'n', '3455.00'),
(208, 'junior', 'COLMEIA FATIMA RESIDENCE EMPREENDIMENTOS IMOB', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'LAUDO DE ATERRAMENTO ', 's', '62', 2, '2016-03-07', '2016', 'PAULOESTEVAO@COLMEIA.COM.BR3', '2016-03-08', '2016-03-21', 0, 0, 11, 's', 's', 'n', '', 'n', '960.00'),
(209, 'eduardo_reboucas', 'GERDAU ACOS LONGOS S/A', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '1 - PROPOSTA PARA REFORMA COM TROCA E RECOLACAO DE 1,00 33.910,00 33.910,00<br /><br />\r\nLUMINARIAS EM 8 POSTES DE 15M, COM INTALACAO DE PAINEIS<br /><br />\r\nE DEMAIS SERVICOS, CONFORME EMAIL DA GERDAU DE<br /><br />\r\n24.02.2016, E RELACAO DE MATERIAIS ABAIXO, FORNECIDO<br /><br />\r\nPELA ELFI.<br /><br />\r\n- VALOR DA MAO DE OBRA E MATERIAL', 'n', '55', 10, '2016-03-08', '2016', 'BRUNO LEONARDO GOMES - 37067139 <bruno.gomes@gerdau.com.br>', '2016-03-16', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '32200.00'),
(210, 'junior', 'FORNECEDORA MAQUINAS E EQUIPAMENTOS LTDA ', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MEDIÃ‡ÃƒO DE LAUDO TECNICO', 'n', '63', 2, '2016-03-10', '2016', 'EMANUEL@FORNECEDORAMAQUINAS.COM.BR', '2016-03-23', '2016-04-01', 0, 0, 0, 's', 'n', 'n', '', 'n', '960.00'),
(211, 'eduardo_reboucas', 'FORNECEDORA MAQUINAS E EQUIPAMENTOS LTDA ', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MANUTENÃ‡ÃƒO CORREYIVA NA SUBESTAÃ‡ÃƒO', 'n', '284', 5, '2016-03-10', '2016', 'EMANUEL@FORNECEDORAMAQUINAS.COM.BR', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '3200.00'),
(212, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'MANUTENCAO PREVENTIVA NA SUBESTACAO AREA DE KVA E 1,00 2.900,00 2.900,00<br /><br /><br />\r\nREAPERTOS E LIMPEZA DE SEIS PAINEIS ELETRICOS DE BAIXA<br /><br /><br />\r\nTESAO NA AREA DE PRODUCAO E ADMINISTRATIVA.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA', 'n', '074', 1, '2016-03-10', '2016', 'gustavo_oliveira@praxair.com', '2016-03-13', '2016-03-18', 0, 0, 4, 's', 's', 'n', '', 'n', '2900.00'),
(213, 'junior', 'FAVO COMERCIO E REPRESENTAÃ‡Ã•ES LTDA ', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'TROCA DE CHAVES ', 'n', '76', 1, '2016-03-23', '2016', 'FAVOFLORA@UOL.COM.BR', '2016-03-23', '2016-03-29', -1, 0, 5, 's', 's', 'n', '', 'n', '967.00'),
(214, 'eduardo_reboucas', 'BEACH PARK HOTEIS E TURISMO S/A', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'MANUTENÃ‡ÃƒO CORRETIVA DA SUBESTAÃ‡ÃƒO ELETRICA ', 'n', '82', 1, '2016-03-29', '2016', 'Emerson Oliveira da Silva <emerson@beachpark.com.br>', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '2010.00'),
(215, 'eduardo_reboucas', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO 1,00 1.100,00 1.100,00<br /><br />\r\nDA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO<br /><br />\r\n- PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO 1,00 1.100,00 1.100,00<br /><br />\r\nDA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO<br /><br />\r\nTECNICO E ART DO CREA-CE.', 'n', '81', 5, '2016-03-30', '2016', 'FELYCIANNO@CDLFOR.COM.BR', '2016-04-17', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '110.00'),
(216, 'eduardo_reboucas', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '- MANUTENCAO PREVENTIVA DA SUBESTACAO CONFORME 1,00 2.050,00 2.050,00<br /><br />\r\nRELACAO DE SERVICO ABAIXO (BANCO CAPACITOR JA INCLUSO)', 'n', '80', 16, '2016-03-30', '2016', 'FELYCIANNO@CDLFOR.COM.BR', '2016-04-17', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '2050.00'),
(217, 'eduardo_reboucas', 'GERDAU ACOS LONGOS S/A', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'Proposta para instalaÃ§Ã£o de iluminaÃ§Ã£o na area de lazer nova', 'n', '35', 3, '2016-04-05', '2016', 'raniere.goes@gerdau.combr', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '4400.00'),
(218, 'eduardo_reboucas', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', 'ManutenÃ§Ã£o preventiva de uma subestaÃ§Ã£o abrigada com 3 transformadores de forÃ§a de 300KVA, disjuntor de media tensÃ£o, chaves seccionadoras quadro geral de baixa tensÃ£o da subestaÃ§Ã£o e bancos capacitores, conforme descriÃ§Ã£o dos serviÃ§os em anexo.', 'n', '92', 1, '2016-04-06', '2016', 'LUCAS@HOLIDAYFORTALEZA.COM.BR', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '2803.00'),
(219, 'eduardo_reboucas', 'poli-nutri alimentos s/a', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', 'serviÃ§o de emergencia no dia 11.04.2016', 'n', '98', 1, '2016-04-11', '2016', 'pricila.santiago@polinutri.com.br', '0000-00-00', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '1200.00');
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `classificacao` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tipo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `data_inclusao` datetime NOT NULL,
  `cnpj_cpf` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `email_tec` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `email_adm_fin` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `clientes` (`id`, `usuario`, `razao_social`, `nome_fantasia`, `classificacao`, `tipo`, `data_inclusao`, `cnpj_cpf`, `cpf`, `ie`, `endereco`, `bairro`, `estado`, `cidade`, `cep`, `tel`, `cel`, `fax`, `email_tec`, `email_adm_fin`) VALUES
(26, 'junior', 'CONDOMINIO DO SHOPPING CENTER IGUATEMI', 'SHOPPING CENTER IGUATEMI', 'padrao', 'Pessoa Juridica', '2014-01-02 14:30:49', '73.870.891/0001-00', '', '', 'AV. WASHINGTON SOARES, 85', 'EDSON QUEIROZ', 'CEARÁ', 'FORTALEZA', '60811-900', '(85) 3477-3581', '', '', 'rafael.silva@iguatemifortaleza.com.br', ''),
(27, 'junior', 'BRADESCO - AGENCIA WALDEMAR DE ALCANTARA', 'BRADESCO - AGENCIA WALDEMAR DE ALCANTARA', 'padrao', 'Pessoa Juridica', '2014-01-03 16:42:09', '60.746.948/3883-31', '', '', 'AV. MISTER HULL NÂ° 5235', 'BEZERRA', 'CEARÁ', 'FORTALEZA', '60356-000', '(11) 5070-7657', '', '', 'lucas.branco@cw-opr.com.br', ''),
(28, 'eduardo_reboucas', 'ESMALTEC S/A', 'ESMALTEC S/A', 'contrato', 'Pessoa Juridica', '2014-01-08 18:21:52', '02.948.030/0002-30', '', '', 'AV. PARQUE OESTE, 2130', 'DISTRITO INDUSTRIAL', 'CEARÁ', 'MARACANAÚ', '61939-120', '(85) 3299-8878', '', '', 'gilson.chaves@esmaltec.com.br', ''),
(29, 'junior', 'SEICOM-SERVICOS ENGENHARIA E INSTALACAO', '', '', '', '2014-01-14 11:27:02', '51.946.200/0001-72', '', '', 'AV. DESEMBARGADO GONZAGA NÂ° 960 B', '', '', '', '60.823-012', '8532755085', '', '', 'julio.lima@seicom.com', ''),
(30, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '2014-01-15 17:30:14', '11.805.397/0001-05', '', '', 'RUA PORTO DAS DUNAS, 2734', '', '', '', '61.700-000', '8540123000', '', '', 'ricardo@beachpark.com.br', ''),
(31, 'junior', 'BANCO BRADESCO AG Montese J. 1379', '', '', '', '2014-01-21 15:39:23', '60.746.948/1600-91', '', '', 'AV. GOMES DE MATOS, MONTESE', '', '', '', '60410001', '(85) 3491-1629', '(11) 5070-7648', '', 'guilherme.lopes@cw-opr.com.br', ''),
(32, 'junior', 'YPIOCA AGROINDUSTRIAL LTDA', '', '', '', '2014-01-22 17:27:40', '05.373.212/0005-61', '', '', 'FAZENDA SANTA ELIZA, S/N, zona rural', '', '', '', '62.685-000', '85 3216-8851', '', '', 'hipolito.alves@ypioca.com.br', ''),
(33, 'junior', 'ADEL COCO BRASIL', '', '', '', '2014-01-24 15:42:38', '10.567.693/0001-52', '', '', 'RD. 163 KM 42', '', '', '', '60.000-000', '3351-1790', '', '', 'compras@adelcoco.com.br', ''),
(34, 'junior', 'DOM PASTEL SELF-SERVICE LTDA-ME', '', '', '', '2014-01-30 15:26:02', '03.531.925/0001-57', '', '', 'RUA IRACEMA, 100', '', '', '', '60.115-180', '(85) 3261-1019', '', '', 'marconisantana1@gmail.com', ''),
(35, 'junior', 'OSASUNA PARTICIPACOES LTDA', '', '', '', '2014-01-30 15:28:57', '03.941.904/0001-00', '', '', 'AV. PARQUE NORTE I, 89', '', '', '', '61.939-170', '(85) 4009-3175', '', '', 'ivon@jangadeirotextil.com.br', ''),
(36, 'junior', 'CONDOMINIO LIVING', '', '', '', '2014-02-07 11:36:39', '10.888.414/0001-52', '', '', 'AV. DOS GOLFINHOS,2071', '', '', '', '61.700-000', '', '', '', 'jcamelo@beachpark.com.br', ''),
(37, 'junior', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '2014-02-07 17:17:51', '03.612.122/0001-27', '', '', 'AV DUQUE DE CAXIAS, 1.701', '', '', '', '60.035-111', '(85) 3452-9042', '', '', 'abatista@sesc-ce.com.br', ''),
(38, 'junior', 'INVESTAR HOTELARIA S/A', '', '', '', '2014-02-13 09:08:27', '04.160.025/0001-03', '', '', 'RUA DR. ATUALPA BARBOSA DE LIMA, 500', '', '', '', '60.060-370', '(85) 4008-4057', '', '', 'infra.fortaleza@bluetree.com.br', ''),
(39, 'junior', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '2014-02-19 10:46:36', '01.092.234/0001-79 ', '', '', 'VIA LOCAL 27 S/N LANDO IMPAR', '', '', '', '61.700-000', '(85) 4012-3083', '(85) 9639-7665', '', 'ednardo@beachpark.com.br', ''),
(40, 'junior', 'CONSTRUTORA GRANITO LTDA', '', '', '', '2014-02-27 09:37:28', '07.134.125/0001-53', '', '', 'RUA DR. ALFREDO WEYNE, 130', '', '', '', '60.415-065', '8532157455', '', '', 'compras@granito.com.br', ''),
(41, 'junior', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', '', '', '', '2014-02-28 09:07:54', '11.088.796/0001-00', '', '', 'AV. PONTES VIEIRA NÂ° 1079', '', '', '', '61.000-000', '(85) 8807-3097', '', '', 'marliete@mrhgestao.com.br', ''),
(42, 'junior', 'BANCO CENTRAL DO BRASIL - BACEN', '', '', '', '2014-03-06 07:52:29', '00.038.166/0005-20', '', '', 'AV. HERACLITO GRACA,273', '', '', '', '60.140-061', '85 33085498', '', '', 'nero.torres@bcb.gov.br', ''),
(43, 'junior', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '2014-03-07 09:15:09', '24.380.578/0032-85', '', '', 'AV. FRANCISCO SA, 2776', '', '', '', '60.310-003', '8532882430', '8588148134', '', 'allysson_mesquita@praxair.com', ''),
(44, '', 'BRADESCO AG. SENADOR POMPEU', '', '', '', '2014-03-07 17:24:57', '', '', '', 'RUA. SENADOR POMPEU NÂ° 970', '', '', '', '', '', '99617048', '', '0678.gerencia@bradesco.com.br', ''),
(45, 'junior', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', '', '', '', '2014-03-24 10:14:17', '15.259.978/0001-40', '', '', 'AV. MARIUBA, S/N LOJA 01 A 23 QUADRA N 61', '', '', '', '61.700-000', '40123179', '', '', 'josegilmar@beachpark.com.br', ''),
(46, 'junior', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '2014-04-10 11:04:05', '02.608.755/0029-08', '', '', 'RUA ELISEU UCHOA BECCO, 600', '', '', '', '60.810-270', '8534564147', '', '', 'francisco.aves@estacio.br', ''),
(47, 'junior', 'CONSORCIO CETENCO ENGENHARIA', '', '', '', '2014-04-11 14:00:51', '18.951.170/0001-17', '', '', 'AV. DOM LUIZ NÂ° 807 SALA 2017', '', '', '', '60.170-002', '85-3402-8559', '', '', 'rialto.ibanez.mira@acciona.com', ''),
(48, 'junior', 'STL INFORMATICA LTDA ', '', '', '', '2014-04-14 08:57:32', '72.500.317/0001-06', '', '', 'RUA JOAO LOBO FILHO, 392', '', '', '', '60.055-360', '8532576600', '', '', 'nunes@stl.com.br', ''),
(49, 'junior', 'EMERSON NETWORK POWER DO BRASIL LTDA', '', '', '', '2014-04-16 09:29:05', '03.698.870/0008-40', '', '', 'AV. HOLLINGSWORTH NÂ° 325 - PARTE B', '', '', '', '18.087-105', '11 3262-5841', '', '', 'antonio.glayton@emerson.com', ''),
(50, 'junior', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '2014-04-22 09:32:20', '03.600.164/0001-48', '', '', 'AV. HIST RAIMUNDO GIRAO, 800', '', '', '', '60.165-050', '8534555332', '', '', 'francisco@holidayfortaleza.com.br', ''),
(51, 'junior', 'AGROPAULO AGROINDUSTRIAL S.A', '', '', '', '2014-04-24 08:40:55', '05.373.212/0009-95', '', '', 'ROD. CE 123 KM 40 - FAZ. LAGOA VERMELHA', '', '', '', '62.823-000', '8532168890', '', '', 'bruno.rafael@agropaulo.com', ''),
(52, 'junior', 'SUPERINTENDENCIA REG. DO TRAB. E EMPREGO - SRTE-CE', '', '', '', '2014-04-28 15:56:14', '07.526.983/0040-50', '', '', 'RUA 24 DE MAIO, 166/178', '', '', '', '60.020-000', '8532553980', '', '', 'arnaldo.amaral@mte.gov.br', ''),
(53, 'junior', 'EMPRESA BRASILEIRA DE BEBIDAS E ALIMENTOS S/A', '', '', '', '2014-05-02 09:48:40', '07.604.556/0006-40', '', '', 'RODOVIA BR 304 KM 55,2 - ARACATI-CE', '', '', '', '62.800-000', '2121.2957', '', '', 'rebeca.correia@ebba.com.br', ''),
(54, 'junior', 'STOCK TECH LOGISTICA', '', '', '', '2014-05-09 09:16:00', '01.306.014/0013-34', '', '', 'BR- 020 KM 12 NÂ° 527', '', '', '', '', '8541050773', '', '', 'evandro.alves@stocktech.com.br', ''),
(55, 'junior', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '2014-05-12 15:51:29', '07.293.038/0001-49', '', '', 'RUA 25 DE MARCO, 882', '', '', '', '60.060-120', '8534333037', '', '', 'wellington@cdlfor.com.br', ''),
(56, 'junior', 'MANSERV MONTAGEM E MANUTENCAO S/A', '', '', '', '2014-05-16 15:23:34', '54.183.587/0003-02', '', '', 'RUA REGENTE ARAUJO DE LIMA (EDIFICIO POTENZA em Fortaleza)', '', '', '', '', '3878-8005', '', '', 'admfort@br.ibm.com', ''),
(57, 'junior', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '2014-06-03 20:33:42', '41.580.077/0001-65', '', '', 'AV. SANTOS DUMONT NÂ° 5633', '', '', '', '60175-047', '8534211444', '85 9962-9680 ', '', 'atylabrasil@hotmail.com', ''),
(58, 'junior', 'SANTANA TEXTIL S/A', '', '', '', '2014-06-11 08:18:25', '72.418.478/0001-47', '', '', 'ROD. BR 116 KM 37, 2015 ', '', '', '', '62.880-000', '85 4009-4178', '', '', 'andre@santanatextiles.com', ''),
(59, 'junior', 'ALAMO ENGENHARIA S/A ', '', '', '', '2014-06-25 15:26:50', '34.125.294/0001-08', '', '', 'R ESTEVES JUNIOR, 74/76', '', '', '', '22.231-160', '85 81209065', '', '', 'adm2.vivoba@alamoengenharia.com.br', ''),
(60, 'junior', 'BERACA SABARA QUIMICOS E INGREDIENTES S/A', '', '', '', '2014-06-26 08:32:54', '12.884.672/0003-58', '', '', 'SITIO ALTO FECHADO S/N', '', '', '', '60864-971', '85 33662350', '', '', 'joao.batista@beraca.com', ''),
(61, 'junior', 'COCO BAMBU PIZZARIA LTDA', '', '', '', '2014-07-01 16:21:50', '04462689000127', '', '', 'R CAP VASCONCELOS 645', '', '', '', '60160-120', '85 86736660', '', '', 'pedrorodrigues20@yahoo.com.br', ''),
(62, 'junior', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '2014-07-01 16:28:02', '11805397000539', '', '', 'R CAP VASCONCELOS 645', '', '', '', '61700-000', '85 40125875', '', '', 'fabianosilva@beachpark.com.br', ''),
(63, 'junior', ' FUNDACAO BRADESCO Teresina - J. 6238', '', '', '', '2014-07-01 16:37:28', '60701521001927', '', '', 'RUA 68, S/n', '', '', '', '64077-450', '86 32362001', '', '', 'teresina@fundacaobradesco.org.br', ''),
(64, 'junior', 'LB SERVICE TERCEIRIZACAO E COBRANCA', '', '', '', '2014-07-03 08:38:34', '06227071000108', '', '', 'AV. GOV. RAUL BARBOSA NÂ° 7347 SALA 01 ', '', '', '', '60851-290', '85 3472-2720', '', '', 'supervisoroperacional@ibservice.com.br', ''),
(65, 'junior', 'CONDOMINIO EDIFICIO ALVORADA', '', '', '', '2014-07-07 16:16:26', '07074982000105', '', '', 'RUA  PERBOYRE E SILVA, NÂº 111 ', '', '', '', '60030-200', '85 32269457', '', '', 'NÃ£o tem', ''),
(66, 'junior', 'CLINICA DE DOENCAS RENAIS E HIPERT. ARTERIAL LTDA', '', '', '', '2014-07-15 15:44:10', '12.360.343/0001-46', '', '', 'AV. PARQUE COMERCIAL, S/', '', '', '', '61939150', '85 32151729', '', '', 'rimcentro@gmail.com', ''),
(67, 'junior', 'STRATURA ASFALTOS S.A', '', '', '', '2014-07-17 10:37:06', '59.128.553/0021-10', '', '', 'RUA OESTE 1, S/N PARTE ', '', '', '', '61910000', '85 32931005', '', '', 'denis.viana@stratura.com.br', ''),
(68, 'junior', 'GERDAU ACOS LONGOS S/A', '', '', '', '2014-07-18 11:48:05', '07.358.761/0013-00', '', '', 'AV. PARQUE DO OESTE, 1400', '', '', '', '61939120', '85 34997227', '', '', 'jose.rocha@gerdau.com.br', ''),
(69, 'junior', 'EMAC ENGENHARIA DE MANUTENCAO LTDA', '', '', '', '2014-07-24 15:01:30', '19.157.650/0001-73', '', '', 'RUA  TAPERI, 560 ', '', '', '', '30532050', '85 32551871 ', '', '', 'na29opt@emac.com.br', ''),
(70, 'junior', 'M. DIAS BRANCO S.A. IND. E COM. DE ALIMENTOS - GME', '', '', '', '2014-07-24 16:55:16', '07.206.816/0028-35', '', '', 'RUA JOSE SETUBAL PESSOAL, 255 ', '', '', '', '60180-560', '8540055669', '', '', 'afonso.costa@mdiasbranco.com.br', ''),
(71, 'junior', 'BEACH PARK HOTEIS E TURISMO S/A (OCEANI)', '', '', '', '2014-07-30 14:31:43', '11.805.397/0010-04', '', '', 'AV. DOS GOLFINHOS, 455 ', '', '', '', '61700-995', '85 40123179', '', '', 'antoniakatia@beachpark.com.br', ''),
(72, 'junior', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', '', '', '', '2014-08-01 16:08:36', '04911062000106', '', '', 'R FREI MANSUETO, 160', '', '', '', '60170-070', '85 40064800', '', '', 'manutencao.cfo@atlanticahotels.com.br', ''),
(73, 'junior', 'CONDOMINIO ED. IRACEMA PRAIA PARK II', '', '', '', '2014-08-12 11:21:38', '23.727.316/0001-85', '', '', 'AV. BEIRA MAR, 1020 ', '', '', '', '60165-120', '85 32191154', '85 89573420', '', 'praiapark1020@hotmail.com', ''),
(74, 'junior', 'DISTRIBUIDORA FARMACEUTICA PANARELLO', '', '', '', '2014-08-19 11:19:03', '012068200 01411', '', '', 'AV JOAO PESSOA , 6886 ', '', '', '', '60030170', '85 40082031', '', '', 'francisco.santos@panpharma.com.br', ''),
(75, 'junior', 'NACIONAL ARCO-IRIS IND. E COM. DE TINTAS LTDA', '', '', '', '2014-08-21 15:02:46', '09.320.639/0001-29', '', '', 'PC DA IMPRENSA, s/n', '', '', '', '60.135-690', '8534578460', '', '', 'angelo.queiroz@hipercor.com.br', ''),
(76, 'junior', 'BERMAS MARACANAU INDUSTRIA E COMERCIO', '', '', '', '2014-09-09 15:06:50', '08.386.287/0001-41', '', '', 'AV. DO CONTORNO S/N, PAJUCARA', '', '', '', '61.939-160', '8540093700', '', '', 'lsilva@bermas.com.br', ''),
(77, 'junior', 'CALCADOS ANIGER NORDESTE LTDA', '', '', '', '2014-09-22 09:24:25', '01.506.990/0004-40', '', '', 'RUA GERALDO BIZARRIA DE CARVALHO, 22', '', '', '', '63.800-000', '34061000', '', '', 'fatima.pinheiro@ne.aniger.com.br', ''),
(78, 'junior', 'IFT IND COMERCIO DE MATERIAIS const - Polimix', '', '', '', '2014-10-02 10:26:35', '13882324000223', '', '', 'AV. VIRGILIO TAVORA NÂ° 34', '', '', '', '61.880-000', '3377-1300', '', '', 'faturamento1.ift@britta.com.br', ''),
(79, 'junior', 'HOSPITAL DE OLHOS LEIRIA DE ANDRADE', '', '', '', '2014-10-07 10:39:06', '07.303.837/0001-59', '', '', 'RUA ROCHA LIMA, 1140', '', '', '', '60.135-000', '8532665511', '', '', 'thalestelles@gmail.com', ''),
(80, 'junior', 'CENTRO DE ESPECIALIDADES MEDICAS JOSE DE ALENCAR', '', '', '', '2014-11-13 15:46:53', '04.885.197/0004-97', '', '', 'RUA GUILHERME ROCHA, 510', '', '', '', '60.030-140', '8534526466', '', '', 'rosana.frf@hotmail.com', ''),
(81, 'junior', 'RESTAURANTE LIMONE', '', '', '', '2014-12-04 10:14:30', '05.833.560/0001-40', '', '', 'R PEREIRA VALENTE, 1146', '', '', '', '60.160-250', '34613333', '', '', 'lelabardot@hotmail.com', ''),
(82, 'junior', 'MARQUISE EMPREENDIMENTOS S/A', '', '', '', '2014-12-29 11:35:13', '07406242000129', '', '', 'AV BEIRA MAR, 3980', '', '', '', '60.165-121', '8540065066', '', '', 'acelio@granmarquise.com.br', ''),
(83, 'junior', 'DEPARTAMENTO NACIONAL DE PRODUCAO MINERAL - DNPM', '', '', '', '2014-12-29 11:47:14', '00381056001105', '', '', 'RUA DR. JOSE LOURENCO, 905', '', '', '', '60.115-280', '8533881330', '', '', 'aline.bezerra@dnpm.gov.br', ''),
(84, 'junior', 'MINISTERIO DA SAUDE', '', '', '', '2015-02-19 12:09:22', '00.394.544/0180-41', '', '', 'R DO ROSARIO 283', '', '', '', '60.110-000', '8532521533', '', '', 'selma.mota@saude.gov.br', ''),
(85, 'junior', 'COBAP-COM. E BENEFICIAMENTO DE ARTEFATOS DE PAPEL', '', '', '', '2015-02-24 14:31:48', '07.329.386/0001-29', '', '', 'AVENIDA PARQUE SUL, 145', '', '', '', '63.939-000', '8540094977', '', '', 'suprimentos2@cobap.com.br', ''),
(86, 'junior', 'INSTITUTO DOENCAS RENAIS', '', '', '', '2015-03-06 09:47:37', '69697449000157', '', '', 'AV. BEZERRA DE MENEZES, 1330', '', '', '', '60.325-001', '8532145171', '', '', 'helenajuca@grupoinstitutodorim.med.br', ''),
(87, 'junior', 'INSTITUTO DO RIM', '', '', '', '2015-03-06 09:51:56', '06929764000142', '', '', 'RUA DOUTOR CASTRO MEDEIROS, 62', '', '', '', '', '8591528613', '', '', 'ir.manutencao@grupoinstitutodorim.med.br', ''),
(88, 'junior', 'POLICLINICA DO RIM S/S LTDA', '', '', '', '2015-03-06 09:54:26', '01806945000168', '', '', 'RUA WENEFRIDO MELO, 150', '', '', '', '60.762-410', '8534666200', '', '', 'poli.manutencao@grupoinstitutodorim.med.br', ''),
(89, 'junior', 'RENAGUA IND. E COM. DE AGUA LTDA', '', '', '', '2015-03-10 10:29:40', '', '', '', 'RUA PADRE SA LEITAO NÂ° 156', '', '', '', '60.521-032', '8534965609', '', '', 'contato@renagua.com.br', ''),
(90, 'junior', 'AMENDOAS DO BRASIL LTDA', '', '', '', '2015-04-13 10:45:54', '03.196.885/0001-34', '', '', 'RUA JOAQUIM FRANKLIN, 1000', '', '', '', '60.361-130', '8532887000', '8532887052', '', 'brito@amendoasdobrasil.com.br', ''),
(91, 'junior', 'Armando', 'Junior', 'padrao', 'Pessoa Juridica', '2015-11-13 09:18:09', '73.624.165/0001-08', '', '', 'Rua professor Jacinto Botelho, 650 Ap 901 Aller', 'AEREEER', 'PIAUÍ', 'AROEIRAS DO ITAIM', '60810050', '+558587261687', '', '', 'elfiservice@hotmail.com', 'elfiservice@hotmail.com'),
(92, 'eduardo_reboucas', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', '', '', '', '2016-01-12 10:36:10', '06.980.064/0002-63', '', '', 'PRACA DA IMPRENSA', '', '', '', '60.135-690', '3466.8921', '', '', 'wildenbergy.lucas@nacionalgas.com.br>', ''),
(93, 'eduardo_reboucas', 'INAPI INDUSTRIA NAC. DE ACESS. PARA IRRIGACAO S/A', '', '', '', '2016-01-13 11:47:33', '55.357.110/0018-4', '', '', 'AV. PARQUE OESTE, S/N', '', '', '', '61.939-120', '8535357400', '', '', 'Renato Sousa <jrbsousa@yahoo.com.br>', ''),
(94, 'eduardo_reboucas', 'FIORI INDUSTRIA E COMERCIO DE CONFECCOES LTDA', '', '', '', '2016-01-15 10:07:29', '63.361.307/0001-38', '', '', 'RUA: 15 DE NOVENBRO NÂ° 270', '', '', '', '60.421-076', '3388-0880', '', '', 'Lany Gomes <lany@turmadamalha.com.br>', ''),
(95, 'eduardo_reboucas', 'CRAVEIRO IMOBILIARIA LTDEA', '', '', '', '2016-01-21 10:23:38', '07.254.840/0001-20', '', '', 'AV. SANTOS DUMONT NÂ°3131', '', '', '', '60.150-162', '98810.1945', '98810.1945', '', 'ana@craveiroimobiliaria.com.br', ''),
(96, 'eduardo_reboucas', 'BRADESCO AG. JOAO DE CASTRO EST UNIF', '', '', '', '2016-01-25 17:00:19', '60.746.948/3890-60', '', '', 'AV. PESSOA ANTA NÂ° 274', '', '', '', '60.060-430', '3219-4895', '3219-4895', '', '0643.adm@bradesco.com.br', ''),
(97, 'eduardo_reboucas', 'YPIOCA AGRICOLA LTDA', '', '', '', '2016-02-24 15:03:35', '18047537000172', '', '', 'FAZENDA SANTA ELIZA  S/N', '', '', '', '62685000', '3216-8850', '', '', 'FRANCISCO.CALIXTO@YPIOCA.COM.BR', ''),
(98, 'eduardo_reboucas', 'COLMEIA FATIMA RESIDENCE EMPREENDIMENTOS IMOB', '', '', '', '2016-03-07 15:01:52', '13323162000102', '', '', 'RUA THOMAZ POMPEU NÂ° 525 SALA 09', '', '', '', '60160080', '32886619', '', '', 'PAULOESTEVAO@COLMEIA.COM.BR', ''),
(99, 'eduardo_reboucas', 'FORNECEDORA MAQUINAS E EQUIPAMENTOS LTDA ', '', '', '', '2016-03-10 08:58:35', '07197718000169', '', '', 'AV. FREI CIRILO ', '', '', '', '60840285', '3366-1222', '', '', 'EMANUEL@FORNECEDORAMAQUINAS.COM.BR', ''),
(100, 'eduardo_reboucas', 'FAVO COMERCIO E REPRESENTAÃ‡Ã•ES LTDA ', '', '', '', '2016-03-22 16:43:09', '06021109000191', '', '', 'RUA GENERAL ROMEL 547', '', '', '', '60861160', '32952375', '', '', 'FAVOFLORA@UOL.COM.BR', ''),
(101, 'eduardo_reboucas', 'poli-nutri alimentos s/a', '', '', '', '2016-04-12 13:57:00', '6021051500229', '', '', 'ros quarto anel viario km 44', '', '', '', '61760000', '33662150', '', '', 'pricila.santiago@polinutri.com.br', ''),
(102, 'eduardo_reboucas', 'TOTAL TRANSPORTADORA E ARMAZENS GERAIS LTDA', 'TOTAL TRANSPORTADORA E ARMAZENS GERAIS LTDA', 'padrao', 'PJ', '2016-04-13 14:23:27', '09.074.664/0001-70', '', '', 'AV. DO VAQUEIRO NÂ° 620', 'ANCURI', 'CEARÁ', 'FORTALEZA', '60000-000', '(85) 3311-2350', '(85) 8552-0900', '', 'RH.PESSOAL@TOTALCOMERCIO.COM.BR', ''),
(103, 'eduardo_reboucas', 'MAIS SABOR IND E COM DE REFRIGERANTES LTDA', 'MAIS SABOR ', 'padrao', 'PJ', '2016-04-14 10:48:04', '07.196.579/0001-59', '', '', 'RUA ESPERANTO NÂ° 1250', 'VILA UNIÃƒO ', 'CEARÁ', 'FORTALEZA', '60410-620', '(85) 3444-3500', '(85) 3444-3528', '', 'loide.lopes@maissabor.com.br', ''),
(104, 'eduardo_reboucas', 'IREP SOCIEDADE DE ENSINO SUPERIOR MEDIO E FUNDAMENTAL LTDA', 'FIC JOCKEY - PARANGABA', 'padrao', 'PJ', '2016-04-15 09:22:07', '02.608.755/0041-96', '', '', 'AV. SENADOR FERNANDES TAVORA NÂ° 137A', 'JOQUEI CLUBE', 'CEARÁ', 'FORTALEZA', '60510-111', '(85) 3194-9634', '', '', 'francisco.alves@estacio.br', '');
...
CREATE TABLE IF NOT EXISTS `colaboradores` (
  ...
  `email_activated` enum('0','1') COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `colaboradores` (`id_colaborador`, `Login`, `Senha`, `cpf`, `tipo`, `last_log_date`, `Email`, `email_activated`) VALUES
(1, 'junior', '58b621db1de66c63bf77c327fe1d0e33', '91418755320', 'ad', '2016-04-15 10:00:22', 'elfiservice@live.com', '0'),
(2, 'lana', '58b621db1de66c63bf77c327fe1d0e33', '12345678920', 'ad', '2013-04-01 16:51:10', 'lana@elfiservice.com.br', '0'),
(3, 'samuel', '58b621db1de66c63bf77c327fe1d0e33', '', 'ad', '2015-03-10 15:22:59', 'samuel@elfiservice.com.br', '1'),
(4, 'eduardo_reboucas', 'fcf06104d285b6fc761ff448ad809a9f', '', 'fi_tec', '2016-04-15 10:41:49', 'eduardo@elfiservice.com.br', '1');

-- --------------------------------------------------------

--
-- Estrutura para tabela `controle_n_orc`
--

CREATE TABLE IF NOT EXISTS `controle_n_orc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mes` int(11) NOT NULL,
  `ano` int(11) NOT NULL,
  `n_orc_feitos` int(11) NOT NULL,
  `produtividade` double NOT NULL,
  `pontual_entrega` double NOT NULL,
  `pos_entrega` double NOT NULL,
  `nao_conforme` double NOT NULL,
  `acompanh_proposta` double NOT NULL,
  `novos_clientes` int(11) NOT NULL,
  `insatisfacao` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=20 ;

--
-- Fazendo dump de dados para tabela `controle_n_orc`
--

INSERT INTO `controle_n_orc` (`id`, `mes`, `ano`, `n_orc_feitos`, `produtividade`, `pontual_entrega`, `pos_entrega`, `nao_conforme`, `acompanh_proposta`, `novos_clientes`, `insatisfacao`) VALUES
(1, 1, 2014, 25, 100, 63.6363636364, 90.9090909091, 0, 44, 1, 0),
(2, 2, 2014, 35, 77.7777777778, 77.7777777778, 77.7777777778, 0, 25.7142857143, 0, 0),
(3, 3, 2014, 25, 100, 100, 100, 0, 28, 0, 0),
(4, 4, 2014, 31, 84.6153846154, 100, 61.5384615385, 0, 41.935483871, 2, 0),
(5, 5, 2014, 37, 83.3333333333, 91.6666666667, 75, 0, 32.4324324324, 1, 0),
(6, 6, 2014, 31, 76.9230769231, 92.3076923077, 76.9230769231, 0, 41.935483871, 0, 0),
(7, 7, 2014, 24, 94.1176470588, 70.5882352941, 70.5882352941, 0, 70.8333333333, 3, 0),
(8, 8, 2014, 29, 100, 76.9230769231, 84.6153846154, 0, 44.8275862069, 1, 0),
(9, 9, 2014, 17, 100, 57.1428571429, 42.8571428571, 0, 41.1764705882, 1, 0),
(10, 10, 2014, 26, 100, 54.5454545455, 54.5454545455, 9.09090909091, 42.3076923077, 1, 0),
(11, 11, 2014, 31, 60, 100, 0, 0, 32.2580645161, 0, 0),
(12, 12, 2014, 20, 10, 100, 0, 0, 50, 1, 0),
(13, 1, 2015, 28, 100, 75, 75, 0, 14.2857142857, 0, 0),
(14, 2, 2015, 33, 86.6666666667, 80, 73.3333333333, 0, 45.4545454545, 2, 0),
(15, 3, 2015, 30, 50, 93.75, 37.5, 0, 53.3333333333, 0, 0),
(16, 4, 2015, 20, 25, 100, 0, 0, 20, 0, 0),
(17, 1, 2016, 30, 90.9090909091, 45.4545454545, 81.8181818182, 0, 36.6666666667, 0, 0),
(18, 2, 2016, 26, 75, 75, 75, 0, 15.3846153846, 1, 0),
(19, 3, 2016, 20, 33.3333333333, 66.6666666667, 25, 0, 60, 1, 0);
...
INSERT INTO `fornecedores` (`id`, `usuario`, `razao_social`, `nome_fantasia`, `classificacao`, `tipo`, `data_inclusao`, `cnpj_cpf`, `cpf`, `ie`, `endereco`, `bairro`, `estado`, `cidade`, `cep`, `tel`, `cel`, `fax`, `email_tec`, `email_adm_fin`) VALUES
(24, 'junior', 'LORENCINI', 'LORENCINI', 'padrao', 'Pessoa Juridica', '2012-01-03 20:53:16', '75.852.585/6444-68', '', '', 'R. CARA, 123', 'POW', 'PARANÁ', 'ALEXANDRA', '60000-303', '(85) 5285-2852', '', '', 'elfi@elk.com3', '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `historico_orc_aprovado`
--

CREATE TABLE IF NOT EXISTS `historico_orc_aprovado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Fazendo dump de dados para tabela `historico_orc_aprovado`
--

INSERT INTO `historico_orc_aprovado` (`id`, `id_acompanhamento`, `data`, `descricao`, `colaborador`) VALUES
(5, 7, '2014-01-06', 'serviÃ§o foi executado dia 04/01, nÃ£o foi possivel trocar o TAP pois ja estava no primeiro.<br /><br />\r\nSera medido tensÃ£o em carga pois em vazio deu 405V - informado pelo Edson', 'junior'),
(6, 7, '2014-01-06', 'informaÃ§Ãµes do Edson', 'junior'),
(7, 6, '2014-01-06', 'Edson informou que serÃ¡ executado 07/01 com Robevaldo', 'junior'),
(8, 7, '2014-01-07', 'relaÃ§Ã£o de hora extra: Bradesco Waldemar de AlcÃ¢ntara:<br />\r\ndia 04/01/2014<br />\r\nDe 07:00 as 17:00hs<br />\r\nEdson<br />\r\nAlex', 'junior'),
(9, 6, '2014-01-07', 'Edson passou Email para Rafael para programar o dia 08/01/2014 as 09:00hs<br />\r\n<br />\r\nRelaÃ§Ã£o FuncionÃ¡rio:<br />\r\nFrancisco Edson de Souza<br />\r\nAntÃ´nio marcos sabino gomes<br />\r\nAlexandro mousinho sabino gomes<br />\r\nFrancisco FlÃ¡vio Alves<br />\r\n<br />\r\nAguardando ConfirmaÃ§Ã£o!', 'junior'),
(10, 6, '2014-01-08', 'Eduardo tentou entrar em contato com Rafael e a Cintia informou que ele trabalhou pela noite e q so voltaria a partir do dia 13/01.', ''),
(11, 10, '2014-01-08', 'Programado para IntegraÃ§Ã£o dia 09/01, 20 funcionarios na Esmaltec as 07:30', 'junior'),
(12, 10, '2014-01-10', 'IntegraÃ§Ã£o concluida com a falta de apenas 1 funcionario.<br />\r\nServiÃ§o programado para 12/jan', 'junior'),
(13, 10, '2014-01-13', 'Edson: serviÃ§o executado! aguardando laudo de campo para fazer Relatorio<br />\r\nEduardo: separando Ã³leo para enviar para Lorencini para analise.<br />\r\nJunior: fazer ART', 'junior'),
(14, 6, '2014-01-13', 'Edson: Liguei para o cliente, quem me atendeu foi o Sr. Mendes, o mesmo informou que Sr. Rafael encontra-se de FÃ©rias ele vai programar o serviÃ§o para quinta ou sexta 16 ou 17 deste mÃªs! <br />\r\nFavor liga para o Sr. Mendes para maiores informaÃ§Ãµes 34773581<br />\r\n', 'junior'),
(15, 10, '2014-01-14', 'Eduardo: garrafas de Ã³leo (11 und) enviadas pela JS transp. para Lorencini SP.<br />\r\nJR: ART feita e Laudo Tecnico Feito.<br />\r\nNOTA: umas 12Âª amostra de Ã³leo de um TRAFO 500kVA que o ximenis diz que coletou da SE-10, ficou na ELFI pois o Edson confirmou que sÃ³ tem 2 trafos de 1500kVA. o OrÃ§amento sÃ³ cobre 11 analises, por isso decidi que ficasse.', 'junior'),
(16, 6, '2014-01-15', 'Eduardo: ligou falou com Mendes, ele informou q estao fazendo serviÃ§o no TP e sÃ³ poderÃ¡ marcar o serviÃ§o para proxima semana a partir dia 20/01', 'junior'),
(17, 11, '2014-01-20', 'eDSON: marcou para 23/jan Termovisao e para 25/jan (SAB) Manut. SE', 'junior'),
(18, 12, '2014-01-20', 'Edson: entrou em contato Barbosa (RAPEL) para vir na ELFI dia 21/jan, fazer orÃ§amento para o serviÃ§o SPDA.', 'junior'),
(19, 12, '2014-01-22', 'Edson: comprado material SV NF 131553, aguardando programaÃ§Ã£o', 'junior'),
(20, 12, '2014-01-22', 'Edson: O pessoal foi hoje 22/01/2014 para dar inicio o serviÃ§o!<br />\r\nRobevaldo<br />\r\nFlavio<br />\r\nBruno<br />\r\nJuan', 'junior'),
(21, 11, '2014-01-22', 'eDSON: ServiÃ§o desprogramado devido a viagem para Iguatu, re-programar para 01/fev.', 'junior'),
(22, 14, '2014-01-23', 'Armando: entrou em contato com o Marcao para aprovar serviÃ§o reparo.', 'junior'),
(23, 13, '2014-01-23', 'Eduardo: programou com o gerente para dia 25/01 trocar o TAP;<br />\r\nmotoqueiro: pegar as chaves da agencia dia 24/01;<br />\r\nEdson: aguardando passar relaÃ§Ã£o da equipe;', 'junior'),
(24, 12, '2014-01-23', 'Hoje ninguem no serviÃ§o, devido terem trabalhado na madrugada de hj no serviÃ§o do Gerador;<br />\r\nEdson/Armando: entrar contato com rapaz do RAPEL, o mesmo nao deu retorno;', 'junior'),
(25, 6, '2014-01-23', 'Eduardo: falou com Rafael q voltou de ferias hj; informou q vao ter um reuniao para marcar a data;', 'junior'),
(26, 10, '2014-01-23', 'Jr: relatorio entregue para Welinton mandar deixar no cliente; finalizando processo ', 'junior'),
(27, 14, '2014-01-23', 'JR: teste', 'junior'),
(28, 14, '2014-01-23', 'JR: teste 2', 'junior'),
(29, 14, '2014-01-23', 'JR: teste 3 tamanho e estilo das letras', 'junior'),
(30, 12, '2014-01-24', 'Hoje novamente trabalharam no outro serviÃ§o do GERADOR pela noite exceto o Bruno que esta na elfi.<br />\r\nEsse continua Parado.', 'junior'),
(31, 13, '2014-01-24', 'Edson: programado com Edson, confirmar com Robevaldo.', 'junior'),
(32, 15, '2014-01-24', 'JR: pre-marcou uma data, esperando confirmaÃ§Ã£o para 28/01, dar retorno dia 27/01 para confirmar; comprar MATERIAL.', 'junior'),
(33, 10, '2014-01-24', 'Gilson ligou perguntando o pq nÃ£o foi executado mediÃ§Ã£o MEga no Disjuntor q sai para SE-40 e na chave do TRAFO auxiliar na SE-69kV', 'junior'),
(34, 13, '2014-01-27', 'Edson: serviÃ§o concluÃ­do, tiradas fotos, Fazer O.S. para pegar assinatura;', 'junior'),
(35, 15, '2014-01-27', '', 'junior'),
(36, 14, '2014-01-27', 'Armando: informou q Ã© para o Alex trazer da Super Trafo hj para conlcuir o serviÃ§o na oficina da ELFI;', 'junior'),
(37, 15, '2014-01-27', 'Edson: programando serviÃ§o com Robevaldo para executar dia 28/01; localizado no TRairi comprar Material', 'junior'),
(38, 15, '2014-01-28', 'JR: MArcos e Vladimir foram para o TRAIRI-CE as 07:00 para executar, previsto para acabar ainda hj.', 'junior'),
(39, 14, '2014-01-28', 'Armando: TRAFO jÃ¡ na elfi na Estufa, finalizar ate sexta', 'junior'),
(40, 11, '2014-01-28', 'Eduardo: ligou, o gerente responsavel esta de ferias, sÃ³ retorna no comeÃ§o de fevereiro', 'junior'),
(41, 6, '2014-01-28', 'Eduardo: aguardando reuniÃ£o para marcar, Mendes disse q daria retorno.', 'junior'),
(42, 14, '2014-01-30', 'Trafo sai para entrega na Ypioca com Alex no CaminhÃ£o.<br />\r\nJR: fazendo Laudo tecnico para enviar .', 'junior'),
(43, 17, '2014-02-03', 'ServiÃ§o iniciado, Robevaldo, vladimir<br />\r\nMarconi ligou para lembrar EDson de suporte que ficou curto e q deve ser regularizado atÃ© 04/02(TER).', 'junior'),
(44, 12, '2014-02-03', 'Edson: semana passada nao foi possivel dar continuidade neste serviÃ§o', 'junior'),
(45, 11, '2014-02-03', 'Programado para 16/fev, de SAB para DOM na madrugada comeÃ§ando as 00:00', 'junior'),
(46, 17, '2014-02-07', 'Aguardando quadro chegar da fabrica para instalar no local.', 'junior'),
(47, 19, '2014-02-07', 'Executado pelo EDSON. no Cond. Living', 'junior'),
(48, 20, '2014-02-13', 'Welinton: Robevaldo e Flavio, viajar de Onibus pela noite para CRATO para executar e voltar dia 14/02 de onibus.', 'junior'),
(49, 12, '2014-02-13', 'Edson: ServiÃ§o parado.', 'junior'),
(50, 17, '2014-02-14', 'Newton passou email confirmando que o material esta no local..<br />\r\nprogramando para continuar os serviÃ§os dia 17/02', ''),
(51, 17, '2014-02-17', 'Edson: foi conferir material, sera executado dia 18/02', 'junior'),
(52, 22, '2014-02-19', 'comprar chave dia 24/02, pre-programado para 25/02 as 10:00', 'junior'),
(53, 24, '2014-02-20', 'Quer executar 04/mar/2014 durante carnaval.', 'junior'),
(54, 11, '2014-02-24', 'executado pelo Edson, Weliton, Ximenes, brito, robevaldo em 23/02 as 01:00 da manha ', 'junior'),
(55, 22, '2014-02-25', 'EDSON E ROBEVALDO FORAM  EXECUTAR ESTE SERVIÃ‡O AS 08:30', 'junior'),
(56, 23, '2014-02-25', 'EXECUTADO JUNTO COM SERVIÃ‡O DA CHAVE SECCI EDSON ROBEVALDO MARCOS', ''),
(57, 21, '2014-02-26', 'JR:Robevaldo, marcos, flavio, Alex, foram executar este serviÃ§o as 13:00 de hj', 'junior'),
(58, 31, '2014-03-12', 'Marconi por Email: aguardando a COECLE para entrar em contato com a ELFI para programar data.', 'junior'),
(59, 32, '2014-03-18', 'Robevaldo foi executar as 14:00', 'junior'),
(60, 26, '2014-03-20', 'JR: feito Memorial Descritivo, falta algumas informaÃ§Ãµes, solicitado por EMAIL', 'junior'),
(61, 33, '2014-04-02', 'edson: O pessoal estarÃ¡ executando o serviÃ§o de proposta de NÂ°0000077/14 InstalaÃ§Ã£o do banco capacitor as 13:00hs de 02/04/2014', 'junior'),
(62, 40, '2014-04-22', 'Eduardo: iniciou dia 17/abr, dia 18, dia 19 dia 20 dia 20 dia 21 e dia 22', 'junior'),
(63, 40, '2014-04-24', 'JR: atÃ© o dia 2 de Maio; faz 15 dias !', 'junior'),
(64, 26, '2014-04-25', 'JR: ART com lana pra pagamento hj;', 'junior'),
(65, 26, '2014-04-25', 'Edson: Programado para iniciar serviÃ§o d instalaÃ§Ã£o dia 28/4 ', 'junior'),
(66, 26, '2014-04-30', 'Jr: Edson foi com pessoal para continuar a instalaÃ§Ã£o da SE', 'junior'),
(67, 12, '2014-04-30', 'JR: dia 29/04, comprado material para este serviÃ§o na RECPEL', 'junior'),
(68, 40, '2014-04-30', 'Eduardo: informou q o Francisco pediu pra faturar esse orÃ§amento mas q iria nova proposta para mais dias de plantÃ£o.', 'junior'),
(69, 46, '2014-05-02', 'JR: pedido por email dia 30/04 para ir conferir o material no local, pois eles jÃ¡ estÃ£o comprando todo o material para iniciar o serviÃ§o. (Anexei na Proposta o Email)', 'junior'),
(70, 42, '2014-05-02', 'edson: O s.r. Ricardo ficou de pegar o transformador nesta segunda em 05/05/2014 pela manhÃ£.<br />\r\nTrafo 750kva - YpÃ­oca<br />\r\n', 'junior'),
(71, 26, '2014-05-02', 'Edson: JÃ¡ realizado a instalaÃ§Ã£o do poste com transformador, esta faltando os quadros de mediÃ§Ã£o e proteÃ§Ã£o.', ''),
(72, 40, '2014-05-07', 'JR: desde o dia 02/maio continua o plantÃ£o. (fazer nova cobranÃ§a)', 'junior'),
(73, 46, '2014-05-08', 'EDSON: programando para ir no local conferir materiais 09/05 (Sr Armando)', 'junior'),
(74, 26, '2014-05-08', 'Jr: aguardando alteraÃ§Ãµes passadas do Edson para O Samuel, para poder enviar para ASTEF.', 'junior'),
(75, 49, '2014-05-08', 'JR: passado Email dia 06/05 perguntando sobre quem Solicitou a SubestaÃ§Ã£o e outros questionamentos, iniciado Memorial Descritivo e Quadro de Cargas OK.;', 'junior'),
(76, 44, '2014-05-12', 'jr: eXECUTADO MANUTENÃ‡ÃƒO.. FAZER RELATORIO', 'junior'),
(77, 48, '2014-05-12', 'JR: instalado medidor grandezas (Robevaldo)', 'junior'),
(78, 40, '2014-05-13', 'Welinton: Finalizou o plantÃ£o HJ. 13/05', 'junior'),
(79, 26, '2014-05-15', 'JR: projeto enviado para analise dia 14/05 pela internet. aguardar 10 dias', 'junior'),
(80, 46, '2014-05-22', 'Enviada em: quinta-feira, 22 de maio de 2014 13:49<br />\r\nPara: Elfi Service Geral<br />\r\nCc: Clara JucÃ¡<br />\r\nAssunto: Re: Comunicado<br />\r\n<br />\r\nSexta-feira estamos posicionamento com a data que iremos Starta o serviÃ§o.<br />\r\n<br />\r\nQuanto o das luminÃ¡rias estÃ£o em negociaÃ§Ã£o, mas o valor passado nÃ£o nos atende.<br />\r\n<br />\r\nAtc,<br />\r\n<br />\r\n<br />\r\nRebeca Correia<br />\r\n', 'junior'),
(81, 41, '2014-05-23', 'Edson: 31/05 serÃ¡ instalado o quadro na whati Martins', 'junior'),
(82, 71, '2014-06-26', 'Edson: Aguardando o Beach Park (Ricardo) comprar materiais para iniciar instalaÃ§Ã£o;', 'junior'),
(83, 60, '2014-06-26', 'Edson: Aguardando a prÃ³xima manutenÃ§Ã£o Mensal para executar. ( comprar Materiais ELFI)', 'junior'),
(84, 41, '2014-06-26', 'Feito Aditivo ORC 166-14', 'junior'),
(85, 26, '2014-06-26', 'JR: projeto retornou com questionamentos na planta de SituaÃ§Ã£o (delimitaÃ§Ã£o do terreno ); aguardando Edson e Samuel;', 'junior'),
(86, 46, '2014-06-26', 'Edson: inicio dos serviÃ§os 09/06 atÃ© 12/06;<br />\r\nesta faltando a EBBA comprar resto do material para finalizar os serviÃ§os;<br />\r\n', 'junior'),
(87, 70, '2014-06-26', 'Edson: Aguardando aluguel de Gerador para iniciar serviÃ§o', 'junior'),
(88, 68, '2014-06-26', 'Edson: aguardando resolverem problema no Gerador ', 'junior'),
(89, 77, '2014-07-03', 'Eduardo iniciou compra dos materiais que serÃ¡ faturado direto para o Cond. Ed. Iracema PArk II.', 'junior'),
(90, 79, '2014-07-07', 'JR: serviÃ§o serÃ¡ executado pela noite de 07/07 para 08/07;', 'junior'),
(91, 81, '2014-07-16', 'Eduardo: programar para o Ultimo domingo do Mes JUL', 'junior'),
(92, 81, '2014-07-17', 'Comprado Materiais: Enpecel, NF 35775, 204,00', 'junior'),
(93, 83, '2014-07-18', 'Edson: Robevaldo foi com marcos dia 17/07 das 12:00 as 17:30; informou q pediram para ir sabado 19/07, JR atualizou orÃ§amento com uma diaria dia d SABADO e jÃ¡ emcaminhou para Denis.', 'junior'),
(94, 69, '2014-07-24', 'Ira marcar para outro dia, primeiramente serÃ¡ executado a MAnut da SubhestaÃ§Ã£o dia 02/08 conforme email no orc 138', 'junior'),
(95, 87, '2014-07-24', 'Comprado controladores F.P - chegaram na ELFI dia 24/07 Sultech NF 5798', 'junior'),
(96, 87, '2014-07-24', 'Eduardo comprando resto material na Linseletrica', 'junior'),
(97, 87, '2014-07-25', 'Comprado resto do material na Lins Eletrica NF 39666 OC 1032', 'junior'),
(98, 77, '2014-08-01', 'Material comprado no nome do Cond. Park Iracema aguardando chegar na ELFI para conferencia, e posteriormente iniciar os serviÃ§os', 'junior'),
(99, 68, '2014-08-04', 'ServiÃ§o executado SAbado 02/08; Jr: fazer relatorios', 'junior'),
(100, 88, '2014-08-04', 'JR: MediÃ§Ãµes realizadas, fazendo relatÃ³rio e ART', 'junior'),
(101, 73, '2014-08-06', 'Jr: Memorial feito; Samuel: desenhos concluidos; enviar para ASTEF pela internet hj', 'junior'),
(102, 90, '2014-08-06', 'Edson iniciou dia 04/08 e 05/08 (pela tarde)', 'junior'),
(103, 49, '2014-08-06', 'SAmuel: desenhos feitos; enviar para ASTEF ate 07/08', 'junior'),
(104, 77, '2014-08-06', 'Iniciando os serviÃ§os HJ; Edson foi deixar pessoal Robevaldo, Marcos, Vladmir', 'junior'),
(105, 75, '2014-08-06', 'proposta dispensada ! por dificuldade do pagamento e deslocamento', 'junior'),
(106, 76, '2014-08-06', 'Iniciando os serviÃ§os HJ; Edson foi deixar pessoal Robevaldo, Marcos, Vladmir', 'junior'),
(107, 80, '2014-08-06', 'Eduardo: providenciando Material.', 'junior'),
(108, 84, '2014-08-06', 'Robevaldo fez integraÃ§Ã£o dia 05/08, aguardando resultado liberaÃ§Ã£o, e Jose Mario da Gerdau nÃ£o pode iniciar o serviÃ§o hj (informaÃ§Ã£o do Weliton)', 'junior'),
(109, 95, '2014-08-06', 'Marcos e Alex no caminhao realizaram dia 05/08', 'junior'),
(110, 69, '2014-08-06', 'ConcluÃ­do ManutenÃ§Ã£o Nas SE''s, aguardando programaÃ§Ã£o do Hospital', 'junior'),
(111, 80, '2014-08-07', 'Material comprado 06/08, Enpecel NF36586', 'junior'),
(112, 99, '2014-08-12', 'Eduardo: Material comprado FAturado direto para o Cliente.', 'junior'),
(113, 73, '2014-08-12', 'Projeto enviado para ASTEF dia 08/08 (JR) pela internet', 'junior'),
(114, 49, '2014-08-12', 'JR(11/08): Aguardando ART vir da Construtora Granito para enviar para ASTEF pela Internet', 'junior'),
(115, 49, '2014-08-13', 'JR: projeto enviado para ASTEF hj pela internet', 'junior'),
(116, 76, '2014-08-18', 'JR: 2 eletricistas no local, Sindico ligou reclamando da retirada de uns funcionÃ¡rios do local para executar outro serviÃ§o. Verificar porcentagem de andamento dos SERVIÃ‡OS;', 'junior'),
(117, 102, '2014-08-21', 'Verificar material - Mufla atÃ© 22/08', 'junior'),
(118, 76, '2014-08-22', 'Dia 21/08 ficaram MARcos, Adminir + 2 auxiliares', 'junior'),
(119, 76, '2014-08-22', 'Hj: Robevaldo, Marcos, Vladimir + 2 auxiliares', 'junior'),
(120, 101, '2014-08-25', 'JR: Trafo na ELFI para recuperaÃ§Ã£o.', 'junior'),
(121, 102, '2014-08-25', 'Edson: serviÃ§o OK! <br />\r\nJR: aguardando levantamento d Campo, para fazer RElatorio.', 'junior'),
(122, 94, '2014-08-26', 'JR: confirmado para 06/09 (SAB) as 11:00am, por email.', 'junior'),
(123, 102, '2014-08-26', 'JR: fazendo RelatÃ³rio, ART feita dia 25/08.', 'junior'),
(124, 102, '2014-08-27', 'JR: relatÃ³rio OK, aguardando o retorno no local para Banco de Capacitores;<br />\r\nEduardo: Ã³leo aguardando transportadora vir pegar amostras para Lorencini, prazdo 10dias.', 'junior'),
(125, 73, '2014-08-27', 'JR: projeto devolvido dia 25/08 para correÃ§Ãµes da 1Âº solicitaÃ§Ã£o; Corrigido parte Memorial <br />\r\naguardando Samuel alterar os desenhos nas plantas para reenvio para 2Âª avaliaÃ§Ã£o;', 'junior'),
(126, 49, '2014-08-27', 'JR: projeto devolvido dia 21/08 para alteraÃ§Ãµes da 1Âª solicitaÃ§Ã£o;', 'junior'),
(127, 76, '2014-08-27', 'JR: hj nÃ£o temos equipe neste ServiÃ§o, pois foram trabalhar no Beach Park a noite do dia 26 para 27/08. <br />\r\nRecebido Email do Francisco Costa: "JÃ¡ havia solicitado a sua equipe que estÃ¡ trabalhando em nosso condomÃ­nio, que toda retirada da fiaÃ§Ã£o velha, fosse guardada em nosso depÃ³sito do subsolo." REFORÃ‡AR!', 'junior'),
(128, 100, '2014-09-02', 'Edson: informou q serÃ¡ executado dia 02/09 iniciando pela manha.', 'junior'),
(129, 101, '2014-09-03', 'Programada para dia 07/09 (DOM) para conclusÃ£o dos serviÃ§os', 'junior'),
(130, 101, '2014-09-08', 'JR: ServiÃ§o executado dia 07/09, devolvido o TRAFO recuperado, instalado para-raios e chaves fusÃ­veis, feito pintura do QGBT; FALTA apenas a TERMOGRAFIA q deve ser executado durante a semana.', 'junior'),
(131, 94, '2014-09-08', 'serviÃ§o executado dia 06/09 (sab) ', 'junior'),
(132, 107, '2014-09-09', 'Armando: orÃ§amento foi aprovado com a condiÃ§Ã£o de ser EXECUTADO dia 10/09/2014.', 'junior'),
(133, 107, '2014-09-10', 'JR: Robevaldo foi executar mediÃ§Ãµes com Luiz comprador pela manha de hj.', 'junior'),
(134, 101, '2014-09-10', 'JR: Edson foi executar termogafria dia 09/09', 'junior'),
(135, 93, '2014-09-11', 'JR: Edson foi com Alex iniciar serviÃ§o com Termografia e levantamento das cargas dos Quadros.', 'junior'),
(136, 107, '2014-09-11', 'JR: Laudo feito, aguardando ART ser liberada.', 'junior'),
(137, 93, '2014-09-12', 'FAZENDO O LAUDO .. ART FEITA DIA 11/09, PRA PAGAMENTO ', 'junior'),
(138, 93, '2014-09-17', 'Laudo concluÃ­do. FAlta fazer manutenÃ§Ã£o corretiva e preventiva nos Quadros.', 'junior'),
(139, 49, '2014-09-17', 'JR: projeto reenviado para segunda AvaliaÃ§Ã£o na ASTEF HJ! 17/09/14', 'junior'),
(140, 73, '2014-09-17', 'JR: projeto Devolvido dia 17/9 com CorreÃ§Ãµes da 2Âª solicitaÃ§Ã£o;', 'junior'),
(141, 106, '2014-09-17', 'jr: COMPRADO MATERIAL NA SV NF 167117, PARA EXECUTAR DO DIA 17 PARA 18/09 JUNTO COM A MANUT. MENSAL. EDSON', 'junior'),
(142, 109, '2014-09-22', 'JR: quer marcar esse SErviÃ§o essa semana, o mais breve possÃ­vel.', 'junior'),
(143, 106, '2014-09-23', 'EDSON: NÃƒO FOI POSSIVEL INSTALAR AS CHAVES NESTE DIA 17/09; FICOU DE REMARCAR', 'junior'),
(144, 111, '2014-09-26', 'Instalado Registrador dia 23/09 e retirado dia 24/09;<br />\r\nFalta Diagrama Unifilar ', 'junior'),
(145, 111, '2014-09-26', 'Programado para 27/09 SAB fazer manutenÃ§Ã£o e Desenho do Diagrama Unifilar ', 'junior'),
(146, 93, '2014-09-29', 'CONCLUIDO MANUTENÃ‡ÃƒO NOS QUADROS DIA 27/09. EDSON E VLADIMIR', 'junior'),
(147, 113, '2014-09-30', 'VAi executar juntamente com a ManutenÃ§Ã£o Mensal da SE de SETEMBRO. Edson', 'junior'),
(148, 108, '2014-09-30', 'RElatorio feito, ART para pagamento dia 29/09<br />\r\nAnalise do Ã³leo isolante do Trafo saindo da ELFI para Lorencini dia 30/09<br />\r\nprazo de 10 dias para laudo do Ã³leo', 'junior'),
(149, 49, '2014-09-30', '- projeto retornou para correÃ§Ãµes segunda vez em 24/09;<br />\r\n- empasse no item 01 do Memorial, sobre ser atendido ou nÃ£o no grupo A, foi enviado para Eng. Jose Nilton da Granito em 30/09 a Carta Projeto de CorreÃ§Ãµes da ASTEF.<br />\r\n', 'junior'),
(150, 111, '2014-09-30', 'Laudo do resgistrador de grandezas FEITO. ART para pagamento no financeiro dia 30/09.<br />\r\nDiagrama Unifilar levantado pelo Marcos e Edson passando para CAD.', 'junior'),
(151, 115, '2014-10-01', 'Eduardo comprando material, aprovou o orÃ§amento apenas por telefone; pedi para eduardo ligar e pedir para enviar um email com aprovaÃ§Ã£o.', 'junior'),
(152, 115, '2014-10-01', 'Material:<br />\r\nDragÃ£o parafusos, NF 65832, 132,45, OC 1199', 'junior'),
(153, 116, '2014-10-02', 'Eles tem atÃ© dia 12 de Outubro para receber o Laudo.<br />\r\nEduardo cotando materiais <br />\r\nquerem iniciar o mais BREVE dia 06/10 (SEG)', 'junior'),
(154, 113, '2014-10-02', 'reLATORIO fEITO E ART PARA PAGAMENTO DIA 02/10', 'junior'),
(155, 115, '2014-10-02', 'mATERIAL:<br />\r\nSV NF 169875 - 3140,39 - OC 1202', 'junior'),
(156, 115, '2014-10-02', 'PrÃ©-programado para dia 08/10 (QUA)', 'junior'),
(157, 117, '2014-10-07', 'Edson Instalar Registrador dia 13/10 (SEG) cedo no TRAFO 01 e instalar no dia 20/10(SEG) no Trafo 2 ', 'junior'),
(158, 116, '2014-10-07', 'Iniciou serviÃ§os com Vladimir hj', 'junior'),
(159, 100, '2014-10-10', 'programada para reinstalar os cabos do gerador dia 14/10', 'junior'),
(160, 46, '2014-10-13', 'MArcos, SebastiÃ£o (avulso) e Alex foram para concluir em 2 dias este serviÃ§o.', 'junior'),
(161, 116, '2014-10-13', 'Vladimir foi continuar o serviÃ§o. <br />\r\nforam comprados mais cabos na SV, OC 1232', 'junior'),
(162, 117, '2014-10-13', 'Edson e Brito foram instalar o Registrador no TRAFO 01 HJ. a troca para o TRAFO 02 serÃ¡ dia 20/10.', 'junior'),
(163, 74, '2014-10-13', 'Estava programado para dia 08/10, mas a Coelce nÃ£o compareceu ao Local<br />\r\nFicou remarcado para dia 15/08.', 'junior'),
(164, 111, '2014-10-13', 'Laudo e Diagrama unifilar ok', 'junior'),
(165, 73, '2014-10-13', 'JR> projeto devolvido dia 01/10, 3Âª correÃ§Ã£o. NÃ£o foi aceito o espaÃ§o para a SubestaÃ§Ã£o, apÃ³s passar por comissÃ£o na COELCE.<br />\r\nArmando falou com Pedro e eles ficaram de entrar em contato com a COELCE e nos dar retorno.', 'junior'),
(166, 116, '2014-10-14', 'Vladimir: Concluido, ficou em 10 Ã´hms os valores, aceitÃ¡vel.<br />\r\nEdson me passar o Laudo para fazer<br />\r\nJr fazer RelatÃ³rio e ART', 'junior'),
(167, 118, '2014-10-14', 'executado pelo Edson e VLadimir', 'junior'),
(168, 116, '2014-10-15', 'ART com financeiro<br />\r\nRelatÃ³rio OK!', 'junior'),
(169, 117, '2014-10-22', 'diad 20/10: foi instalado no TRAFO 02 pelo Edson', 'junior'),
(170, 76, '2014-10-22', 'entregue ultimos materiais <br />\r\n60 espelhos (tampas cegas);<br />\r\n03 luminÃ¡rias de embutir (tipo tartaruga) para o muro.<br />\r\nfalta apenas a instalaÃ§Ã£o dos mesmos para CONCLUIR este SERVIÃ‡O', 'junior'),
(171, 117, '2014-10-27', 'Brito e Ximenes foram retirar o registrador no Leiria.<br />\r\nJR. retirou a memoria de massa para o PC.', 'junior'),
(172, 100, '2014-10-27', 'foi reinstalado o cabos do Gerador no dia 27/10, Edson', 'junior'),
(173, 117, '2014-10-28', 'RElatorio OK', 'junior'),
(174, 121, '2014-10-28', 'Edson instalou o Registrador no 1Âº TRAFO 300kVA. passar 72 hrs<br />\r\nproximo dia 31/10', 'junior'),
(175, 123, '2014-10-30', 'iniciado com Marcos e Vladimir - Edson', 'junior'),
(176, 114, '2014-11-03', 'Sr ARmando: serviÃ§o deve finalizar essa semana. atÃ© 05/11', 'junior'),
(177, 126, '2014-11-04', 'Cliente aguardando uma DATA para programar inicio dos serviÃ§os.', 'junior'),
(178, 74, '2014-11-05', 'fABIANO COBRANDO O PROJETO, EDSON INFORMOU Q JÃ ESTA PRONTA A PLANTA COM A ALTERAÃ‡ÃƒO;<br />\r\nFOI TIRADO A DUVIDA JUNTO AO LIRA DA COELCE, PARA SABER O Q ENVIAR PARA APROVAÃ‡ÃƒO NA COELCE, FOI INFORMADO Q TEM Q ENVIAR AS PLANTAS E O MEMORIAL.', 'junior'),
(179, 115, '2014-11-05', 'AGUARDANDO PROGRAMAÃ‡ÃƒO;', 'junior'),
(180, 121, '2014-11-10', 'DIA 31/10 INSTALADO NO SEGUNDO TRAFO E DIA 06/11 NO 3ÂºTRAFO', 'junior'),
(181, 127, '2014-11-12', 'material comprado 11/11: SV NF 176560', 'junior'),
(182, 129, '2014-11-12', 'Cliente quer Realizar dia 18/11 (TER). confirmar com o cliente!', 'junior'),
(183, 130, '2014-11-13', 'Vladimir Marcos Alex e Paula foram executar.', 'junior'),
(184, 131, '2014-11-14', 'MediÃ§Ãµes conlcuidas Vladimir e MArcos<br />\r\nJR fazendo Laudo + ART', 'junior'),
(185, 122, '2014-11-17', 'EXECUTADO DIA 16/11 POR <br />\r\nAniger 16/11/2014<br />\r\nDe 04:00 as 21:00HS<br />\r\n<br />\r\nEdson<br />\r\nAlex<br />\r\nVladmir<br />\r\nPaulo<br />\r\nXimenes<br />\r\nMarcos<br />\r\n', 'junior'),
(186, 122, '2014-11-17', 'Jr. FAZENDO LAUDO + ART', 'junior'),
(187, 25, '2014-11-18', 'programado para dia 20/11', 'junior'),
(188, 74, '2014-11-18', 'programado a ligaÃ§Ã£o do novo ramal entrada SE Acqua dia 20/11 junto a Coelce.', 'junior'),
(189, 25, '2014-11-20', 'Viajou: Edson - Marcos - Alex<br />\r\nIbiapaba-CE - iniciar serviÃ§os', 'junior'),
(190, 74, '2014-11-20', 'Foi Vladmir - Paulo - Luizin para iniciar serviÃ§os juntamente com a COELCE', 'junior'),
(191, 73, '2014-11-26', 'Projeto Aprovado na ASTEF, imprimindo para montar 2 vias para levar na ASTEF para Assinatura da Eng(a) para posterior entrega no cliente.', 'junior'),
(192, 128, '2014-11-26', 'TRAFO PRONTO, JR FAZENDO RELATORIO E ART', 'junior'),
(193, 25, '2014-12-04', 'RelaÃ§Ã£o pessoal viagem TianguÃ¡ /Granito/CAGECE<br />\r\n<br />\r\nEDSON<br />\r\nVLADIMIR<br />\r\nALEX<br />\r\nMARCOS<br />\r\n<br />\r\nQUARTA/QUINTA/SEXTA/ = 03 04 e 05 de DEZ<br />\r\n', 'junior'),
(194, 132, '2014-12-04', 'MAterial comprado, nÃ£o foi possÃ­vel executar dia 02/12 devido esta havendo aula. ficou de remarcar.', 'junior'),
(195, 136, '2014-12-04', 'Cliente ficou de comprar MAterial. E fica pre-agendado dia 15/12 as 14:00 (SEG), falta Confirmar!', 'junior'),
(196, 134, '2014-12-04', 'em 02/DEZ:<br />\r\nrelaÃ§Ã£o dos funcionÃ¡rios para Sr cardoso para integraÃ§Ã£o<br />\r\nâ€¢   Antonio Marcos Sabino Gomes          (RG: 91005016820 â€“ SSP-CE)<br />\r\nâ€¢  Alexsandro Mousinho Marcolino   (RG: 323191769 â€“ SSP-SP)<br />\r\nâ€¢  Francisco Edson de Souza      ( RG: 940021594-39 SSP-CE)<br />\r\nâ€¢ Vladimir InÃ¡cio Bezerra     (RG: 99021025060 â€“ SSP-CE)<br />\r\nâ€¢Paulo Roberto Nunes Marque     (RG:  2003006011840-SSP-CE)<br />\r\n', 'junior'),
(197, 138, '2014-12-10', 'PELO TELEFONE SR. NERO me informou q o serviÃ§o serÃ¡ executado esse mes de DEZ e sÃ³ serÃ¡ pago em JAN com valores reajustados, nÃ£o sÃ³ para uma BOMBA, mas para 2. Tendo q atualizar este OrÃ§amento em JAN 2015 para cobrar. conforme acertado com Sr. Armando.', 'junior'),
(198, 137, '2014-12-10', 'NÃ£o foi executado dia 06/12 pois foi cancelado dia 05/12 pelo Sr Teles devido o Gerador nao funcionar. <br />\r\nEsta sendo remarcado para dia 20/12 as 14:00 ', 'junior'),
(199, 139, '2014-12-12', 'MEDIÃ‡Ã•ES EXECUTADAS POR VLADIMIR E MARCOS<br />\r\nFAZER LAUDO E ART', 'junior'),
(200, 136, '2014-12-12', 'Material comprado no nome do Restaurante; esta na ELFI. serviÃ§o sera executado dia 15/12 (15:00)', 'junior'),
(201, 134, '2014-12-16', 'iniciado hj 16/12 Marcos e Vladimir', 'junior'),
(202, 141, '2014-12-17', 'Edson, Eliezer, Alex, Claudemir, Ximenis concluirÃ£o os serviÃ§os<br />\r\nJR fazendo ART e Laudo atÃ© 18/12<br />\r\nTEm amostras de Ã³leo para enviar Lorencini', 'junior'),
(203, 74, '2014-12-18', 'Edson concluÃ­do alteraÃ§Ãµes no Projeto para ser enviado para Coelce Eng. Lira<br />\r\nJr fazendo ART', 'junior'),
(204, 143, '2014-12-18', 'Material comprado na ELFI NF 45024 Linseletrica 1341,14 OC 1363', 'junior'),
(205, 134, '2014-12-19', 'Vladimir e Marcos continuam realizando as MediÃ§Ãµes.', 'junior'),
(206, 74, '2014-12-19', 'ART FEITA, NO FINANCEIRO PARA PAGAMENTO', 'junior'),
(207, 143, '2014-12-19', 'Montagem do Painel na ELFI iniciada pelo Leonardo Cipriano.', 'junior'),
(208, 143, '2014-12-19', 'comprado material acessorios para montar o Quadro solicitado pelo Leonardo. Comercial Dragao NF 70299 85,50', 'junior'),
(209, 134, '2014-12-19', 'Vladimir e Marcos voltaram na Hora do almoÃ§o devido o Marcos precisar ir no Banco trocar o Chegue do pagamento. perdendo a tarde de serviÃ§o', 'junior'),
(210, 134, '2014-12-22', 'Vladimir e MArcos foram continuar o serviÃ§o pela manhÃ£, pela tarde irÃ£o para serviÃ§o do Limone.<br />\r\nNÃ£o teve serviÃ§o nem SAB nem DOM 20 e 21.', 'junior'),
(211, 136, '2014-12-23', 'ServiÃ§o executado 22/12 por Marcos, Vladimir e Ximenis.<br />\r\nHj Jr. fazendo ART e relatorio <br />\r\nOleo sendo enviado para Lorencini, prazo de 10 dias uteis.', 'junior'),
(212, 137, '2014-12-29', 'Foi executado dia 20/12<br />\r\nART OK<br />\r\nRelatorio OK<br />\r\nrelatorio Ã³leo: enviado dia 23/12', 'junior'),
(213, 141, '2014-12-29', 'Enviado Ã³leo para Lorencini dia 23/12 aguardando laudos', 'junior'),
(214, 143, '2014-12-29', 'Edson: Quadro Montado, esta na ELFI.', 'junior'),
(215, 134, '2014-12-29', 'vladimir e marcos foram fazer os ultimos pontos para concluir ainda hj', 'junior'),
(216, 142, '2015-01-05', 'realizada a manutenÃ§Ã£o das subesdtaÃ§Ãµes abrigadas<br />\r\nfalta realizar manutenÃ§Ã£o da SE aÃ©rea<br />\r\nJR fez ART 05/01/2015, aguardando laudo de campo<br />\r\nTem Ã³leo para enviar ', 'junior'),
(217, 145, '2015-01-06', 'eduardo:<br />\r\nConforme contato por telefone solicita a coelce  desligamento de energia referente a manutenÃ§Ã£o preventiva da subestaÃ§Ã£o de aÃ©rea de 225kva.<br />\r\n<br />\r\nHorÃ¡rio do desligamento da Coelce 08:00<br />\r\n<br />\r\nHorÃ¡rio do religamento da Coelce 11:00<br />\r\n<br />\r\nPrograma o serviÃ§o para sÃ¡bado dia 10.01.2015<br />\r\n<br />\r\nVladimir InÃ¡cio bezerra<br />\r\nJoÃ£o de pinho Ximenes<br />\r\nFrancisco Edson de Souza<br />\r\nAlexsandro mousinho Marcolino<br />\r\n', 'junior'),
(218, 146, '2015-01-07', 'Iniciado dia 06/01/15 com Edson e Vladimir e Marcos', 'junior'),
(219, 143, '2015-01-07', 'Edson: Sr. Gilson sÃ³ quer instalar o quadro apÃ³s o termino do ServiÃ§o dos Geradores.', 'junior'),
(220, 148, '2015-01-09', 'serviÃ§o de manutenÃ§Ã£o que serÃ¡ realizado sÃ¡bado dia 10.01.2015 aparte das 07:00 horas.<br />\r\nFRANCISCO EDSON DE SOUZA ......................RG 94002159439<br />\r\nVALDIMIR INACIO BEZERRA............................RG 99021025060<br />\r\nALEXSANDRO MOUSINHO MARCOLINO.......RG 2007009218775 <br />\r\nANTONIO MARCOS SABINO...........................RG 91005016820 <br />\r\nJOÃƒO DE PINHO XIMENES..............................RG 20080764333<br />\r\nRAIMUNDO CLAUDENIR DOS SANTOS GUIAS.....RG 2007389677', 'junior'),
(221, 145, '2015-01-09', 'ïƒ˜	EDU SESC DIA 10.01.2015<br />\r\n<br />\r\n- EDSON<br />\r\n- ALEX<br />\r\n- MARCOS<br />\r\n- VLADIMIR<br />\r\n- XIMENS<br />\r\n', 'junior'),
(222, 147, '2015-01-12', 'comprado dia 09/01 na Carmehil para ser entregue montado o Painel', 'junior'),
(223, 149, '2015-01-12', 'passado email VAlter com relaÃ§Ã£o de materiais para eles comprarem<br />\r\nserviÃ§o deve iniciar 13/01', 'junior'),
(224, 148, '2015-01-13', 'rELATORIO FEITO, ART FEITA.<br />\r\nTEM Ã“LEO PARA ENVIAR PARA LORENCINI', 'junior'),
(225, 145, '2015-01-13', 'maNUTENÃ‡ÃƒO EXECUTADA DIA 10/01<br />\r\nRELATORIO FEITO 13/1<br />\r\nART FEITA 13/1<br />\r\nÃ“LEO ESPERANDO SER ENVIADO LORENCINI', 'junior'),
(226, 149, '2015-01-13', 'ARmando e ARmando JR em loco para passar o serviÃ§o de escavaÃ§Ã£o para Tec. Ed. Junior iniciar <br />\r\nhouve algumas alteraÃ§Ãµes do percurso das valas', 'junior'),
(227, 149, '2015-01-14', 'ServiÃ§o continua, com Jr (tec edificaÃ§Ã£o) + 2 pessoas para escavaÃ§Ã£o das valas e passagem dos eletrodutos', 'junior'),
(228, 150, '2015-01-19', 'Edson foi com alex, marcos, Ximens e claudenir', 'junior'),
(229, 151, '2015-01-19', 'progamado para DOMINGO 25/JAN, VERIFICAR NECESSIDADE DE COELCE.', 'junior'),
(230, 149, '2015-01-20', 'Junior + 2 ajudantes estÃ£o concluindo a EscavaÃ§Ã£o', 'junior'),
(231, 150, '2015-01-23', 'Disjuntor do SESC trocado na loja, esta na elfi o novo.<br />\r\nVAi ser substituido dia 26/01 para ser concluido o serviÃ§o', 'junior'),
(232, 147, '2015-01-23', 'comprado cabo 16mm para concluir serviÃ§o', 'junior'),
(233, 150, '2015-01-26', 'Vladimir e Marcos foram trocar o Disjunto HJ <br />\r\nART OK <br />\r\nLaudo OK<br />\r\nLaudo Ã³leo, aguardando envio para Lorencini atÃ© Quarta 28/01', 'junior'),
(234, 151, '2015-01-26', 'serviÃ§o concluÃ­do com Robevaldo (avulso) cobrou 200<br />\r\nFazendo LAUDO e ART.', 'junior'),
(235, 147, '2015-01-26', 'Concluido, falta programa desligamento no HOTEL para fazer a ligaÃ§Ã£o do quadro<br />\r\nARmando entrou em contato com o resposavel ficou de dar resposta sobre a programaÃ§Ã£o', 'junior'),
(236, 150, '2015-01-26', 'Vladimir e marcos concluirÃ£o a troca do Disjuntor OK<br />\r\nFalta apenas laudo do Ã³leo', 'junior'),
(237, 149, '2015-01-27', 'Dia 26/01 os dois avulsos faltaram, nÃ£o teve serviÃ§o na FIC<br />\r\nhj dia 27/01 os dois avulsos estao por lÃ¡ para juntar entulhos (areia) e deixar limpo o canteiro d obra.', 'junior'),
(238, 155, '2015-02-09', 'Executar - Ã³leo (ximenis tratando) e disjuntor (weliton foi pegar na loja) para ser executado hj 09/02 as 15:00 - Edson, Vladimir, Alex', 'junior'),
(239, 146, '2015-02-09', 'Diagramas e Laudo aterramento entregues <br />\r\nEdson ficou de conlcuir apenas o da SubestaÃ§Ã£o', 'junior'),
(240, 150, '2015-02-09', 'Ã³leo chegou hj da Lorencini <br />\r\nenviando por email para Wagner', 'junior'),
(241, 74, '2015-02-09', 'Projeto nÃ£o aceito pela COELCE em 21/01/15<br />\r\nRequerem um projeto todo novo<br />\r\nO responsavel do Beach PArk ficou de tentar algo com a Coelce e nos dar retornor.', 'junior'),
(242, 73, '2015-02-09', 'dia 29/01 foram feitos os buracos dos postes<br />\r\nfoi identificado q o espaÃ§o precisava ser aumentado de 4,80m para 5,60m de largura (ficaram de quebrar)<br />\r\nDia 02/02 foram instalados os postes no local com Cruzetas e o transformador ( Edson - Vladimir ', 'junior'),
(243, 149, '2015-02-09', 'Vlamidir e Marcos estao desde 02/02 passando os cabos, previsÃ£o para finalizar dia 10/02<br />\r\nEdson levou Mega para testar os cabos hj.', 'junior'),
(244, 149, '2015-02-09', 'Vlamidir e Marcos estao desde 02/02 passando os cabos, previsÃ£o para finalizar dia 10/02<br />\r\nEdson levou Mega para testar os cabos hj.', 'junior'),
(245, 153, '2015-02-11', 'passou a ser ORC 42/15', 'junior'),
(246, 126, '2015-02-19', 'ïƒ˜	Stock 15/02<br />\r\nDe 07:00hs as 17:00hs<br />\r\n<br />\r\nAlex<br />\r\nMarcos<br />\r\n', 'junior'),
(247, 163, '2015-02-19', 'ProgramaÃ§Ã£o do serviÃ§o de emergÃªncia no dia 21.02.2015 SÃ¡bado.<br />\r\nRelaÃ§Ã£o<br />\r\nFRANCISCO EDSON DE SOUSA<br />\r\nVLADIMIR INACIO BEZERRA<br />\r\nANTONIO MARCOS SABINO GOMES<br />\r\nALEXSANDRO MOUSINHO MARCOLINO<br />\r\n', 'junior'),
(248, 164, '2015-02-20', 'iniciado dia 19/02 Ximenes e MArcos sabino', 'junior'),
(249, 73, '2015-02-24', 'Os itens de vermelho sÃ£o todos com a Inelsa. Eles deram o prazo hoje de estarem entregando tudo atÃ© sexta-feira.<br />\r\nOs cabeamentos  nÃ£o compramos ainda. Precisamos ter 100% da certeza de vocÃªs que a metragem estÃ¡ correta, para nÃ£o haver perigo de ter sobra. O IdÃ©zio preferiu nÃ£o autorizar a compra para que durante a obra vocÃªs chequem essa medida in loco.<br />\r\n<br />\r\nPedro de Castro Rodrigues<br />\r\n', 'junior'),
(250, 164, '2015-02-25', 'tratamento concluido com Ximenes dia 24/02<br />\r\nÃ³leo na ELFI para enviar para Cemec para fazer ensaio de Teor De Agua. (Sr Armando Negociando valor)<br />\r\nProposta para o Financeiro para faturar', 'junior'),
(251, 166, '2015-02-25', 'programado para 27/02 (SEX) as 12:00 conforme Email<br />\r\nConforme contato com Edison, estamos confirmando orÃ§amento anexo para execuÃ§Ã£o dos serviÃ§os para dia 27/02 nesta sexta-feira a partir das 12:00hs.', 'junior'),
(252, 158, '2015-02-25', 'iniciado Edson em 25/02', 'junior'),
(253, 146, '2015-02-26', 'Diagrama SE concluido, Samuel ficou de imprimir, pois Sr Armando vez algumas alteraÃ§Ãµes', 'junior'),
(254, 168, '2015-02-26', 'disjuntor jÃ¡ na oficina da ELFI', 'junior'),
(255, 167, '2015-02-27', 'material comprado SV 192418 OC 1433 e Dragao NF 73456 OC 1432<br />\r\n', 'junior'),
(256, 167, '2015-03-02', 'concluÃ­do Edson;<br />\r\nEdson falta passar laudo para ser digitado para ser entregue.', 'junior'),
(257, 73, '2015-03-03', 'O quadro QGBT chegou ontem( 28-02-15); O restante da planilha o fornecedor entrega atÃ© o dia 03-03. (por email)<br />\r\nass. Pedro de Castro Rodrigues<br />\r\n', 'junior'),
(258, 160, '2015-03-04', 'eXECUTADO PELO EDSON. EM 03/03/2015', 'junior'),
(259, 170, '2015-03-04', 'aguardando material ser comprado pelo Mariuba', 'junior'),
(260, 164, '2015-03-10', 'Laudo recebido da CEMEC em 09/03 e evniado ao cliente <br />\r\nOK', 'junior'),
(261, 167, '2015-03-10', 'MediÃ§Ã£o realizado pelo Vladimir 0,5 ohms<br />\r\nFazendo ART JR', 'junior'),
(262, 167, '2015-03-10', 'Foi solicitado a pintura do MASTRO que foi substituio em 05/03', 'junior'),
(263, 175, '2015-03-10', 'executado por Edson EMERGENCIA', 'junior'),
(264, 73, '2015-03-11', 'INICIADO instalaÃ§Ã£o da SubestaÃ§Ã£o Edson - Vladimir - Marcos _ alex', 'junior'),
(265, 176, '2015-03-12', 'Concluido dia 10/03 - Vladimir<br />\r\nrelatorio em 12/03 JR', 'junior'),
(266, 173, '2015-03-13', '- INSTITUTO DO RIM â€“ PROGRAMADO PARA DIA 15.03.2015, 08:00 HORAS CONFIRMADO COM ADRIANO POR TELEFONE<br />\r\n- INSTITUTO DE DOENÃ‡AS RENAIS  - PROGRAMADO PARA DIA 15.03.2015 13:00 HORAS CONFIRMADO PELO ITALO POR TELEFONE<br />\r\nANTONIO MARCOS SABINO GOMES<br />\r\nFRANCISCO ROBEVALDO DOS SANTOS', 'junior'),
(267, 172, '2015-03-13', '- INSTITUTO DO RIM â€“ PROGRAMADO PARA DIA 15.03.2015, 08:00 HORAS CONFIRMADO COM ADRIANO POR TELEFONE<br />\r\n- INSTITUTO DE DOENÃ‡AS RENAIS - PROGRAMADO PARA DIA 15.03.2015 13:00 HORAS CONFIRMADO PELO ITALO POR TELEFONE<br />\r\nANTONIO MARCOS SABINO GOMES<br />\r\nFRANCISCO ROBEVALDO DOS SANTOS', 'junior'),
(268, 177, '2015-03-13', 'Vladimir - Alex e MArcos iniciaram o serviÃ§o', 'junior'),
(269, 178, '2015-03-13', 'Segue abaixo relaÃ§Ã£o dos funcionÃ¡rios que irÃ£o executar o serviÃ§o no dia 15.03.2015.<br />\r\nFRANCISCO EDSON DE SOUSA<br />\r\nVLADIMIR INACIO BEZERRA<br />\r\n', 'junior'),
(270, 168, '2015-03-13', 'recupeÃ§Ã£o concluida<br />\r\nrelatorio com JR<br />\r\nfalta instalar no local ', 'junior'),
(271, 162, '2015-03-16', 'Edson: <br />\r\nconcluido<br />\r\nAguardando relatorio de campo ', 'junior'),
(272, 172, '2015-03-16', 'Edson: Executado, aguardando laudo de campo<br />\r\nJr: fazer ART', 'junior'),
(273, 173, '2015-03-16', 'Edson: executado.<br />\r\nJR: aguardando laudo campo e fazer ART', 'junior'),
(274, 180, '2015-03-16', 'enpecel<br />\r\nNF 44558', 'junior'),
(275, 168, '2015-03-16', 'JR: relatorio enviado por email.<br />\r\nARMANDO: disjuntor entregue, mas falta programaÃ§Ã£o para instalar o mesmo.', 'junior'),
(276, 168, '2015-03-31', 'instalado dia 30/03 - Edson', 'junior'),
(277, 172, '2015-03-31', 'aguardando Ã³leo', 'junior'),
(278, 173, '2015-03-31', 'aguardando Ã³leo - previsao atÃ© 02/04', 'junior'),
(279, 174, '2015-03-31', 'aguardando Ã³leo - previsao 02/04', 'junior'),
(280, 183, '2015-03-31', 'Cabo serÃ¡ comprado pelo Instituto 10m cabo cobre 35mm nu', 'junior'),
(281, 25, '2015-04-13', 'Viagem Tiangua: dia 08/04/2015: Vladimir, Edson, Marcos e Alex<br /><br />\r\natÃ© dia 11/04/2015<br /><br />\r\n', 'junior'),
(282, 188, '2015-04-14', 'dia 13/08: executado parte da montagem da Eletrocalhas, falta passar cabos, Robevaldo, vladimir e alex<br />\r\nFicou do responsavel do Hotel programar o desligamento para conlcuir os serviÃ§os, provavel dia 22/04/2015', 'junior'),
(283, 190, '2016-01-07', 'Executado por Ximenis e Bruno nesta data, concluido', 'junior'),
(284, 192, '2016-01-13', 'Sr ARmando e Samuel trabalhando na atualizaÃ§Ã£o do Projeto conforme carta de recomendaÃ§Ã£o da COELCE<br />\r\nJR. Atualizar ART e Memorial', 'junior'),
(285, 194, '2016-01-14', 'Disjuntor na ELFI desde 11/01 Vladimir e Bruno trabalhando nele<br />\r\nTiago da nacional e Eduardo da ELFI junto com Edson estÃ£o programando para por o Dijsuntor no local dia 16/01, houve um problema com a programaÃ§Ã£o com a COELCE. talvez seja executado dia 16/01 a partir das 17, aguardando confirmaÃ§Ã£o do Tiago', 'junior'),
(286, 195, '2016-01-15', 'Pediu para Emitir a Nota dentro do mes de JAN, ver no email anexado na Proposta ', 'junior'),
(287, 194, '2016-01-15', 'chegou a Ordem de ServiÃ§o por Email esta anexo na Proposta, serviÃ§o programado para finalizar dia 24/01 (DOM)', 'junior'),
(288, 192, '2016-01-18', 'Mandou OS de NÂº16000553 referente aos 30% iniciais', 'junior'),
(289, 194, '2016-01-25', 'ServiÃ§o concluido por Edson <br />\r\nEdson fez LAUDO<br />\r\nLana faturou NF 425<br />\r\nJr Fazer ART', 'junior'),
(290, 191, '2016-01-25', 'ServiÃ§o concluido por Edson<br />\r\nCliente ligou solicitando retorno do Edson para verificar alguns itens<br />\r\n', 'junior'),
(291, 191, '2016-01-25', 'ficou acertado receber o Trafo por 2.700', 'junior'),
(292, 195, '2016-01-26', 'Nao foi executado dia 23/1 devido a chuva, remarcar', 'junior'),
(293, 193, '2016-01-27', 'concluido Laudos <br />\r\nCom weliton para entregar ', 'junior'),
(294, 194, '2016-01-27', 'ART Ok<br />\r\nFaturado', 'junior'),
(295, 195, '2016-01-27', 'reprogramado para 13/02', 'junior'),
(296, 196, '2016-01-27', 'vladimir esta trabalhando nele', 'junior'),
(297, 197, '2016-01-27', 'aguardando Ana (cliente) comprar o material para programar uma data', 'junior'),
(298, 192, '2016-01-27', 'Jr: feita ART, para pagamento. Memorial pronto na Pasta de Projetos 2016', 'junior'),
(299, 192, '2016-01-28', 'ART Paga Hoje com Lana', 'junior'),
(300, 200, '2016-01-28', 'Lana Faturou 40%<br />\r\nServiÃ§o iniciado com ', 'junior'),
(301, 198, '2016-02-02', 'Adenur e Robevaldo deram previsao de concluir ate SEXTA 05/02', 'junior'),
(302, 196, '2016-02-02', 'Vladimir e Marcos forram instalar Disjuntor no local hoje', 'junior'),
(303, 200, '2016-02-02', 'dia 01 e 02 de fev parado devido a chuva', 'junior'),
(304, 200, '2016-02-05', 'Edson informou que foi concluida a parte da ELFI <br />\r\nporem o Disjuntor de MT nao estavam armando', 'junior'),
(305, 200, '2016-02-11', 'Edson fez laudo<br />\r\ne Lana faturou os ultimos 60%', 'junior'),
(306, 198, '2016-02-11', 'Edson faendo LAUDO<br />\r\nJR ART', 'junior'),
(307, 198, '2016-02-15', 'Edson mandou imprimir Laudo colorido na Eurocopias<br />\r\nART esta ronta esperando apenas Laudo<br />\r\nJr faturou hj NF 441', 'junior'),
(308, 195, '2016-02-15', 'Lana faturou NF 440<br />\r\nJr vai fazer ART<br />\r\nEdson fazer o Laudo', 'junior'),
(309, 192, '2016-02-15', '', 'junior'),
(310, 201, '2016-02-15', 'Eduardo informou q estao finalizando compra materiais <br />\r\nquerem executar esse proximo final semana 20/02', 'junior'),
(311, 202, '2016-02-18', 'realizado Madrugada de 17 para 18 de FEV<br /><br />\r\npor Alex, Edson, Marcos, Ximenes<br /><br />\r\nFalta Laudo Fisico-quimico do Ã³leo do TRAFO<br />\r\nLana Faturou NF 442', 'junior'),
(312, 195, '2016-02-22', 'Laudo concluido e entrergue <br />\r\nFAlta Laudo do Ã³leo isolante', 'junior'),
(313, 192, '2016-02-22', 'Projeto refeito, assinado por JR <br />\r\nEntregue Weliton para pegar Assinatura com Cliente e Deixar na COELCE<br />\r\n', 'junior'),
(314, 192, '2016-02-22', 'Retornou hj mesmo, pedindo para corregir o papel de Pedido de Acrescimo<br />\r\ne a funcionaria da COELCE ficou de dar entrada na AVT e enviar por email a confirmaÃ§Ã£o<br />\r\ninformaÃ§Ãµes passada pelo Marcos Motoqueiro', 'junior'),
(315, 192, '2016-02-24', 'JR> liguei, falei com Neurivania, 3453-4988, me informou q deveria ter dado entrada na AVT, entao ela o fez, mandou por email o numero da Ordem de pedido de AVT, agora Ã© esperar ate 10 dias para sair a AVT, q sÃ³ ai podemos encaminhar o projeto para a Coelce com a AVT em mÃ£os.<br />\r\nE pediu para alterar no Pedido de Acrescimo a Demanada Atual de 138 para 75 kW', 'junior'),
(316, 203, '2016-02-26', 'trafos para entrega<br />\r\nLana faturou NF 448', 'junior'),
(317, 204, '2016-02-29', 'Realizado dia 28/02 (DOM) Alex e Marcos<br />\r\nLana vai faturar dia 01/03<br />\r\n', 'junior'),
(318, 195, '2016-02-29', 'Laudo do Ã³leo ok<br />\r\nenviado por Email por JR', 'junior'),
(319, 202, '2016-02-29', 'Laudo do Ã³leo chegou, esta OK<br />\r\nfoi enviado por Email para Ricardo', 'junior'),
(320, 197, '2016-03-03', 'Eduardo falou com ela dia 01/03<br />\r\nainda aguardando a compra do material', 'junior'),
(321, 201, '2016-03-03', '- comprou material da media tensÃ£o de sp chegou hoje dia 03.03.2016 vai entra em contato para agendar o dia para executar o serviÃ§o.', 'eduardo_reboucas'),
(322, 205, '2016-03-03', '- falei com Atyla ele deixou pre agendado para dia 12.03.2016', 'eduardo_reboucas'),
(323, 207, '2016-03-03', '- falei com Atyla ele deixou pre agendado para dia 12.03.2016', 'eduardo_reboucas'),
(324, 208, '2016-03-08', 'Executado dia 08/03 pelo Vladimir e o Bruno<br />\r\nno cond. LeEssence Obra 214<br />\r\nJr fez o Laudo e ART, esperando pagamento e liberaÃ§ao ', 'junior'),
(325, 206, '2016-03-31', 'programado para dia 02 de abril', 'eduardo_reboucas'),
(326, 212, '2016-03-15', 'serviÃ§o Executado dia 13/03 por Edson Marcos,<br />\r\nJR fez o laudo no PC 15/03 com ART, aguardando pagamento<br />\r\nEduardo ainda ira enviar o Ã³leo para analise', 'junior'),
(327, 213, '2016-03-23', 'funcionÃ¡rio Bruno nÃ£o foi o mesmo que fez o levantamento deste serviÃ§o, pois ele trabalhou ontem pela noite e esta de folga hoje, nossos funcionÃ¡rios sÃ£o instruÃ­dos a negar o serviÃ§o, caso nÃ£o se sintam seguros, por se tratar do ramo da eletricidade estes sÃ£o periculosos. <br />\r\nEntÃ£o iremos falar com o funcionÃ¡rio Vladimir, que foi quem fez este levantamento em campo, e decidir a melhor forma de executar este serviÃ§o, lhe dando o desconto na nossa proposta devido a solicitaÃ§Ã£o da', 'junior'),
(328, 210, '2016-03-23', 'executado 21/03 por Vladimir <br />\r\nJR fez laudo 23/03 junto com ART<br />\r\nART para pagamento', 'junior'),
(329, 209, '2016-03-23', 'Ademir e Elvis executando ', 'junior'),
(330, 208, '2016-03-23', 'ART OK LAudo entregue dia 21/03', 'junior'),
(331, 207, '2016-03-23', 'serviÃ§o concluido MArcos Bruno dia 18/03', 'junior'),
(332, 210, '2016-03-28', 'ART OK<br />\r\n', 'junior'),
(333, 213, '2016-03-30', 'executado dia 29/03<br />\r\nVladimir<br />\r\nJr faturou NF 465', 'junior'),
(334, 192, '2016-03-31', 'programado para dia 03.04.2016 domingo', 'eduardo_reboucas'),
(335, 192, '2016-04-05', 'Projeto esta para sair dia 11/04/2016 na COelce. ', 'junior'),
(336, 201, '2016-04-05', 'executadop NACIONAL GAS<br />\r\nDIA: 03.04.2016 (DOMINGO)<br />\r\nORÃ‡AMENTO: 008/2016<br />\r\n- EDSON<br />\r\n- ALEX<br />\r\n- MARCOS<br />\r\n- VLADIMIR<br />\r\n- BRUNO<br />\r\n', 'junior'),
(337, 205, '2016-04-05', 'DIA: 02.04.2016 (SÃBADO)<br />\r\nORÃ‡AMENTOS: 029/2016   028/2016<br />\r\n<br />\r\n- EDSON<br />\r\n- XIMENES<br />\r\n- ALEX<br />\r\n- MARCOS<br />\r\n- VLADIMIR<br />\r\n- BRUNO<br />\r\n', 'junior'),
(338, 206, '2016-04-05', 'DIA: 02.04.2016 (SÃBADO)<br />\r\nORÃ‡AMENTOS: 029/2016   028/2016<br />\r\n<br />\r\n- EDSON<br />\r\n- XIMENES<br />\r\n- ALEX<br />\r\n- MARCOS<br />\r\n- VLADIMIR<br />\r\n- BRUNO<br />\r\n', 'junior'),
(339, 206, '2016-04-05', 'Edson fazendo Relatorio<br /><br />\r\nJR fazendo ART hj<br />\r\nÃ²leos para Analise, enviar', 'junior'),
(340, 205, '2016-04-05', 'Enviar amostra de Ã³leo apos serviÃ§o para Analise. Eduardo', 'junior');

-- --------------------------------------------------------

--
-- Estrutura para tabela `historico_orc_n_aprovado`
--

CREATE TABLE IF NOT EXISTS `historico_orc_n_aprovado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_orc` int(11) NOT NULL,
  `dia_do_contato` datetime NOT NULL,
  `dia_da_edicao` datetime NOT NULL,
  `id_colab` int(11) NOT NULL,
  `colab_elfi` varchar(30) NOT NULL,
...
--
-- Estrutura para tabela `link_pesquisa`
--

CREATE TABLE IF NOT EXISTS `link_pesquisa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Fazendo dump de dados para tabela `link_pesquisa`
--

INSERT INTO `link_pesquisa` (`id`, `link`) VALUES
(1, 'http://survs.com/survey/o1vvxfdk1r');
...
CREATE TABLE IF NOT EXISTS `orcamentos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `n_orc` varchar(20) NOT NULL,
  `ano_orc` int(5) NOT NULL,
  `colaborador_orc` varchar(50) NOT NULL,
  `situacao_orc` varchar(100) NOT NULL,
  `razao_social_contr` varchar(255) NOT NULL,
  `cnpj_contr` varchar(22) NOT NULL,
  `endereco_contr` varchar(255) NOT NULL,
  `bairro_contr` varchar(255) NOT NULL,
  `cidade_contr` varchar(255) NOT NULL,
  `estado_contr` varchar(255) NOT NULL,
  `cep_contr` varchar(12) NOT NULL,
  `telefone_contr` varchar(17) NOT NULL,
  `celular_contr` varchar(17) NOT NULL,
  `email_contr` varchar(255) NOT NULL,
  `contato_clint` varchar(100) NOT NULL,
  `razao_social_obra` varchar(255) NOT NULL,
  `cnpj_obra` varchar(22) NOT NULL,
  `endereco_obra` varchar(255) NOT NULL,
  `bairro_obra` varchar(255) NOT NULL,
  `cidade_obra` varchar(255) NOT NULL,
  `estado_obra` varchar(255) NOT NULL,
  `cep_obra` varchar(12) NOT NULL,
  `telefone_obra` varchar(17) NOT NULL,
  `celular_obra` varchar(17) NOT NULL,
  `email_obra` varchar(255) NOT NULL,
  `atividade` varchar(255) NOT NULL,
  `classificacao` varchar(255) NOT NULL,
  `quantidade` varchar(10) NOT NULL,
  `unidade` varchar(20) NOT NULL,
  `descricao_servico_orc` varchar(10000) NOT NULL,
  `prazo_exec_orc` varchar(10) NOT NULL,
  `validade_orc` varchar(10) NOT NULL,
  `pagamento_orc` varchar(100) NOT NULL,
  `obs_orc` varchar(500) NOT NULL,
  `duvida_orc` varchar(60) NOT NULL,
  `vr_servco_orc` varchar(15) NOT NULL,
  `vr_material_orc` varchar(15) NOT NULL,
  `desconto_orc` varchar(10) NOT NULL,
  `vr_total_orc` varchar(15) NOT NULL,
  `obra_igual_contrat` varchar(5) NOT NULL,
  `data_adicionado_orc` datetime NOT NULL,
  `data_ultima_alteracao` datetime NOT NULL,
  `colaborador_ultim_alteracao` varchar(255) NOT NULL,
  `data_aprovada` date NOT NULL,
  `data_inicio` date NOT NULL,
  `data_conclusao` date NOT NULL,
  `dias_d_aprovado` int(11) NOT NULL,
  ...
  `obs_n_conformidad` varchar(500) NOT NULL,
  `client_insatisfeito` enum('n','s') NOT NULL,
  `data_ultimo_cont_cliente` date NOT NULL,
  `colab_ultimo_contato_client` varchar(50) NOT NULL,
  `novo_cliente` enum('n','s') NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `orcamentos` (`id`, `n_orc`, `ano_orc`, `colaborador_orc`, `situacao_orc`, `razao_social_contr`, `cnpj_contr`, `endereco_contr`, `bairro_contr`, `cidade_contr`, `estado_contr`, `cep_contr`, `telefone_contr`, `celular_contr`, `email_contr`, `contato_clint`, `razao_social_obra`, `cnpj_obra`, `endereco_obra`, `bairro_obra`, `cidade_obra`, `estado_obra`, `cep_obra`, `telefone_obra`, `celular_obra`, `email_obra`, `atividade`, `classificacao`, `quantidade`, `unidade`, `descricao_servico_orc`, `prazo_exec_orc`, `validade_orc`, `pagamento_orc`, `obs_orc`, `duvida_orc`, `vr_servco_orc`, `vr_material_orc`, `desconto_orc`, `vr_total_orc`, `obra_igual_contrat`, `data_adicionado_orc`, `data_ultima_alteracao`, `colaborador_ultim_alteracao`, `data_aprovada`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `data_ultimo_cont_cliente`, `colab_ultimo_contato_client`, `novo_cliente`) VALUES
(1, '66.2013', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO SHOPPING CENTER IGUATEMI', '', '', '', '', '', '', '', '', 'rafael.silva@iguatemifortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Disjuntor', '', '', '- PROPOSTA PARA SERVICO DE INSTALACAO E MANUTENCAO CORRETIVA DE UM DISJUNTOR SIEMENS, TIPO AC3 -BRA 800A/15KV, CONFORME ABAIXO:<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO PARA IGUATEMI<br /><br /><br /><br />\r\n- RETIRADA DO VAZAMENTO DE OLEO DOS POLOS COM TROCA<br /><br /><br /><br />\r\nDE GUARNICOES DE VEDACAO LAVAGEM E TROCA DE CARGA DE<br /><br /><br /><br />\r\nOLEO DOS POLOS<br /><br /><br /><br />\r\n- REGULAGEM E LUBRIFICACAO DO C', '15', '', '', '', '', '3480.00', '', '', '3480.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-02', '2014-04-14', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(2, '64.2013', 2014, 'junior', 'Aprovado', 'BRADESCO - AGENCIA WALDEMAR DE ALCANTARA', '', '', '', '', '', '', '', '', 'lucas.branco@cw-opr.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'CONSULTORIA E VISTORIA TECNICA DE VERIFICACAO DO TAP DO TRANSFORMADOR E FORNECIMENTO DA TENSAO NA<br /><br />\r\nAGENCIA WALDEMAR DE ALCANTARA J. 0683 - SERVICO EXECUTADO DIA 04 E 06 DE JANEIRO DE 2014', '1', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-03', '2014-01-04', '2014-01-07', 0, 0, 2, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(3, '18.2013', 2014, 'junior', 'Aprovado', 'ESMALTEC S/A', '', '', '', '', '', '', '', '', 'gilson.chaves@esmaltec.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DE UMA SUBESTACAO DE 69KV, COM (02) TRANSFORMADORES DE 5.000 KVA E QUATRO SUBESTACOES DE MEDIA TENSAO EM CLASSE 15KV, ONDE ENCONTRAM-SE DISTRIBUIDOS (05) TRANSFORMADORES DE<br />\r\n1,5KVA, (03) TRANSFORMADORES 1,0KVA E (01)TRANSFORMADOR 0,5KVA.', '1', '', '', '', '', '19077.00', '', '', '19077.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-08', '2014-01-12', '2014-01-13', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(4, '1', 2014, 'junior', 'Aprovado', 'SEICOM-SERVICOS ENGENHARIA E INSTALACAO', '', '', '', '', '', '', '', '', 'julio.lima@seicom.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ABRIGADA,BLINDADA, COM UM TRANSFORMADOR DE 500KVA A SECO,DISJUNTOR DE ALTA TENSAO, CHAVES SECCIONADORAS E TRES QUADROS GERAIS DE BAIXA TENSAO, CONFORME RELACAO DE SERVICOS ABAIXO:<br /><br /><br /><br />\r\n- SERVICO DE TERMOGRAFIA ESTA INCLUSO NA PROPOSTA<br /><br /><br /><br />\r\nLOCAL DO SERVICO: CENTRAL VIVO E TELEFONIA - RUA<br /><br /><br /><br />\r\nGONCALVES LEDO NÂ° 911 - PRAIA DE IRACEMA - 085-81670305', '5', '', '', '', '', '2700.00', '', '', '2700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-13', '2014-02-22', '2014-02-24', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(5, '068.2014', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'MANUTENCAO CORRETIVA NO SISTEMA DE PARA-RAIOS (SPDA) DOS SEGUINTES BRINQUEDOS:<br /><br /><br />\r\n- RAMU-BRINCAR<br /><br /><br />\r\n- ARREPIOS<br /><br /><br />\r\n- INSANO<br /><br /><br />\r\nNO RAMU-BRINCAR E NO ARREPIOS SERA FEITA UMA MALHA DE TERRA PARA CADA.<br /><br /><br />\r\nMATERIAL FONECIDO PELA ELFI.<br /><br /><br />\r\nSERVICO REALIZADO EM ALTURA COM PESSOAL DE RAPEL.', '10', '', '', '', '', '13470.00', '', '', '13470.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-15', '2014-01-22', '2014-05-16', 0, 0, 105, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(6, '18', 2014, 'junior', 'Aprovado', 'BANCO BRADESCO AG Montese J. 1379', '', '', '', '', '', '', '', '', 'guilherme.lopes@cw-opr.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'SERVICO DE TROCA DE TAP DO TRANSFORMADOR DA SUBESTACAO PARA AJUSTE DE TENSAO CONFORME SOLICITADO POR EMAIL<br /><br />\r\nCHAMADO: 07838975<br /><br />\r\nAGENCIA: MONTESE URB. FORTALEZA<br /><br />\r\nJUNCAO: 1379', '1', '', '', '', '', '1180.00', '', '', '1180.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-21', '2014-01-25', '2014-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(7, '17', 2014, 'junior', 'Aprovado', 'YPIOCA AGROINDUSTRIAL LTDA', '', '', '', '', '', '', '', '', 'hipolito.alves@ypioca.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', '- MANUTENCAO CORRETIVA EM UM TRASFORMADOR DE 225KVA NÂ° 120.527, CONFORME DESCRICAO ABAIXO.<br /><br />\r\n- RELACAO DE SERVICOS:<br />\r\n- TRANSPORTE CAMINHAO MUCK PARA PEGAR E LEVAR DE VOLTA PARA INDUSTRIA EM PARAIPABA<br />\r\n- DESENCAIXOTAMENTO<br />\r\n- SUBISTITUICAO DE 1 COLUNA DE ALTA TENSAO "H2"<br />\r\n- SECAGEM DA PARTE ATIVA EM ESTUFA<br />\r\n- TROCA DE TODAS GUARNICOES E VEDACOES<br />\r\n- TRATAMENTO DAS PECAS OXIDADAS', '20', '', '', '', '', '4000.00', '', '', '4000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-22', '2014-01-25', '2014-01-30', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(8, '2', 2014, 'junior', 'Aprovado', 'ADEL COCO BRASIL', '', '', '', '', '', '', '', '', 'compras@adelcoco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Aterramento', '', '', '- INSTALACAO DE ATERRAMENTO COM MALHA EM UM TANQUE CONFORME ESBOCO FORNECIDO POR EMAIL.<br /><br /><br /><br /><br />\r\n- MATERIAL FORNECIDO PELA ELFI<br /><br /><br /><br /><br />\r\n- MEDICAO DO ATERRAENTO COM FORNECIMENTO DE LAUDO E ART DO CREA.<br /><br /><br /><br /><br />\r\n- LOCAL: TRAIRI-CE', '2', '', '', '', '', '2980.00', '', '', '2980.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-24', '2014-01-28', '2014-01-28', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(9, '22', 2014, 'junior', 'Aprovado', 'OSASUNA PARTICIPACOES LTDA', '', '', '', '', '', '', '', '', 'ivon@jangadeirotextil.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'SERVICO EMERGENCIAL EXECUTADO DIA 27/01/2014 AS 09:00:<br /><br /><br />\r\nLOCAL: JANGADEIRO TEXTIL,<br /><br /><br />\r\nEQUIPAMENTO: SUBESTACAO DE ENERGIA DE 150 KVA AEREA<br /><br /><br />\r\nMOTIVO: CURTO-CIRCUITO, QUEIMA DAS "CANELAS" DAS<br /><br /><br />\r\nCHAVES SECCIONADORAS UNIPOLARES.<br /><br /><br />\r\nREPARO: REALIZADA A TROCA DOS ELOS FUSIVEIS, FEITO UMA<br /><br /><br />\r\nLIMPEZA NAS BUCHAS COM REAPERTO DAS CONEXOES DO<br /><br /><br />\r\nTRANSFORMADOR.', '1', '', '', '', '', '646.00', '', '', '646.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-27', '2014-01-27', '2014-01-27', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(10, '9', 2014, 'junior', 'Aprovado', 'DOM PASTEL SELF-SERVICE LTDA-ME', '', '', '', '', '', '', '', '', 'marconisantana1@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA REALIZAR A ETAPA DE INSTERLIGACAO DA SE-300KVA (NOVA) COM O NOVO QGBT, INTERLIGAR O NOVO<br /><br /><br /><br />\r\nQGBT COM O QDF (EXISTENTE DA SE-112,5KVA - GERADOR), PARA PODER DESATIVAR A SUBESTACAO ANTIGA.', '5', '', '', '', '', '3000.00', '', '', '3000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-30', '2014-02-03', '2014-02-18', 0, 0, 11, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(11, '25', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'MATERIAL FORNECIDO DIA 28/JAN/14 PARA SERVICO BEACH GRILL - OS 23.2013 DA ELFI, ONDE ESTE SO COBRI MAO DE<br /><br /><br />\r\nOBRA.<br /><br /><br />\r\n- ABRACADEIRAS CHAVETA<br /><br /><br />\r\n- COND. ALUM. 02<br /><br /><br />\r\n- CABO FLEX 1KV 2X1,5MM<br /><br /><br />\r\n- TERM. PRESSAO 240MM<br /><br /><br />\r\n- PARAFUSOS CAB. PAN AA<br /><br /><br />\r\n- TOMADA 2P+T P/ CONDULETE<br /><br /><br />\r\n- TERM. PRESSAO 400MM<br /><br /><br />\r\n- ACESSORIOS', '1', '', '', '', '', '450.00', '', '', '450.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-01-28', '2014-01-28', '2014-01-31', 8, 0, 2, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(12, '30', 2014, 'junior', 'Aprovado', 'CONDOMINIO LIVING', '', '', '', '', '', '', '', '', 'jcamelo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'SERVICO DE TROCA DE TAP DO TRANSFORMADOR DA SUBESTACAO PARA AJUSTE DE TENSAO, SE Cond. Living', '1', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-07', '2014-02-07', '2014-02-07', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(13, '29', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'abatista@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'REALIZAR TESTE DE RESISTENCIA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA<br /><br /><br /><br />\r\nSPDA. COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM ART DO CREA-CE.<br /><br /><br /><br />\r\nLOCAL: SESC CRATO-CE; DISTANCIA: 1050 KM ( IDA E VOLTA), APROXIMADO 08 HORAS DE VIAGEM.<br /><br /><br /><br />\r\n', '2', '', '', '', '', '1810.00', '', '', '1810.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-07', '2014-02-14', '2014-02-14', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(14, '24', 2014, 'junior', 'Aprovado', 'INVESTAR HOTELARIA S/A', '', '', '', '', '', '', '', '', 'infra.fortaleza@bluetree.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENÃ‡ÃƒO PREVENTIVA DA SUBESTAÃ‡ÃƒO ABRIGADA COM DOIS TRANSFORMADORES A SECO DE 500KVA, DISJUNTOR DE MEDIA TENSÃƒO, CHAVES SECCIONADORAS E QUADRO GERAL DE BAIXA TENSÃƒO.', '3', '', '', '', '', '1500.00', '', '', '1500.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-12', '2014-02-26', '2014-02-27', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(15, '44.2013', 2014, '', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'ednardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamento SubestaÃ§Ã£o', '', '', 'TROCA DA CHAVE SECCIONADORA TRIPOLAR DE 15 VK, 400 A, DO ITEM "A" DO RELATORIO. (Abertura com Carga)', '1', '', '', '', '', '2100.00', '', '', '2100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-19', '2014-02-25', '2014-02-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(16, '27', 2014, '', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'ednardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SPDA', '', '', 'FORNECIMENTO DE MATERIAIS PARA MANUTENCAO CORRETIVA NO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS (SPDA) DO HOTEL MARIUBA', '1', '', '', '', '', '1841.00', '', '', '1841.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-19', '2014-02-25', '2014-02-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(17, '51', 2014, 'junior', 'Aprovado', 'OSASUNA PARTICIPACOES LTDA', '', '', '', '', '', '', '', '', 'ivon@jangadeirotextil.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA BLINDADA COM TRES TRANSFORMADORES DE 1000KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS E UMA SUBESTACAO AEREA DE 225 KVA, CONFORME DESCRICAO DOS SERVICOS EM ANEXO<br /><br /><br /><br />\r\nCOM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA-CE.', '5', '', '', '', '', '4239.00', '', '', '4239.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-20', '2014-03-04', '2014-03-10', 0, 0, 1, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(18, '35', 2014, 'junior', 'Aprovado', 'CONSTRUTORA GRANITO LTDA', '', '', '', '', '', '', '', '', 'compras@granito.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '00ESTAMOS PASSANDO PROPOSTA DE MAO DE OBRA PARA FAZER AMPLIACAO DA PARTE ELETRICA DE MEDIA TENSAO, 15KV, COM INSTALACAO DO CUBICULO DE ENTRADA DE ENERGIA 15KV,(DISJUNTOR, CHAVE, ISOLADORES, BARRAMENTO, ETC), TROCA DOS CABOS DA REDE AEREA TRIFASICA EM ALUMINIO 1/0AWG, COM EXTENSAO APROXIMADO DE 270M, DESCONEXAO DOS CABOS DE MEDIA TENSAO QUE ALIMENTA OS TRANSFORMADORES E INSTALAR UM BAYPASS PROVISORIO ENQUANTO OS NOVOS CUBICULOS METALICOS SAO INSTALADOS. E INTERLIGACAO DOS CABOS DE BAIXA TENSAO DO', '45', '', '', '', '', '55000.00', '', '', '55000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-18', '2014-04-15', '2014-06-15', 9, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(19, '46', 2014, 'junior', 'Aprovado', 'CONSTRUTORA GRANITO LTDA', '', '', '', '', '', '', '', '', 'compras@granito.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'Projeto e INSTALACAO DE UMA SUBESTACAO AEREA DE 112,5KVA EM CASCAVEL-CE<br /><br /><br /><br />\r\n', '45', '', '', '', '', '6000.00', '', '', '6000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-24', '2014-03-18', '2014-05-18', 3, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(20, '56', 2014, 'junior', 'Aprovado', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', '', '', '', '', '', '', '', '', 'marliete@mrhgestao.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'NSTALACAO DE DOIS FUSIVEL PARA O TP, FORNECIDOS PELA MRH.<br /><br /><br /><br /><br />\r\n- INSTALACAO DE DOIS FUSIVEL DE 15KV NO TRANSFORMADOR DE POTENCIA DENTRO DA SUBESTACAO<br /><br /><br /><br /><br />\r\n- TROCA DE UM NOBREAK E DE UMA FONTE CAPACITIVA DA SUBESTACAO, DENTRO DO CONTRATO<br /><br /><br /><br /><br />\r\n- PROGRAMACAO DO SERVICO PARA O DIA 09.03.2014, DEPOIS DA APROVACAO DA PROPOSTA', '1', '', '', '', '', '660.00', '', '', '660.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-02-28', '2014-03-16', '2014-03-18', 0, 0, 1, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(21, '53', 2014, 'junior', 'Aprovado', 'BANCO CENTRAL DO BRASIL - BACEN', '', '', '', '', '', '', '', '', 'nero.torres@bcb.gov.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Gerador', '', '', 'SERVICO - REVISAO/INSPECAO GERAL DO GRUPO GERADOR COM FORNECIMENTO DE PECAS:<br /><br /><br /><br />\r\n2891 BICO INJETORES 6,00<br /><br /><br /><br />\r\n2892 UNIAO FLEXIVEL DE ACO 6 X 350MM 1,00<br /><br /><br /><br />\r\n2893 SUPORTE DE FERRO P/ FIXACAO DA DESCARGA 1,00<br /><br /><br /><br />\r\n2894 FLANGE DE ACOPLAMENTO DA DESCARGA 2,00<br /><br /><br /><br />\r\n2895 PARABOLT DE 9/16" X 3" 4,00', '20', '', '', '', '', '12530.00', '', '', '12530.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-05', '2014-03-06', '2014-03-10', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(22, '61.2013', 2014, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'allysson_mesquita@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'INSTALACAO DE 02 DISJUNTORES TIPO CAIXA MOLDADA DE 175 1,00 4.860,00 4.860,00<br /><br /><br />\r\nA 250A AJUSTAVEL, TRIFASICO, PARA ALIMENTAR OS<br /><br /><br />\r\nCOMPRESSORES NA UNIDADE DO IJF.<br /><br /><br />\r\nMATERIAL FORNECIDO PELA ELFI:<br /><br /><br />\r\n- 02 UND DISJUNTOR TRIPOLAR AJUSTAVEL 175-250A, CAIXA<br /><br /><br />\r\nMOLDADA<br /><br /><br />\r\n- 12 UND TERMINAL DE COMPRESSAO PARA CABO 120MMÂ²<br /><br /><br />\r\n- 12 M CABO ISOLADO 120MM 1KV', '1', '', '', '', '', '4860.00', '', '', '4860.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-07', '2014-03-12', '2014-03-13', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(23, '62', 2014, 'junior', 'Aprovado', 'BRADESCO AG. SENADOR POMPEU', '', '', '', '', '', '', '', '', '0678.gerencia@bradesco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO DA SUBESTACAO ABRIGADA DE 225KVA, DA AGENCIA SENADOR POMPEU ONDE SE REALIZADO O SERVICOS', '2', '', '', '', '', '2600.00', '', '', '2600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-07', '2014-03-08', '2014-03-10', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(24, '65', 2014, 'junior', 'Aprovado', 'DOM PASTEL SELF-SERVICE LTDA-ME', '', '', '', '', '', '', '', '', 'marconisantana1@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA INSTALACAO DE SUBESTACAO DE 300KVA, 1,00 8.680,00 8.680,00<br /><br /><br />\r\nCONFORME DESCRICAO DOS SERVICOS ABAIXO:<br /><br /><br />\r\n- DESMONTAGEM DA SUBESTACAO DE 300KVA (NOVA) E<br /><br /><br />\r\nINSTALAR EM OUTRO LOCAL AO LADO DE SE-112,5KVA<br /><br /><br />\r\n(EXISTENTE)<br /><br /><br />\r\n- REMOCAO DA SE- 112,5KVA PARA INSTALACAO DA SE-300KVA<br /><br /><br />\r\n(NOVA)<br /><br /><br />\r\n- INSTERLIGACAO DA SE-300KVA COM O NOVO QGBT<br /><br /><br />\r\n- ALUGUEL DE CAMINHA', '5', '', '', '', '', '7500.00', '', '', '7500.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-12', '2014-03-28', '2014-03-29', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(25, '73', 2014, 'junior', 'Aprovado', 'INVESTAR HOTELARIA S/A', '', '', '', '', '', '', '', '', 'infra.fortaleza@bluetree.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'MEDICAO E INSPECAO DO SPDA COM LAUDO TECNICO E ART EM UM TOTAL DE TRES DESCIDAS.', '2', '', '', '', '', '1100.00', '', '', '1100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-18', '2014-03-18', '2014-03-20', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(26, '77', 2014, '', 'Aprovado', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', '', '', '', '', '', '', '', '', 'josegilmar@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Banco de Capacitores', '', '', 'INSTALACAO DE BANCO CAPCITOR DE 25KVR EM 440V SEMI-AUTOMATICO NA SUBESTACAO.', '5', '', '', '', '', '3150.00', '', '', '3150.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-24', '2014-03-26', '2014-03-02', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(27, '87', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACAO EM CARATER DE EMERGENCIAL DE 3 TERMINAIS DE COMPRESSAO DE 400MM, E ISOLAMENTO COM FITA DE AUTA FUSAO, PARTE DOS CABOS DANIFICADOS. ESTE TRABALHO FOI REALIZADO NO DIA 29 E 30/03/2014, AS 18 HORAS AS 3:00 DA MADRUGADA POR UMA EQUIPE DE QUATRO TECNICOS DA ELFI. O LOCAL DO SERVICO FOI REALIZADO NA CASA DE MAQUINA DA ARCA DE NOE.', '1', '', '', '', '', '2380.00', '', '', '2380.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-03-29', '2014-03-29', '2014-03-29', 4, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(28, '86', 2014, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'francisco.aves@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA INSTALACAO DE 3 CHAVES FUSIVEIS UNIPOLAR 400A,25KV COM 3 ELO FUSIVEL 50K, NO POSTE DO RAMAL DE ENTRADA DA SUBESTACAO DE 90KVA.', '1', '', '', '', '', '1620.00', '', '', '1620.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-08', '2014-04-13', '2014-04-13', 2, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(29, '93', 2014, 'junior', 'Aprovado', 'CONSORCIO CETENCO ENGENHARIA', '', '', '', '', '', '', '', '', 'rialto.ibanez.mira@acciona.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'SERVICO DE MEDICAO RESISTENCIA OHMICA DE ATERRAMENTO EM 20 CONTAINERS E 2 GRUPOS GERADORES SENDO UM DE 180KVA E OUTRO DE 100KVA. COM EMISSAO DE LAUDO COM ART DO CREA-CE', '4', '', '', '', '', '1700.00', '', '', '1700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-11', '2014-04-16', '2014-04-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(30, '88', 2014, 'junior', 'Aprovado', 'STL INFORMATICA LTDA ', '', '', '', '', '', '', '', '', 'nunes@stl.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO.', '1', '', '', '', '', '1467.00', '', '', '1467.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-11', '2014-05-24', '2014-05-25', 3, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(31, '94', 2014, 'junior', 'Aprovado', 'EMERSON NETWORK POWER DO BRASIL LTDA', '', '', '', '', '', '', '', '', 'antonio.glayton@emerson.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'MEDICAO DA RESISTENCIA OHMICA DO ATERRAMENTO EM 09 (NOVE) PONTOS COM EMISSAO DE ART DO CREA E LAUDO TECNICO.', '1', '', '', '', '', '800.00', '', '', '800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-16', '2014-04-16', '2014-04-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(32, '101', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', 'INSTALACAO DE UM GRUPO GERADOR PROVISORIO COM INTERLIGACAO DOS CABOS NO BARRAMENTO DE EMERGENCIA DA USCA (APOS O SERVICO SERA REALIZADO TESTE).', '2', '', '', '', '', '1605.00', '', '', '1605.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-17', '2014-04-17', '2014-04-18', 5, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(33, '102', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Plantonista', '', '', '- LOCACAO HOMEM X HORA DE UM ELETRECISTA PLANTONISTA NO PERIODO DE 15 DIAS PARA ACIONAMENTO DO GERADOR (VALOR DO HOMEM X HORA)', '30', '', '', '', '', '25.00', '', '', '25.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-17', '2014-04-17', '2014-05-13', 5, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(34, '40', 2014, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'gustavo_oliveira@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACAO COM MODERNIZACAO DE UM QUADRO DE COMANDO PARA ACIONAMENTO DAS BOMBAS COM INTERTRAVAMENTO DAS MESMAS ATRAVES DE SOFT-STARTER. COM FORNECIMENTO DE TODO MATERIAL PELA ELFI. NOTA: SERA FORNECIDO DIAGRAMA UNIFILAR DO QUADRO', '6', '', '', '', '', '23507.00', '', '', '23507.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-24', '2014-05-05', '2014-05-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(35, '98', 2014, 'junior', 'Aprovado', 'AGROPAULO AGROINDUSTRIAL S.A', '', '', '', '', '', '', '', '', 'bruno.rafael@agropaulo.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', 'MANUTENCAO DE UM TRANSFORMADOR DE 750KVA NÂ° BI47/78 FABRICACAO INOUSELET, ANO DE FABRICACAO 1978, SEGUE ABAIXO RELACAO DE SERVICO:<br /><br /><br /><br />\r\n- RECUPERACAO DE FIO PARTIDO NA DERIVACAO DA COLUNA H2<br /><br /><br /><br />\r\n- DESENCAIXOTAMENTO DA PARTE ATIVA;<br /><br /><br /><br />\r\n- PINTURA GERAL DA CAIXA, TAMPA E RADIADORES;<br /><br /><br /><br />\r\n- RETIRADA DE VAZAMENTO COM A TROCA DE TODAS AS GUARNICOES DE VEDACOES;<br /><br /><br /><br />\r\n- TRATAR E COMPLETAR O OLEO ISOLAN', '15', '', '', '', '', '3676.00', '', '', '3676.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-24', '2014-04-16', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(36, '82', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- PROPOSTA PARA INSTALACAO DE REDE ELETRICA PARA FAZER CORRECAO NUM CIRCUITO ELETRICO COM SUBISTITUICAO DOS<br /><br /><br />\r\nCABOS QUE SE ENCONTRA EXPOSTO E PASSA NOVA FIACAO NA TUBULACAO PARA ALIMENTACAO DE DOIS PAINEIS DA ADMINISTRACAO.<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELO BEACH PARK<br /><br /><br />\r\nABAIXO:<br /><br /><br />\r\n- 60 MT CABO FLEX 1KV 50MM<br /><br /><br />\r\n- 15 UND LUNA DE COMPRESSAO PARA CABO DE 50MM<br /><br /><br />\r\n- 02 UND FITA ISOLANTE DE BAIXA TEN', '1', '', '', '', '', '2640.00', '', '', '2640.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-15', '2014-04-25', '2014-04-25', 10, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(37, '106', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DA SUBESTACAO DE 500KVA DA UNIDADE SESC CENTRO: LIMPEZA DOS CUBICULOS INCLUINDO TRANSFORMADORES DE CORRENTES, DISJUNTORES, CHAVE SECCIONADORA, QUADRO GERAL, MEDICAO DE RESISTENCIA DE ISOLAMENTO DO TRANSFORMADOR, CONFORME RELACAO DE SERVICOS EM ANEXO.', '13', '', '', '', '', '1600.00', '', '', '1600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-25', '2014-05-10', '2014-05-15', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(38, '116', 2014, 'junior', 'Aprovado', 'SUPERINTENDENCIA REG. DO TRAB. E EMPREGO - SRTE-CE', '', '', '', '', '', '', '', '', 'arnaldo.amaral@mte.gov.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACAO DE UM DISJUNTOR TRIFASICO DE 250A, COM CABIACAO, TERMINAIS FITAS ISOLANTES ETC', '1', '', '', '', '', '1400.00', '', '', '1400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-28', '2014-04-28', '2014-04-29', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(39, '60', 2014, 'junior', 'Aprovado', 'EMPRESA BRASILEIRA DE BEBIDAS E ALIMENTOS S/A', '', '', '', '', '', '', '', '', 'rebeca.correia@ebba.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SPDA', '', '', 'SERVICOS DE ADEQUACAO E INSTALACAO DO SISTEMA PROTECAO CONTRA DESCARGA ATMOSFERICAS (S.P.D.A) NOS PREDIOS DA EBBA, CONFORME ESCOPO DE SERVICOS FORNECIDOS COM PROJETO E RELACAO DE MATERIAS. <br /><br /><br />\r\nNOTA: MATERIAL FORNECIDO PELA EBBA, CONFORME RELACAO QUE SEGUE EM ANEXO. NO MODELO DA EBBA.', '20', '', '', '', '', '39000.00', '', '', '39000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-30', '2014-06-09', '2014-10-16', 2, 0, 109, 's', 'n', 'n', '', 'n', '0000-00-00', '', 's'),
(40, '96', 2014, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'francisco.alves@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'INSTALACAO DE MEDIDOR DE GRANDEZAS ELETRICAS EM TRES TRANSFORMADORES DE 300KVA, POR UM PERIODO DE 24 HORAS EM CADA TRAFO ( DIAS UTEIS ), PARA ANALISAR A QUALIDADE DE ENERGIA NO SISTEMA FIC; ONDE SERA FORNECIDO RELATORIO COM OS VALORES DE : POTENCIA ATIVA E REATIVA ENTRE FASES - CORRENTE POR FASE PARA ANALISAR POSSIVEIS ESBALANCIAMENTOS MEDICAO DE FATOR DE POTENCIA.', '6', '', '', '', '', '3360.00', '', '', '3360.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-08', '2014-05-12', '2014-05-22', 0, 0, 4, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(41, '97', 2014, 'junior', 'Aprovado', 'CONSTRUTORA GRANITO LTDA', '', '', '', '', '', '', '', '', 'orcamento@granito.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA INSTALACAO DE UMA SUBESTACAO AEREA DE 45 KVA, COM PROJETO APROVADO NA COELCE NO MUNICIPIO DE ALTO SANTO - CE.<br /><br /><br />\r\n- PROJETO COM MAO DE OBRA PARA INSTALACAO', '30', '', '', '', '', '7690.00', '', '', '7690.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-04-15', '2014-05-05', '2014-08-05', 23, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(42, '74', 2014, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'evandro.alves@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACAO DE 03 PROJETORES NA AREA AMINISTRATIVA, PARTE EXTERNA E NO ESTACIONAMENTO. TODO MATERIAL FORNECIDO PELA STOCKTECH.', '3', '', '', '', '', '1480.00', '', '', '1480.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-09', '2014-05-19', '2014-05-22', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(43, '122', 2014, 'junior', 'Aprovado', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '', '', '', '', '', 'wellington@cdlfor.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '- MANUTENCAO PREVENTIVA NA SUBESTACAO ABRIGADA E CORRETIVA:<br /><br /><br /><br /><br />\r\n- REALIZAR A TROCA DA CARGA DE OLEO ISOLANTE DO TRAFO DE 225KVA, NÂ° 122026<br /><br /><br /><br /><br />\r\n- MANUTENCAO PREVENTIVA DA SUBESTACAO CONFORME RELACAO DE SERVICO ABAIXO (BANCO CAPACITOR JA INCLUSO)', '2', '', '', '', '', '4084.00', '', '', '4084.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-12', '2014-05-25', '2014-05-26', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(44, '123', 2014, 'junior', 'Aprovado', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '', '', '', '', '', 'wellington@cdlfor.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO DA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA-CE.', '2', '', '', '', '', '1100.00', '', '', '1100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-12', '2014-05-14', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(45, '134', 2014, 'junior', 'Aprovado', 'MANSERV MONTAGEM E MANUTENCAO S/A', '', '', '', '', '', '', '', '', 'admfort@br.ibm.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'MEDEICAO DE ATERRAMENTO EM UM PONTO DE TOMADA, NO SEGUNDO ANDAR DO EDIFICIO POTENZA, SALA 212 A 215. SERA EMITIDO LAUDO COM ART DO CREA-CE.', '1', '', '', '', '', '600.00', '', '', '600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-16', '2014-05-16', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(46, '44', 2014, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'valdair.souza@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA EM UMA SUBESTACAO ABRIGADA COM UM TRAFO DE 1.000 KVA, DISJUNTOR DE MEDIA TENSAO, QGBT E BANCO CAPACITORES, CONFORME RELACAO DE SERVICOS ABAIXO:', '18', '', '', '', '', '2413.00', '', '', '2413.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-16', '2014-05-25', '2014-06-12', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(47, '45', 2014, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'valdair.souza@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO, COM A CONCLUSAO SERA REMETIDO RELATORIO TECNICO E ART DO CREA-CE.', '3', '', '', '', '', '1000.00', '', '', '1000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-16', '2014-05-21', '2014-05-22', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(48, '141', 2014, 'junior', 'Aprovado', 'CONDOMINIO LIVING', '', '', '', '', '', '', '', '', 'gustavopereira@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MANUTENCAO PREVENTIVA EM UM QUADRO DE DISTRIBUICAO DO CONDOMINIO PARA RETIRADA DE INFILTRACAO DE AGUA NA TUBULACAO E LIMPEZA COM RETIRADA DE AGUA E AREIA DENTRO DO QUADRO.', '1', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-16', '2014-05-16', '2014-05-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(49, '153', 2014, 'junior', 'Aprovado', 'INVESTAR HOTELARIA S/A', '', '', '', '', '', '', '', '', 'infra.fortaleza@bluetree.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENÃ‡ÃƒO CORRETIVA NA SUBESTAÃ‡ÃƒO PARA MUDANÃ‡A D TAP EM 2 TRAFOS A SECO, TROCA DE 03 CHAVES FUSIVEIS  FORNECIDOS PELO CLIENTE.', '1', '', '', '', '', '1480.00', '', '', '1480.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-28', '2014-05-29', '2014-05-29', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(50, '160', 2014, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', 'INSTALACAO DE UM GRUPO GERADOR ALUGADO COM INTERLIGACAO DOS CABOS DO QUADRO GERAL DE EMERGENCIA (QTA).', '1', '', '', '', '', '2124.00', '', '', '2124.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-02', '2014-06-03', '2014-06-03', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(51, '159', 2014, 'junior', 'Aprovado', 'SANTANA TEXTIL S/A', '', '', '', '', '', '', '', '', 'andre@santanatextiles.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA INSPECAO E MEDICAO DE RESISTENCIA OHMICA DOS PONTOS DE ATERRAMENTOS RELACIONADOS ABAIXO. COM A CONCLUSAO SERA FORNECIDO LAUDO COM ART.<br /><br /><br />\r\n- PIT STOP - CAIXA D"AGUA - GALPAO DA CALDEIRA P1 - GALPAO DA CALDEIRA P2 - GALPAO DA CALDEIRA P3 - GALPAO DE QUIMICA - GALPAO DA TECELAGEM - GALPAO DO COMPRESSOR - GALPAO DA FIACAO - GALPAO DA TECELAGEM/ACABAMENTO - ADMINISTRACAO - REFEITORIO', '3', '', '', '', '', '1890.00', '', '', '1890.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-10', '2014-06-06', '2014-06-09', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(52, '161', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'carlosdias@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO CORRETIVA NA SUBESTACAO ELETRICA COM TROCA DE 01 ISOLADOR PEDESTAL 15KV E UM CAPACITOR TRIFASICO DE 20 KVAR EM 440V. ', '1', '', '', '', '', '1378.00', '', '', '1378.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-10', '2014-06-30', '2014-06-30', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(53, '173', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA MEDICAO DE MALHA DE ATERRAMENTO NOS QUADROS DE MAQUINA DOS MOTORES. NUM TOTAL DE 19 PAINES.', '5', '', '', '', '', '2592.00', '', '', '2592.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-11', '2014-06-16', '2014-06-20', 5, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(54, '140', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'MANUTENCAO PREVENTIVA E CORRETIVACOM REPOSICAO DE PECAS, COM TESTE DE RESISTIVIDADE DO SISTEMA DE UN 4 PROTECAO CONTRA DESCARGAS ATMOSFERICAS - SPDA<br /><br /><br /><br />\r\nLOCAL: HOTEL - SESC IPARANA * COM EMISAO DE LAUDO TECNICO E EMISSAO DE ART DO SERVICO REALIZADO<br /><br /><br /><br />\r\n1,00 512,00 512,00- MANUTENCAO PREVENTIVA E CORRETIVA COM REPOSICAO DE PECAS, COM TESTE DE RESISTIVIDADE DO SISTEMA DE UN 1 PROTECAO CONTRA DESCARGAS ATMOSFERICAS - SPDA<br /><br /><br /><br />\r\nLOCAL: TOR', '2', '', '', '', '', '3030.00', '', '', '3030.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-24', '2014-06-10', '2014-06-29', 0, 0, 17, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(55, '164', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ednardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'ManutenÃ§Ã£o corretiva no SPDA<br /><br /><br /><br />\r\nLocal:  MAriuba', '5', '', '', '', '', '3224.00', '', '', '3224.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-24', '2014-07-01', '2014-07-03', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(56, '170', 2014, 'junior', 'Aprovado', 'ALAMO ENGENHARIA S/A ', '', '', '', '', '', '', '', '', 'adm2.vivoba@alamoengenharia.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'CONFORME SOLICITADO ESTAMOS APRESENTADO PROPOSTA PARA INSPECAO DO SPDA E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTA DESCARGAS ATMOSFERICAS DO PREDIO DA ALAMO ENGENHARIA.COM A CONCLUSAO SERA REMETIDO LAUDO TECNICO E ART DO CREA-CE', '1', '', '', '', '', '1498.00', '', '', '1498.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-18', '2014-06-18', '2014-06-19', 7, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(57, '172', 2014, 'junior', 'Aprovado', 'EMERSON NETWORK POWER DO BRASIL LTDA', '', '', '', '', '', '', '', '', 'Antonio.Glayton@Emerson.com', '', '', '', '', '', '', '', '', '', '', '', 'InspeÃ§Ã£o', 'TermovisÃ£o', '', '', ' ORCAMENTO PARA ANALISE TERMOGRAFICA DOS SEGUINTES EQUIPAMENTOS: SUBESTACAO, QUADRO DO BANCO CAPACITOR, QUADRO CHILLER, QCA, QDGE, CHAVES AT, TRANSFORMADOR E DISJUNTOR DE MEDIA TENSAO. COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM ART', '2', '', '', '', '', '1360.00', '', '', '1360.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-18', '2014-06-18', '2014-06-20', 7, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(58, '165', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'abatista@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA INSPECAO E MEDICAO DE RESISTENCIA OHMICA MALHA DE ATERRAMENTO NA UNIDADE EDUCAR - SESC FORTALEZA. COM A CONCLUSAO SERA FORNECIDO RELATORIO COM ART.', '5', '', '', '', '', '980.00', '', '', '980.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-09', '2014-06-10', '2014-06-15', 16, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(59, '186', 2014, 'junior', 'Aprovado', 'BERACA SABARA QUIMICOS E INGREDIENTES S/A', '', '', '', '', '', '', '', '', 'joao.batista@beraca.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'SERVICO DE MEDICAO E INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICAS (SPDA) COM EMISSAO DE LAUDO ART-CREA', '2', '', '', '', '', '1050.00', '', '', '1050.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-26', '2014-06-27', '2014-06-27', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(60, '138', 2014, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '00SERVICOS PARA MANUTENCAO DE UMA SUBESTACAO ABRIGADA: - COM QUATRO TRANSFORMADORES, SENDO UM TR-112,5KVA DOIS TR - 300KVA E UM 500KVA A SECO, - COM DISJUNTOR DE ALTA TENSAO ALTONS E - DOIS QUADROS GERAIS DE BAIXA TENSAO E - DE UMA SUBESTACAO AEREA DE 150 KVA DA LAVANDERIA', '12', '', '', '', '', '6000.00', '', '', '6000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-20', '2014-08-02', '2014-08-06', 37, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(61, '139', 2014, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'TRATAMENTO TERMO-VACUO EM 03 TRANFORMADORES DA SE-01, UM DE 112,5KVA E DOIS DE 300KVA, PARA CORRIGIR TEOR DE AGUA E RIGIDEZ E DIELETRICA DOS MESMOS. APOS TRATAMENTO SERA FEITA NOVA ANALISE DE OLEO ISOLANTE<br /><br />\r\n<br /><br />\r\n00NO TRAFO DE 150KVA, "SE" LAVANDERIA , NAO E POSSIVEL FAZER TRATAMENTO TERMO-VACUO POR SEREM POSTE, RECOMENDAMOS TROCAR CARGA DE OLEO', '2', '', '', '', '', '5365.00', '', '', '5365.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-27', '2014-05-27', '2014-05-27', 30, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(62, '31', 2014, 'junior', 'Aprovado', 'ADEL COCO BRASIL', '', '', '', '', '', '', '', '', 'compras@adelcoco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '00MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA COM 02 TRAFOS DE 300KVA, CHAVES SECCIONADORAS, TRES QUADROS GERAIS DE BAIXA TENSAO E DISJUNTOR DE MEDIA TENSAO.<br /><br />\r\nNOTA: SERVICO SERA REALIZADO EM APENAS 01 TRANSFORMADOR.<br /><br />\r\n<br /><br />\r\n00ANALISE DO OLEO ISOLATE FISICO-QUIMICO EM 01 TRANSFORMADO', '12', '', '', '', '', '2800.00', '', '', '2800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-01', '2014-06-01', '2014-06-01', 25, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(63, '83', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA INSTALACAO DOS CABOS SUBITERANEO DA SUBESTACAO AEREA DE 112,5KVA (EXISTENTE ) DA ESTACAO DE TRATAMENTO DE ESGOTO, PARTINDO DO QUADRO DE PROTECAO ATE O QGBT. TUBULACAO EXISTENTE.<br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELO BEACH PARK ABAIXO:<br /><br />\r\n- 320 MT CABO FLEX DE 70MM 1KV - 100 MT CABO FLEX 35MM 1 KV (VERDE) - 100 MT CABO FLEX 35MM 1 KV (AZUL) - 06 UND TERMINAL DE COMPRESSAO PARA CABO 70MM - 06 UND TERMINAL DE COMPRESSAO PARA CABO 35MM - 02 UND FITA DE BAIXA TENSA', '4', '', '', '', '', '3240.00', '', '', '3240.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-05-21', '2014-05-21', '2014-05-21', 36, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(64, '166', 2014, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'poliana_costa@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'CONFORME A NECESSIDADE DE ACRESCIMO DE MAIS DOIS MOTORES, NA PROPOSTA JA APROVADA DE NÂ° 40/14 E PEDIDO NÂ° 408838110J2014 DA WHITE. ESTAMOS PASSANDO PROPOSTA PARA ADITIVAR ACRESCIMO CONFORME ABAIXO.<br /><br /><br />\r\n- RELACAO DE MATERIAL;<br /><br /><br />\r\n01 UND - CX. MET TIPO QG 1700X600X600MM 03 UND - DISJUNTOR MOTOR MPW25-3-D063(4-6.3A) C/10409817 03 UND - MINICONTATOR CW07.10 30V25 220V - C/10185951 30 MT - CABO FLEXSIVEL 10MM - PRETO 10 UND - SPIRAL 3/4 PE BRNACO - METRO 03 UND - CANAL', '4', '', '', '', '', '5146.00', '', '', '5146.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-04', '2014-06-04', '2014-08-04', 22, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(65, '84', 2014, 'junior', 'Aprovado', 'COCO BAMBU PIZZARIA LTDA', '', '', '', '', '', '', '', '', 'pedrorodrigues20@yahoo.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA PROJETO APROVADO NA COELCE E INSTALACAO DE UMA SUBESTACAO DE 300KVA AEREA E DESMONTAGEM DE DUAS SUBESTACOES DE 75KVA EXISTENTE, INSTALACAO DO QUADRO GERAL (QGBT) NOVO DA SE 300 KVA E PASSAR RAMAL DE INTERLIGACAO ENTRE SE 300KVAE QGBT NOVO. INSTALAR DOIS RAMAIS DERIVANDO DO NOVO QGBT DA SE-300KVA, PARA OS DOIS QGBT (EXISTENTE )DAS DUAS SUBESTACOES DE 75KVA QUE SERAO DESATIVADAS.<br /><br /><br />\r\n1,00 10.000,00 10.000,00- PROJETO + MAO DE OBRA (ELFI RECEBENDO 2TR-75KVA)<br /><br />', '30', '', '', '', '', '10000.00', '', '', '10000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-06-01', '2014-07-03', '2014-08-03', 30, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(66, '169', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'fabianosilva@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'INSTALACAO DE UM NOVO RAMAL DE ENTRADA DA SUBESTACAO ABRIGADA DE 500KVA, COM MODIFICACAO NO PROJETO E APROVACAO NA COELCE, CONFORME DT002/2011', '30', '', '', '', '', '17918.00', '', '', '17918.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-01', '2014-10-15', '2014-11-15', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(67, '114', 2014, 'junior', 'Aprovado', 'LB SERVICE TERCEIRIZACAO E COBRANCA', '', '', '', '', '', '', '', '', 'supervisoroperacional@ibservice.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA INSTALACAO DE LUMINARIAS, FIACOES, SENSOR DE PRESENCA, PERFILADOS, TOMADAS, QUADRO DE COMANDO, NAS AREAS DO LEVANTAMENTO: GARAGEM 01 (SUBSOLO) - GARAGEM 02 (AREA RECPCAO) - ESCADAS E CORREDORES. (Materiais faturado direto para Cond. Edificio Iracema Praia Park II  ORC 115/14<br /><br /><br />\r\n)', '20', '', '', '', '', '22977.00', '', '', '22977.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-02', '2014-08-06', '2014-10-20', 1, 0, 55, 's', 'n', 'n', '', 'n', '0000-00-00', '', 's'),
(68, '115', 2014, 'junior', 'Aprovado', 'LB SERVICE TERCEIRIZACAO E COBRANCA', '', '', '', '', '', '', '', '', 'supervisoroperacional@ibservice.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA Fornecimento DE MATERIAIS NAS AREAS: GARAGEM 01 (SUBSOLO), GARAGEM 02, ESCADAS E CORREDORES. <br /><br /><br />\r\n(Material faturato direto para Cond. Ed. Iracema Praia Park II CNPJ 23.727.316/0001-85 )', '20', '', '', '', '', '0.00', '', '', '0.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-02', '2014-07-03', '2014-08-04', 1, 0, 12, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(69, '184', 2014, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'evandro.alves@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'TermovisÃ£o', '', '', 'MEDIÃ‡ÃƒO TERMOGRAFIA EM PAINEIS ELETRICOS NA SUBESTAÃ‡ÃƒO E GALPÃƒO DE DESCARREGAMENTO E CAEMRAS FRIAS, COM ART', '5', '', '', '', '', '1500.00', '', '', '1500.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-03', '2014-07-11', '2014-07-16', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n');
INSERT INTO `orcamentos` (`id`, `n_orc`, `ano_orc`, `colaborador_orc`, `situacao_orc`, `razao_social_contr`, `cnpj_contr`, `endereco_contr`, `bairro_contr`, `cidade_contr`, `estado_contr`, `cep_contr`, `telefone_contr`, `celular_contr`, `email_contr`, `contato_clint`, `razao_social_obra`, `cnpj_obra`, `endereco_obra`, `bairro_obra`, `cidade_obra`, `estado_obra`, `cep_obra`, `telefone_obra`, `celular_obra`, `email_obra`, `atividade`, `classificacao`, `quantidade`, `unidade`, `descricao_servico_orc`, `prazo_exec_orc`, `validade_orc`, `pagamento_orc`, `obs_orc`, `duvida_orc`, `vr_servco_orc`, `vr_material_orc`, `desconto_orc`, `vr_total_orc`, `obra_igual_contrat`, `data_adicionado_orc`, `data_ultima_alteracao`, `colaborador_ultim_alteracao`, `data_aprovada`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `data_ultimo_cont_cliente`, `colab_ultimo_contato_client`, `novo_cliente`) VALUES
(70, '192', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO ALVORADA', '', '', '', '', '', '', '', '', 'NÃ£o tem', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'Emergencia: - PROPOSTA PARA MANUTENCAO CORRETIVA NO RAMAL DE ENTRADA DE ALTA TENSAO DA SUBESTACAO, ONDE SERA REALIZADO A TROCA DOS CABOS DE ALTA TENSAO E MUFLAS TERMO CONTRATIL, RELACAO DE MATERIAL ABAIXO:<br /><br /><br /><br />\r\n250 METROS - CABO SINYENAX 8,7 / 15KV SE 25MM 08 UND - MUFLAS TERMO CONTRATIL PARA CABO DE 25MM USO EXTERNO, 15KV <br /><br /><br /><br />\r\n(APenas MÃ£o de OBra)_', '2', '', '', '', '', '3370.00', '', '', '3370.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-07', '2014-07-07', '2014-07-08', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(71, '194', 2014, 'junior', 'Aprovado', 'STL INFORMATICA LTDA ', '', '', '', '', '', '', '', '', 'nunes@stl.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA TROCA DE TRES CHAVES FUSIVEIS DE 25KV, 300A, E 3 ELOS FUSIVEL DE 5H.', '1', '', '', '', '', '2300.00', '', '', '2300.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-15', '2014-08-09', '2014-08-10', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(72, '182', 2014, 'junior', 'Aprovado', 'CLINICA DE DOENCAS RENAIS E HIPERT. ARTERIAL LTDA', '', '', '', '', '', '', '', '', 'rimcentro@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 75 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO ABAIXO.', '1', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-15', '2014-07-27', '2014-07-28', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(73, '183', 2014, 'junior', 'Aprovado', 'CLINICA DE DOENCAS RENAIS E HIPERT. ARTERIAL LTDA', '', '', '', '', '', '', '', '', 'rimcentro@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA NOVA MALHA DE ATERRAMENTO PARA A SE -75KVA, RELACAO DE MATERIAL ABAIXO:<br /><br /><br /><br />\r\n06 UND - HASTE DE TERRA 5/8"X2400M 06 UND - CONECTOR TIPO GRAMPO PARA HASTE 15 KL - CABO BOBRE NU 50MM 01 UND - CAIXA DE INSPECAO COM TAMPA 04 UND - CONECTOR SPLIT-BOLT 50MM', '2', '', '', '', '', '1700.00', '', '', '1700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-15', '2014-07-17', '2014-07-18', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(74, '199', 2014, 'junior', 'Aprovado', 'STRATURA ASFALTOS S.A', '', '', '', '', '', '', '', '', 'denis.viana@stratura.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'DIARIA DE UM TECNICO ELETROTECNICO E UM ELETRECISTA PARA EXECUTAR SERVICOS DE INSTALACOES ELETRICAS EM DIA COMERCIAL (08:00 AS 17:30 / SEGUNDA A SEXTA)', '1', '', '', '', '', '1630.00', '', '', '1630.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-17', '2014-07-17', '2014-07-21', 0, 0, 3, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(75, '167', 2014, 'junior', 'Aprovado', 'GERDAU ACOS LONGOS S/A', '', '', '', '', '', '', '', '', 'jose.rocha@gerdau.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA REALIZAR AFERICAO DE CONFORMIDADE COM FOTOS DAS MALHAS DE ATERRAMENTO E SPDA NUM TOTAL DE 42 PONTOS, COM A CONCLUSAO SERA FORNECIDO LAUDO TECNICO COM MEDICOES DE RESISTENCIA OHMICA DOS ATERRAMENTOS E ART, CREA-CE', '5', '', '', '', '', '6000.00', '', '', '6000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-18', '2014-08-20', '2014-08-26', 0, 0, 1, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(76, '202', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Aterramento', '', '', 'INSTALACAO DE UMA NOVA MALHA DE TERRA NA SUBESTACAO DO BEACH GRILL.<br /><br /><br />\r\n- OBS: SERVICO JA EXECUTADO NO DIA 19.07.2014', '1', '', '', '', '', '1689.00', '', '', '1689.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-21', '2014-07-19', '2014-07-19', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(77, '203', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA INSTALACAO DE UM AUTO TRAFO DE 35KVA NA SUBESTACAO AVRIGADA DO ATLANTIS', '1', '', '', '', '', '1196.00', '', '', '1196.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-21', '2014-07-21', '2014-07-22', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(78, '187', 2014, 'junior', 'Aprovado', 'EMAC ENGENHARIA DE MANUTENCAO LTDA', '', '', '', '', '', '', '', '', 'na29opt@emac.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- PROPOSTA PARA MANUTENCAO CORRETIVA DE UM BANCO DE CAPACITORES DA SUBESTACAO, ONDE SERA REALIZADO A TROCA DE DOIS CONTROLADORES DE FATOR DE POTENCIA DE 12 ESTAGIOS, E 10 CAPACITORES DANIFICADOS, CONFORME RELACAO ABAIXO:<br /><br /><br />\r\n02 UND - CONTROLADOR FATOR DE POTENCIA 12 ESTAGIOS, FABRICACAO SULTECH ST-8200C - 12 SAIDAS / TC<br /><br /><br />\r\n04 UND - CONTACTOR PARA CAPACITOR TRIFASICO DE 7,2KVAR, 220V<br /><br /><br />\r\n04 UND - CONTACTOR PARA CAPCITOR 7,2 KVAR 3,80V<br /><br /><br /', '15', '', '', '', '', '6794.00', '', '', '6794.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-11', '2014-07-28', '2014-07-31', 13, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(79, '206', 2014, 'junior', 'Aprovado', 'M. DIAS BRANCO S.A. IND. E COM. DE ALIMENTOS - GME', '', '', '', '', '', '', '', '', 'afonso.costa@mdiasbranco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'PROPOSTA DE SERVICO DE MEDICOES DE SPDA NO TOTAL DE 50 PONTOS EM NOSSAS MAQUINAS E EQUIPAMENTOS NA AREA DE PRODUCAO E SUBESTACOES 13,8KV E 69KV, DE ACORDO COM AS NORMAS TECNICAS OFICIAIS VIGENTES (12.15/2120208), COM EMISSAO DE LAUDOS TECNICOS POR EQUIPAMENTOS E MAQUINAS NO INTERIOR DE NOSSA UNIDADE MOINHO DIAS BRANCO, LOCALIZADO NO MUCURIPE.', '5', '', '', '', '', '2700.00', '', '', '2700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-24', '2014-07-28', '2014-08-04', 0, 0, 2, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(80, '190', 2014, 'junior', 'Aprovado', 'DOM PASTEL SELF-SERVICE LTDA-ME', '', '', '', '', '', '', '', '', 'marconisantana1@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', ' PROPOSTA PARA INSTALACAO DE UM BANCO CAPACITOR COM PROGRAMADOR HORARIO, (TIMER) COM POTENCIA DE 25KVAR EM 440V.<br /><br /><br />\r\n- VALOR DO MATERIAL <br /><br /><br />\r\nOBS: MATERIAL COMPRADO PELO CLIENTE<br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br />\r\n01 UND - QUADRO DE COMANDO EM CHAPA DE ACO 600X500X250MM 01 UND - CAPACITOR 25KVAR 440V WEG 01 UND - DISJUNTOR TRIPOLAR 50A FIXACAO DIM 01 UND - DISJUNTOR MONOPOLAR DE 2A 20 MTS - CABO FLEX 10MM 1KV 15 MTS - CABO FLEX DE 2,5', '3', '', '', '', '', '1050.00', '', '', '1050.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-09', '2014-07-23', '2014-07-24', 16, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(81, '209', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', ' PROPOSTA PARA MANUTENCAO PREVENTIVA EM 21 PAINEIS ELETRICOS E BUSWAY ONDE SERAO REALIZADO OS SEGUINTES SERVICOS; - ANALISE TERMOGRAFICA - MANUTENCAO PREVENTIVA NO BUSWAY (REAPERTO E LIMPEZA) - MEDICAO DA MALHA TERRA SPDA DO PREDIO (SERA EMITIDO LAUDO COM ART)<br /><br /><br />\r\n- ANALISE TERMOGRAFICA = 1200,00<br /><br /><br />\r\n- MANUTENCAO BUSWAY = 1900,00<br /><br /><br />\r\n- MEDICAO DA MALHA DE TERRA = 900,00', '5', '', '', '', '', '4000.00', '', '', '4000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-29', '2014-08-04', '2014-08-08', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(82, '197', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A (OCEANI)', '', '', '', '', '', '', '', '', 'antoniakatia@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', '- MANUTENCAO CORRETIVA NO PARA RAIO NO MASTRO E MEDICAO DO SISTEMA DO (SPDA), COM LAUDO TECNICO.<br /><br /><br />\r\nRELACAO DE MATERIAL ABAIXO:<br /><br /><br />\r\n01 UND - CAPITOR TIPO FRNAKLIN 300MM 2 DESCIDAS 01 UND - ISOLADOR PEDESTAL CLASSE 15KV 02 UND - BUCHA DE REDUCAO 2/4" PARA 1/2 02 UND - NYPLE FERRO GALVANIZADO DE 3/4', '1', '', '', '', '', '1466.00', '', '', '1466.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-07-30', '2014-08-07', '2014-08-07', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(83, '124', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', '', '', '', '', '', '', '', '', 'manutencao.cfo@atlanticahotels.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'MEDICAO DE RESISTENCIA OHMICA DA MALHA DE TERRA DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA E INSPECAO EM TODO SISTEMA DE PROTECAO, APOS A MEDICAO SERA ENVIADO RELATORIO TECNICO E ART CREA-CE.', '4', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-01', '2014-08-11', '2014-08-12', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(84, '125', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', '', '', '', '', '', '', '', '', 'manutencao.cfo@atlanticahotels.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MANUTENCAO PREVENTIVA EM 27 PAINEIS ELETRICOS, ONDE SERA REALIZADO OS SEGUINTES SERVICOS; ORGANIZACAO DA FIACAO MEDICAO DE ISOLAMENTO, LIMPEZA E REAPERTOS NAS CONEXOES ELETRICAS; BALACEMANETO DE CARGA; TERMOGRAFIA PARA VERIFICAR A EXISTENCIA DE PONTOS, QUENTES E ELIMINAR.', '5', '', '', '', '', '3700.00', '', '', '3700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-01', '2014-09-11', '2014-09-19', 0, 0, 3, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(85, '126', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO EDIFICIO COMFORT SUITES', '', '', '', '', '', '', '', '', 'manutencao.cfo@atlanticahotels.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Disjuntor', '', '', 'MANUTENCAO CORRETIVA NO LOCAL EM UM DISJUNTOR DE ALTA TENSAO DA SUBESTACAO ONDE SERA REALIZADAS TESTES ELETRICOS E REATIVACAO DO SISTEMA OPERACIONAL E CONSERTO DO MECANISMO', '1', '', '', '', '', '1700.00', '', '', '1700.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-01', '2014-09-06', '2014-09-06', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(86, '213', 2014, 'junior', 'Aprovado', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '', '', '', '', '', 'wellington@cdlfor.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '00INSTALACAO COM TROCA PARA CORRECAO NO POSTE DE ILUMINACAO DO ESTACIONAMENTO, ONDE SERAO SUBSTITUIDAS LAMPADAS E REATORES COM FOTO CELULA CONFORME ABAIXO:<br /><br /><br />\r\n- CAMINHAO ..................R$: 300,00<br /><br /><br />\r\n- 04 UND REATOR USO EXTERNO P/ LAMPADA DE 400W VAPOR METALICO; ..................................R$: 559.68<br /><br /><br />\r\n- 04 UND LAMPADA TUBULAR VALOR METALICO.............R$: 373,76<br /><br /><br />\r\n- 02 UND RELE FOTO CELULA COM BASE......................R', '1', '', '', '', '', '1860.00', '', '', '1860.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-01', '2014-08-05', '2014-08-06', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(87, '214', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO CORRETIVA NO RAMAL DE ENTRADA DA SUBESTACAO ELETRICA, JA REALIZADO NO DIA 04.08.2014 COM REAPERTO E LIMPEZA NA CHAVE FUSIVEL.', '1', '', '', '', '', '600.00', '', '', '600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-04', '2014-08-04', '2014-08-05', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(88, '218', 2014, 'junior', 'Aprovado', 'STRATURA ASFALTOS S.A', '', '', '', '', '', '', '', '', 'denis.viana@stratura.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'DIARIA DE UM TECNICO ELETROTECNICO E UM ELETRECISTA PARA EXECUTAR SERVICOS DE INSTALACOES ELETRICAS EM DIA COMERCIAL (08:00 AS 17:30 / SEGUNDA A SEXTA) - Foram 2 diarias', '2', '', '', '', '', '1160.00', '', '', '1160.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-04', '2014-08-04', '2014-08-05', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(89, '52', 2014, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'luis.lima@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', '00SERVICO DE INSPECAO E MEDICOES DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS ( SPDA), COM EMISSAO DE LAUDO TECNICO COM ART DO CREA-CE.<br /><br /><br />\r\nLOCAL: FIC ALDEOTA', '5', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-11', '2014-08-11', '2014-08-12', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(90, '224', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A (OCEANI)', '', '', '', '', '', '', '', '', 'carlosdias@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Gerador', '', '', 'REMANEJO DOS CABOS DO GRUPO GERADOR PARA MANUTENÃ‡ÃƒO CORRETIVA DO MESMO', '2', '', '', '', '', '1692.00', '', '', '1692.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-18', '2014-09-02', '2014-09-02', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(91, '168', 2014, 'junior', 'Aprovado', 'DISTRIBUIDORA FARMACEUTICA PANARELLO', '', '', '', '', '', '', '', '', 'francisco.santos@panpharma.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', '- PROPOSTA PARA MANUTENCAO PREVENTIVA E CORRETIVA DA SUBESTACAO:<br /><br /><br />\r\n1.1- TRANFORMADOR DE 225KVA: - RETIRADA DO TRANSFORMADOR DO POSTE COM CAMINHAO MUCK E COLOCACAO DE OUTRO ALUGADO. - PINTURA GERAL DA CAIXA DO TRANSFORMADOR - TROCA TODAS AS GUARNICOES DE VEDACAO - SECAGEM PARTE ATIVA NA ESTUFA - TRATAMENTO DO OLEO ISOLANTE PELO PROCESSO TERMO-VACUO - ANALISE DO OLEO ISOLANTE - ENSAIOS ELETRICOS - REISTALACAO NO POSTE E RETIRADA DO OUTRO TRAFO<br /><br /><br />\r\n1.2- PINTURA DO QU', '20', '', '', '', '', '5200.00', '', '', '5200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-19', '2014-08-24', '2014-09-15', 0, 0, 2, 's', 'n', 'n', '', 'n', '0000-00-00', '', 's'),
(92, '230', 2014, 'junior', 'Aprovado', 'NACIONAL ARCO-IRIS IND. E COM. DE TINTAS LTDA', '', '', '', '', '', '', '', '', 'angelo.queiroz@hipercor.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '- MANUTENCAO PREVENTIVA NA SUBESTACAO ELETRICA DE 2.225KVA, ( DOIS TRAFO DE 1000KVA E 1 X 225KVA); COM ANALISE DE OLEO , DENTRO DA MANUTENCAO SERA REALIZADO OS SEGUINTES SERVICOS ABAIXO;<br /><br /><br />\r\n1 - FORNECER E INSTALAR UMA MULFA TERMO CONTRATIL AO RAMAL DE ENTRADA 2 - FAZER TESTE EM UM TR - 1000KVA, PARA ENERGIZACAO', '5', '', '', '', '', '3900.00', '', '', '3900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-21', '2014-08-23', '2014-09-08', 0, 0, 11, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(93, '239', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', ' SERVICO JA EXECUTADO NO DIA 26.08.2014 PARA INSTALACAO DE UM GRUPO GERADOR PROVISSORIO NA SUBESTACAO ELETRICA PARA O CONSERTO DO OUTRO GERADOR QUE ESTA COM DEFEITO.', '1', '', '', '', '', '1300.00', '', '', '1300.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-26', '2014-08-26', '2014-08-27', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(94, '240', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'oliveira@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', ' INSTALACAO DOS SEGUINTES ITENS JA FORNECIDO EM 26.08.2014 NA SUBESTACAO DO BEACH GRILL.<br /><br /><br />\r\n20 UND - TERMINAL DE COMPRESSAO 400MM 50 MT - DUTO PEAD 90MM', '1', '', '', '', '', '1290.00', '', '', '1290.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-26', '2014-08-26', '2014-08-27', 2, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(95, '238', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '  INSTALACAO COM FORNECIMENTO DOS SEGUINTES MATERIAIS PARA ADEQUACAO DA SUBESTACAO DO BEACH GRILL<br /><br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL IND. UNIPOLAR 25KV 300A, RVP. 6,3KA 03 UND - ELO FUSIVEL', '1', '', '', '', '', '1214.00', '', '', '1214.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-08-28', '2014-09-17', '2014-09-18', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(96, '246', 2014, 'junior', 'Aprovado', 'BERMAS MARACANAU INDUSTRIA E COMERCIO', '', '', '', '', '', '', '', '', 'lsilva@bermas.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'SERVICO DE MEDICAO DA RESISTENCIA OHMICA DO ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS<br /><br /><br />\r\nATMOSFERICAS<br /><br /><br />\r\nEM 13 PONTOS NAS DEPENDENCIAS DA BERMAS. SERA<br /><br /><br />\r\nFORNECIDO LAUDO TECNICO COM OS VALORES DAS MEDICOES<br /><br /><br />\r\nCOM ART DO<br /><br /><br />\r\nCREA-CE.', '5', '', '', '', '', '1000.00', '', '', '1000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-09', '2014-09-10', '2014-09-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 's'),
(97, '251', 2014, 'junior', 'Aprovado', 'ALAMO ENGENHARIA S/A ', '', '', '', '', '', '', '', '', 'adm2.vivoba@alamoengenharia.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', 'MANUTENCAO PREVENTIVA DE UM TRANSFORMADOR EM POSTE, RETIRADA DE AMOSTRA DE OLEO PARA REALZIAR<br /><br /><br /><br />\r\nANALISE FISICO<br /><br /><br /><br />\r\nQUIMICO DO MESMO CONFORME RELACAO DE SERVICOS<br /><br /><br /><br />\r\nABAIXO;', '1', '', '', '', '', '1320.00', '', '', '1320.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-16', '2014-09-28', '2014-10-16', 0, 0, 17, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(98, '219', 2014, 'junior', 'Aprovado', 'M. DIAS BRANCO S.A. IND. E COM. DE ALIMENTOS - GME', '', '', '', '', '', '', '', '', 'afonso.costa@mdiasbranco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'SERVICO DE MEDICOES DE SPDA E ATERRAMENTO NO TOTAL DE APROXIMADAMENTE 25 PONTOS NAS SUBESTACOES 13,8KV E<br /><br /><br />\r\n69KV E MOINHOS, DE ACORDO COM AS NORMAS TECNICAS<br /><br /><br />\r\nOFICIAIS VIGENTES (12.15/2120208), COM EMISSAO DE LAUDOS<br /><br /><br />\r\nTECNICOS.', '5', '', '', '', '', '1425.00', '', '', '1425.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-22', '2014-09-24', '2014-09-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(99, '252', 2014, 'junior', 'Aprovado', 'CALCADOS ANIGER NORDESTE LTDA', '', '', '', '', '', '', '', '', 'fatima.pinheiro@ne.aniger.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Laudo TÃ©cnico', 'Transformador', '', '', 'ANALISE FISICO QUIMICO EM 03 AMOSTRA DE OLEO ISOLANTE DOS TRANSFORMADORES.', '15', '', '', '', '', '600.00', '', '', '600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-22', '2014-09-29', '2014-10-17', 0, 0, 3, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(100, '144', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO DO QUADRO GERAL DE BAIXA TENSAO (QGBT) COM LIMPEZA, REAPERTO DAS CONEXOES,<br /><br /><br />\r\nINDETIFICACAO DOS DISJUNTORES PARA CONFECCAO DE UM<br /><br /><br />\r\nDIAGRAMA UNIFILAR DO QUADRO E INSTALACAO DE UM<br /><br /><br />\r\nREGISTRADOR DE GRANDEZAS ELETRICAS PARA INDETIFICAR,<br /><br /><br />\r\nVALORES DE: TENSAO-CORRENTE, POTENCIA, FATOR DE<br /><br /><br />\r\nPOTENCIA. COM A CONCLUSAO SERA ELABORADO LAUDO<br /><br /><br />\r\nTECNICO COM DIAGRAMA UNIFILAR E ART.', '5', '', '', '', '', '1260.00', '', '', '1260.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-22', '2014-09-23', '2014-10-13', 0, 0, 15, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(101, '257', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'oliveira@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', 'REMOCAO DOS CABOS GERADORES 1 E 2 E INSTALAR OS CABOS NO GERADOR PROVISORIO.', '1', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-26', '2014-09-26', '2014-09-26', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(102, '130', 2014, 'junior', 'Aprovado', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', '', '', '', '', '', '', '', '', 'marliete@mrhgestao.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'MEDICAO E INSPECAO DO SPDA E PONTOS DE ATERRAMENTO DO PREDIO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CREA.', '1', '', '', '', '', '960.00', '', '', '960.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-09-30', '2014-10-01', '2014-10-02', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(103, '244', 2014, 'junior', 'Aprovado', 'CONDOMINIO ED. IRACEMA PRAIA PARK II', '', '', '', '', '', '', '', '', 'praiapark1020@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MANUTENCAO CORRETIVA NOS QUADROS DE MEDICAO DA COELCE QUE ALIMENTA OS APARTAMENTOS ONDE SERAO REALIZADOS A TROCA DAS FIACOES PARTIDO DO QUADRO DE MEDICAO ATE OS APARTAMENTOS COM REAPERTOS DAS CONEXOES E LIMPEZA.', '14', '', '', '', '', '9240.00', '', '', '9240.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-01', '2014-10-20', '2014-11-05', 0, 0, 2, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(104, '254', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- TROCA DE RAMAL DE ENTRADA DE 15KV DA SUBESTACAO ATLANTIS, CONFORME MATERIAL ABAIXO FORNECIDO PELA<br /><br /><br />\r\nELFI.<br /><br /><br />\r\n03 UND - ALCA PREF. P/ COND. COBRE 25MM<br /><br /><br />\r\n30 UND - ARRUELA QUAD. 50X3MMC/FURO DE 18MM<br /><br /><br />\r\n08 UND - ARRUELA QUAD. 32X3MM C/FURO DE 18MM<br /><br /><br />\r\n6,2 KG - CABO DE COBRE NU 25MM<br /><br /><br />\r\n03 UND - CHAVE FUSIVEL IND. 25KV, 300A RUP 6,3KA<br /><br /><br />\r\n01 UND - CINTA DE ACO INOX (1ROLO)<br /><br /><br />', '1', '', '', '', '', '5765.00', '', '', '5765.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-01', '2014-10-08', '2014-11-19', 0, 0, 41, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(105, '259', 2014, 'junior', 'Aprovado', 'IFT IND COMERCIO DE MATERIAIS const - Polimix', '', '', '', '', '', '', '', '', 'faturamento1.ift@britta.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA CORRIGIR MALHA DE ATERRAMENTO DA eMPRESA POLIMIX, CONFORME LAUDO TECNICO DA CONTROL<br /><br /><br /><br />\r\nENGENHARIA E RELACAO DE MATERIAL ABAIXO FORNECIDO<br /><br /><br /><br />\r\nPELA ELFI.<br /><br /><br /><br />\r\n42 UND - HASTE DE TERRA ROSCADA 5/8" X 240MM<br /><br /><br /><br />\r\n12 PCT - TERROGEL 14KL CADA<br /><br /><br /><br />\r\n60 MT - CABO DE COBRE NU DE 50MM<br /><br /><br /><br />\r\n30 UND - CONECTOR REFORCADO TIPO GRAMPO<br /><br /><br /><br />\r\n18 UND - LUVA ROSCAD', '8', '', '', '', '', '8000.00', '', '', '8000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-02', '2014-10-06', '2014-10-15', 0, 0, 1, 's', 'n', 's', 'VAlor Paiol 01 ficou fora do recomendado de 10 Ã´hms, apÃ³s a PoliMix ter chamado outra empresa para fazer a mediÃ§Ã£o; Tomamos medidas imediatas para corrigir o Valor citado.', 'n', '0000-00-00', '', 's'),
(106, '261', 2014, 'junior', 'Aprovado', 'HOSPITAL DE OLHOS LEIRIA DE ANDRADE', '', '', '', '', '', '', '', '', 'thalestelles@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'REALIZAR MEDICAO PARA VERIFICAR O CARREGAMENTO EM DOIS TRANSFORMADORES A OLEO DA SUBESTACAO, SENDO UM DE 225KVA E OUTRO DE 150KVA, COM INSTALACAO DE UM REGISTRADOR DE GRANDEZAS NO SECUNDARIO DE CADA TRAFO POR UM PERIODO DE 05 DIAS EM CADA, PARA IDENTIFICAR POSSIVEIS SOBRE CARGAS. SERA FORNECIDO TABELA COM MEMORIA DE MASSA COM TENSOES, CORRENTES E POTENCIAS.', '15', '', '', '', '', '2900.00', '', '', '2900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-07', '2014-10-07', '2014-10-28', 0, 0, 6, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(107, '267', 2014, 'junior', 'Aprovado', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', '', '', '', '', '', '', '', '', 'josegilmar@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'MUDANCA DO "TAP" DO TRANSFORMADOR DE 300KVA DA SUBESTACAO AEREA, PARA AJUSTE DA TENSAO FORNECIDA.', '1', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-14', '2014-10-14', '2014-10-14', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(108, '268', 2014, 'junior', 'Aprovado', 'MRH GESTAO DE PESSOAS E SERVICOS LTDA', '', '', '', '', '', '', '', '', 'marliete@mrhgestao.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE ACOMPANHAMENTO DE UM TECNICO ELETROTECNICO PARA ACOMPANHAMENTO DE INSTALACOES ELETRICAS DE BAIXA TENSAO DENTRO DA SUBESTACAO ABRIGADA DA MRH, EM UM DIA DE DOMINGO.', '1', '', '', '', '', '520.00', '', '', '520.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-15', '2014-10-19', '2014-10-20', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(109, '269', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', 'INSTALAR CABOS DO GERADOR DEFINITIVAMENTE APOS JA EXECUTADO O SERVICO DO ORCAMENTO 257/14, DE INSTALACAO NO GERADOR PROVISORIO.<br /><br /><br />\r\nLOCAL: MAREMOTO<br /><br /><br />\r\nNOTA: SERVICO JA EXECUTADO DIA 15/10/2014', '2', '', '', '', '', '1800.00', '', '', '1800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-15', '2014-10-15', '2014-10-16', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(110, '274', 2014, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'francisco.alves@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Transformador', '', '', 'INSTALACAO DE REGISTRADOR DE GRANDEZAS ELETRICAS, POR UM PERIODO DE 72 HORAS, EM CADA TRANSFORMADOR, SENDO<br /><br /><br />\r\n03 DE 300 KVA. SERA EMITIDO MEMORIA DE MASSA IDENTIFICANDO O TOTAL DE CARGA QUE CADA TRAFO ESTA ATENDENDO E QUANTO ESTA SOBRANDO PARA FUTURA DISTRIBUICAO DE NOVAS CARGAS DE APROXIMADAMENTE 275 KW, CONFOME INFORMADO PELA FIC.', '10', '', '', '', '', '3000.00', '', '', '3000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-24', '2014-10-27', '2014-11-10', 0, 0, 4, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(111, '272', 2014, 'junior', 'Aprovado', 'CALCADOS ANIGER NORDESTE LTDA', '', '', '', '', '', '', '', '', 'fatima.pinheiro@ne.aniger.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '1-SERVICOS PARA MANUTENCAO DE 03 SUBESTACOES ABRIGADAS, CADA UMA COM:<br /><br /><br /><br /><br />\r\n- 01 TRANSFORMADOR;<br /><br /><br /><br /><br />\r\n- 01 DISJUNTOR DE MEDIA TENSAO;<br /><br /><br /><br /><br />\r\n- QUADROS GERAIS DE BAIXA TENSAO E<br /><br /><br /><br /><br />\r\n- CHAVE SECCIONADORAS.<br /><br /><br /><br /><br />\r\nCONFORME RELACAO DE SERVICOS ABAIXO:<br /><br /><br /><br /><br />\r\n<br /><br /><br /><br /><br />\r\n2- CONFORME RELATORIO DO OLEO ISOLANTE DO TRANSFORMADOR DE 450KVA', '5', '', '', '', '', '6250.00', '', '', '6250.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-24', '2014-11-16', '2014-11-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(112, '233', 2014, 'junior', 'Aprovado', 'STRATURA ASFALTOS S.A', '', '', '', '', '', '', '', '', 'denis.viana@stratura.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- INSTALACAO DA NOVA TUBULACAO E PASSAGEM DE CABOS ELETRICOS DO NOVO PAINEL DOS AQUECEDORES PARA OS DOIS MOTORES, UM DE 25CV E OUTRO DE 1,5CV. OBS: MATERIAL FORNECIDO PELO CLIENTE, RELACAO DE<br /><br /><br /><br />\r\nMATERIAL ABAIXO:', '3', '', '', '', '', '1311.00', '', '', '1311.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-28', '2014-10-30', '2014-10-31', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(113, '285', 2014, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'gustavo_oliveira@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'MEDICAO DA RESISTENCIA OHIMCA DA MALHA DE ATERRAMENTO DOS TANQUES, E DO SPDA DAS INSTALACOES DA WHITE NA AV. FRANCISCO SA, COM EMISSAO DE LAUDO E ART DO CREA, CE', '1', '', '', '', '', '1000.00', '', '', '1000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-10-31', '2014-10-31', '2014-10-31', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(114, '286', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Gerador', '', '', 'ATENDIMENTO DE EMERGENCIA REALIZADO DIA 01/11/2014 (SABABDO) PARA INSTALACAO DE UM GRUPO GERADOR PROVISORIO PARA ALIMENTACAO DAS CARGAS PRIORITARIAS. LOCAL: HOTEL HOLIDAY INN', '1', '', '', '', '', '1850.00', '', '', '1850.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-03', '2014-11-03', '2014-11-03', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(115, '215', 2014, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'aristophanes.sousa@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACOES ELETRICAS PARA MANUTENCAO CORRETIVA NA SALA DA KIBON ONDE SERA REMANEJADO O CIRCUITO DE TOMADAS DO QFAC PARA O QUADRO DISTRIBUICAO. PARA EVITAR OCILACOES E QUEDA DE TENSAO, INSTALAR TAMPAS CEGAS NAS TOMADAS DE PISOS: (VALOR APENAS DA MAO DE OBRA)<br /><br /><br />\r\n03 UND - TOMADA CEGA EM LATAO PARA TOMADA DE PISO 4 X 4<br /><br /><br />\r\n10 MT - CO TUBO 1"<br /><br /><br />\r\n06 UND - ABRACADEIRA DE 1" TIPO "D"<br /><br /><br />\r\n30 MT - CABO FLEX 6MM PRETO<br /><br /><br />\r\n30 MT -', '2', '', '', '', '', '1100.00', '', '', '1100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-03', '2015-02-14', '2015-02-14', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(116, '289', 2014, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'gustavo_oliveira@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'MONTAGEM DE UM PAINEL DE CONTROLE PARA AUTOMACAO DO ENCHIMENTO CO2 NA OFICINA DA ELFI, MATERIAL TODO<br /><br /><br />\r\nFORNECIDO PELA WHITE MARTINS.', '5', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-04', '2014-11-10', '2014-11-14', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(117, '288', 2014, 'junior', 'Aprovado', 'AGROPAULO AGROINDUSTRIAL S.A', '', '', '', '', '', '', '', '', 'bruno.rafael@agropaulo.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', '- MANUTENCAO CORRETIVA EM UM TRASFORMADOR DE 150 KVA NÂ° 21109227, WEG, CONFORME DESCRICAO ABAIXO.<br /><br />\r\n- RELACAO DE SERVICOS:<br /><br />\r\n- DESENCAIXOTAMENTO<br /><br />\r\n- SUBISTITUICAO DE 02 COLUNAS DE ALTA TENSAO "H1" E "H3"<br /><br />\r\n- SUBISTITUICAO DE 01 COLUNA DE BAIXA TENSAO "H1"<br /><br />\r\n- SECAGEM DA PARTE ATIVA EM ESTUFA<br /><br />\r\n- TROCA DE TODAS GUARNICOES DE VEDACOES<br /><br />\r\n- TRATAMENTO DAS PECAS OXIDADAS<br /><br />\r\n- TRATAMENTO DA CARGA DE OLEO ISOLANTE<b', '25', '', '', '', '', '3650.00', '', '', '3650.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-10', '2014-11-10', '2014-11-27', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(118, '298', 2014, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA RETIRADA DE UM PAINEL ELETRICO ENERGIZADO DO GRUPO GERADOR ANTIGO.', '2', '', '', '', '', '1300.00', '', '', '1300.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-12', '2015-03-28', '2015-03-28', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(119, '306', 2014, 'junior', 'Aprovado', 'CENTRO DE ESPECIALIDADES MEDICAS JOSE DE ALENCAR', '', '', '', '', '', '', '', '', 'rosana.frf@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'SERVICO DE EMERGENCIA PARA INSTALACAO DE TRES CHAVES FUSIVEIS COM PARA RAIO POLIMERICO E UMA CRUZETA PArA ATIVACAO DA SUBESTACAO ELETRICA NO PREDIO DO CEMJA-JACARECANGA.<br /><br /><br />\r\nRELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 UND - CHAVE FUSIVEL 25KV UNIPOLAR<br /><br /><br />\r\n03 UND - PARA RAIO POLIMERICO 12KV 10KA<br /><br /><br />\r\n01 UND - CRUZETA DE CONCRETO PARA ESTRUTURA H<br /><br /><br />\r\n03 VR - VERGALHAO DE COBRE 1/4" X 3M<br /><br /><br />\r\n04 UND -', '1', '', '', '', '', '3980.00', '', '', '3980.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-13', '2014-11-13', '2014-11-14', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(120, '300', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'TESTE DE RESISTENCIA OHMICA DO ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA SPDA, COM EMISSAO DE ART. <br /><br /><br />\r\nLOCAL:<br /><br /><br />\r\nEDUCAR SESC FORTALEZA<br /><br /><br />\r\nav jose bastos 813', '4', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-13', '2014-11-14', '2014-11-17', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(121, '311', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'PROPOSTA PARA FAZER CORRECAO DOS PONTOS DE ATERRAMENTO DO SPDA DO AUDITORIO E CAIXA DAGUA, PARA DEIXAR OS MESMOS DENTRO DOS PADROES NBR 5419, QUE RECOMENDA NO MAXIMO 10 OHMIS. COM A CONCLUSAO SERA EMITIDO UM LAUDO COM ART.<br /><br />\r\n- LOCAL:<br /><br />\r\nEDUCAR SESC FORTALEZA', '5', '', '', '', '', '1740.00', '', '', '1740.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-27', '2014-11-27', '2014-11-27', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(122, '317', 2014, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'eneiasfacanha@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'PROPOSTA PARA MEDICAO DA MALHA DE ATERRAMENTO DO SPDA DO CONDOMINIO ACQUA RESORT APOS A MEDICAO SERA EMITIDO LAUDO E ART.', '2', '', '', '', '', '1260.00', '', '', '1260.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-03', '2014-12-10', '2014-12-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(123, '309', 2014, 'junior', 'Aprovado', 'ESMALTEC S/A', '', '', '', '', '', '', '', '', 'francisco.gentil@esmaltec.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'INSPECAO E MEDICOES EM 205 PONTOS SPDA (165 PAINEIS E 40 PONTOS SPDA) REFERENTE A MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS (SPDA), NAS SUBESTACOES E NOS QUADROS DE DISTRIBUICOES DE FORCA E ILUMINACAO, COM O FIM DE OBTER O VALOR DA RESISTENCIA DE ISOLAMENTO, COM EMISSAO DE LAUDO ASSINADO POR PROFISSIONAL HABILITADO E ART', '15', '', '', '', '', '6400.00', '', '', '6400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-01', '2014-12-16', '2014-12-30', 2, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(124, '313', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'MEDICAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA COM LAUDO E ART, NA LOCALIDADE DE QUIXERAMOBIM', '5', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-26', '2014-12-02', '2014-12-04', 7, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(125, '282', 2014, 'junior', 'Aprovado', 'RESTAURANTE LIMONE', '', '', '', '', '', '', '', '', 'lelabardot@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO.<br /><br /><br /><br />\r\nITEM 02 - MANUTENCAO CORRETIVA, TROCA;<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL UNIPOLAR DE 25KV, 300A, 6,3KA<br /><br /><br /><br />\r\n03 UND - PARA - RAIOS POLIMERICOOXIDO DE ZINCO, 12KV,<br /><br /><br /><br />\r\n10KA<br /><br /><br /><br />\r\n03 UND - ELO FUSIVEL 6K<br /><br /><br /><br /', '16', '', '', '', '', '2610.00', '', '', '2610.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-03', '2014-12-22', '2015-01-06', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 's'),
(126, '307', 2014, 'junior', 'Aprovado', 'HOSPITAL DE OLHOS LEIRIA DE ANDRADE', '', '', '', '', '', '', '', '', 'thalestelles@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ELETRICA COM 02 TRAFOS, SENDO UM DE 225 KVA E OUTRO DE 150 KVA CONFORME DESCRICAO DOS SERVICOS EM ANEXO, COM EMISSAO DE LAUDO E ART-CREA. COM ANALISE FISICO-QUIMICO DO OLEO ISOLANTE DOS TRANSFORMADORES.', '16', '', '', '', '', '2000.00', '', '', '2000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-11-28', '2014-12-20', '2015-01-06', 6, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(127, '327', 2014, 'junior', 'Aprovado', 'BANCO CENTRAL DO BRASIL - BACEN', '', '', '', '', '', '', '', '', 'nero.torres@bcb.gov.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA CONSERTO DE 02 <br />\r\nBOMBAs KSB 100-150-2 COM 1,00 3.760,00 3.760,00<br /><br />\r\nTROCA DE ROLAMENTOS, RETENTORES, JOGO DE JUNTA,<br /><br />\r\nGAXETAS, ANEIS, ORING, BUCHAS PROTETORA DO EIXO, JUNTA<br /><br />\r\nDO MANCAL, CARGA DE OELO MAIS SERVICOS DE RETIRADA<br /><br />\r\nREINSTALACAO, CONFORME RELACAO DE COMPONENTES A<br /><br />\r\nSEREM TROCADOS:<br /><br />\r\n02 - ROLAMENTO<br /><br />\r\n02 - RETETORES<br /><br />\r\n01 - JOGO DE JUNTA<br /><br />\r\n01 - JOGO DE GAXETA 3/8<br /><b', '10', '', '', '', '', '7520.00', '', '', '7520.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-09', '2014-12-10', '2015-01-20', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(128, '320', 2014, 'junior', 'Aprovado', 'ALAMO ENGENHARIA S/A ', '', '', '', '', '', '', '', '', 'enc.vivoce@alamoengenharia.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'CONFORME SOLICITADO ESTAMOS APRESENTADO PROPOSTA PARA INSPECAO DO SPDA E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO DO SISTEMA DE PROTECAO CONTA DESCARGAS ATMOSFERICAS DO PREDIO DA ALAMO ENGENHARIA.COM A CONCLUSAO SERA REMETIDO LAUDO TECNICO E ART DO CREA-CE.', '4', '', '', '', '', '1500.00', '', '', '1500.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-11', '2014-12-12', '2014-12-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(129, '329', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'MEDICAO DE ATERRAMENTO EM PAINEIS ELETRICOS E POSTES 1,00 2.950,00 2.950,00<br /><br />\r\nMETALICOS, FREZER, FORNOS E MOTORES CONFORME NR-10<br /><br />\r\nNBR-5410 APOS AS MEDICOES SERA EMITIDO LAUDO E ART.<br /><br />\r\n- RELACAO DE PAINEIS E EQUIPAMENTO ABAIXO;- PAINEL CALDEIRA;- PAINEL CALDEIRA ELETRICA;- CALDEIRA 1 E ;- QUADRO E BOMBADO ESGOTO;- QUADRO COZINHA;- QUADRO DA COZINHA BALCAO;- QUADRO EXALTOUR;- QUADRO DA OMBA RECALQUE;- BOMBA HIDRANTE;- QUADRO Q.F.A.C.S;- QUADRO DO HALL 1 E 2;- QUAD', '5', '', '', '', '', '2950.00', '', '', '2950.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-12', '2015-01-05', '2015-01-10', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(130, '321', 2014, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA COM 03 TRANSFORMADORES DE FORCA DE 300KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS, QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO E BANCOS CAPACITORES, CONFORME DESCRICAO DOS SERVICOS EM ANEXO.', '20', '', '', '', '', '1800.00', '', '', '1800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-05', '2014-12-17', '2015-01-06', 11, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(131, '312', 2014, 'junior', 'Aprovado', 'OSASUNA PARTICIPACOES LTDA', '', '', '', '', '', '', '', '', 'ivon@jangadeirotextil.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO ABRIGADA BLINDADA COM TRES TRANSFORMADORES DE 1000KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS DE UMA SUBESTACAO AEREA DE 225KVA E 150KAV CONFORME DESCRICAO DOS SERVICOS EM ANEXO COM FORNECIMENTO DE LAUDO TECNICO E ART DO CRE-CE.', '15', '', '', '', '', '4460.00', '', '', '4460.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-15', '2014-12-31', '2015-01-06', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(132, '276', 2014, 'junior', 'Aprovado', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', '', '', '', '', '', '', '', '', 'josegilmar@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'INSTALACAO DE QUADRO DE COMANDO COM UM SOFT-START PARA MOTOR DA CASCATA. TODO MATERIAL FORNECIDO PELA ELFI, CONFORME ABAIXO.<br /><br /><br />\r\nRELACAO DE MATERIAIS<br /><br /><br />\r\n01 UND SOFT START SSW.05 - WEG P/ 20CV<br /><br /><br />\r\n01 UND MINI CONTATOR 220V 6A 2NA+2NF<br /><br /><br />\r\n01 UND QUADRO DE COMANDO 300X300X200MM PVC<br /><br /><br />\r\n01 UND BOTOEIRA LIGA DESLIGA DUPLO<br /><br /><br />\r\n01 UND DISJUNTOR MONOPOLAR DE 2A<br /><br /><br />\r\n01 UND CONJUNTO DE SINALIZACAO LED', '5', '', '', '', '', '4100.00', '', '', '4100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-16', '2014-12-19', '2015-01-15', 0, 0, 0, 's', 'n', 'n', 'Passou do prazo de execuÃ§Ã£o devido a prioridade do serviÃ§o dos Geradores', 'n', '0000-00-00', '', 'n'),
(133, '280', 2014, 'junior', 'Aprovado', 'CONDOMINIO WELLNESS RESORT APART - HOTEL', '', '', '', '', '', '', '', '', 'josegilmar@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Gerador', '', '', 'PROPOSTA DE MAO DE OBRA PARA MANUTENCAO DE DOIS GRUPOS GERADORES, ONDE SERAO REALIZADOS OS SERVICOS DE PINTURA, TROCA DE OLEO LUBRIFICANTE, FILTROS, ADITIVOS DOS RADIADORES, ( MATERIAIS FORNECIDOS PELO CLIENTE CONFORME ABAIXO).<br /><br />\r\nRELACAO MATERIAIS:<br /><br />\r\n60 LTRS OLEO LUBRIFICANTE PARA MOTOR A DIESEL<br /><br />\r\n02 UND FILTRO DE COMBUSTIVEL FF5052<br /><br />\r\n02 UND FILTRO DE OLEO LUBRIFICANTE 1280<br /><br />\r\n02 UND ADITIVO P/ AGUA RADIADOR<br /><br />\r\n01 GL. TINTA PARA FER', '15', '', '', '', '', '17000.00', '', '', '17000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-16', '2014-12-29', '2015-01-13', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(134, '325', 2014, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA DE 225KVA, CONFORME RELACAO DE SERVICOS EM ANEXO.', '15', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-18', '2015-01-10', '2015-01-25', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(135, '330', 2014, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', 'DIAGRAMA UNIFILAR DOS PAINEIS ELETRICOS E SUBESTACAO COM ESPECIFICACAO DE DISJUNTORES E CABOS COM SUAS PROTECOES. CONFORME RELACAO ABAIXO;<br /><br /><br />\r\nOBS: SERA FORNECIDO DESENHOS EM CD<br /><br /><br />\r\n- PAINEL CALDEIRA;<br /><br /><br />\r\n- PAINEL CALDEIRA ELETRICA;<br /><br /><br />\r\n- CALDEIRA 1 E 2;<br /><br /><br />\r\n- QUADRO E BOMBADO ESGOTO;<br /><br /><br />\r\n- QUADRO COZINHA;<br /><br /><br />\r\n- QUADRO DA COZINHA BALCAO;<br /><br /><br />\r\n- QUADRO EXALTOUR;<br /><br /><br />', '25', '', '', '', '', '6100.00', '', '', '6100.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-18', '2015-01-06', '2015-02-26', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n');
INSERT INTO `orcamentos` (`id`, `n_orc`, `ano_orc`, `colaborador_orc`, `situacao_orc`, `razao_social_contr`, `cnpj_contr`, `endereco_contr`, `bairro_contr`, `cidade_contr`, `estado_contr`, `cep_contr`, `telefone_contr`, `celular_contr`, `email_contr`, `contato_clint`, `razao_social_obra`, `cnpj_obra`, `endereco_obra`, `bairro_obra`, `cidade_obra`, `estado_obra`, `cep_obra`, `telefone_obra`, `celular_obra`, `email_obra`, `atividade`, `classificacao`, `quantidade`, `unidade`, `descricao_servico_orc`, `prazo_exec_orc`, `validade_orc`, `pagamento_orc`, `obs_orc`, `duvida_orc`, `vr_servco_orc`, `vr_material_orc`, `desconto_orc`, `vr_total_orc`, `obra_igual_contrat`, `data_adicionado_orc`, `data_ultima_alteracao`, `colaborador_ultim_alteracao`, `data_aprovada`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `data_ultimo_cont_cliente`, `colab_ultimo_contato_client`, `novo_cliente`) VALUES
(136, '318', 2014, 'junior', 'Aprovado', 'MARQUISE EMPREENDIMENTOS S/A', '', '', '', '', '', '', '', '', 'acelio@granmarquise.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA SUBISTITUICAO DA FIACAO QUE ALIMENTA OS MOTORES DA BOMBA DE EMERGENCIA DE 40CV COM INSTALACAO DE QUADRO DE COMANDO COM SOFTSTARTER E DISJUNTOR DE PROTECAO NO SUBESTACAO.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA 1,00 2.256,00 2.256,00<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELA ELFI; <br /><br /><br />\r\n210 MT - CABO FLEX 16MM 1KV<br /><br /><br />\r\n09 UND - TERMINAL DE COMPRESSAO CABO 16MM<br /><br /><br />\r\n01 UND - QUADRO DE COMANDO EM CHAPA DE ACO<br /><br /><br />\r', '6', '', '', '', '', '7600.00', '', '', '7600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-29', '2015-01-21', '2015-01-26', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(137, '294', 2014, 'junior', 'Aprovado', 'DEPARTAMENTO NACIONAL DE PRODUCAO MINERAL - DNPM', '', '', '', '', '', '', '', '', 'aline.bezerra@dnpm.gov.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE MANUTENCAO DE UM TRANSFORMADOR DE 75 KVA EM POSTE, INCLUINDO OS SEGUINTES SERVICOS:<br /><br /><br />\r\n- RETIRADA DO OLEO PARA ANALISE EM LABORATORIO OFICIAL,<br /><br /><br />\r\nDE ACIDEZ E RIGIDEZ DIELETRICA;<br /><br /><br />\r\n- LIMPEZA EXTERNA DO TRANSFORMADOR NO POSTE;<br /><br /><br />\r\n- MANUTENCAO E CALIBRACAO DAS CHAVES FUSIVEIS<br /><br /><br />\r\nINDICADORAS;<br /><br /><br />\r\n- LIMPEZA, REAPERTOS E POLIMENTOS DOS EQUIPAMENTOS DA<br /><br /><br />\r\nSUBESTACAO;<br /><br /><br', '4', '', '', '', '', '1989.00', '', '', '1989.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-29', '2015-01-10', '2015-02-05', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(138, '310', 2014, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'chicosombra@gmail.com', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROJETO E INSTALACAO DE UM RAMAL DE BAIXA TENSAO TRIFASICO SUBITERRANEO COM EXTENSAO APROXIMADA DE 170M, PARTINDO DO QGBT DA SUBESTACAO EXISTENTE DE 900KVA, PARA ALIMENTAR UM QUADRO DE FORCA QDF, E QUATRO QUADROS DE DISTRIBUICAO DE LUZ E FORCA QDLF, PARA ENERGIZAR AS 42 SALAS DE AULA. ( POSTEIROMENTE PASSAREMOS UMA PROPOSTA PARA ATENDER AS 42 SALAS DE<br /><br /><br />\r\nAULA).', '15', '', '', '', '', '15768.00', '', '', '15768.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2014-12-10', '2015-01-13', '2015-02-13', 27, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(139, '11', 2015, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE SUBSTITUICAO DO DISJUNTOR TRIPOLAR DE 250A, DEVE SER FORNECIDO PELA A PRESTADORA DE SERVICO<br /><br /><br /><br />\r\nCONTRATADA.<br /><br /><br /><br />\r\nSERVICO DE SUBSTITUICAO TC 15 KVA - 100/5 FORNECIDO PELO SESC PARA CUBICULO DE ENTRADA;<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DO CUBICULO<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DA SUBESTACAO 01<br /><br /><br /><br />\r\nSERVICO DE MANUTENCAO PREVENTIVA DA SUBESTACAO 02<br /><br /><br /><br />\r\nSE', '15', '', '', '', '', '3969.00', '', '', '3969.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-01-16', '2015-01-19', '2015-02-09', 3, 0, 6, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(140, '8', 2015, 'junior', 'Aprovado', 'NACIONAL ARCO-IRIS IND. E COM. DE TINTAS LTDA', '', '', '', '', '', '', '', '', 'ronauth.rodrigues@hipercor.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'CONFORME SUA SOLICITACAO DE UMA VISITA TECNICA, ONDE FOI REALIZADO EM 06.01.2015. ESTAMOS PASSANDO PROPOSTA<br /><br /><br /><br />\r\nPARA COLOCAR EM PARALELO OS 2 TRANSFORMADORES DE 1000KVA, PARA DISTRIBUIR MELHOR AS CARGAS, COM O ACRESCIMO DE UM SEGUNDO MOINHO NO SISTEMA.<br /><br /><br /><br />\r\nOBS: 1 - FAVOR PASSAR DIAGRAMA UNIFILAR DA SUBESTACAO COM QUADRO DE CARGA E MOMORIAL DE CALCULO.<br /><br /><br /><br />\r\n2- DURANTE O SERVICO TEREMOS QUE PASSAR APARELHOS: MEGA -MICROMIMETRO - TTR PAR', '1', '', '', '', '', '2200.00', '', '', '2200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-01-19', '2015-01-25', '2015-01-26', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(141, '326', 2015, 'junior', 'Aprovado', 'CONSTRUTORA GRANITO LTDA', '', '', '', '', '', '', '', '', 'wmelo_engcivil@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Disjuntor', '', '', 'PROPOSTA PARA PARAMETRIZACAO DAS PROTECOES COM AJUSTE DOS RELES, BASEADO NOS VALORES DE CALCULO DO PROJETO FORNECIDO PELA CAGECE, NO DISJUNTOR GERAL DE ENTRADA DA COELCE E DAS PROTECOES DAS SUBESTACOES DAS EBB-01 E EBB-02.', '10', '', '', '', '', '3000.00', '', '', '3000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-01-19', '2015-01-28', '2015-01-29', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(142, '22', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'MEDICAO DA MALHA DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA DOS SEGUINTES BRIQUEDOS; INSANO; RAMUBRINCAR; ARREPIOS; TORRE. LAUDO E ART.', '1', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-01-23', '2015-01-23', '2015-01-24', 6, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(143, '33', 2015, 'junior', 'Aprovado', 'RESTAURANTE LIMONE', '', '', '', '', '', '', '', '', 'danielle_costa20@hotmail.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'INSTALACAO DE UM DISJUNTOR TRIPOLAR DE BAIXA TENSAO DA SUBESTACAO, EM SUBSTITUICAO AO ATUAL QUE NAO ESTA OPERANDO.<br /><br /><br /><br />\r\n- 01 UND DISJUNTOR TRIPOLAR 175A 10KA TIPO CA ELETROMAR - FORNECIMENTO E TROCA DA CARGA DE OLEO DO TRANSFORMADOR DE 112,5 KVA COM VOLUME TOTAL DE 120 LITROS, POR OLEO NOVO TIPO AV-GOIN, PETROBRAS.', '1', '', '', '', '', '2403.00', '', '', '2403.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-06', '2015-02-09', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(144, '38', 2015, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'telma.maciel@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA INSTALACAO DE REDE ELETRICA NO ESTACIONAMENTO PARA ALUNOS III, QUE FOI ROUBADO, CONFORME RELACAO DE MATERIAIS ABAIXO;<br /><br /><br />\r\n40 MT - CABO ISOLADO 750V, 2,5MM<br /><br /><br />\r\n10 MT - CABO ISOLADO 750V 6,00MM', '2', '', '', '', '', '900.00', '', '', '900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-06', '2015-02-10', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(145, '39', 2015, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'telma.maciel@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA FAZER REDE ELETRICA NO ESTACIONAMENTO DOS ALUNOS III, QUE FOI ROUBADO.<br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO;<br /><br /><br />\r\n60MT - CABO DE ALUMINIO MULTIFLEXADO 16MM<br /><br /><br />\r\nVB - FITA ISOLANTE , TERMINAIS ETC', '2', '', '', '', '', '1000.00', '', '', '1000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-06', '2015-02-10', '2015-02-10', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(146, '44', 2015, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Aterramento', '', '', 'PROPOSTA PARA MELHORIA DO ATERRAMENTO NOS PAINEIS ELETRICOS E POSTE METALICO CONFORME A RELACAO ABAIXO;<br /><br /><br /><br />\r\n- QUADRO DA BOMBA DE RECALQUE;<br /><br /><br /><br />\r\n- QUADRO RAMAL 1 E 2;<br /><br /><br /><br />\r\n- QUADRO DO EXASTOR DA PADARIA;<br /><br /><br /><br />\r\n- POSTE METALICO;<br /><br /><br /><br />\r\n- QUADRO DO CAMARIM;<br /><br /><br /><br />\r\nOBS: COM A CONCLUSAO SERA EMITO LAUDO <br /><br /><br /><br />\r\nNOTA: MATERIAL FORNECIDO PELO BEACH PARK MARIUBA<br /><br ', '10', '', '', '', '', '6800.00', '', '', '6800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-10', '2015-02-25', '2015-02-27', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(147, '42', 2015, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA MEDICAO E INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICA; APOS AS MEDICOES SERAO EMITIDOS LAUDOS E ART.', '4', '', '', '', '', '1440.00', '', '', '1440.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-09', '2015-02-10', '2015-02-11', 2, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(148, '31', 2015, 'junior', 'Aprovado', 'SESC - SERVICO SOCIAL DO COMERCIO - SESC - AR.CE', '', '', '', '', '', '', '', '', 'wagnerbastos@sesc-ce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Laudo TÃ©cnico', 'Aterramento', '', '', 'PROPOSTA PARA FORNECIMENTO DE LAUDO TECNICO DE ATERRAMENTO ELETRICO NO SISTEMA DE PROTECAO CONTRA DESCARGA ATMOSFERICAS, NO PREDIO DE IGUATU- CE. <br /><br /><br />\r\n<br /><br /><br />\r\nLOCAL: SESC IGUATU', '2', '', '', '', '', '1800.00', '', '', '1800.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-10', '2015-03-03', '2015-03-04', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(149, '48', 2015, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'aristophanes.sousa@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Plantonista', '', '', 'SERVICO DE UMA DIARIA DE UM ELETRECISTA EXECUTADO NO DIA 11.02.2015 NA STOCK TECH.<br /><br /><br /><br />\r\n- ORDEM DE COMPRA NÂ° 739', '1', '', '', '', '', '288.00', '', '', '288.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-11', '2015-02-11', '2015-02-11', 8, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(150, '47', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Transformador', '', '', 'ESTACÃƒO DE TRATAMENTO<br /><br /><br />\r\n<br /><br /><br />\r\n1 - PROPOSTA PARA MANUTENCAO CORRETIVA NO TRAFO DE<br /><br /><br />\r\n112,5KVA DE NÂ° A91406, ANO FABRICACAO 2012.<br /><br /><br />\r\n- SERVICOS A SER REALIZADO;<br /><br /><br />\r\n- TRATAMENTOS DOS TERMINAIS DE ALTA E BAIXA TENSAO QUE<br /><br /><br />\r\nESTAO OXIDADOS;<br /><br /><br />\r\n- PINTURA EXTERNA;<br /><br /><br />\r\n- TROCA DOS TRES PARA-RAIO CLASSE 12KV, 10KA;<br /><br /><br />\r\n- SECAGEM DA PARTE ATIVA NA ESTUFA 48 HORAS;<', '8', '', '', '', '', '3200.00', '', '', '3200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-19', '2015-03-02', '2015-03-25', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(151, '46', 2015, 'junior', 'Aprovado', 'MINISTERIO DA SAUDE', '', '', '', '', '', '', '', '', 'selma.mota@saude.gov.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE EMERGENCIA PARA SUBISTIRUICAO DE UMA CHAVE DE BAIXA TENSAO IRTA DE 1000A, TIPO DTI QUE NAO<br /><br /><br /><br />\r\nEXISTE MAIS NO COMERCIO; ELIMANDO A CHAVE E SUBISTITUINDO PELA CABIACAO DE COBRE FICANDO PROTEGIDO PELOS TRES FUSIVEIS DE 1000A EXISTENTES.', '2', '', '', '', '', '7120.00', '', '', '7120.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-19', '2015-02-21', '2015-02-23', 0, 0, 1, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(152, '41', 2015, 'junior', 'Aprovado', 'OSASUNA PARTICIPACOES LTDA', '', '', '', '', '', '', '', '', 'ivon@jangadeirotextil.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'CONFORME LAUDO DE OLEO ISOLANTE DOS TRANSFORMADORES DE 1000KVA, NÂ° 123526.NÂ° 123527 E NÂ° 90102, ESTAMOS PASSANDO PROPOSTA PARA FAZER TRATAMENTO DO OLEO MINERAL ISOLANTE PELO PROCESSO TERMO-VACUO CORRIGIR TEOR DE AGUA E RIGIDEZ DIELETRICA.<br /><br /><br /><br /><br />\r\nNOTA<br /><br /><br /><br /><br />\r\n1 - A ELFI GARANTE O VALOR DE TEOR DE AGUA SATISFATORIO DA AMOSTRA APOIS O TRATAMENTO.<br /><br /><br /><br /><br />\r\n2 - TRATAMENTO COM OS TRES TRANSFORMADORES ENERGIZADOS', '20', '', '', '', '', '8000.00', '', '', '8000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-12', '2015-02-19', '2015-03-09', 8, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(153, '49', 2015, 'junior', 'Aprovado', 'COBAP-COM. E BENEFICIAMENTO DE ARTEFATOS DE PAPEL', '', '', '', '', '', '', '', '', 'suprimentos2@cobap.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', '- VISITA TECNICA REALIZADA 20/02/2015 DE EMERGENCIA, ONDE FOI RECLAMADO UM PROBLEMA NO TRANSFORMADOR DA SUBESTACAO, A ELFI APLICOU OS APARELHOS DE MEDICOES ELETRICAS NO MESMO CONSTATANDO QUE O MESMO ESTA SEM PROBLEMAS. O REAL PROBLEMA FOI INDENTIFICADO EM UM DISJUNTOR DE BAIXA TENSAO NO QGBT DA SUBESTACAO ONDE O RESPONSAVEL DA POC, SR. ALEX, FICOU DE SUBSTITUIR O MESMO.<br /><br /><br />\r\nNOTA: RECOMENDAMOS UMA MANUTENCAO PREVENTIVA GERAL NA SUBESTACAO (SEGUE EM NOVO ORCAMENTO)', '1', '', '', '', '', '450.00', '', '', '450.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-20', '2015-02-20', '2015-02-20', 5, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(154, '18', 2015, 'junior', 'Aprovado', 'INVESTAR HOTELARIA S/A', '', '', '', '', '', '', '', '', 'infra.fortaleza@bluetree.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA DA SUBESTACAO ABRIGADA COM dOIS TRANSFORMADORES A SECO DE 500KVA, DISJUNTOR DE MEDIA TENSAO, CHAVES SECCIONADORAS E QUADRO GERAL DE BAIXA TENSAO, CONFORME RELACAO DE SERVICOS ABAIXO:', '3', '', '', '', '', '1600.00', '', '', '1600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-25', '2015-04-02', '2015-04-02', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(155, '40', 2015, 'junior', 'Aprovado', 'INVESTAR HOTELARIA S/A', '', '', '', '', '', '', '', '', 'infra.fortaleza@bluetree.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'MANUTENCAO PREVENTIVA E CORRETIVA DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS SPDA, COM MEDICOES DA RESISTENCIA DA MALHA DE TERRA E SUBISTITUICAO DO MASTRO E DEMAIS COMPONENTES ABAIXO;<br /><br /><br />\r\n01 UND - MASTRO F.G A FOGO 4M X 1 1/2<br /><br /><br />\r\n01 UND - BASE PARA MASTRO 1 1/2" G. A FOFO<br /><br /><br />\r\n04 UND - ISOLADOR PARA MASTRO 1 1/2 X 2<br /><br /><br />\r\n01 UND - CAPITOR CROMADO LATAO 300MM PARA 2 DESCIDAS<br /><br /><br />\r\n20 MT - CABO DE ACO ISOLADO COM PLAST', '5', '', '', '', '', '1675.00', '', '', '1675.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-25', '2015-03-02', '2015-03-10', 1, 0, 3, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(156, '62', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'fabianosilva@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Disjuntor', '', '', 'PROPOSTA PARA MANUTENCAO CORRETIVA DE UM DISJUNTOR DE MEDIA TENSAO 17KV, FABRICACAO BEGHIM NÂ° 1780 17,5KV; 630A A VACUO, CONFORME DESCRICAO DOS SERVICOS ABAIXO;<br /><br /><br />\r\n- TRANSPORTE<br /><br /><br />\r\n- PINTURA NO GABINETE<br /><br /><br />\r\n- TRATAMENTO DAS PARTES ISOLANTES<br /><br /><br />\r\n- TRATAMENTO DOS 3 TC"S<br /><br /><br />\r\n- TRATAMENTO DAS BARRAS DE COBRE E PARAFUSOS ETC<br /><br /><br />\r\n- ENSAIOS ELETRICOS;<br /><br /><br />\r\n- MEDICAO DE RESISTENCIA DE ISOLAMENTO<br ', '5', '', '', '', '', '2650.00', '', '', '2650.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-26', '2015-02-26', '2015-03-13', 0, 0, 10, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(157, '189 /14', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Aterramento', '', '', 'PROPOSTA PARA MANUTENCAO CORRETIVA NA MALHA DE TERRA DOS PAINEIS ELETRICOS DOS BRIQUEDOS: ACQUA CIRCO, QGBT-1211, QUANDO INSANO, QUADRO MOREIA NEGRA, QUADRO ZUMPTCHIBUM, QUADRO NS-0215, BOMBA 4 CORRENTEZA, QUADRO DE BOMBA NS-50213, CORRENTEZA BOMBA 3, CCM ATLANTIS NS-0344 NUM TOTAL DE 10 PAINEIS.<br /><br /><br /><br />\r\n- RELACAO DE MATERIAIS ABAIXO:<br /><br /><br /><br />\r\n40 UND - HASTE TERRA 5/8 X 2,40 MTS COBREADA ROSCADA<br /><br /><br /><br />\r\n40 UND - LUVA PARA HASTE TERRA 5/8<br /><br', '10', '', '', '', '', '9950.00', '', '', '9950.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-02-26', '2015-03-04', '2015-03-05', 5, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(158, '65', 2015, 'junior', 'Aprovado', 'CONDOMINIO DO BEACH PARK RESORT - Mariuba', '', '', '', '', '', '', '', '', 'jonatan@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SPDA', '', '', 'PROPOSTA PARA MELHORIA DO ATERRAMENTO NOS PONTOS DAS TORRE 1 E 2, EM UM TOTAL DE 4 PONTOS.<br /><br />\r\nOBS: COM A CONCLUSAO SERA EMITO LAUDO<br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELO BEACH PARK MARIUBA;<br /><br />\r\n30 MT - CABO DE COBRE NU DE 35MM<br /><br />\r\n12 UND - HASTE DE TERRA ROSCADA 5/8 X 2,400<br /><br />\r\n12 UND - LUVA PARA HASTE DE TERRA 5/8<br /><br />\r\n30 UND - CONECTOR TIPO GRAMPO REFORCADO<br /><br />\r\n04 DOSE - TERROGEL', '10', '', '', '', '', '3260.00', '', '', '3260.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-04', '2015-03-04', '2015-03-04', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(159, '64', 2015, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hsmce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', '1- PROPOSTA PARA SERVICO DE MODIFICACAO NAS INSTALACOES DA SUBESTACAO;<br /><br /><br /><br /><br /><br /><br />\r\n1.1 - FAZER BY PASS D TRANSFORMADOR - TR-02 E TR-03 TRAFOS DE 300KVA; PARA RETIRADA DOS CABOS GERADOR E QUADRO DE TRANSFERENCIA.<br /><br /><br /><br /><br /><br /><br />\r\n1.2 - FAZER BY PASS DO TRAFO DE 500KVA PARA A RETIRADA DOS CABOS DO GERADOR E RETIRADA DO QUADRO DE TRANSFERENCIA.<br /><br /><br /><br /><br /><br /><br />\r\n1.3 - FAZER INSTALACAO DO GRUPO GERADOR COM PASSAGEM DOS', '1', '', '', '', '', '18500.00', '', '', '18500.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-04', '2015-03-28', '2015-03-28', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(160, '66', 2015, 'junior', 'Aprovado', 'INSTITUTO DOENCAS RENAIS', '', '', '', '', '', '', '', '', 'helenajuca@grupoinstitutodorim.med.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 225KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', '16', '', '', '', '', '1215.00', '', '', '1215.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-06', '2015-03-15', '2015-03-30', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(161, '67', 2015, 'junior', 'Aprovado', 'INSTITUTO DO RIM', '', '', '', '', '', '', '', '', 'helenajuca@grupoinstitutodorim.med.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 150KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', '16', '', '', '', '', '1215.00', '', '', '1215.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-06', '2015-03-15', '2015-03-30', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(162, '68', 2015, 'junior', 'Aprovado', 'POLICLINICA DO RIM S/S LTDA', '', '', '', '', '', '', '', '', 'helenajuca@grupoinstitutodorim.med.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'MANUTENCAO PREVENTIVA EM UM SUBESTACAO DE 112,5KVA AEREA CONFOME RELACAO SERVICOS ABAIXO:', '16', '', '', '', '', '1215.00', '', '', '1215.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-06', '2015-03-22', '2015-04-22', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(163, '71', 2015, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'francisco.sousa@estacio.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE EMERGENCIA EXECUTADO DIA 07/03/2015 (SAB) COM RETIRADA DE UM TC (TRANSFORMADOR DE CORRENTE), DEIXANDO UM BYPASS NO MESMO; E DIA 09/03/2015 (SEG) COM RETIRADA DE UM FUSIVEL HH 20A, CLASSE 15KV DO TRANSFORMADOR NÂº02. <br /><br /><br />\r\nLOCAL: FIC VIA CORPUS - SUBESTACAO DO BLOCO NOVO', '5', '', '', '', '', '2050.00', '', '', '2050.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-07', '2015-03-07', '2015-03-09', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(164, '72', 2015, 'junior', 'Aprovado', 'RENAGUA IND. E COM. DE AGUA LTDA', '', '', '', '', '', '', '', '', 'contato@renagua.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Banco de Capacitores', '', '', 'MANUTENCAO PREVENTIVA EM UM BANCO DE CAPACITOR CONFORME FOTO ENVIADA.<br /><br /><br />\r\n- LIMPEZA GERAL COM PRODUTOS APROPRIADOS.<br /><br /><br />\r\n- LEVANTAMENTO DAS POTENCIAS DOS CAPACITORES, PARA<br /><br /><br />\r\nAVALIAR O RENDIMENTO DOS MESMOS.<br /><br /><br />\r\n- MEDICAO DA CORRENTE ELETRICA EM CADA FASE.<br /><br /><br />\r\n- REAPERTO DAS CONEXOES.<br /><br /><br />\r\n- EMISSAO DE LAUDO.', '4', '', '', '', '', '550.00', '', '', '550.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-10', '2015-03-10', '2015-03-12', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(165, '57', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA PARA INSTALACAO DE 03 CHAVES FUSIVEIS CLASSE 25KV E TROCA DE UM QUADRO DE PROTECAO SECUNDARIA, PARA ADEQUACAO DA SUBESTACAO AEREA 112,5KVA DA ESTACAO DE TRATAMENTO ETA.<br /><br /><br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI<br /><br /><br /><br />\r\n03 UND - CHAVE FUSIVEL CLASSE 25KV 300A COM ELO FUSIVEL<br /><br /><br /><br />\r\n01 UND - QUADRO DE PROTECAO SECUNDARIA SUBESTACAO<br /><br /><br /><br />\r\nAEREA DE 1125,5KA PADRAO COELCE.', '4', '', '', '', '', '2918.00', '', '', '2918.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-12', '2015-03-13', '2015-03-13', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(166, '69', 2015, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'aristophanes.sousa@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'PROPOSTA PARA MUDANCA DE TAP DE UM TRANSFORMADOR DE 750KVA. COM A COM A CONCLUSAO DO SERVICO SERA FEITO MEDICOES DE RESISTENCIA DE CONTATO E DE RELACAO DE TRANSFORMACAO (TTR).', '1', '', '', '', '', '880.00', '', '', '880.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-12', '2015-03-15', '2015-03-16', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(167, '75', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'Aterramento', '', '', '- MEDICAO DE ATERRAMENTO EM 01 (UM) QUADRO COM EMISSAO DE LAUDO.<br /><br />\r\nLOCAL: PARQUE - QUADRO GERAL DAS CABANAS', '2', '', '', '', '', '600.00', '', '', '600.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-12', '2015-03-12', '2015-03-12', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(168, '78', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'fabianosilva@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Material', 'Equipamento SubestaÃ§Ã£o', '', '', 'FORNECIMENTO VERGALHAO COBRE 3/8 X 3000MM, NUM TOTAL DE 03 PECAS, CONFORME SOLICITADO.', '1', '', '', '', '', '550.00', '', '', '550.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-13', '2015-03-13', '2015-03-13', 3, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(169, '79', 2015, 'junior', 'Aprovado', 'STL INFORMATICA LTDA ', '', '', '', '', '', '', '', '', 'nunes@stl.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'pROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA SUBESTACAO AEREA COM UM TRANSFORMADOR DE 112,5 KVA E QUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME RELACAO DE SERVICO EM ANEXO', '16', '', '', '', '', '1477.00', '', '', '1477.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-17', '2015-03-19', '2015-03-20', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(170, '84', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'emerson@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Material', 'Fornecimento', '', '', 'MATERIAL FORNECIDO PARA SER INSTALADO NA SUBESTACAO DA ESTACAO DE ESGOTO DO PARQUE EM 23/03/2015<br /><br /><br />\r\n- 03 UND ISOLADOR ANCOR POLIM SUSP 25KV<br /><br /><br />\r\n- 02 UND CURVA<br /><br /><br />\r\n- 03 UND LUVAS', '1', '', '', '', '', '570.00', '', '', '570.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-23', '2015-03-23', '2015-03-24', 1, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(171, '91', 2015, 'junior', 'Aprovado', 'INSTITUTO DOENCAS RENAIS', '', '', '', '', '', '', '', '', 'helenajuca@grupoinstitutodorim.med.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA INSTALACAO DO CABO DE ATERRAMENTO De COBRE NU DE 35MM NO QUADRO GERAL DE BAIXA TENSAO PARA QUE A SUBESTACAO FIQUE DENTRO DOS PADROES DE SEGURANCA.', '1', '', '', '', '', '400.00', '', '', '400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-31', '2015-04-07', '2015-04-08', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(172, '85', 2015, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'angelo.zavadski@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'MediÃ§Ã£o', 'SPDA', '', '', 'INSPECAO DO SISTEMA DE PROTECAO CONTRA DESCARGAS ATMOSFERICAS E MEDICAO DE RESISTENCIA OHMICA DA MALHA DE ATERRAMENTO, COM A CONCLUSAO SERA REMETIDO RELATORIO TECNICO E ART DO CREA-CE.', '3', '', '', '', '', '1000.00', '', '', '1000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-31', '2015-03-31', '2015-03-31', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(173, '86', 2015, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'gustavo_oliveira@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Equipamentos ElÃ©tricos', '', '', '1 - PROPOSTA PARA RETIRADA DE UM MOTOR DA CAIXA DAGUA E INSTALACAO DE UM NOVO (1CV, MONOFASICO, 127/220V) FORNECIDO PELA ELFI.<br /><br /><br />\r\n2 - CONSERTO DE UM MOTOR BUSCK TYPE: M563B-4', '5', '', '', '', '', '1680.00', '', '', '1680.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-03-25', '2015-03-25', '2015-04-06', 13, 0, 7, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(174, '99', 2015, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'aristophanes.sousa@stocktech.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'SubestaÃ§Ã£o', '', '', 'SERVICO DE EMERGENCIA REALIZADO NO DIA 07/04/2015 A NOITE, NA SUBESTACAO ELETRICA ONDE FORAM REALIZADO INSPECAO VISUAL NO DISJUNTOR DE ALTA TENSAO, DISJUNTOR DE BAIXA TENSAO , TRANSFORMADOR, CHAVES ETC. FOI CONSTATADO QUE DOIS PORTA FUSIVEIS TINHA DESARMADO, FOI REALIZADO A TROCA DOS FUSIVEIS RESTABELECIDO E FORNECIMENTO DE ENERGIA.(RECOMENDAMOS A TROCA DAS 3 CHAVES FUSIVEIS DO POSTE PARA CLASSE 25KV)', '1', '', '', '', '', '960.00', '', '', '960.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-04-07', '2015-04-07', '2015-04-08', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(175, '56', 2015, 'junior', 'Aprovado', 'AMENDOAS DO BRASIL LTDA', '', '', '', '', '', '', '', '', 'brito@amendoasdobrasil.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ServiÃ§o TÃ©cnico', 'Transformador', '', '', 'PROPOSTA PARA FILTRAGEM DE OLEO ISOLANTE PELO O PROCESSO TERMO VACUO EM 02 (DOIS) TRANSFORMADOR SENDO UM 500KVA E OUTRO DE 300KVA APOS A FILTRAGEM SERA EMITIDO UM NOVO RELATORIO DE ANALISE DE OLEO.', '3', '', '', '', '', '3200.00', '', '', '3200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-04-13', '2015-04-21', '2015-04-22', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(176, '93', 2015, 'junior', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'francisco@holidayfortaleza.com.br', '', '', '', '', '', '', '', '', '', '', '', 'InstalaÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- PROPOSTA PARA MONTAGEM DE ELETROCALHA COM PASSAGEM DOS CABOS E INTERLIGACAO COM O GERARDOR NOVO.<br /><br /><br />\r\nOBS: RELACAO DE MATERIAL ABAIXO FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 UND - CALHA PERFURADA 200 X 50 X 300<br /><br /><br />\r\n03 UND - EMENDA PARA CALHA 200 X 50 JUNCAO INTERNA<br /><br /><br />\r\n06 UND - SUPORTE ANGULAR 200 X 50<br /><br /><br />\r\n09 MT - BARRA ROSCADA DE 3/8"<br /><br /><br />\r\n15 UND - GANCHO CURTO PARA PREFILADO<br /><br /><br />\r\n50 UND - PORCA SERTAVAD', '5', '', '', '', '', '2116.00', '', '', '2116.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-04-08', '2015-04-13', '2015-05-13', 5, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(177, '111', 2015, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'fabianosilva@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'Projeto e InstalaÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA FAZER UM NOVO PROJETO APROVADO NA COELCE, DO RAMAL DE ENTRADA DA SUBESTACAO DO ACQUARESORT CONFORME CARTA PROJETO NÂ° 013/2015, ONDE SERA FEITO ESTUDO E CALCULOS COORDERNACAO E SELETIVIDADE, COM AJUSTE DA PROTECAO E ADEQUACAO DO PROJETO DENTRO DAS EXISTENCIAS DA COELCE.', '30', '', '', '', '', '5000.00', '', '', '5000.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2015-04-16', '2015-04-16', '2015-04-16', 1, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(178, '5', 2016, 'junior', 'Aprovado', 'INSTITUTO DOENCAS RENAIS', '', '', '', '', '', '', '', '', 'helenajuca@grupoinstitutodorim.med.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA INSTALACAO DE CABO DE ATERRAMENTO DA 1,00 980,00 980,00<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nSUBESTACAO AEREA DE 225KVA, EM SUBISTITUICAO AO OUTRO<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nQUE FOI ROUBADO. O CABO DEPOIS DE INSTALADO SERA<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />\r\nREVERTIDO E COM PROTECAO DE CIMENTO NA DECIDA DO<br /><br /><br /><br /><br /><br /><br ', '1', '', '', '', '', '980.00', '', '', '980.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-07', '2016-01-07', '2016-01-07', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(179, '2', 2016, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'atylabrasil@hsmce.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- PROPOSTA COM SISTEMA ENERGIZADO PARA INSTALACAO 1,00 17.840,00 17.840,00<br /><br /><br /><br /><br /><br />\r\nCOM PASSAGENS DE CABOS DO QTA PARA O QUADRO DE<br /><br /><br /><br /><br /><br />\r\nEMERGENCIA. COM OS DEMAIS SERVICOS;<br /><br /><br /><br /><br /><br />\r\n- RETIRADA DO BY PASS GERADOR PROVISORIO PARA O QGBT<br /><br /><br /><br /><br /><br />\r\n- RETIRADA DOS 5 CIRCUUITOS TRIFASICOS DE 300KVA PARA<br /><br /><br /><br /><br /><br />\r\nQGBT 500KVA<br /><br /><br /><br /><br /><br />\r\n-', '5', '', '', '', '', '17840.00', '', '', '17840.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-12', '2016-01-23', '2016-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(180, '03', 2016, 'junior', 'Aprovado', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', '', '', '', '', '', '', '', '', 'wildenbergy.lucas@nacionalgas.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '1 - CONFORME CARTA COELCE: PROJETO DE NÂ° 195/2015, 1,00 12.162,00 12.162,00<br /><br />\r\nESTAMOS PASSANDO PROPOSTA PARA PROJETO ELETRICO<br /><br />\r\nREFERENTE A UM ACRESCIMO DE POTENCIA DE 150KVA PARA<br /><br />\r\n600KVA, AFIM DE ATENDER AS NOVAS CARGAS. DESCRICAO<br /><br />\r\nCONFORME ABAIXO;<br /><br />\r\n1.1 - PROVIDENCIAR DOCUMENTACAO EXIGIDO PELA COELCE.<br /><br />\r\n1.2 - FAZER NOVA ART.<br /><br />\r\n1.3 - REFAZER NOVO MEMORIAL DESCRITIVO PARA SE<br /><br />\r\nENQUADRA DENTRO DAS ESPECIFIC', '30', '', '', '', '', '12162.00', '', '', '12162.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-11', '2016-01-12', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(181, '10', 2016, 'junior', 'Aprovado', 'INAPI INDUSTRIA NAC. DE ACESS. PARA IRRIGACAO S/A', '', '', '', '', '', '', '', '', 'jrbsousa@yahoo.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA INSPECAO EM DOIS TRANSFORMADORES DE 1,00 1.960,00 1.960,00<br /><br /><br /><br />\r\n750KVA E OUTRO DE 500KVA, ONDE FOI REALIZADO OS<br /><br /><br /><br />\r\nSEGUINTES ENSAIOS; RESISTENCIA OHMICA DE ISOLAMENTO,<br /><br /><br /><br />\r\nRESISTENCIA OHMICAS ENROLAMENTOS, RELACAO DE<br /><br /><br /><br />\r\nTRANSFROMACAO (TTR), COLETA DE OLEO NOS DOIS<br /><br /><br /><br />\r\nTRANSFOS, PARA ENSAIO FISICO-QUIMICO E<br /><br /><br /><br />\r\nCROMATOGRAFICO NO TRANSFORMADOR DE 750KVA.', '5', '', '', '', '', '1900.00', '', '', '1900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-13', '2016-01-09', '2016-01-27', 0, 0, 13, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(182, '09', 2016, 'junior', 'Aprovado', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', '', '', '', '', '', '', '', '', 'thiago.alencar@nacionalgas.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA MANUTENCAO CORRETIVA DE UM DISJUNTOR 1,00 3.580,00 3.580,00<br /><br /><br /><br />\r\nDE MEDIA TENSAO AEC, TIPO DSF, 630A, 17,5KV, CONFORME<br /><br /><br /><br />\r\nDESCRICAO DE SERVICO ABAIXO;<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO PARA JORNAL O POVO<br /><br /><br /><br />\r\n- TROCA DE 3 BARRA DE TRACAO<br /><br /><br /><br />\r\n- REGULAGEM LUBRIFICADO COMANDO<br /><br /><br /><br />\r\n- REGULAGEM E TROCA DE OLEO D', '15', '', '', '', '', '3580.00', '', '', '3580.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-13', '2016-01-11', '2016-01-27', 1, 0, 1, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(183, '13', 2016, 'junior', 'Aprovado', 'FIORI INDUSTRIA E COMERCIO DE CONFECCOES LTDA', '', '', '', '', '', '', '', '', 'Lany Gomes <lany@turmadamalha.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA 1,00 1.350,00 1.350,00<br /><br /><br /><br /><br /><br />\r\nSUBESTACAO AEREA COM UM TRANSFORMADOR DE 150 KVA E<br /><br /><br /><br /><br /><br />\r\nQUADRO GERAL DE BAIXA TENSAO DA SUBESTACAO, CONFORME<br /><br /><br /><br /><br /><br />\r\nRELACAO DE SERVICO EM ANEXO.', '1', '', '', '', '', '1350.00', '', '', '1350.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-15', '2016-02-13', '2016-02-29', 0, 0, 16, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(184, '15', 2016, 'junior', 'Aprovado', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '', '', '', '', '', '', '', '', 'Emerson Oliveira da Silva <emerson@beachpark.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA MANUTENCAO CORRETIVA NO DISJUNTOR DE 1,00 3.400,00 3.400,00<br /><br /><br /><br />\r\nMEDIA TENSAO FABRICACAO BEGHIM NÂ° FABRICACAO 1780,<br /><br /><br /><br />\r\nCLASSE 15KV 630A, TIPO PL COM TRES TRANSFORMADORES DE<br /><br /><br /><br />\r\nCORRENTE, E 01 (TP A OLEO )<br /><br /><br /><br />\r\n- RETIRADA E TRANSPORTE PARA OFICINA DA ELFI E<br /><br /><br /><br />\r\nDEVOLUCAO<br /><br /><br /><br />\r\n- REGULAGEM LUBRIFICADO COMANDO<br /><br /><br /><br />\r\n- RECUPERACAO DAS PARTES ISO', '10', '', '', '', '', '3400.00', '', '', '3400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-19', '2016-01-18', '2016-02-02', 0, 0, 5, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(185, '21', 2016, 'junior', 'Aprovado', 'CRAVEIRO IMOBILIARIA LTDEA', '', '', '', '', '', '', '', '', 'ana@craveiroimobiliaria.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '1 - CONFORME LAUDO COELCE NÂ° UC. 9010524, DE 30/12/2015 1,00 554,00 554,00<br /><br />\r\nESTAMOS PASSANDO RELACAO DE MATERIAL FORNECIDO PELO<br /><br />\r\nCLIENTE E MAO DE OBRA DA ELFI PARA CORRIGIR VALOR<br /><br />\r\nATERRAMENTO PARA VALORES ABAIXO DE 10 HOMIS.<br /><br />\r\n- VALOR DA MAO DE OBRA<br /><br />\r\n1,00 0,00 0,00<br /><br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELO CLIENTE;<br /><br />\r\n06 UND - HASTE TERRA ROSCADA 5/8" X 2,40MTS<br /><br />\r\n06 UND - LUVA PARA HASTE DE TERRA<br /', '1', '', '', '', '', '554.00', '', '', '554.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-21', '2016-03-24', '2016-03-24', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(186, '342-15', 2016, 'junior', 'Aprovado', 'GERDAU ACOS LONGOS S/A', '', '', '', '', '', '', '', '', 'jefferson.pereira@gerdau.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA MEDICAO E INSPECAO DO SISTEMA DE 1,00 7.750,00 7.750,00<br /><br /><br /><br /><br />\r\nPROTECAO CONTRA DESCARGAS ATMOSFERICAS SPDA, SENDO<br /><br /><br /><br /><br />\r\nUM TOTAL DE 89 PONTOS A SEREM MEDIDOS, E 189 CAIXA DE<br /><br /><br /><br /><br />\r\nINSPECAO A SEREM INSPECIONADOS . SERA TIRADO FOTO DOS<br /><br /><br /><br /><br />\r\nPONTOS COM FALHAS PARA CORRECAO APOS A CONCLUSAO<br /><br /><br /><br /><br />\r\nSERA FORNECIDO LAUDO COM ART.<br /><br /><br /><br /><br />\r\n- SE', '15', '', '', '', '', '7750.00', '', '', '7750.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-21', '2016-01-27', '2016-02-15', 0, 0, 4, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(187, '27', 2016, 'junior', 'Aprovado', 'BRADESCO AG. JOAO DE CASTRO EST UNIF', '', '', '', '', '', '', '', '', '0643.adm@bradesco.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- SERVICO DE EMERGENCIA JA EXECUTADO DIA 25/01/2016 DE 1,00 1.400,00 1.400,00<br /><br /><br />\r\nMANUTENCAO CORRETIVA NO QGBT DA SUBESTACAO DESTA<br /><br /><br />\r\nAGENCIA BRADESCO, COM FORNECIMENTO E TROCA DO<br /><br /><br />\r\nDISJUNTOR GERAL DE BAIXA TENSAO DA MESMA.', '1', '', '', '', '', '1400.00', '', '', '1400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-25', '2016-01-25', '2016-01-25', 0, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(188, '26', 2016, 'junior', 'Aprovado', 'CONSTRUTORA GRANITO LTDA', '', '', '', '', '', '', '', '', 'vandemberg@msn.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', ' CONCLUIR A MONTAGEM DE UMA SUBESTACAO ABRIGADA DA CAGECE NO PECEM DE 500KVA COM DISJUNTOR EVOKIT BLINDADO. FALTA FAZER OS SEGUINTES SERVICOS;<br /><br /><br />\r\n1 - FAZER MUFLAS DO RAMAL DE ENTRADA NO POSTE <br /><br /><br />\r\n2 - FAZER MUFLAS DO CUBICULO DE ALTA TENSAO<br /><br /><br />\r\n3 - FAZER MUFLAS DO TRANSFORMADOR DE 500KVA<br /><br /><br />\r\n4 - CONECTAR MUFLAS NA CHAVE FUSIVEL DO RAMAL DE ENTRADA <br /><br /><br />\r\n5 - LIMPEZA DO TRANSFORMADOR E DISJUNTOR DE ALTA TENSAO <br /><br /><', '5', '', '', '', '', '6690.00', '', '', '6690.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-01-28', '2016-01-28', '2016-02-05', 0, 0, 3, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(189, '8', 2016, 'junior', 'Aprovado', 'NACIONAL GAS BUTANO DISTRIBUIDORA LTDA', '', '', '', '', '', '', '', '', 'raimundo.gomes@nacionalgas.com.br] ', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA MANUTENCAO CORRETIVA COM TROCA DE 1,00 3.456,00 3.456,00<br /><br />\r\nTRES CHAVES SECCIONADORA TRIPOLAR 25KV, 400A, E<br /><br />\r\nISOLADORES DE PEDESTAL 25KV NA SUBESTACAO ELETRICA<br /><br />\r\nPARA ADEQUACAO FUTURA AO PROJETO DE MODERNIZACAO DA<br /><br />\r\nMESMA, A SER APROVADO NA COELCE.', '2', '', '', '', '', '3456.00', '', '', '3456.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-02-05', '2016-04-03', '2016-04-04', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(190, '44', 2016, 'junior', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'ricardo@beachpark.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'PROPOSTA PARA TRATAMENTO TERMO VACUO NO OLEO 1,00 2.200,00 2.200,00<br /><br /><br /><br />\r\nISOLANTE DO TRANSFORMADOR DE 500KVA, NÂ° 128787, PARA<br /><br /><br /><br />\r\nCORRIGIR RIGIDEZ DIELETRICA E TEOR DE AGUA QUE ESTAO<br /><br /><br /><br />\r\nFORA DOS VALORES PADROES PARA OLEO EM USO. COM A<br /><br /><br /><br />\r\nCONCLUSAO SERA FORNECIDO NOVO LAUDO.', '1', '', '', '', '', '2200.00', '', '', '2200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-02-17', '2016-02-17', '2016-02-29', 0, 0, 12, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(191, '37', 2016, 'junior', 'Aprovado', 'YPIOCA AGRICOLA LTDA', '', '', '', '', '', '', '', '', 'FRANCISCO.CALIXTO@YPIOCA.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'MANUTENCAO CORRETIVA EM DOIS TRANSFORMADORES DE 1,00 8.868,00 8.868,00<br /><br /><br /><br />\r\n75KVA, NÂ° 127483 E NÂ° 220.817.', '20', '', '', '', '', '8868.00', '', '', '8868.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-02-16', '2016-02-15', '2016-02-26', 9, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(192, '42', 2016, 'junior', 'Aprovado', 'STOCK TECH LOGISTICA', '', '', '', '', '', '', '', '', 'angelo.zavadski@stockteach.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- SERVICO DE EMERGENCIA NA SUBESTACAO ELETRICAS NO DIA 1,00 0,00 0,00<br /><br /><br />\r\n12.02.2016 AS 20:00 HORAS: PROBLEMA NA CHAVE FUSIVEL DO<br /><br /><br />\r\nRAMAL DE ENTRADA COM ELO ROMPIDO OCASIONANDO FALTA<br /><br /><br />\r\nDE FASE NO QGBT. FOI REALIZADO A TROCA DO ELO E AJUSTE<br /><br /><br />\r\nDA LAMINA DE CONTATO DA MESMA, COMO MEDIDA PALEATIVA<br /><br /><br />\r\nRECOMENDAMOS A TROCA COM URGENCIA.<br /><br /><br />\r\n- RELACAO DE MATERIAL FORNECIDO PELA ELFI;<br /><br /><br />\r\n03 U', '1', '', '', '', '', '3220.00', '', '', '3220.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-02-23', '2016-02-28', '2016-02-29', 2, 0, 0, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(193, '28', 2016, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'Atyla Brasil <atylabrasil@hsmce.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- TRATAMENTO DO OLEO ISOLANTE PELO PROCESSO 1,00 3.980,00 3.980,00<br /><br />\r\nTERMO-VACUO EM 02 TRANFORMADORES DE 300KVA, PARA<br /><br />\r\nCORRIGIR TEOR DE AGUA E RIGIDEZ E DIELETRICA DOS<br /><br />\r\nMESMOS. APOS TRATAMENTO SERA FEITA NOVA ANALISE DE<br /><br />\r\nOLEO ISOLANTE', '2', '', '', '', '', '3980.00', '', '', '3980.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-02', '2016-04-03', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(194, '29', 2016, 'junior', 'Aprovado', 'HOSPITAL SAO MATEUS S/C LTDA', '', '', '', '', '', '', '', '', 'Atyla Brasil <atylabrasil@hsmce.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '- PROPOSTA PARA MANUTENCAO PREVENTIVA DE UMA 1,00 4.820,00 4.820,00<br /><br />\r\nSUBESTACAO ABRIGADA: COM TRES TRANSFORMADORES, DOIS<br /><br />\r\nTR - 300KVA A OLEO ISOLANTE E UM 500KVA A SECO, COM<br /><br />\r\nDISJUNTOR DE ALTA TENSAO DOIS QUADROS GERAIS DE BAIXA<br /><br />\r\nTENSAO E UMA SUBESTACAO AEREA DE 150 KVA DA<br /><br />\r\nLAVANDERIA.<br /><br />\r\nCONFORME RELACAO DE SERVICOS ABAIXO:', '11', '', '', '', '', '4820.00', '', '', '4820.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-02', '2016-04-02', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(195, '48', 2016, 'junior', 'Aprovado', 'SOCIEDADE DE ENSINO SUPERIOR DO CEARA LTDA', '', '', '', '', '', '', '', '', 'sami@bayde.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'PROPOSTA PARA INSTALACAO DE 6 MEDIDORES DE ENERGIA 1,00 4.147,00 4.147,00<br /><br /><br />\r\nMONOFASICO COM PASSAGEM DOS CABOS PARA ALIMENTACAO<br /><br /><br />\r\nDOS 6 QUIOSQUE DOS NOVOS BLOCOS.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA', '6', '', '', '', '', '3455.00', '', '', '3455.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-02', '2016-03-10', '2016-03-18', 0, 0, 2, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(196, '62', 2016, 'junior', 'Aprovado', 'COLMEIA FATIMA RESIDENCE EMPREENDIMENTOS IMOB', '', '', '', '', '', '', '', '', 'PAULOESTEVAO@COLMEIA.COM.BR3', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'LAUDO DE ATERRAMENTO ', '2', '', '', '', '', '960.00', '', '', '960.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-07', '2016-03-08', '2016-03-21', 0, 0, 11, 's', 's', 'n', '', 'n', '0000-00-00', '', 's'),
(197, '55', 2016, 'eduardo_reboucas', 'Aprovado', 'GERDAU ACOS LONGOS S/A', '', '', '', '', '', '', '', '', 'BRUNO LEONARDO GOMES - 37067139 <bruno.gomes@gerdau.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', '1 - PROPOSTA PARA REFORMA COM TROCA E RECOLACAO DE 1,00 33.910,00 33.910,00<br /><br />\r\nLUMINARIAS EM 8 POSTES DE 15M, COM INTALACAO DE PAINEIS<br /><br />\r\nE DEMAIS SERVICOS, CONFORME EMAIL DA GERDAU DE<br /><br />\r\n24.02.2016, E RELACAO DE MATERIAIS ABAIXO, FORNECIDO<br /><br />\r\nPELA ELFI.<br /><br />\r\n- VALOR DA MAO DE OBRA E MATERIAL', '10', '', '', '', '', '32200.00', '', '', '32200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-08', '2016-03-16', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n');
INSERT INTO `orcamentos` (`id`, `n_orc`, `ano_orc`, `colaborador_orc`, `situacao_orc`, `razao_social_contr`, `cnpj_contr`, `endereco_contr`, `bairro_contr`, `cidade_contr`, `estado_contr`, `cep_contr`, `telefone_contr`, `celular_contr`, `email_contr`, `contato_clint`, `razao_social_obra`, `cnpj_obra`, `endereco_obra`, `bairro_obra`, `cidade_obra`, `estado_obra`, `cep_obra`, `telefone_obra`, `celular_obra`, `email_obra`, `atividade`, `classificacao`, `quantidade`, `unidade`, `descricao_servico_orc`, `prazo_exec_orc`, `validade_orc`, `pagamento_orc`, `obs_orc`, `duvida_orc`, `vr_servco_orc`, `vr_material_orc`, `desconto_orc`, `vr_total_orc`, `obra_igual_contrat`, `data_adicionado_orc`, `data_ultima_alteracao`, `colaborador_ultim_alteracao`, `data_aprovada`, `data_inicio`, `data_conclusao`, `dias_d_aprovado`, `dias_d_exec`, `dias_ultrapassad`, `serv_concluido`, `feito_pos_entreg`, `nao_conformidade`, `obs_n_conformidad`, `client_insatisfeito`, `data_ultimo_cont_cliente`, `colab_ultimo_contato_client`, `novo_cliente`) VALUES
(198, '63', 2016, 'junior', 'Aprovado', 'FORNECEDORA MAQUINAS E EQUIPAMENTOS LTDA ', '', '', '', '', '', '', '', '', 'EMANUEL@FORNECEDORAMAQUINAS.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MEDIÃ‡ÃƒO DE LAUDO TECNICO', '2', '', '', '', '', '960.00', '', '', '960.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-10', '2016-03-23', '2016-04-01', 0, 0, 0, 's', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(199, '284', 2016, 'eduardo_reboucas', 'Aprovado', 'FORNECEDORA MAQUINAS E EQUIPAMENTOS LTDA ', '', '', '', '', '', '', '', '', 'EMANUEL@FORNECEDORAMAQUINAS.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MANUTENÃ‡ÃƒO CORREYIVA NA SUBESTAÃ‡ÃƒO', '5', '', '', '', '', '3200.00', '', '', '3200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-10', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(200, '074', 2016, 'junior', 'Aprovado', 'WHITE MARTINS GASES IND. DO NORDESTE S/A', '', '', '', '', '', '', '', '', 'gustavo_oliveira@praxair.com', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'MANUTENCAO PREVENTIVA NA SUBESTACAO AREA DE KVA E 1,00 2.900,00 2.900,00<br /><br /><br />\r\nREAPERTOS E LIMPEZA DE SEIS PAINEIS ELETRICOS DE BAIXA<br /><br /><br />\r\nTESAO NA AREA DE PRODUCAO E ADMINISTRATIVA.<br /><br /><br />\r\n- VALOR DA MAO DE OBRA', '1', '', '', '', '', '2900.00', '', '', '2900.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-10', '2016-03-13', '2016-03-18', 0, 0, 4, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(201, '76', 2016, 'junior', 'Aprovado', 'FAVO COMERCIO E REPRESENTAÃ‡Ã•ES LTDA ', '', '', '', '', '', '', '', '', 'FAVOFLORA@UOL.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'TROCA DE CHAVES ', '1', '', '', '', '', '967.00', '', '', '967.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-23', '2016-03-23', '2016-03-29', -1, 0, 5, 's', 's', 'n', '', 'n', '0000-00-00', '', 'n'),
(202, '82', 2016, 'eduardo_reboucas', 'Aprovado', 'BEACH PARK HOTEIS E TURISMO S/A', '', '', '', '', '', '', '', '', 'Emerson Oliveira da Silva <emerson@beachpark.com.br>', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'MANUTENÃ‡ÃƒO CORRETIVA DA SUBESTAÃ‡ÃƒO ELETRICA ', '1', '', '', '', '', '2010.00', '', '', '2010.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-29', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(203, '81', 2016, 'eduardo_reboucas', 'Aprovado', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '', '', '', '', '', 'FELYCIANNO@CDLFOR.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO 1,00 1.100,00 1.100,00<br /><br />\r\nDA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO<br /><br />\r\n- PROPOSTA PARA INSPECAO DO SISTEMA DE SPDA E MEDICAO 1,00 1.100,00 1.100,00<br /><br />\r\nDA MALHA DE ATERRAMENTO COM FORNECIMENTO DE LAUDO<br /><br />\r\nTECNICO E ART DO CREA-CE.', '5', '', '', '', '', '110.00', '', '', '110.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-30', '2016-04-17', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(204, '80', 2016, 'eduardo_reboucas', 'Aprovado', 'CAMARA DE DIRIGENTES LOJISTAS DE FORTALEZA', '', '', '', '', '', '', '', '', 'FELYCIANNO@CDLFOR.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', '- MANUTENCAO PREVENTIVA DA SUBESTACAO CONFORME 1,00 2.050,00 2.050,00<br /><br />\r\nRELACAO DE SERVICO ABAIXO (BANCO CAPACITOR JA INCLUSO)', '16', '', '', '', '', '2050.00', '', '', '2050.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-03-30', '2016-04-17', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(205, '35', 2016, 'eduardo_reboucas', 'Aprovado', 'GERDAU ACOS LONGOS S/A', '', '', '', '', '', '', '', '', 'raniere.goes@gerdau.combr', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'Proposta para instalaÃ§Ã£o de iluminaÃ§Ã£o na area de lazer nova', '3', '', '', '', '', '4400.00', '', '', '4400.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-04-05', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(206, '92', 2016, 'eduardo_reboucas', 'Aprovado', 'CONDOMINIO EDIFICIO IDIBRA RESIDENCE', '', '', '', '', '', '', '', '', 'LUCAS@HOLIDAYFORTALEZA.COM.BR', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamentos ElÃ©tricos', '', '', 'ManutenÃ§Ã£o preventiva de uma subestaÃ§Ã£o abrigada com 3 transformadores de forÃ§a de 300KVA, disjuntor de media tensÃ£o, chaves seccionadoras quadro geral de baixa tensÃ£o da subestaÃ§Ã£o e bancos capacitores, conforme descriÃ§Ã£o dos serviÃ§os em anexo.', '1', '', '', '', '', '2803.00', '', '', '2803.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-04-06', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(207, '98', 2016, 'eduardo_reboucas', 'Aprovado', 'poli-nutri alimentos s/a', '', '', '', '', '', '', '', '', 'pricila.santiago@polinutri.com.br', '', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '', '', 'serviÃ§o de emergencia no dia 11.04.2016', '1', '', '', '', '', '1200.00', '', '', '1200.00', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '2016-04-11', '0000-00-00', '0000-00-00', 1, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(209, '31', 2016, 'eduardo_reboucas', 'Aguardando aprovaÃ§Ã£o', 'TOTAL TRANSPORTADORA E ARMAZENS GERAIS LTDA', '09.074.664/0001-70', 'AV. DO VAQUEIRO NÂ° 620', 'ANCURI', 'FORTALEZA', 'CEARÃ', '60000-000', '(85) 3311-2350', '(85) 8552-0900', 'RH.PESSOAL@TOTALCOMERCIO.COM.BR', 'SRA. ALINE', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1', 'ServiÃ§o', '- PROPOSTA PARA ELABORAÃ‡ÃƒO DOS DIAGRAMAS UNIFILARES DOS PAINEIS ELETRICOS DE BAIXA TENSÃƒO E MEDIÃ‡ÃƒO DA MALHA DE TERRA DO QGBT E DOS PAINEIS DE DISTRIBUIÃ‡ÃƒO;QDF''S; CPD; CORREDO RH (2); GUARITA; TERREO1; TERREO 2; QDF TERREO; QUADROI GALPÃƒO DESATIVADO. NUM TOTAL DE 9 PAINEIS + SUBESTAÃ‡ÃƒO AEREA DE 112.5KVA', '15', '20', '30% COM APROVAÃ‡ÃƒO E 70% COM A CONCLUSÃƒO ', '', 'SR. ARMANDO OU EDSON', '6.980,00', '0,00', '', '6.980,00', '', '2016-04-13 14:30:12', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(210, '32', 2016, 'eduardo_reboucas', 'Aguardando aprovaÃ§Ã£o', 'MAIS SABOR IND E COM DE REFRIGERANTES LTDA', '07.196.579/0001-59', 'RUA ESPERANTO NÂ° 1250', 'VILA UNIÃƒO ', 'FORTALEZA', 'CEARÃ', '60410-620', '(85) 3444-3500', '(85) 3444-3528', 'loide.lopes@maissabor.com.br', 'SRA. LOIDE LOPES', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1', 'ServiÃ§o', '- PROPOSTA DE MÃƒO DE OBRA PARA ATIVAÃ‡ÃƒO DE DOIS BANCOS CAPACITORES E DOS 2 TRANSFORMADORES DE 500KVA E 750KVA, COM APROVEITAMENTO DOS CONTATORES, CAPACITORES, ARMARIO DE FERRO ETC, DEVENDO SER INSTALADO OS COMPONENTES RELACIONADOS ABAIXO, FORNECIDO PELO CLIENTE.<br />\r\n<br />\r\nNOTA: HOJE A MAIS SABOR ESTA PAGANDO APROXIMADAMENTE<br />\r\nR$: 4.000,00 POR MES, DE MULTA POR REATIVO EXCEDENTE<br />\r\nPARA A COELCE. LOGO INVESTIMENTO SE PAGARA EM 3 MESES.<br />\r\n<br />\r\n- VALOR DA MAO DE OBRA<br />\r\n<br />\r\n- RELACAO DE MATERIAL ABAIXO FORNECIDO PELO CLIENTE 1,00 0,00 0,00<br />\r\n(MAIS SABOR);<br />\r\n<br />\r\n02 UND - CONTROLADOR PARA FOTOR DE POTENCIA SULTECH<br />\r\nST8200C OU SIMILAR COM 12 SAIDAS 220V<br />\r\n<br />\r\n100 MT - CABO PP DE 1,5MM X 4 DE 0,6KV<br />\r\n<br />\r\n01 UND - TC DO TIPO JANELA 0,6KV DE 60HZ COM REACAO DE<br />\r\n800/5A<br />\r\n<br />\r\n01 UND - TC DO TIPO JANELA 0,6KV DE 60HZ COM REACAO DE<br />\r\n1200/5A<br />\r\n<br />\r\n100 UND - TERMINAL DO TIPO PARA CABO 1,5MM<br />\r\n<br />\r\n100 UND - TERMINAL DO TIPO OLHAL PARA CABO 1,5MM<br />\r\n<br />\r\n02 UND - DISJUNTOR UNIPOLAR 2A, SIEMENS OU SIMILAR<br />\r\n<br />\r\nNOTA: CASO ALGUM OUTRO COMPONENTE ESTEJA DANIFICADO<br />\r\nSERA INFORMADO AO CLIENTE PARA PROVIDENCIAR A COMPRA<br />\r\n<br />\r\n', '5', '10', '30% COM APROVAÃ‡ÃƒO E 70% COM A CONCLUSÃƒO ', '', 'ENGÂ° ARMANDO', '4.270,00', '0,00', '', '4.270,00', '', '2016-04-14 10:55:08', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(211, '33', 2016, 'eduardo_reboucas', 'Aguardando aprovaÃ§Ã£o', 'IREP SOCIEDADE DE ENSINO SUPERIOR MEDIO E FUNDAMENTAL LTDA', '02.608.755/0041-96', 'AV. SENADOR FERNANDES TAVORA NÂ° 137A', 'JOQUEI CLUBE', 'FORTALEZA', 'CEARÃ', '60510-111', '(85) 3194-9634', '', 'francisco.alves@estacio.br', 'FRANCISCO ALVES ', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1', 'ServiÃ§o', '- PROPOSTA DE MÃƒO DE OBRA PARA INSTALAÃ‡ÃƒO DE UMA CHAVE DE TRANSFERENCIA MANUAL PARA GRUPO GERADOR, COM QUADRO PARA ATENDER OS HORARIOS DE PICO.<br />\r\n<br />\r\n- VALOR DA MÃƒO DE OBRA <br />\r\n<br />\r\n- RELAÃ‡ÃƒO DE MATERIAL ABAIXO FORNECIDO PELA FIC<br />\r\n<br />\r\n01 UND - CHAVE DE TRANSFERENCIA MANUAL GERADOR / COELCE DE 630A<br />\r\n<br />\r\n01 UND - QUADRO DE COMANDO 800X600X400 (H X L X P)<br />\r\n<br />\r\n10 MT - ELETRODUTO CORRUGADO DE 4''<br />\r\n<br />\r\n24 MT - CABO FLEX DE 400MM 1KV<br />\r\n<br />\r\n15 UND - TERMINAL DE COMPRESSÃƒO 400MM<br />\r\n<br />\r\n', '3', '10', '100% COM A CONCLUSÃƒO ', 'NOTA- CABOS E ELETRODUTOS SERÃƒO DEFINIDOS A METRAGEM CORRETA COM LOCALIZAÃ‡ÃƒO DO GERADOR', 'ENGÂ° ARMANDO', '2.877,00', '0,00', '', '2.877,00', '', '2016-04-15 09:35:52', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(212, '34', 2016, 'eduardo_reboucas', 'Aguardando aprovaÃ§Ã£o', 'COLMEIA FATIMA RESIDENCE EMPREENDIMENTOS IMOB', '13323162000102', 'RUA THOMAZ POMPEU NÂ° 525 SALA 09', '', 'FORTALEZA', 'CEARA', '60160080', '32886619', '', 'PAULOESTEVAO@COLMEIA.COM.BR', 'ENGÂ° CLEBER FONTENELE ', 'COLMEIA ', '13.323.162/0001-02', 'AV. MINISTRO JOSE AMERICO NÂ° 757', 'CAMBEBA ', 'FORTALEZA', 'CEARA', '', '(85) 3288-6619', '(85) 9988-6771', 'CLEBER@COLMEIA.COM.BR', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1', 'ServiÃ§o', '- PROPOSTA PARA LAUDO DE ATERRAMENTO SPDA COM EMISSAO DE RELATORIO E ART DA OBRA, LOCALIZADA NA AVENIDA MINISTRO JOSE AMERICO NÂ° 757 BAIRRO: CAMBEBA', '2', '10', '100% COM A CONCLUSÃƒO ', '', 'ENGÂ° ARMANDO', '960,00', '0,00', '', '960,00', '', '2016-04-15 10:20:31', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n'),
(213, '35', 2016, 'eduardo_reboucas', 'Aguardando aprovaÃ§Ã£o', 'BEACH PARK HOTEL E TURISMO S/A - ACQUA RESORT', '11805397000539', 'R CAP VASCONCELOS 645', 'PORTO DAS DUNAS', 'FORTALEZA', 'CE', '61700-000', '85 40125875', '8531949634', 'fabianosilva@beachpark.com.br', 'SÃVIO MAIA ', '', '', '', '', '', '', '', '', '', '', 'ManutenÃ§Ã£o', 'Equipamento SubestaÃ§Ã£o', '1', 'ServiÃ§o', '- PROPOSTA PARA PINTURA DO PISO DA SUBESTAÃ‡ÃƒO DE 500KVA ENVOLVENDO TODA AREA INTERNA, COM TINTA TIPO CONCRETO PARA PISO.', '2', '20', '100% COM A CONCLUSÃƒO ', '', 'ENGÂ° ARMANDO / EDSON', '1.800,00', '0,00', '', '1.800,00', '', '2016-04-15 10:39:35', '0000-00-00 00:00:00', '', '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 'n', 'n', 'n', '', 'n', '0000-00-00', '', 'n');

-- --------------------------------------------------------

--
-- Estrutura para tabela `orc_atividades`
--

CREATE TABLE IF NOT EXISTS `orc_atividades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `atividade` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `quantidade` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;

--
-- Fazendo dump de dados para tabela `orc_atividades`
--

INSERT INTO `orc_atividades` (`id`, `atividade`, `quantidade`) VALUES
(1, 'Manutenção', 0),
(2, 'Instalação', 0),
(3, 'Medição', 0),
(4, 'Inspeção', 0),
...
(7, 'Parametrizar', 0),
(8, 'Serviço Técnico', 0),
(9, 'Projeto e Instalação', 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `orc_classificacao_ativid`
--
...
--
-- Fazendo dump de dados para tabela `orc_classificacao_ativid`
--
...
--
-- Estrutura para tabela `orc_unidades`
--

CREATE TABLE IF NOT EXISTS `orc_unidades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Fazendo dump de dados para tabela `orc_unidades`
--

INSERT INTO `orc_unidades` (`id`, `unidade`, `quantidade`) VALUES
(1, 'Serviço', 0),
(2, 'Unidade', 0);

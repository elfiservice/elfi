...
<fieldset>
    ...
    $pesquisasRespondidas = $pesquisaCtrl->buscarControleNOrc("*", "");
    ...
    <div class="col-md-3" >
        <ul class="w3-ul w3-border w3-col l4 m5">
            ...
            <li class="elfi_cor_fundo_indice elfi_cor_padrao_texto"><span class="w3-badge elfi_cor_fundo_branco elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR(($totalPesquisasRespondidas / $totalOrcConcluidos) * 100) . "%" ?></span> Total</li> 
        </ul>
    </div>
...
<fieldset>
 ...
 //var_dump($nDeConfiabilidade);
    ...
    <div class="col-md-3" >
        <ul class="w3-ul w3-border w3-col l4 m5">
            <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeConfiabilidade) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Confiabilidade </li>
            <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDepontualidade) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Pontualidade </li>
            <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDedisponibilide) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Disponibilidade </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDequalidade) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Qualidade </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeapresentacao) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Apresentação </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeenvolvimento) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Envolvimento </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeeducacao) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Educação </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeorganizacao) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Organização </li>
             <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDecompetencia) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Competencia </li>
              <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeorcamento) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Prazo entrega do Orçamento </li>
              <li><span class="w3-badge elfi_cor_fundo_tabela elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDeservico) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Prazo entrega do Serviço </li>
               
             
             
              <li class="elfi_cor_fundo_indice elfi_cor_padrao_texto"><span class="w3-badge elfi_cor_fundo_branco elfi_cor_padrao_texto w3-right"><?= Formatar::moedaBR((count($nDesatisfeito) / $totalPesquisasRespondidas) * 100) . "%" ?></span> Satisfação no Geral</li> 
        </ul>
    </div>

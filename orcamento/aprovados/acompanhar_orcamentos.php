...
<hr>
            <div class="alinhamentoHorizontal">
                <ul>
                    ...
                    <li><a class="bt_link" href="#" onclick="window.open('relatorios.php?ano_orc=<?php echo $ano_atual; ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1250, HEIGHT=500');">
                            Relatórios
                        </a>
                    </li>
                    <li><a class="bt_link" class="bt_link" href="#" onclick="window.open('link_pesquisa_satisfacao.php?mes=fev&ano_orc=<?php echo $ano_atual; ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1250, HEIGHT=500');">
                            Link Pesquisa
                        </a>
                    </li>

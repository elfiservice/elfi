...
if (isset ($_POST['razao_social']))
     ...
     $email_admin = $_POST['email_admin'];        
           ...
           if(isset($_POST['tipo'])) {
             ...
             */
         	...
         	$sql_razao = mysql_query("SELECT * FROM fornecedores WHERE razao_social='$razao_social'") or die (mysql_error()); 
		$razao_check = mysql_num_rows($sql_razao); 
                
                $sql_fantasia = mysql_query("SELECT * FROM fornecedores WHERE nome_fantasia='$nome_fantasia'") or die (mysql_error()); 
		$fantasia_check = mysql_num_rows($sql_fantasia); 
                
         	$sql_email_tec = mysql_query("SELECT * FROM fornecedores WHERE email_tec='$email_tec'") or die (mysql_error()); 
		$email_tec_check = mysql_num_rows($sql_email_tec);
         	...
         	$sql_cnpj_cpf = mysql_query("SELECT * FROM fornecedores WHERE cnpj_cpf='$cnpj_cpf'") or die (mysql_error()); 
    ...
    // Add user info into the database table for the main site table
     $sql = mysql_query("INSERT INTO fornecedores (usuario, razao_social, nome_fantasia, classificacao, data_inclusao, ie, endereco, bairro, estado, cidade, cep, tel, cel, fax, email_tec, email_adm_fin, cnpj_cpf, tipo) 
    ...
    echo "Novo fornecedor adicionado.";

...
<link rel="stylesheet" href="tabela/demo_table.css">  
	...
	<div>
		<form action="visualizar_acompanhamento_orc.php?ano_orc=<?php echo $ano_orc_selec; ?>" method="post" enctype="multipart/form-data" name="formAgenda">
			Selecione o ANO:	
    ...
    <div id="demo">
            ...
            <?php
                ...
                $consulta_usuarios = mysql_query("select * from orcamentos WHERE ano_orc = '$ano_orc' AND situacao_orc = 'Aprovado' ORDER BY id  DESC");

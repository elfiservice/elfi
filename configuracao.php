        ...
        if ($tipo_conta == "ad" && $userlogin->getId_colaborador() == 1) {
            ...
            <div style="margin:20px 0px 20px 0px;">
                ...
                <div id="painel">
                    ...
                    //QUERY STRING
                    if (!empty($menu)):
                        $includepatch = __DIR__ . DIRECTORY_SEPARATOR . 'configuracoes' . DIRECTORY_SEPARATOR . strip_tags(trim($menu) . '.php');
                    else:
                        $includepatch = __DIR__ . DIRECTORY_SEPARATOR . 'configuracao.php';
                    endif;
